...
void main() // Position - 0x0
{
	...
	func_315(5);
	func_304(&(Static_174.f_1), Global_98458[5 /*19*/]);
	func_303(&Static_174, 2);

	if (Global_114931.f_9092.f_99.f_205[9] != 5)
		Global_114931.f_9092.f_99.f_205[9] = 5;

	while (!func_302(5))
	{
		if (!Global_80576 && !func_301(14))
		{
			func_293();
			func_279(&Static_174, 32f, 35f);
			func_277(&Static_174);
			func_154();
		
			if (func_152(0) || IS_BIT_SET(Static_174.f_449, 2))
			{
				func_67(&Static_174);
				func_4(&Static_174);
				func_3(&Static_174);
...
void func_2() // Position - 0x1AD
{
	...
	uVar0 = BUILTIN::ROUND(1f + (1000f * BUILTIN::TIMESTEP()));
	Global_98649.f_8 = Global_98649.f_8 + uVar0;
}

void func_3(var uParam0) // Position - 0x1EF
{
	if (IS_BIT_SET(Global_98437, *uParam0))
	{
		if (IS_BIT_SET(uParam0->f_449, 1))
		{
			...
			MISC::CLEAR_BIT(&Global_98437, *uParam0);
		}
	}
}
...
void func_6(var uParam0, int iParam1, int iParam2) // Position - 0x2F5
{
	switch (iParam1)
	{
		...
		case 4:
			...
			Global_114931.f_1.f_6[*uParam0] = true;
			HUD::CLEAR_HELP(0);
...
bool func_10(int iParam0, int iParam1) // Position - 0x90F
{
	...
	bVar0 = IS_BIT_SET(Global_114931.f_9092.f_99.f_219[iParam0], iParam1);
	return bVar0;
}
...
void func_13(var uParam0, bool bParam1) // Position - 0x9E1
{
	int iVar0;
	int iVar1;
	...
	{
		if (MISC::ARE_STRINGS_EQUAL(uParam0, &Global_114931.f_20417[iVar0 /*16*/]))
		{
			...
			func_15(Global_114931.f_20417.f_145 - 1);
...
void func_17(var uParam0) // Position - 0xD4F
{
	...
	iVar1 = uParam0->f_1.f_16 + uParam0->f_1.f_18;
	iVar1.f_1 = uParam0->f_1.f_16.f_1 + uParam0->f_1.f_18.f_1;
	func_25(uParam0, &iVar1, uParam0->f_1.f_10);
	func_23(uParam0, 1, 1);
	func_11(uParam0, false);
	func_18(uParam0);
}
			...
			switch (uParam0->f_464)
			{
				case 3:
					if (!Global_114931.f_1[*uParam0])
					{
						...
						Global_114931.f_1[*uParam0] = true;
					}
				...
				case 2:
					if (!Global_114931.f_1.f_6[*uParam0])
					{
						...
						if (!IS_BIT_SET(uParam0->f_449, 10))
						{
							if (!func_12("PB_H_GUNM" /* GXT: Select a gunman to hire. */) && !func_12("PB_H_HACK" /* GXT: Select a hacker to hire. */) && !func_12("PB_H_DRIV" /* GXT: Select a driver to hire. */))
							{
								...
								if (uParam0->f_417 < 5)
								{
									if (!IS_BIT_SET(uParam0->f_449, 11) && !IS_BIT_SET(uParam0->f_449, 10) && !func_19() && uParam0->f_483 == 0)
									{
										switch (Global_98458[iVar0 /*19*/].f_1[uParam0->f_417])
										{
											case 1:
...
void func_25(var uParam0, var uParam1, float fParam2) // Position - 0x136C
{
	...
	uVar0 = { func_27(uParam0, &(uParam0->f_411)) };
	func_26(&(uParam0->f_649), uVar0, fParam2);
}
...
Vector3 func_27(var uParam0, var uParam1) // Position - 0x13D0
{
	...
	uVar6 = uParam0->f_404;
	uVar7 = { uParam0->f_401 };
	uVar7 = { uVar7 + { fVar5, fVar4 * BUILTIN::COS(90f - uVar6), fVar4 * BUILTIN::SIN(90f - uVar6) } };
	fVar10 = fVar4;
	fVar11 = MISC::ATAN(fVar10 / uParam0->f_1.f_8);
	fVar12 = uParam0->f_401.f_2 - uParam0->f_649.f_1.f_2;
	fVar13 = uVar7.f_2 - uParam0->f_649.f_1.f_2;
...
void func_28(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x14B5
{
	...
	uVar0 = uParam0->f_1.f_2;
	uVar1 = uParam0->f_1.f_3;

	if (*uParam1 < 0 || *uParam1 > uVar0)
		return;

	if (uParam1->f_1 < 0 || uParam1->f_1 > uVar1)
		return;

	*uParam2 = BUILTIN::TO_FLOAT(*uParam1) / BUILTIN::TO_FLOAT(uVar0);
	*uParam3 = BUILTIN::TO_FLOAT(uParam1->f_1) / BUILTIN::TO_FLOAT(uVar1);
}
...
void func_31(var uParam0) // Position - 0x1657
{
	...
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(BUILTIN::TO_FLOAT(uParam0->f_1.f_16));
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(BUILTIN::TO_FLOAT(uParam0->f_1.f_16.f_1));
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_33(uParam0);
...
{
	return IS_BIT_SET(Global_114931.f_1.f_120[iParam0], iParam1);
}
...
void func_35(var uParam0, int iParam1, int iParam2) // Position - 0x1AFF
{
	...
	func_23(uParam0, 2, 1);
	iVar0 = func_65(func_30(*uParam0));
	iVar1 = Global_98458[iVar0 /*19*/].f_1[iParam1];
...
void func_36(var uParam0, int iParam1) // Position - 0x1C35
{
	...
	iVar1 = func_65(iVar0);
	iVar2 = Global_98458[iVar1 /*19*/].f_1[iParam1];
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "CREATE_VIEW");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(BUILTIN::TO_FLOAT(uParam0->f_1.f_97[iParam1 /*2*/]));
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(BUILTIN::TO_FLOAT(uParam0->f_1.f_97[iParam1 /*2*/].f_1));
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_33(uParam0);
	iVar3 = 0;

	if (Global_114931.f_1.f_12[iVar1 /*6*/][iParam1] != 0)
	{
		iVar4 = Global_114931.f_1.f_12[iVar1 /*6*/][iParam1];
		func_41(uParam0->f_413, iVar4, iParam1, iVar3, iVar4);
	}
	else
	{
		for (iVar5 = 0; iVar5 < 14; iVar5 = iVar5 + 1)
		{
			iVar6 = iVar5;
...
bool func_37(var uParam0, int iParam1) // Position - 0x1DBF
{
	...
	for (iVar1 = 0; iVar1 < uParam0->f_417; iVar1 = iVar1 + 1)
	{
		if (Global_114931.f_1.f_12[iVar0 /*6*/][iVar1] == iParam1)
			return true;
	}
...
{
	return IS_BIT_SET(Global_114931.f_1.f_118, iParam0);
}

bool func_39(int iParam0) // Position - 0x1E17
{
	return IS_BIT_SET(Global_114931.f_1.f_116, iParam0);
}
...
{
	return Global_98304[iParam0 /*5*/].f_1;
}

var func_43(int iParam0, int iParam1) // Position - 0x1F88
{
	return BUILTIN::ROUND((BUILTIN::TO_FLOAT(func_45(iParam0, iParam1)) / BUILTIN::TO_FLOAT(func_44(iParam1))) * 100f);
}
...
{
	return func_47(iParam1, Global_114931.f_1.f_73[iParam0 /*3*/].f_1, Global_114931.f_1.f_73[iParam0 /*3*/].f_2);
}

int func_47(int iParam0, var uParam1, var uParam2) // Position - 0x2033
{
	switch (iParam0)
	{
		case 0:
		case 1:
			return BUILTIN::SHIFT_RIGHT(uParam1, 15 * iParam0) & 32767;
	
		case 2:
		case 3:
			return BUILTIN::SHIFT_RIGHT(uParam2, 15 * (iParam0 - 2)) & 32767;
	}
...
var func_50(int iParam0, int iParam1) // Position - 0x2179
{
	return BUILTIN::ROUND((BUILTIN::TO_FLOAT(func_52(iParam0, iParam1)) / BUILTIN::TO_FLOAT(func_51(iParam1))) * 100f);
}
...
var func_54(int iParam0, int iParam1) // Position - 0x2209
{
	return BUILTIN::ROUND((BUILTIN::TO_FLOAT(func_56(iParam0, iParam1)) / BUILTIN::TO_FLOAT(func_55(iParam1))) * 100f);
}
...
void func_62(var uParam0, int iParam1, int iParam2) // Position - 0x2401
{
	...
	if (!IS_BIT_SET(Global_98458[iParam1 /*19*/].f_18, iParam2))
	{
		if (!MISC::ARE_STRINGS_EQUAL(&Global_98458[iParam1 /*19*/].f_7[iParam2 /*2*/], ""))
		{
			func_24(uParam0, uParam0->f_1.f_276, Global_98458[iParam1 /*19*/].f_7[iParam2 /*2*/], 1);
			MISC::SET_BIT(&(Global_98458[iParam1 /*19*/].f_18), iParam2);
		
			for (iVar0 = 0; iVar0 < 10; iVar0 = iVar0 + 1)
			{
				if (MISC::ARE_STRINGS_EQUAL(&Global_98458[iParam1 /*19*/].f_7[iParam2 /*2*/], &Global_98458[iVar0 /*19*/].f_7[iParam2 /*2*/]))
					MISC::SET_BIT(&(Global_98458[iVar0 /*19*/].f_18), iParam2);
			}
		}
	}
}
...
int func_65(int iParam0) // Position - 0x2522
{
	...
	return Global_114931.f_9092.f_99.f_205[iParam0];
}
...
void func_68(var uParam0) // Position - 0x25B8
{
	...
	if (!IS_BIT_SET(uParam0->f_449, 2))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (!func_151(0))
			{
				if (func_142(8))
				{
					if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), uParam0->f_401) < 4f)
					{
						uVar1 = { uParam0->f_401 - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
						fVar4 = MISC::GET_HEADING_FROM_VECTOR_2D(uVar1, uVar1.f_1);
		...
		if (bVar0)
		{
			if (uParam0->f_451 == -1)
			{
				func_141(&(uParam0->f_451), 3, "PB_H_ENT" /* GXT: Press ~INPUT_CONTEXT~ to view the plans. */, 0, 0, 0, 0);
			}
			else if (func_140(uParam0->f_451, true))
			{
	...
	else
	{
		...
		if (!bVar7 && uParam0->f_453 > 15 && PAD::IS_CONTROL_JUST_PRESSED(2, Static_34) || PAD::IS_CONTROL_JUST_PRESSED(2, 238) || IS_BIT_SET(uParam0->f_449, 8))
		{
...
void func_69(var uParam0, bool bParam1) // Position - 0x27D1
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			uVar0 = { uParam0->f_401 };
			uVar0 = { uVar0 + { 0f, 1f * BUILTIN::COS(180f - uParam0->f_404), 1f * BUILTIN::SIN(180f - uParam0->f_404) } };
...
void func_79(var uParam0) // Position - 0x2BCC
{
	...
	uVar0 = PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(0, 1, 1);
	...
	func_80(&(uParam0->f_649), IS_BIT_SET(uParam0->f_449, 4), IS_BIT_SET(uParam0->f_449, 5) && !bVar1, true, false, 1045220557, true, 1065353216, false);
	...
	if (!IS_BIT_SET(uParam0->f_449, 7))
	{
		...
		{
			uVar2 = { uParam0->f_401 };
			uVar2 = { uVar2 + { 0.5f, 2.9f * BUILTIN::COS(180f - uParam0->f_404), 2.9f * BUILTIN::SIN(180f - uParam0->f_404) } };
			MISC::GET_GROUND_Z_FOR_3D_COORD(uVar2, &(uVar2.f_2), 0, 0);
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 134);
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
			ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 1);
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), uVar2, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), uParam0->f_404);
...
void func_80(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, bool bParam8) // Position - 0x2E09
{
	...
	func_83(&uVar0[0], &uVar0[1], &uVar0[2], &uVar0[3], false, false);
	...
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2))
	{
		...
		if (bParam4)
		{
			uVar0[2] = -BUILTIN::ROUND(fVar7 * iParam5 * 127f);
			uVar0[3] = -BUILTIN::ROUND(fVar8 * iParam5 * 127f);
		}
		else
		{
			uVar0[2] = BUILTIN::ROUND(PAD::GET_CONTROL_UNBOUND_NORMAL(2, 327) * iParam5 * 127f);
			uVar0[3] = BUILTIN::ROUND(PAD::GET_CONTROL_UNBOUND_NORMAL(2, 328) * iParam5 * 127f);
		}
	
		uVar0[2] = func_82(uVar0[2] + uParam0->f_24, -127, 127);
		uVar0[3] = func_82(uVar0[3] + uParam0->f_25, -127, 127);
	}

	if (uParam0->f_24 == uVar0[2] && uParam0->f_25 == uVar0[3])
	{
	...
	{
		uParam0->f_24 = uVar0[2];
		uParam0->f_25 = uVar0[3];
	...
	if (bParam2)
	{
		uParam0->f_8.f_2 = -(BUILTIN::TO_FLOAT(uVar0[2]) / 127f) * (float)uParam0->f_20;
		uParam0->f_8.f_1 = (-uParam0->f_8.f_2 * (float)uParam0->f_22) / (float)uParam0->f_20;
		uParam0->f_8 = -(BUILTIN::TO_FLOAT(uVar0[3]) / 127f) * (float)uParam0->f_21;
	}
	else
	{
		uParam0->f_8 = { 0f, 0f, 0f };
	...
	fVar9 = 30f * BUILTIN::TIMESTEP();
	fVar10 = { uParam0->f_8 + uParam0->f_11 };

	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && bParam2 && !uParam0->f_28)
	{
		uParam0->f_14 = fVar10;
		uParam0->f_14.f_1 = fVar10.f_1;
		uParam0->f_14.f_2 = fVar10.f_2;
	}
	else
	{
		uParam0->f_14 = uParam0->f_14 + func_81((fVar10 - uParam0->f_14) * 0.05f * fVar9 * iParam7, -3f, 3f);
		uParam0->f_14.f_1 = uParam0->f_14.f_1 + func_81((fVar10.f_1 - uParam0->f_14.f_1) * 0.05f * fVar9 * iParam7, -3f, 3f);
		uParam0->f_14.f_2 = uParam0->f_14.f_2 + func_81((fVar10.f_2 - uParam0->f_14.f_2) * 0.05f * fVar9 * iParam7, -3f, 3f);
	}

	if (uParam0->f_26)
	{
		uParam0->f_14 = func_81(uParam0->f_14, BUILTIN::TO_FLOAT(-uParam0->f_21), BUILTIN::TO_FLOAT(uParam0->f_21));
		uParam0->f_14.f_1 = func_81(uParam0->f_14.f_1, BUILTIN::TO_FLOAT(-uParam0->f_22), BUILTIN::TO_FLOAT(uParam0->f_22));
		uParam0->f_14.f_2 = func_81(uParam0->f_14.f_2, BUILTIN::TO_FLOAT(-uParam0->f_20), BUILTIN::TO_FLOAT(uParam0->f_20));
	}
	...
	if (bParam1)
	{
		...
		{
			uVar0[1] = PAD::GET_CONTROL_VALUE(2, 207);
			uVar0[3] = PAD::GET_CONTROL_VALUE(2, 208);
		
			if (bParam3)
			{
				if (BUILTIN::TO_FLOAT(uVar0[3]) > 127f)
					uParam0->f_17 = uParam0->f_17 - (float)BUILTIN::ROUND((BUILTIN::TO_FLOAT(uVar0[3]) / 128f) * (uParam0->f_19 / 2f));
			}
			else
			{
				uParam0->f_17 = uParam0->f_17 + (float)BUILTIN::ROUND((BUILTIN::TO_FLOAT(uVar0[1]) / 128f) * uParam0->f_19);
				uParam0->f_17 = uParam0->f_17 - (float)BUILTIN::ROUND((BUILTIN::TO_FLOAT(uVar0[3]) / 128f) * uParam0->f_19);
			}
		}
		else if (bParam3)
		{
			if (BUILTIN::TO_FLOAT(uVar0[1]) < 0f)
				uParam0->f_17 = uParam0->f_17 + (float)BUILTIN::ROUND((BUILTIN::TO_FLOAT(uVar0[1]) / 128f) * uParam0->f_19);
		}
		else
		{
...
{
	*uParam0 = BUILTIN::FLOOR(PAD::GET_CONTROL_UNBOUND_NORMAL(2, 218) * 127f);
	*uParam1 = BUILTIN::FLOOR(PAD::GET_CONTROL_UNBOUND_NORMAL(2, 219) * 127f);
	*uParam2 = BUILTIN::FLOOR(PAD::GET_CONTROL_UNBOUND_NORMAL(2, 220) * 127f);
	*uParam3 = BUILTIN::FLOOR(PAD::GET_CONTROL_UNBOUND_NORMAL(2, 221) * 127f);

	if (bParam4)
	{
		if (!PAD::IS_CONTROL_ENABLED(2, 218))
			*uParam0 = BUILTIN::FLOOR(PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(2, 218) * 127f);
	
		if (!PAD::IS_CONTROL_ENABLED(2, 219))
			*uParam1 = BUILTIN::FLOOR(PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(2, 219) * 127f);
	
		if (!PAD::IS_CONTROL_ENABLED(2, 220))
			*uParam2 = BUILTIN::FLOOR(PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(2, 220) * 127f);
	
		if (!PAD::IS_CONTROL_ENABLED(2, 221))
			*uParam3 = BUILTIN::FLOOR(PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(2, 221) * 127f);
	}
	...
	if (!func_10(3, *uParam0))
	{
		if (uParam0->f_483 == 0 && uParam0->f_455 > 3)
		{
			...
			else if (MISC::GET_GAME_TIMER() > uParam0->f_452)
			{
				...
				for (iVar1 = 0; iVar1 < uParam0->f_1.f_369; iVar1 = iVar1 + 1)
				{
					if (!bVar0)
					{
...
void func_85(int iParam0, int iParam1, bool bParam2) // Position - 0x3583
{
	...
	if (bParam2)
		MISC::SET_BIT(&Global_114931.f_9092.f_99.f_219[iParam0], iParam1);
	else
		MISC::CLEAR_BIT(&Global_114931.f_9092.f_99.f_219[iParam0], iParam1);
}
...
bool func_93(int iParam0, int iParam1) // Position - 0x3BE7
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_94(int iParam0) // Position - 0x3BFF
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_95() // Position - 0x3C11
{
	return -1;
}

void func_96() // Position - 0x3C1A
{
	int iVar0;
...
int func_100() // Position - 0x3E1B
{
	func_101();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_101() // Position - 0x3E34
{
	int iVar0;

	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_104(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_103(PLAYER::PLAYER_PED_ID());
		
			if (func_102(iVar0) && !func_301(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != iVar0 && func_102(Global_114931.f_2370.f_539.f_4321))
...
bool func_102(int iParam0) // Position - 0x3F31
{
	return iParam0 < 3;
}

int func_103(int iParam0) // Position - 0x3F3D
{
	int iVar0;
	int iVar1;
...
int func_104(int iParam0) // Position - 0x3F7A
{
	if (func_102(iParam0))
...
int func_105(int iParam0) // Position - 0x3F9F
{
	return Global_2339[iParam0 /*29*/];
}

void func_106() // Position - 0x3FAE
{
	int iVar0;
...
bool func_107(int iParam0, int iParam1) // Position - 0x4006
{
	switch (iParam0)
	{
		case 5:
...
void func_109(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4095
{
...
void func_110(var uParam0) // Position - 0x40EB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!IS_BIT_SET(uParam0->f_449, 11))
	{
		if (PAD::IS_CONTROL_JUST_PRESSED(2, Static_35) || PAD::IS_CONTROL_JUST_PRESSED(2, Static_37) || PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_PRESSED(2, Static_36) || PAD::IS_CONTROL_JUST_PRESSED(2, Static_38))
		{
			func_120();
	...
	if (!IS_BIT_SET(uParam0->f_449, 10))
	{
		if (!IS_BIT_SET(uParam0->f_449, 11))
		{
			if (MISC::GET_GAME_TIMER() - uParam0->f_456 > 200)
			{
				...
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, Static_35) || PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_PRESSED(2, Static_36))
					{
						switch (uParam0->f_464)
						{
							case 3:
							...
							case 2:
								if (!func_10(4, *uParam0))
								{
									...
									if (uParam0->f_450 < Global_98458[iVar1 /*19*/])
									{
										GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "GET_CURRENT_SELECTION");
							...
							case 4:
								...
								for (iVar2 = 0; iVar2 < Global_98458[iVar1 /*19*/]; iVar2 = iVar2 + 1)
								{
									if (Global_114931.f_1.f_12[iVar1 /*6*/][iVar2] == 0 || func_40(Global_114931.f_1.f_12[iVar1 /*6*/][iVar2]) != Global_98458[iVar1 /*19*/].f_1[iVar2])
									{
										bVar4 = false;
										...
										for (iVar5 = 0; iVar5 < 14; iVar5 = iVar5 + 1)
										{
											if (!bVar4)
											{
												...
												if (iVar3 != 0)
												{
													if (Global_98304[iVar3 /*5*/] != Global_98458[iVar1 /*19*/].f_1[iVar2])
														bVar4 = false;
												
													if (!IS_BIT_SET(Global_114931.f_1.f_116, iVar3))
														bVar4 = false;
												
													if (IS_BIT_SET(Global_114931.f_1.f_118, iVar3))
														bVar4 = false;
										...
										Global_114931.f_1.f_12[iVar1 /*6*/][iVar2] = iVar3;
									}
								}
					...
					if (PAD::IS_CONTROL_JUST_PRESSED(2, Static_37) || PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_PRESSED(2, Static_38))
					{
						switch (uParam0->f_464)
						{
							case 2:
								...
								if (uParam0->f_450 > 0)
								{
									...
									iVar6 = Global_114931.f_1.f_12[iVar1 /*6*/][uParam0->f_450];
									Global_114931.f_1.f_12[iVar1 /*6*/][uParam0->f_450] = 0;
									uParam0->f_465 = Global_98458[iVar1 /*19*/].f_1[uParam0->f_450];
								...
								else if (!func_302(0))
								{
									if (*uParam0 != 2)
									{
										for (iVar7 = 0; iVar7 < uParam0->f_1.f_96; iVar7 = iVar7 + 1)
										{
											GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
										...
										for (iVar7 = 0; iVar7 < 2; iVar7 = iVar7 + 1)
										{
											if (uParam0->f_1.f_30[iVar7] != 13)
												func_116(*uParam0, uParam0->f_1.f_30[iVar7], false);
										}
							...
							case 4:
								if (*uParam0 != 1)
								{
									...
									uParam0->f_450 = uParam0->f_450 - 1;
									uParam0->f_417 = uParam0->f_450;
									iVar8 = Global_114931.f_1.f_12[iVar1 /*6*/][uParam0->f_450];
									Global_114931.f_1.f_12[iVar1 /*6*/][uParam0->f_450] = 0;
									uParam0->f_465 = Global_98458[iVar1 /*19*/].f_1[uParam0->f_450];
								...
								else
								{
									for (iVar9 = 0; iVar9 < 2; iVar9 = iVar9 + 1)
									{
										if (uParam0->f_1.f_30[iVar9] != 13)
											func_116(*uParam0, uParam0->f_1.f_30[iVar9], false);
									}
	...
	else if (uParam0->f_455 > 5)
	{
		...
		if (uParam0->f_450 >= Global_98458[iVar1 /*19*/] || *uParam0 == 1 && uParam0->f_450 > uParam0->f_415)
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "FOCUS_VIEW");
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(99);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(-1);
		...
		else
		{
			...
			{
				iVar10 = Global_114931.f_1.f_12[iVar1 /*6*/][uParam0->f_450];
				Global_114931.f_1.f_12[iVar1 /*6*/][uParam0->f_450] = 0;
				uParam0->f_465 = Global_98458[iVar1 /*19*/].f_1[uParam0->f_450];
	...
	if (uParam0->f_680 != 0)
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uParam0->f_680))
		{
			...
			if (uParam0->f_1.f_30[iVar11] != 13)
				func_116(*uParam0, uParam0->f_1.f_30[iVar11], true);
		
			for (iVar12 = 0; iVar12 < uParam0->f_1.f_96; iVar12 = iVar12 + 1)
			{
				func_61(uParam0, iVar12);
			
				if (iVar12 < Global_98458[iVar1 /*19*/])
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SHOW_VIEW");
	...
	if (uParam0->f_681 != 0)
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uParam0->f_681))
		{
			...
			iVar0 = func_30(*uParam0);
			iVar1 = func_65(iVar0);
			Global_114931.f_1.f_12[iVar1 /*6*/][uParam0->f_450] = uParam0->f_418[iVar13];
			iVar14 = Global_114931.f_1.f_12[iVar1 /*6*/][uParam0->f_450];
...
void func_111(var uParam0, int iParam1) // Position - 0x4E93
{
	if (!func_19())
	{
		if (uParam0->f_483 == 0)
		{
			...
			{
				case 10:
					if (IS_BIT_SET(Global_114931.f_1.f_119, 14))
					{
						if (!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_304[14 /*2*/], ""))
						{
							...
							MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 14);
				...
				case 13:
					if (IS_BIT_SET(Global_114931.f_1.f_119, 16))
					{
						if (!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_304[16 /*2*/], ""))
						{
							...
							MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 16);
							MISC::SET_BIT(&(uParam0->f_449), 12);
							return;
						}
					}
				...
				case 12:
					if (IS_BIT_SET(Global_114931.f_1.f_119, 15))
					{
						if (!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_304[15 /*2*/], ""))
						{
							...
							MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 15);
							MISC::SET_BIT(&(uParam0->f_449), 12);
							return;
						}
					}
				...
				case 11:
					if (IS_BIT_SET(Global_114931.f_1.f_119, 17))
					{
						if (!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_304[17 /*2*/], ""))
						{
							...
							MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 17);
							MISC::SET_BIT(&(uParam0->f_449), 12);
							return;
						}
					}
		...
		else
		{
			switch (*uParam0)
			{
				case 2:
					...
					{
						case 1:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 0))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					
						case 10:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 1))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					}
					break;
				...
				case 3:
					...
					{
						case 12:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 3))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[24 /*2*/], 1);
							break;
					
						case 9:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 6))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[26 /*2*/], 1);
							break;
					
						case 1:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 0))
								if (IS_BIT_SET(Global_114931.f_1.f_117, 7))
									func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
								else
									func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							else if (IS_BIT_SET(Global_114931.f_1.f_117, 7))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
							break;
					
						case 10:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 1))
								if (IS_BIT_SET(Global_114931.f_1.f_117, 8))
									func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
								else
									func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							else if (IS_BIT_SET(Global_114931.f_1.f_117, 8))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
							break;
					
						case 6:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 4))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					
						case 7:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 2))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					
						case 8:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 5))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					}
					break;
				...
				case 4:
					...
					{
						case 12:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 15))
								if (IS_BIT_SET(Global_114931.f_1.f_117, 3))
						...
						case 4:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 17))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
							break;
					
						case 5:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 12))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
							break;
					
						case 1:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 10))
								if (IS_BIT_SET(Global_114931.f_1.f_117, 0))
									if (IS_BIT_SET(Global_114931.f_1.f_117, 7))
						...
						case 10:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 11))
								if (IS_BIT_SET(Global_114931.f_1.f_117, 1))
									if (IS_BIT_SET(Global_114931.f_1.f_117, 8))
										func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[23 /*2*/], 1);
									else
						...
						case 3:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 13))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
							break;
					
						case 6:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 19))
								if (IS_BIT_SET(Global_114931.f_1.f_117, 4))
									func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
								else
									func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
						...
						case 8:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 16))
								if (IS_BIT_SET(Global_114931.f_1.f_117, 5))
									func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
								else
									func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
						...
						case 13:
							if (IS_BIT_SET(Global_114931.f_1.f_117, 20))
								func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
							break;
					}
					break;
...
void func_113(int iParam0) // Position - 0x57CE
{
	int iVar0;
	...
	{
		case 0:
			iVar0 = Global_114931.f_9092.f_99.f_205[7];
		...
		case 1:
			iVar0 = Global_114931.f_9092.f_99.f_205[8];
		...
		case 3:
			iVar0 = Global_114931.f_9092.f_99.f_205[10];
		...
		case 4:
			iVar0 = Global_114931.f_9092.f_99.f_205[11];
...
void func_114(int iParam0, int iParam1) // Position - 0x58C9
{
	if (iParam0 == 13 || iParam0 == -1)
		return;
...
void func_115(int iParam0, bool bParam1) // Position - 0x590E
{
...
void func_116(int iParam0, int iParam1, bool bParam2) // Position - 0x5953
{
	if (bParam2)
		MISC::SET_BIT(&Global_114931.f_1.f_120[iParam0], iParam1);
	else
		MISC::CLEAR_BIT(&Global_114931.f_1.f_120[iParam0], iParam1);

	MISC::SET_BIT(&Global_98437, iParam0);
}

void func_117(int iParam0) // Position - 0x5991
{
	int iVar0;
	int iVar1;
	...
	{
		case 0:
			iVar1 = Global_114931.f_9092.f_99.f_205[7];
		
			for (iVar0 = 0; iVar0 < Global_98458[iVar1 /*19*/]; iVar0 = iVar0 + 1)
			{
				switch (Global_114931.f_1.f_12[iVar1 /*6*/][iVar0])
				{
					case 1:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 0);
						break;
				
					case 10:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 1);
						MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 14);
						break;
				
					case 7:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 2);
						break;
				
					case 12:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 3);
						MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 15);
						break;
				
					case 6:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 4);
						break;
				
					case 8:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 5);
						break;
				
					case 9:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 6);
						break;
				}
			
				MISC::SET_BIT(&(Global_114931.f_1.f_119), Global_114931.f_1.f_12[iVar1 /*6*/][iVar0]);
			}
			break;
	
		case 2:
			iVar1 = Global_114931.f_9092.f_99.f_205[9];
			...
			for (iVar0 = 0; iVar0 < Global_98458[iVar1 /*19*/]; iVar0 = iVar0 + 1)
			{
				...
				{
					case 1:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 7);
						break;
				
					case 10:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 8);
						MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 14);
						break;
				
					case 11:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 9);
						MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 17);
						break;
				}
		...
		case 3:
			iVar1 = Global_114931.f_9092.f_99.f_205[10];
			...
			for (iVar0 = 0; iVar0 < Global_98458[iVar1 /*19*/]; iVar0 = iVar0 + 1)
			{
				...
				{
					case 1:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 10);
						break;
				
					case 10:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 11);
						MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 14);
						break;
				
					case 5:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 12);
						break;
				
					case 3:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 13);
						break;
				
					case 4:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 17);
						break;
				
					case 7:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 14);
						break;
				
					case 12:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 15);
						MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 15);
						break;
				
					case 6:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 19);
						break;
				
					case 8:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 16);
						break;
				
					case 9:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 18);
						break;
				
					case 13:
						MISC::SET_BIT(&(Global_114931.f_1.f_117), 20);
						MISC::CLEAR_BIT(&(Global_114931.f_1.f_119), 16);
						break;
				}
...
void func_118(int iParam0) // Position - 0x5D0E
{
	switch (iParam0)
	{
		case 0:
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 0);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 1);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 2);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 3);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 4);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 5);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 6);
			break;
	
		case 2:
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 7);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 8);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 9);
			break;
	
		case 3:
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 10);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 11);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 12);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 13);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 14);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 15);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 16);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 17);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 18);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 19);
			MISC::CLEAR_BIT(&(Global_114931.f_1.f_117), 20);
			break;
	}
}

bool func_119(bool bParam0) // Position - 0x5E56
{
...
void func_120() // Position - 0x5E7E
{
	Global_21866 = 0;
	func_121();
}

void func_121() // Position - 0x5E8E
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
void func_122() // Position - 0x5EAF
{
	RECORDING::REPLAY_PREVENT_RECORDING_THIS_FRAME();
	func_123();
}

void func_123() // Position - 0x5EBF
{
	Global_24407.f_134 = 1;
}

void func_124(var uParam0) // Position - 0x5ECD
{
	var uVar0;
	int iVar3;
	...
	if (!CUTSCENE::IS_CUTSCENE_PLAYING())
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			uVar0 = { uParam0->f_401 };
			uVar0 = { uVar0 + { 0.5f, 2.9f * BUILTIN::COS(180f - uParam0->f_404), 2.9f * BUILTIN::SIN(180f - uParam0->f_404) } };
			MISC::GET_GROUND_Z_FOR_3D_COORD(uVar0, &(uVar0.f_2), 0, 0);
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 134);
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), uVar0, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), uParam0->f_404);
	...
	HUD::SET_HUD_COMPONENT_POSITION(17, 0.612f, 0.818f);
	GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
	func_127(&(uParam0->f_649), uParam0->f_405, uParam0->f_408, 45f, 18, 13, 3, uParam0->f_1.f_9, 0, 0, -1082130432, false);
	iVar3 = INTERIOR::GET_INTERIOR_AT_COORDS(uParam0->f_401);

	if (iVar3 != 0)
		INTERIOR::PIN_INTERIOR_IN_MEMORY(iVar3);

	INTERIOR::SET_ROOM_FOR_GAME_VIEWPORT_BY_NAME(&(Global_98375[uParam0->f_1.f_1 /*15*/].f_7));
...
void func_126(bool bParam0) // Position - 0x611D
{
	if (!bParam0)
...
void func_127(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, var uParam11, int iParam12, int iParam13, int iParam14, bool bParam15) // Position - 0x613B
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_128() // Position - 0x6233
{
	Global_24407.f_5 = 1;
}

void func_129(int iParam0) // Position - 0x6241
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_130(int iParam0) // Position - 0x629A
{
...
int func_131(int iParam0) // Position - 0x631D
{
	int iVar0;
...
void func_132(int iParam0, int iParam1, int iParam2) // Position - 0x634E
{
	func_133(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_133(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x6363
{
	int iVar0;
...
bool func_135(int iParam0, int iParam1, int iParam2) // Position - 0x6416
{
...
int func_136(int iParam0, int iParam1, int iParam2) // Position - 0x6431
{
	int iVar0;
...
int func_137(int iParam0) // Position - 0x647D
{
	int iVar0;
...
void func_138(var uParam0) // Position - 0x64C6
{
	int iVar0;
...
int func_139(int iParam0) // Position - 0x651D
{
	int iVar0;
...
bool func_140(int iParam0, bool bParam1) // Position - 0x6558
{
	int iVar0;
...
void func_141(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x6610
{
	int iVar0;
...
bool func_142(int iParam0) // Position - 0x673B
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_150() || Global_113978 || Global_33795 || func_149() || func_107(8, -1) || func_148() || func_147() || func_146() || func_145() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_150() || Global_33795 || func_149() || func_107(8, -1) || func_146() || func_148() || func_147() || func_145() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_150() || Global_113978 || Global_33795 || func_149() || func_107(8, -1) || func_146() || func_148() || func_147() || func_145() || Global_114931.f_7695.f_919[iVar0] == 5 || Global_45433 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_150() || Global_113978 || Global_33795 || func_149() || func_107(8, -1) || func_148() || func_147() || func_145() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 4:
						if (func_150() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_107(8, -1) || func_145() || func_144() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_150() || Global_33795 || func_149() || func_107(8, -1) || func_147() || func_146() || func_145() || Global_114931.f_7695.f_919[iVar0] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_150() || func_147() || Global_113978 || Global_33795 || func_149() || Global_46111 || func_107(8, -1) || func_146() || func_144() || func_145() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_150() || Global_113978 || Global_33795 || func_149() || func_107(8, -1) || func_146() || func_144() || func_148() || func_147() || func_145())
							return false;
						break;
				}
			}
...
bool func_143() // Position - 0x6E58
{
	return Global_102493.f_1;
}

bool func_144() // Position - 0x6E66
{
	if (Global_99351 != -1)
...
bool func_147() // Position - 0x6ECD
{
	return Global_102506.f_418 > 0;
}

bool func_148() // Position - 0x6EDE
{
	return Global_102506.f_417 > 0;
}

bool func_149() // Position - 0x6EEF
{
	return Global_1575092;
}

bool func_150() // Position - 0x6EFB
{
...
bool func_151(int iParam0) // Position - 0x6F17
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
bool func_152(int iParam0) // Position - 0x6F6E
{
	return func_153(iParam0, Global_44886);
}

bool func_153(int iParam0, int iParam1) // Position - 0x6F7F
{
	if (iParam1 == 15)
		return 1;
...
void func_154() // Position - 0x7160
{
	...
	if (func_302(40))
	{
		if (func_302(39))
		{
			...
			{
				if (!ENTITY::IS_ENTITY_DEAD(Static_126, 0))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_126, "LESTER", 1, 0, 0);
			
				if (!ENTITY::IS_ENTITY_DEAD(Static_127, 0))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_127, "MICHAEL" /* GXT: Michael */, 0, joaat("PLAYER_ZERO"), 0);
			
				if (!ENTITY::IS_ENTITY_DEAD(Static_130[2], 0))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_130[2], "TREVOR" /* GXT: Trevor */, 0, joaat("PLAYER_TWO"), 0);
			
				func_126(true);
				func_72(true);
				func_268(true, true, true, 0, false, false, false);
				Static_40 = -1;
		...
		else if (CUTSCENE::IS_CUTSCENE_PLAYING())
		{
			...
			if (IS_BIT_SET(Static_39, 18))
			{
				if (!ENTITY::IS_ENTITY_DEAD(Static_127, 0))
					ENTITY::SET_ENTITY_VISIBLE(Static_127, 1, 0);
			
				if (!ENTITY::IS_ENTITY_DEAD(Static_126, 0))
					ENTITY::SET_ENTITY_VISIBLE(Static_126, 1, 0);
			
				if (ENTITY::DOES_ENTITY_EXIST(Static_130[2]))
					ENTITY::SET_ENTITY_VISIBLE(Static_130[2], 1, 0);
			
				MISC::CLEAR_BIT(&Static_39, 18);
			}
		
			if (!CAM::DOES_CAM_EXIST(Static_125))
				Static_125 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), 1398.167f, 3605.4375f, 39.6443f, -8.2882f, 0f, 126.8884f, 50f, 1, 2);
		
			CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
		
			if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Trevor" /* GXT: Trevor */, 0)))
			{
				if (!IS_BIT_SET(Static_39, 7))
				{
					Static_130[2] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Trevor" /* GXT: Trevor */, 0));
					MISC::SET_BIT(&Static_39, 7);
				}
			}
			...
			{
				if (func_100() != 2)
					if (func_263(&Static_130, 2))
						func_199(&Static_130, false, false, 0);
				...
				if (!func_119(false))
				{
					...
					uVar0 = { 1391.8099f, 3614.6062f, 37.97f };
					MISC::GET_GROUND_Z_FOR_3D_COORD(uVar0, &(uVar0.f_2), 0, 0);
					...
					MISC::SET_BIT(&Static_39, 11);
					Static_128 = 0;
				}
				else
				{
					MISC::CLEAR_BIT(&Static_39, 11);
					MISC::CLEAR_BIT(&Static_39, 17);
				}
			}
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(1))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(Static_126))
					PED::DELETE_PED(&Static_126);
			
				if (ENTITY::DOES_ENTITY_EXIST(Static_127))
					PED::DELETE_PED(&Static_127);
			
				func_198(15000);
				GRAPHICS::RESET_ADAPTATION(6);
			}
		}
		else if (IS_BIT_SET(Static_39, 11))
		{
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!IS_BIT_SET(Static_39, 12))
				{
					func_197(&(Static_174.f_484), 2, PLAYER::PLAYER_PED_ID(), "TREVOR" /* GXT: Trevor */, 1, 1);
				
					if (func_88(&(Static_174.f_484), "RBS1AUD", "RBS1_VOMIT", 8, 0, 0, 0))
						MISC::SET_BIT(&Static_39, 12);
				}
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_PUKING_LEADOUT", 3))
				{
					...
					if (fVar4 < 1f && fVar4 >= 0f)
					{
						...
						{
							if (!IS_BIT_SET(Static_39, 13))
							{
								if (Static_128 == 0)
								{
									Static_128 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_PED_BONE("SCR_TREV_PUKE", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1f, 0, 0, 0);
									MISC::SET_BIT(&Static_39, 13);
									...
									if (CAM::DOES_CAM_EXIST(Static_125))
										CAM::DESTROY_CAM(Static_125, 0);
								}
							}
						}
						else if (fVar4 > 0.22f && fVar4 < 0.3f)
						{
							if (!IS_BIT_SET(Static_39, 14))
							{
								if (Static_128 == 0)
								{
									Static_128 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_PED_BONE("SCR_TREV_PUKE", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1f, 0, 0, 0);
									MISC::SET_BIT(&Static_39, 14);
								}
							}
						}
						else if (fVar4 > 0.34f && fVar4 < 0.36f)
						{
							if (!IS_BIT_SET(Static_39, 15))
							{
								if (Static_128 == 0)
								{
									Static_128 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_PED_BONE("SCR_TREV_PUKE", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1f, 0, 0, 0);
									MISC::SET_BIT(&Static_39, 15);
								}
							}
						}
						else if (fVar4 > 0.4222f && fVar4 < 0.516f)
						{
							if (!IS_BIT_SET(Static_39, 16))
							{
								if (Static_128 == 0)
								{
									Static_128 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_PED_BONE("SCR_TREV_PUKE", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1f, 0, 0, 0);
									MISC::SET_BIT(&Static_39, 16);
								}
							}
						}
						else if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(Static_128))
						{
							GRAPHICS::STOP_PARTICLE_FX_LOOPED(Static_128, 0);
							Static_128 = 0;
						}
				...
				else if (IS_BIT_SET(Static_39, 16))
				{
					MISC::CLEAR_BIT(&Static_39, 11);
				}
			}
		...
		else if (Static_40 == -1)
		{
			...
			{
				Static_40 = MISC::GET_GAME_TIMER() + 1000;
			}
		}
		else if (MISC::GET_GAME_TIMER() > Static_40)
		{
			if (!func_119(false))
			{
				Global_65027 = false;
			...
			func_72(false);
			func_194(&(Global_114931.f_2370.f_539), 91);
			func_164(&(Global_114931.f_2370.f_539), 91);
		
			if (ENTITY::DOES_ENTITY_EXIST(Static_44))
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Static_44, 0))
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Static_44, 0, 1);
		
			func_163(&Static_42);
			MISC::CLEAR_BIT(&Static_39, 1);
			PED::REMOVE_SCENARIO_BLOCKING_AREA(Static_123, 0);
		
			if (Static_124 != -1)
				if (PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(Static_124))
					PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(Static_124);
		
			PED::CLEAR_PED_NON_CREATION_AREA();
			PATHFIND::SET_PED_PATHS_IN_AREA(Static_174.f_1.f_394 - Static_174.f_1.f_397, Static_174.f_1.f_394 + Static_174.f_1.f_397, 1, 0);
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LEADOUT", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LeadOut_FPS", 3))
			Static_41 = MISC::GET_GAME_TIMER() + 4000;

	if (MISC::GET_GAME_TIMER() < Static_41)
	{
		if (!PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
...
void func_155(int iParam0) // Position - 0x7A0D
{
	if (iParam0 == -1)
		return;
...
void func_156(int iParam0, bool bParam1) // Position - 0x7A32
{
	int iVar0;
	int iVar1;
	...
	if (!func_39(10) && IS_BIT_SET(Global_114931.f_25002.f_8[4], 0))
		func_160(9, true);

	if (!func_39(13) && IS_BIT_SET(Global_114931.f_25002.f_8[16], 0))
		func_160(12, true);
	...
	if (!bParam1)
	{
		...
		func_157("DI_FEED_HST" /* GXT: Heist crew members */);
	}
}

void func_157(char* sParam0) // Position - 0x7BF8
{
...
bool func_158(int iParam0) // Position - 0x7C1C
{
	int iVar0;
	int iVar1;
...
bool func_159(int iParam0) // Position - 0x7C5C
{
...
void func_160(int iParam0, bool bParam1) // Position - 0x7C88
{
	int iVar0;
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_162(iParam0))
		{
			...
			if (!bParam1)
				func_157(func_161(iParam0));
		}
	}
}

char* func_161(int iParam0) // Position - 0x7CD1
{
	switch (iParam0)
	{
		case 0:
...
bool func_162(int iParam0) // Position - 0x7DB4
{
...
void func_163(var uParam0) // Position - 0x7DE0
{
	if (*uParam0 == -1)
		return;
...
void func_164(var uParam0, int iParam1) // Position - 0x7E1D
{
	switch (iParam1)
	{
		case 17:
		...
		case 42:
			...
			Global_101858[0 /*98*/] = false;
			func_165(uParam0, 2, 59);
			Global_101858[2 /*98*/] = false;
			break;
...
int func_165(var uParam0, int iParam1, int iParam2) // Position - 0x8168
{
	int iVar0;
	var uVar1;
	var uVar99;
	...
	if (!IS_BIT_SET(Global_114931.f_9092.f_99.f_219[0], 9))
	{
		iVar0 = Global_114931.f_18540[iParam1];
	...
	Global_114931.f_18540[iParam1] = iParam2;
	...
	{
		if (!func_181(Global_100893[iParam2 /*3*/], 0f, 0f, 0f, false))
		{
			uVar1.f_11 = 12;
			uVar1.f_31 = 49;
			uVar1.f_81 = 2;
		
			if (func_166(iParam1, iParam2, &uVar1, &uVar99, &uVar102, &uVar103, &uVar106))
				Global_101858[iParam1 /*98*/] = { uVar1 };
		}
	}
...
bool func_166(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x8285
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
	...
	{
		case 5:
			*uParam2 = { Global_101858[iParam0 /*98*/] };
		
			if (Global_102153[iParam0] != 2)
			{
				if (OBJECT::IS_POINT_IN_ANGLED_AREA(Global_102161[iParam0 /*3*/], -829.7478f, 192.11703f, 76.73248f, -827.13837f, 153.85951f, 59.961723f, 33.25f, 0, 1))
				{
					if (Global_102153[iParam0] == 1)
					{
						*uParam3 = { Global_102161[iParam0 /*3*/] - Global_114931.f_2370.f_539.f_2300[iParam0 /*3*/] };
						*uParam4 = Global_102171[iParam0] - Global_114931.f_2370.f_539.f_2310[iParam0];
					
						if (BUILTIN::VMAG2(*uParam3) > 5f * 5f)
						{
							*uParam3 = { 0f, 0f, 0f };
							*uParam4 = 0f;
							return false;
				...
				*uParam4 = Global_102171[iParam0] - Global_114931.f_2370.f_539.f_2310[iParam0];
				...
				if (BUILTIN::VMAG2(*uParam3) < 0.5f * 0.5f)
	...
	switch (iParam1)
	{
		case 110:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 32.5629f, -387.5143f, -147.166f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 341.4322f - 133f;
			return true;
	
		case 111:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 24.4283f, -689.1462f, -1306.7816f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 214.6826f - 33f;
			return true;
	
		case 153:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 79.3324f, 254.0631f, -708.9244f } - Global_100893[iParam1 /*3*/] };
		...
		case 165:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 35.0054f, -441.1681f, -1100.8779f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 297.5568f - -144.622f;
			return true;
	
		case 159:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 36.3852f, -199.5354f, -825.3141f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 29.4869f - -62.5f;
			return true;
	
		case 160:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 36.2086f, -144.1027f, -730.8218f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 28.532f - 119f;
			return true;
	
		case 167:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 31.7307f, -523.2257f, -1144.1743f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 299.2956f - -22.32f;
			return true;
	
		case 152:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 60.9436f, 314.6989f, -1421.7998f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 335.4134f - 72f;
			return true;
	
		case 157:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 79.469f, 255.3143f, -706.187f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 117.3069f - 37.27f;
			return true;
	
		case 225:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 28.7165f, -1677.7335f, 185.4888f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 54.2538f - -83.8f;
			return true;
	
		case 218:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 28.3218f, -1405.1594f, -17.556f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 91.3098f - -70.4124f;
			return true;
	
		case 219:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 30.2611f, -1492.1511f, -219.3172f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 139.2572f - -12f;
			return true;
	
		case 220:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 25.3018f, -1811.6935f, -22.6138f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 141.0423f - -117.356f;
			return true;
	
		case 206:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 208.5337f, 773.6719f, 164.1308f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 136.3104f - -36f;
			return true;
	
		case 207:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 108.9995f, 396.924f, -263.3745f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 284.4611f - -95.588f;
			return true;
	
		case 274:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 139.5782f, 2030.4458f, -1883.836f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 340.5746f - 9f;
			return true;
	
		case 312:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 10.0296f, 6560.5566f, -200.684f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 134.5505f - 110.5931f;
			return true;
	
		case 271:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 6.4647f, -1083.7513f, -1278.0234f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 115.8919f - 26.3597f;
			return true;
	
		case 248:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 102.4417f, 164.5124f, 325.8113f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 68.4108f - 10.77f;
			return true;
	
		case 242:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 56.616f, -122.9896f, -1622.2205f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 210.8653f - 13.7207f;
			return true;
	
		case 254:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 53.0019f, -213.7796f, 172.442f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 250.3032f - -40f;
			return true;
	
		case 287:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 17.3426f, -836.0328f, -887.9977f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 270.8607f - -81f;
			return true;
	
		case 286:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 4.8359f, -1182.7039f, -1264.2178f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 298.4328f - -150f;
			return true;
	
		case 239:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 104.8218f, 289.0073f, -80.4564f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 247.6446f - -122f;
			return true;
	
		case 243:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 28.2762f, -1477.2819f, 434.9171f } - Global_100893[iParam1 /*3*/] };
		...
		case 249:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 103.1881f, 177.7729f, 288.977f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 68.9831f - 138f - 180f;
			return true;
	
		case 273:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 32.7794f, -432.4635f, -161.4589f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 340.0368f - -153f;
			return true;
	
		case 92:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 202.1143f, 828.3607f, -806.8813f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 101.1612f - -54.347f;
			return true;
	
		case 103:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 12.0174f, -1108.081f, -1724.72f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 319.8931f - 143.4931f;
			return true;
	
		case 109:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 10.2248f, -628.4899f, -1859.5045f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 229.0784f - 99f;
			return true;
	
		case 81:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 53.1469f, 90.4242f, -1393.4424f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 123.1782f - -45f;
			return true;
	
		case 95:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 101.921f, 186.1865f, 370.5876f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 159.7861f - 70f;
			return true;
	
		case 97:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 45.9871f, -188.5636f, -1391.1559f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 36.5172f - -45f;
			return true;
	
		case 134:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 46.0567f, 3076.742f, 2001.9182f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 328.101f - -33.128f;
			return true;
	
		case 88:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 60.9442f, 314.7191f, -1421.8212f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 336.5938f - -132f;
			return true;
	
		case 306:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 37.4888f, 5643.7256f, -569.3535f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 296.1685f - MISC::GET_HEADING_FROM_VECTOR_2D(7.4998f, -7.4995f);
			return true;
	
		case 307:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 47.4526f, 4717.728f, -1555.5929f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 236.223f - MISC::GET_HEADING_FROM_VECTOR_2D(-10.6345f, -0.7246f);
			return true;
	
		case 308:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 22.7549f, 4629.148f, -1553.861f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 332.7842f - MISC::GET_HEADING_FROM_VECTOR_2D(3.4271f, 13.6787f);
			return true;
	
		case 278:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 35.9161f, -1009.7451f, 631.8275f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 98.8128f - -33.77f;
			return true;
	
		case 279:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 234.6825f, 900.8749f, -111.9033f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 6.1087f - 155.68f;
			return true;
	
		case 240:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 33.5351f, 3636.151f, 1546.3232f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 298.4009f - -4.124f;
			return true;
	
		case 241:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 30.512f, 6439.6665f, -179.4242f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 225.5593f - 108f;
			return true;
	
		case 264:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 28.2977f, -1390.5446f, 486.7419f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 178.298f - -90f;
			return true;
	
		case 266:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 10.5662f, 143.2342f, -3052.8945f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 85.3429f - 68.8227f;
			return true;
	
		case 267:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 39.9155f, 4934.08f, 2202.3752f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 314.2654f - 56.2037f;
			return true;
	
		case 269:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 28.149f, -782.0952f, 401.2502f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 179.9905f - -106.6605f;
			return true;
	
		case 246:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 3.3919f, -1534.5072f, -1195.2559f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 305.8221f - -165f;
			return true;
	
		case 263:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 12.8792f, -1241.2125f, -573.3765f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 316.9941f - -171f;
			return true;
	
		case 259:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 4.0002f, -1298.5391f, -724.429f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 230.5715f - -32.488f;
			return true;
	
		case 260:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 61.203f, 250.8387f, -1309.1135f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 10.7756f - -29.093f;
			return true;
	
		case 261:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 79.764f, 60.3233f, 917.6678f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = 148.021f - 229.6085f;
			return true;
	
		case 270:
			func_168(iParam0, uParam2, 0);
			*uParam3 = { { 350f, 8588f, 2919f } - Global_100893[iParam1 /*3*/] };
			*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			return true;
...
void func_167(int iParam0, var uParam1, int iParam2) // Position - 0xB6F7
{
	int iVar0;
...
int func_168(int iParam0, var uParam1, int iParam2) // Position - 0xB953
{
	if (Global_101858[iParam0 /*98*/] == false)
	{
	...
	if (Global_101858[iParam0 /*98*/] == joaat("BLIMP"))
	{
		func_167(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (VEHICLE::IS_THIS_MODEL_A_BOAT(Global_101858[iParam0 /*98*/]))
	{
		func_167(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (VEHICLE::IS_THIS_MODEL_A_PLANE(Global_101858[iParam0 /*98*/]))
	{
		func_167(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (VEHICLE::IS_THIS_MODEL_A_HELI(Global_101858[iParam0 /*98*/]))
	{
		func_167(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (VEHICLE::IS_THIS_MODEL_A_TRAIN(Global_101858[iParam0 /*98*/]))
	{
		func_167(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (iParam2 == 1)
	{
		if (!VEHICLE::IS_THIS_MODEL_A_CAR(Global_101858[iParam0 /*98*/]))
		{
			func_167(iParam0, uParam1, iParam2);
			uParam1->f_91 = iParam2;
			return 1;
	...
	{
		if (!VEHICLE::IS_THIS_MODEL_A_BIKE(Global_101858[iParam0 /*98*/]))
		{
			func_167(iParam0, uParam1, iParam2);
			uParam1->f_91 = iParam2;
			return 1;
	...
	if (!func_169(Global_101858[iParam0 /*98*/], false, -1))
	{
		func_167(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (iParam2 != 0)
	{
		...
		if (Global_101858[iParam0 /*98*/] != *uParam1)
		{
			*uParam1 = { Global_101858[iParam0 /*98*/] };
			uParam1->f_91 = 0;
			return 0;
		}
	}
...
bool func_169(bool bParam0, bool bParam1, int iParam2) // Position - 0xBB8B
{
	int iVar0;
	var uVar1;
...
bool func_170(bool bParam0) // Position - 0xBD10
{
	int iVar0;
	var uVar1;
	var uVar2;
...
bool func_172(bool bParam0, int iParam1) // Position - 0xBDF3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_173() // Position - 0xBFDB
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

bool func_174() // Position - 0xBFF1
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

bool func_175() // Position - 0xC008
{
	return false;
}

bool func_176() // Position - 0xC011
{
	return true;
}

bool func_177() // Position - 0xC01A
{
	return true;
}

bool func_178() // Position - 0xC023
{
...
bool func_180(int iParam0) // Position - 0xC0F4
{
	if (Global_101858[iParam0 /*98*/] == joaat("BLIMP") || Global_101858[iParam0 /*98*/] == joaat("BLIMP2"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("SUBMERSIBLE") || Global_101858[iParam0 /*98*/] == joaat("SUBMERSIBLE2"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("FREIGHT"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("PACKER"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("ASEA2"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("BURRITO2") || Global_101858[iParam0 /*98*/] == joaat("FBI2"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("ENTITYXF") && !Global_114931.f_9092.f_330[8 /*6*/])
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("CHEETAH") && !Global_114931.f_9092.f_330[8 /*6*/])
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("POLICEB") && !Global_114931.f_9092.f_330[8 /*6*/])
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("ZTYPE") && !Global_114931.f_9092.f_330[9 /*6*/])
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("POLMAV") && !Global_114931.f_9092.f_330[9 /*6*/])
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("JB700") && !Global_114931.f_9092.f_330[10 /*6*/])
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("MONROE") && !Global_114931.f_9092.f_330[11 /*6*/])
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("FIRETRUK"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("HANDLER"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("MONROE"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("PHANTOM"))
		return true;

	if (Global_101858[iParam0 /*98*/] == joaat("GAUNTLET") && !Global_114931.f_9092.f_330[80 /*6*/] && !Global_114931.f_9092.f_330[81 /*6*/] && !Global_114931.f_9092.f_330[82 /*6*/])
		return true;

	return false;
}

bool func_181(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, bool bParam6) // Position - 0xC374
{
	if (bParam6)
...
bool func_182(int iParam0, var uParam1, var uParam2) // Position - 0xC3BB
{
	switch (iParam0)
	{
		case 11:
...
void func_184(var uParam0, int iParam1) // Position - 0xCD70
{
	if (iParam1 <= 0)
		return;
...
void func_185(var uParam0, int iParam1) // Position - 0xCDF6
{
...
void func_186(var uParam0, int iParam1) // Position - 0xCE29
{
	int iVar0;
	int iVar1;
...
int func_187(int iParam0, int iParam1) // Position - 0xCE7A
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_188(int iParam0) // Position - 0xCF1C
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_189(bool bParam0, var uParam1, var uParam2) // Position - 0xCF3E
{
	if (bParam0)
		return uParam1;
...
int func_190(int iParam0) // Position - 0xCF55
{
	return iParam0 & 15;
}

void func_191(var uParam0, int iParam1) // Position - 0xCF62
{
...
void func_192(var uParam0, int iParam1) // Position - 0xCF9C
{
...
void func_193(var uParam0, int iParam1) // Position - 0xCFD7
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_194(var uParam0, int iParam1) // Position - 0xD013
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	for (iVar0 = 0; iVar0 < 3; iVar0 = iVar0 + 1)
	{
		...
		else
		{
			...
			if (!func_182(Global_114931.f_18540[iVar0], &uVar2, &fVar5))
			{
...
void func_195(var uParam0) // Position - 0xD1D9
{
	*uParam0 = -15;
}

int func_196() // Position - 0xD1E7
{
	if (func_119(false))
		return 0;
...
void func_197(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD232
{
...
void func_198(int iParam0) // Position - 0xD2CD
{
	Global_45437 = MISC::GET_GAME_TIMER() + iParam0;
}

int func_199(var uParam0, bool bParam1, bool bParam2, int iParam3) // Position - 0xD2DF
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(uParam0->[uParam0->f_7]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && uParam0->[uParam0->f_7] != PLAYER::PLAYER_PED_ID())
	{
		...
		if (!uParam0->f_23)
			func_250(uVar0, false);
	
		func_248(iVar1, &uVar0);
		PED::SET_PED_CONFIG_FLAG(uVar0, 32, 1);
		PED::SET_PED_CONFIG_FLAG(uVar0, 250, 1);
		iVar2 = func_247(uParam0->f_7);
		func_250(uParam0->[uParam0->f_7], false);
		fVar3 = ((BUILTIN::TO_FLOAT(ENTITY::GET_ENTITY_HEALTH(uParam0->[uParam0->f_7])) - 100f) / (BUILTIN::TO_FLOAT(PED::GET_PED_MAX_HEALTH(uParam0->[uParam0->f_7])) - 100f)) * 100f;
		...
		{
			if (Global_24407.f_13)
			{
				for (iVar4 = 0; iVar4 < 7; iVar4 = iVar4 + 1)
				{
					if (IS_BIT_SET(Global_93181[iVar4 /*5*/].f_1, 2))
					{
						iVar5 = Global_93181[iVar4 /*5*/];
						TEXT_LABEL_ASSIGN_STRING(&uVar6, "MISS_SWITCH_", 64);
						TEXT_LABEL_APPEND_STRING(&uVar6, &Global_93217[Global_80576.f_109[iVar5 /*4*/] /*34*/], 64);
						STATS::STAT_INCREMENT(MISC::GET_HASH_KEY(&uVar6), 1f);
					}
				}
			}
		}
		...
		uParam0->[uParam0->f_5] = uVar0;
		uParam0->[uParam0->f_7] = 0;
		uParam0->f_6 = func_245(iVar2);
		uParam0->f_7 = 4;
		uVar22 = PLAYER::PLAYER_PED_ID();
		ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
		func_244(uVar22);
		PED::SET_PED_CAN_LOSE_PROPS_ON_DAMAGE(uVar22, 0, 0);
	
		if (fVar3 < 25f && !PED::IS_PED_SWIMMING_UNDER_WATER(PLAYER::PLAYER_PED_ID()))
			ENTITY::SET_ENTITY_HEALTH(PLAYER::PLAYER_PED_ID(), BUILTIN::ROUND(((25f / 100f) * (BUILTIN::TO_FLOAT(PED::GET_PED_MAX_HEALTH(PLAYER::PLAYER_PED_ID())) - 100f)) + 100f), 0, 0);
		...
		if (bParam1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uVar0))
			{
				...
				func_244(uVar0);
				PED::SET_PED_CAN_LOSE_PROPS_ON_DAMAGE(uVar0, 0, 0);
				PED::SET_PED_STEALTH_MOVEMENT(uVar0, 0, 0);
			}
		}
		else if (ENTITY::DOES_ENTITY_EXIST(uVar0))
		{
			uVar24 = ENTITY::GET_ENTITY_SCRIPT(uVar0, &uVar23);
		
			if (!MISC::IS_STRING_NULL(uVar24))
			{
				if (!MISC::ARE_STRINGS_EQUAL(uVar24, SCRIPT::GET_THIS_SCRIPT_NAME()))
		...
		func_203(iVar2, &uVar22);
	
		if (func_301(0) || func_301(3) || func_301(2) || func_301(4))
		{
			PED::SET_PED_CONFIG_FLAG(uVar22, 32, 0);
			PED::SET_PED_CONFIG_FLAG(uVar22, 250, 0);
		}
		else
		{
			PED::SET_PED_CONFIG_FLAG(uVar22, 32, 1);
			PED::SET_PED_CONFIG_FLAG(uVar22, 250, 1);
		}
...
void func_200() // Position - 0xD7CF
{
	if (Global_99741)
	{
		func_101();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_201(Global_114931.f_2370.f_539.f_4321));
	}
	else
	{
...
char* func_201(int iParam0) // Position - 0xD801
{
	iParam0 = iParam0;
	return "";
}

bool func_202() // Position - 0xD810
{
	return Global_24405;
}

void func_203(int iParam0, var uParam1) // Position - 0xD81B
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			if (Global_114931.f_9092.f_330[2 /*6*/])
				func_204(4, *uParam1);
			...
			if (Global_114931.f_9092.f_99.f_58[126])
				func_204(12, *uParam1);
			break;
	
		case 2:
			if (Global_114931.f_9092.f_330[20 /*6*/])
				func_204(4, *uParam1);
...
void func_204(int iParam0, int iParam1) // Position - 0xD8E7
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (Global_43582[iParam0 /*31*/].f_24 < 5)
	{
		Global_43582[iParam0 /*31*/].f_25[Global_43582[iParam0 /*31*/].f_24] = iParam1;
		Global_43582[iParam0 /*31*/].f_24 = Global_43582[iParam0 /*31*/].f_24 + 1;
	}
	else
	{
		bVar2 = false;
		...
		for (iVar0 = 0; iVar0 < 5; iVar0 = iVar0 + 1)
		{
			iVar1 = Global_43582[iParam0 /*31*/].f_25[iVar0];
		
			if (!ENTITY::DOES_ENTITY_EXIST(iVar1) || PED::IS_PED_INJURED(iVar1))
			{
				Global_43582[iParam0 /*31*/].f_25[iVar0] = iParam1;
				bVar2 = true;
				iVar0 = 6;
			}
		}
...
bool func_205(int iParam0, int iParam1) // Position - 0xD999
{
	int iVar0;

	for (iVar0 = 0; iVar0 < Global_43582[iParam0 /*31*/].f_24; iVar0 = iVar0 + 1)
	{
		if (iParam1 == Global_43582[iParam0 /*31*/].f_25[iVar0])
			return true;
	}
...
void func_206(int iParam0) // Position - 0xD9D2
{
	if (iParam0 == 10)
		return;
	...
	{
		case 0:
			MISC::SET_BIT(&Global_40246[38 / 32], 38 % 32);
			func_207(38, 0);
			MISC::SET_BIT(&Global_40246[41 / 32], 41 % 32);
			func_207(41, 0);
			MISC::SET_BIT(&Global_40246[43 / 32], 43 % 32);
			func_207(43, 0);
			MISC::SET_BIT(&Global_40246[42 / 32], 42 % 32);
			func_207(42, 0);
			MISC::SET_BIT(&Global_40246[44 / 32], 44 % 32);
			func_207(44, 0);
			break;
	
		case 1:
			MISC::SET_BIT(&Global_40246[51 / 32], 51 % 32);
			func_207(51, 0);
			break;
		...
		case 3:
			MISC::SET_BIT(&Global_40246[53 / 32], 53 % 32);
			func_207(53, 0);
			break;
	
		case 4:
			MISC::SET_BIT(&Global_40246[81 / 32], 81 % 32);
			func_207(81, 0);
			MISC::SET_BIT(&Global_40246[82 / 32], 82 % 32);
			func_207(82, 0);
			break;
	
		case 5:
			MISC::SET_BIT(&Global_40246[47 / 32], 47 % 32);
			func_207(47, 0);
			MISC::SET_BIT(&Global_40246[50 / 32], 50 % 32);
			func_207(50, 0);
			break;
...
void func_207(int iParam0, int iParam1) // Position - 0xDB62
{
	int iVar0;
...
void func_208(int iParam0) // Position - 0xDC4F
{
...
void func_209(int iParam0) // Position - 0xDC9A
{
	var uVar0;
	bool bVar7;
	bool bVar8;
...
int func_211(int iParam0) // Position - 0xE1DF
{
	int iVar0;
...
bool func_212(int iParam0) // Position - 0xE407
{
	int iVar0;
...
var func_213(var uParam0) // Position - 0xE473
{
	return uParam0;
}

void func_214(int iParam0, var uParam1) // Position - 0xE47D
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_215(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93217[26 /*34*/].f_6) == 0)
			{
				Global_114931.f_7268[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114931.f_7268[iParam0], 1, 1);
			}
...
bool func_215(int iParam0) // Position - 0xEE15
{
	var uVar0;
	int iVar7;
...
int func_216(int iParam0) // Position - 0xEE49
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 9) & 31;
}

struct<7> func_217(int iParam0) // Position - 0xEE5C
{
	var uVar0;
...
bool func_218() // Position - 0x11A67
{
...
int func_219() // Position - 0x11A97
{
	return Global_33793;
}

int func_220() // Position - 0x11AA2
{
	return Global_33792;
}

int func_221(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x11AAD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_222(int iParam0) // Position - 0x11B3C
{
	return IS_BIT_SET(Global_114931.f_7236[iParam0], 0);
}

void func_223(int iParam0) // Position - 0x11B51
{
	int iVar0;
...
void func_224(int iParam0, int iParam1) // Position - 0x11B74
{
	int iVar0;
	float fVar1;
	var uVar2;
	...
	func_229(iParam0, iParam1, &uVar2, &iVar3);
...
int func_225(int iParam0, bool bParam1) // Position - 0x11C60
{
	var uVar0;
	int iVar1;
	...
	if (iParam0 != 18486)
	{
		uVar0 = func_226(iParam0, bParam1);
...
var func_226(int iParam0, bool bParam1) // Position - 0x11C8F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_227(bParam1));
}

bool func_227(bool bParam0) // Position - 0x11CA4
{
	bool bVar0;
	bool bVar1;
...
bool func_228() // Position - 0x11CD8
{
	return Global_1574927;
}

void func_229(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x11CE4
{
	switch (iParam0)
	{
		case 0:
...
void func_230() // Position - 0x11F3B
{
	var uVar0;
	...
	uVar0.f_39 = 9;
	uVar0.f_49 = 9;
	func_232(PLAYER::PLAYER_PED_ID(), &uVar0, 1, -1);
	func_231(1306, uVar0[0], -1);
	func_231(1307, uVar0[1], -1);
	func_231(1308, uVar0[2], -1);
	func_231(1309, uVar0[3], -1);
	func_231(1310, uVar0[4], -1);
	func_231(1311, uVar0[5], -1);
	func_231(1312, uVar0[6], -1);
	func_231(1313, uVar0[7], -1);
	func_231(1314, uVar0[8], -1);
	func_231(1315, uVar0[9], -1);
	func_231(1316, uVar0[10], -1);
	func_231(1317, uVar0[11], -1);
	func_231(1318, uVar0.f_13[0], -1);
	func_231(1319, uVar0.f_13[1], -1);
	func_231(1320, uVar0.f_13[2], -1);
	func_231(1321, uVar0.f_13[3], -1);
	func_231(1322, uVar0.f_13[4], -1);
	func_231(1323, uVar0.f_13[5], -1);
	func_231(1324, uVar0.f_13[6], -1);
	func_231(1325, uVar0.f_13[7], -1);
	func_231(1326, uVar0.f_13[8], -1);
	func_231(1327, uVar0.f_13[9], -1);
	func_231(1328, uVar0.f_13[10], -1);
	func_231(1329, uVar0.f_13[11], -1);
	func_231(1330, uVar0.f_26[0], -1);
	func_231(1331, uVar0.f_26[1], -1);
	func_231(1332, uVar0.f_26[2], -1);
	func_231(1333, uVar0.f_26[3], -1);
	func_231(1334, uVar0.f_26[4], -1);
	func_231(1335, uVar0.f_26[5], -1);
	func_231(1336, uVar0.f_26[6], -1);
	func_231(1337, uVar0.f_26[7], -1);
	func_231(1338, uVar0.f_26[8], -1);
	func_231(1339, uVar0.f_26[9], -1);
	func_231(1340, uVar0.f_26[10], -1);
	func_231(1341, uVar0.f_26[11], -1);
	func_231(1342, uVar0.f_39[0], -1);
	func_231(1343, uVar0.f_39[1], -1);
	func_231(1344, uVar0.f_39[2], -1);
	func_231(1345, uVar0.f_39[3], -1);
	func_231(1346, uVar0.f_39[4], -1);
	func_231(1347, uVar0.f_39[5], -1);
	func_231(1348, uVar0.f_39[6], -1);
	func_231(1349, uVar0.f_39[7], -1);
	func_231(1350, uVar0.f_39[8], -1);
	func_231(1351, uVar0.f_49[0], -1);
	func_231(1352, uVar0.f_49[1], -1);
	func_231(1353, uVar0.f_49[2], -1);
	func_231(1354, uVar0.f_49[3], -1);
	func_231(1355, uVar0.f_49[4], -1);
	func_231(1356, uVar0.f_49[5], -1);
	func_231(1357, uVar0.f_49[6], -1);
	func_231(1358, uVar0.f_49[7], -1);
	func_231(1359, uVar0.f_49[8], -1);
	func_231(1360, func_100(), -1);
	STATS::STAT_SET_BOOL(joaat("CLO_STORED_INITIAL"), 1, 1);
	Global_114931.f_2370.f_539.f_4315 = 1;
}

void func_231(int iParam0, int iParam1, bool bParam2) // Position - 0x122E1
{
	if (bParam2 == -1)
		bParam2 = func_228();
...
void func_232(int iParam0, var uParam1, int iParam2, bool bParam3) // Position - 0x12309
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			if (func_233(161, bParam3))
				uParam1->f_59 = func_225(2053, bParam3);
			else
				uParam1->f_59 = func_225(753, bParam3);
		
			uParam1->f_60 = func_225(754, bParam3);
			uParam1->f_61 = func_225(755, bParam3);
		}
...
bool func_233(int iParam0, bool bParam1) // Position - 0x124A3
{
	var uVar0;
	bool bVar1;

	uVar0 = func_234(iParam0, bParam1);
...
var func_234(int iParam0, bool bParam1) // Position - 0x124C7
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_227(bParam1));
}

void func_235(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0x124DC
{
	int iVar0;
...
void func_236(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6) // Position - 0x12A25
{
	int iVar0;
...
bool func_237() // Position - 0x12C66
{
...
bool func_238(int iParam0) // Position - 0x12C84
{
	return Global_1574538[iParam0];
}

bool func_239() // Position - 0x12C94
{
	return func_238(func_228() + 1);
}

void func_240(int iParam0) // Position - 0x12CA6
{
	switch (iParam0)
	{
		case 0:
			...
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, Global_97432, joaat("PLAYER"));
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("PLAYER"), Global_97432);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, Global_97433, joaat("PLAYER"));
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("PLAYER"), Global_97433);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, Global_97434, joaat("PLAYER"));
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("PLAYER"), Global_97434);
			break;
...
void func_241() // Position - 0x12E5A
{
	var uVar0;
	int iVar1;
	...
	{
		iVar1 = Global_114931.f_2370.f_539.f_4321;
	
		if (func_301(14))
			iVar1 = func_103(PLAYER::PLAYER_PED_ID());
	
		if (iVar1 == 0)
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar0, "BLIP_MICHAEL" /* GXT: Michael */);
		else if (iVar1 == 1)
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar0, "BLIP_FRANKLIN" /* GXT: Franklin */);
		else if (iVar1 == 2)
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar0, "BLIP_TREV" /* GXT: Trevor */);
		else
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar0, "BLIP_PLAYER" /* GXT: Player */);
	}
}

void func_242(var uParam0) // Position - 0x12EDD
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	for (iVar0 = 0; iVar0 < 44; iVar0 = iVar0 + 1)
	{
		...
		if (iVar2 != 0)
		{
			iVar3 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(uParam0, iVar2);
		
			if (iVar3 != 0 && iVar3 != joaat("WEAPON_UNARMED") && iVar3 != joaat("OBJECT"))
				if (WEAPON::GET_AMMO_IN_PED_WEAPON(uParam0, iVar3) == -1)
					if (WEAPON::GET_MAX_AMMO(uParam0, iVar3, &uVar1))
						WEAPON::SET_PED_INFINITE_AMMO(uParam0, 0, iVar3);
		}
	}

	iVar5 = EXTRAMETADATA::GET_NUM_DLC_WEAPONS();

	for (iVar4 = 0; iVar4 < iVar5; iVar4 = iVar4 + 1)
	{
		if (EXTRAMETADATA::GET_DLC_WEAPON_DATA(iVar4, &uVar6))
		{
			iVar3 = uVar6.f_1;
...
int func_243(int iParam0) // Position - 0x12F9F
{
	int iVar0;
...
void func_244(var uParam0) // Position - 0x13213
{
	int iVar0;

	iVar0 = func_103(uParam0);

	if (func_102(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
		if (uParam0 == PLAYER::PLAYER_PED_ID() && PED::GET_PED_MAX_HEALTH(uParam0) == 200)
			PED::SET_PED_MAX_HEALTH(uParam0, BUILTIN::ROUND((float)PED::GET_PED_MAX_HEALTH(uParam0) * Global_262145.f_104 /* Tunable: MAX_HEALTH_MULTIPLIER */));
	
		if (Global_114931.f_2370.f_539.f_290[iVar0] <= 0f)
			Global_114931.f_2370.f_539.f_290[iVar0] = 100f;
		else if (Global_114931.f_2370.f_539.f_290[iVar0] <= 10f)
			Global_114931.f_2370.f_539.f_290[iVar0] = 10f;
	
		ENTITY::SET_ENTITY_HEALTH(uParam0, BUILTIN::ROUND(((Global_114931.f_2370.f_539.f_290[iVar0] / 100f) * (BUILTIN::TO_FLOAT(PED::GET_PED_MAX_HEALTH(uParam0)) - 100f)) + 100f), 0, 0);
	}
}

int func_245(int iParam0) // Position - 0x13301
{
	if (iParam0 == 0)
		return 0;
	else if (iParam0 == 2)
...
bool func_246(int iParam0) // Position - 0x1333C
{
	if (Global_44886 == 15)
		return false;
...
int func_247(int iParam0) // Position - 0x1335E
{
	if (iParam0 == 0)
		return 0;
	else if (iParam0 == 2)
...
void func_248(int iParam0, var uParam1) // Position - 0x1338C
{
	switch (iParam0)
	{
		case 0:
...
void func_249(int iParam0, int iParam1, bool bParam2) // Position - 0x13444
{
	int iVar0;
	bool bVar1;
	...
	for (iVar0 = 0; iVar0 < Global_43582[iParam0 /*31*/].f_24; iVar0 = iVar0 + 1)
	{
		if (bVar1)
		{
			Global_43582[iParam0 /*31*/].f_25[iVar0 - 1] = Global_43582[iParam0 /*31*/].f_25[iVar0];
			Global_43582[iParam0 /*31*/].f_25[iVar0] = 0;
		}
		else if (iParam1 == Global_43582[iParam0 /*31*/].f_25[iVar0])
		{
			Global_43582[iParam0 /*31*/].f_25[iVar0] = 0;
			bVar1 = true;
		}
...
void func_250(var uParam0, bool bParam1) // Position - 0x13500
{
	func_262(uParam0);
	func_256(uParam0, bParam1);
	func_255(uParam0);
	func_254(uParam0);
	func_253(uParam0);
	func_252(uParam0);
...
void func_251(var uParam0) // Position - 0x13534
{
	int iVar0;
...
void func_252(var uParam0) // Position - 0x1357B
{
	int iVar0;
...
void func_253(var uParam0) // Position - 0x135B9
{
	int iVar0;
...
void func_254(var uParam0) // Position - 0x13746
{
	int iVar0;
...
void func_255(var uParam0) // Position - 0x13782
{
	int iVar0;
...
void func_256(var uParam0, bool bParam1) // Position - 0x137DF
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_102(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
		if (uParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_257(uParam0, &Global_114931.f_2370.f_539.f_298[iVar0 /*477*/]);
...
void func_257(var uParam0, var uParam1) // Position - 0x138D2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		for (iVar0 = 0; iVar0 <= 44 - 1; iVar0 = iVar0 + 1)
		{
			...
			if (iVar3 != 0)
			{
				iVar4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(uParam0, func_243(iVar0));
				iVar4.f_1 = 0;
				iVar4.f_2 = 0;
				iVar4.f_3 = 0;
				iVar4.f_4 = 0;
				...
				if (iVar4 != 0 && iVar4 != joaat("WEAPON_UNARMED"))
				{
					...
					for (iVar2 = func_260(iVar4, iVar1); iVar2 != 0; iVar2 = func_260(iVar4, iVar1))
					{
		...
		{
			if (EXTRAMETADATA::GET_DLC_WEAPON_DATA_SP(iVar9, &uVar11) && !func_259(uVar11.f_1) && iVar72 < 51)
			{
...
bool func_258(int iParam0) // Position - 0x13B5A
{
	switch (iParam0)
	{
...
bool func_259(int iParam0) // Position - 0x13BFB
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_260(int iParam0, int iParam1) // Position - 0x13DF3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_261(int iParam0, var uParam1) // Position - 0x14B75
{
	int iVar0;
	int iVar1;
...
void func_262(var uParam0) // Position - 0x14BB0
{
	int iVar0;
	...
	if (func_102(iVar0) && !PED::IS_PED_INJURED(uParam0))
		Global_114931.f_2370.f_539.f_2296[iVar0] = func_183();
}

bool func_263(var uParam0, int iParam1) // Position - 0x14BEA
{
	bool bVar0;
	bool bVar1;
	...
	else
	{
		...
		if (func_245(func_100()) != iParam1 || bVar0)
		{
			bVar1 = false;
		
			if (bVar0 || uParam0->f_24[iParam1] != 0 || func_267(iParam1) && func_264(iParam1) && !uParam0->f_18[iParam1])
				if (!uParam0->f_23)
					if (!PED::IS_PED_INJURED(uParam0->[iParam1]) || bVar0)
						if (uParam0->f_34[iParam1] != 1 && uParam0->f_34[iParam1] != 3)
							bVar1 = true;
				else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0 && !IS_BIT_SET(Global_99907.f_47, iParam1))
					bVar1 = true;
			else if (!(IS_BIT_SET(Global_114931.f_9092.f_2[27 /*3*/], 1) && !Global_4 && !func_119(false)))
				if (uParam0->f_23)
					bVar1 = true;
...
int func_264(int iParam0) // Position - 0x14D3F
{
	if (Global_114931.f_9092 || Global_4)
		if (!Global_80305 || Global_80305 && iParam0 != func_245(func_266()))
...
bool func_265(int iParam0) // Position - 0x14D8F
{
	if (func_102(iParam0))
		if (Global_114931.f_9092 || Global_4 || func_119(false))
			return Global_114931.f_2370.f_539.f_2348[iParam0];
		else
			return true;
...
int func_266() // Position - 0x14DDD
{
	return Global_114931.f_2370.f_539.f_4323;
}

int func_267(int iParam0) // Position - 0x14DF2
{
	if (Global_114931.f_9092 || Global_4 || func_119(false))
		if (!Global_80305 || Global_80305 && iParam0 != func_245(func_266()))
...
void func_268(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6) // Position - 0x14E7E
{
	if (bParam0)
	{
		PLAYER::SPECIAL_ABILITY_DEACTIVATE_FAST(PLAYER::PLAYER_ID(), 0);
...
bool func_269() // Position - 0x14FCD
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

bool func_270(int iParam0, int iParam1) // Position - 0x14FE7
{
	bool bVar0;
...
bool func_271(bool bParam0, bool bParam1) // Position - 0x15040
{
	bool bVar0;
	bool bVar1;
...
bool func_272(int iParam0) // Position - 0x15081
{
	int iVar0;
...
bool func_273(int iParam0) // Position - 0x150A3
{
...
bool func_274() // Position - 0x150E2
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_275(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x150F0
{
	int iVar0;
...
void func_276(int iParam0) // Position - 0x15123
{
	if (iParam0 == 1)
...
void func_277(var uParam0) // Position - 0x15146
{
...
bool func_278(int iParam0) // Position - 0x15195
{
	switch (iParam0)
	{
		case 0:
...
void func_279(var uParam0, float fParam1, float fParam2) // Position - 0x15202
{
	float fVar0;

	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		fVar0 = BUILTIN::VDIST2(uParam0->f_401, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
	
		if (IS_BIT_SET(uParam0->f_449, 1))
			func_290(uParam0);
		else if (fVar0 < fParam1 * fParam1 || IS_BIT_SET(Global_98438, *uParam0))
			if (IS_BIT_SET(uParam0->f_449, 0))
				if (func_289(uParam0))
					if (IS_BIT_SET(Global_98438, *uParam0))
						if (IS_BIT_SET(Global_98440, *uParam0))
							func_284(uParam0);
					else
						func_284(uParam0);
			else
		...
		if (fVar0 > fParam2 * fParam2 && !IS_BIT_SET(Global_98438, *uParam0))
		{
			if (IS_BIT_SET(uParam0->f_449, 0))
			{
				if (IS_BIT_SET(uParam0->f_449, 1))
...
void func_280(var uParam0) // Position - 0x152D3
{
	...
	MISC::CLEAR_BIT(&Global_98439, *uParam0);
	MISC::CLEAR_BIT(&(uParam0->f_449), 0);
}

void func_281(var uParam0) // Position - 0x1533D
{
	if (IS_BIT_SET(uParam0->f_449, 1))
	{
		if (!CUTSCENE::IS_CUTSCENE_PLAYING())
		...
		MISC::CLEAR_BIT(&Global_98438, *uParam0);
	}
}

void func_282(var uParam0) // Position - 0x15383
{
	int iVar0;

	for (iVar0 = 0; iVar0 < uParam0->f_1.f_33; iVar0 = iVar0 + 1)
	{
...
void func_283(var uParam0) // Position - 0x153BF
{
	...
	MISC::SET_BIT(&Global_98437, *uParam0);
	MISC::SET_BIT(&(uParam0->f_449), 0);
}

void func_284(var uParam0) // Position - 0x1543D
{
	int iVar0;

	if (!IS_BIT_SET(uParam0->f_449, 1))
	{
		for (iVar0 = 0; iVar0 < uParam0->f_1.f_96; iVar0 = iVar0 + 1)
		{
...
void func_285(var uParam0) // Position - 0x15497
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	for (iVar0 = 0; iVar0 < uParam0->f_1.f_33; iVar0 = iVar0 + 1)
	{
		if (func_32(*uParam0, uParam0->f_1.f_75[iVar0]))
		{
			...
			fVar2 = BUILTIN::TO_FLOAT(MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) - 32767) / 4000f;
			fVar3 = BUILTIN::TO_FLOAT(MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) - 32767) / 4000f;
			uVar4 = { func_286(uParam0, &uParam0->f_1.f_34[iVar0 /*2*/]) };
			uParam0->f_428[iVar0] = OBJECT::CREATE_OBJECT(iVar1, uVar4, 1, 1, 0);
			...
			ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_428[iVar0], 1, 0);
	...
	MISC::CLEAR_BIT(&Global_98440, *uParam0);
}

Vector3 func_286(var uParam0, var uParam1) // Position - 0x155CD
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_287(var uParam0) // Position - 0x1564B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	for (iVar0 = 0; iVar0 < uParam0->f_1.f_117; iVar0 = iVar0 + 1)
	{
		iVar2 = uParam0->f_1.f_186[iVar0];
		bVar3 = IS_BIT_SET(Global_114931.f_1.f_120[iVar1], iVar2);
		...
		else
		{
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar3);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(BUILTIN::TO_FLOAT(uParam0->f_1.f_141[iVar0 /*2*/]));
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(BUILTIN::TO_FLOAT(uParam0->f_1.f_141[iVar0 /*2*/].f_1));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
	}
}

void func_288(var uParam0) // Position - 0x15728
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(2);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(BUILTIN::TO_FLOAT(uParam0->f_1.f_14));
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(BUILTIN::TO_FLOAT(uParam0->f_1.f_14.f_1));
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	iVar0 = *uParam0;
	iVar1 = 0;

	for (iVar2 = 0; iVar2 < uParam0->f_1.f_209; iVar2 = iVar2 + 1)
	{
...
bool func_289(var uParam0) // Position - 0x15868
{
	...
	MISC::SET_BIT(&Global_98439, *uParam0);
	return true;
}

void func_290(var uParam0) // Position - 0x15903
{
	float fVar0;
	float fVar1;
	...
	if (func_32(*uParam0, 0))
	{
		...
		GRAPHICS::DRAW_SCALEFORM_MOVIE_3D(uParam0->f_413, uParam0->f_401 + { fVar1, fVar0 * BUILTIN::COS(90f - uParam0->f_404), fVar0 * BUILTIN::SIN(90f - uParam0->f_404) }, 180f, 0f, uParam0->f_404, 1f, 1f, 1f, uParam0->f_1.f_6, uParam0->f_1.f_7, 1f, 2);
	}
}

void func_291(var uParam0) // Position - 0x1598C
{
	int iVar0;
	int iVar1;
	bool bVar2;
		...
		for (iVar0 = 0; iVar0 < uParam0->f_1.f_33; iVar0 = iVar0 + 1)
		{
			if (func_32(*uParam0, uParam0->f_1.f_75[iVar0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_428[iVar0]))
				{
					...
					fVar4 = BUILTIN::TO_FLOAT(MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) - 32767) / 4000f;
					fVar5 = BUILTIN::TO_FLOAT(MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) - 32767) / 4000f;
					uVar6 = { func_286(uParam0, &uParam0->f_1.f_34[iVar0 /*2*/]) };
					uParam0->f_428[iVar0] = OBJECT::CREATE_OBJECT(iVar3, uVar6, 1, 1, 0);
...
void func_292(var uParam0) // Position - 0x15BCD
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_293() // Position - 0x15BF1
{
	if (func_302(37) || func_302(38))
	{
		if (!func_119(false))
		{
			if (func_302(37))
			{
				if (!IS_BIT_SET(Static_39, 8))
				{
					if (IS_BIT_SET(Static_39, 9))
					{
						CUTSCENE::REMOVE_CUTSCENE();
						MISC::CLEAR_BIT(&Static_39, 9);
					}
				
					CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("RBHS_MCS_3", 5, 8);
					MISC::SET_BIT(&Static_39, 8);
				}
			...
			if (func_159(91))
			{
				if (func_152(0))
				{
					if (func_299(&Static_42, 0, 0, false, 0) == 1)
					{
						func_298();
						Static_123 = PED::ADD_SCENARIO_BLOCKING_AREA(Static_174.f_1.f_394 - Static_174.f_1.f_397, Static_174.f_1.f_394 + Static_174.f_1.f_397, 0, 1, 1, 1, 1);
						Static_124 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Static_174.f_1.f_394, Static_174.f_1.f_397 * { 1.5f, 1.5f, 1.5f }, 0f, 0, 7);
						PED::SET_PED_NON_CREATION_AREA(Static_174.f_1.f_394 - Static_174.f_1.f_397, Static_174.f_1.f_394 + Static_174.f_1.f_397);
						PATHFIND::SET_PED_PATHS_IN_AREA(Static_174.f_1.f_394 - Static_174.f_1.f_397, Static_174.f_1.f_394 + Static_174.f_1.f_397, 0, 0);
						...
						MISC::SET_BIT(&Static_39, 1);
					}
				}
			}
		
			if (IS_BIT_SET(Static_39, 1))
			{
				if (func_297("RBHS_MCS_3"))
				{
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Static_44))
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(Static_44, 0))
								VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Static_44, 0, 0);
					
						if (ENTITY::DOES_ENTITY_EXIST(Global_98926.f_9[0]))
						{
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98926.f_9[0], 1, 1);
							Static_126 = Global_98926.f_9[0];
							Global_98926.f_9[0] = 0;
						}
					
						if (func_100() == 0)
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "MICHAEL" /* GXT: Michael */, 0, joaat("PLAYER_ZERO"), 0);
						
							if (ENTITY::DOES_ENTITY_EXIST(Static_130[2]) && !ENTITY::IS_ENTITY_DEAD(Static_130[2], 0))
							{
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_130[2], "TREVOR" /* GXT: Trevor */, 0, joaat("PLAYER_TWO"), 0);
							}
							else
							{
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_130[2], "TREVOR" /* GXT: Trevor */, 2, joaat("PLAYER_TWO"), 0);
								MISC::SET_BIT(&Static_39, 2);
							}
						}
						else if (func_100() == 2)
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "TREVOR" /* GXT: Trevor */, 0, joaat("PLAYER_TWO"), 0);
						
							if (ENTITY::DOES_ENTITY_EXIST(Static_127) && !ENTITY::IS_ENTITY_DEAD(Static_127, 0))
							{
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_127, "MICHAEL" /* GXT: Michael */, 0, joaat("PLAYER_ZERO"), 0);
							}
							else
							{
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_127, "MICHAEL" /* GXT: Michael */, 2, joaat("PLAYER_ZERO"), 0);
								MISC::SET_BIT(&Static_39, 3);
							}
						}
					
						func_197(&(Static_174.f_484), 0, 0, "MICHAEL" /* GXT: Michael */, 1, 1);
						func_197(&(Static_174.f_484), 2, PLAYER::PLAYER_PED_ID(), "TREVOR" /* GXT: Trevor */, 1, 1);
						func_197(&(Static_174.f_484), 3, 0, "LESTER", 1, 1);
						Static_40 = MISC::GET_GAME_TIMER();
						CUTSCENE::START_CUTSCENE(2048);
					}
					else
					{
						...
						if (!IS_BIT_SET(Static_39, 19))
						{
							if (!CAM::IS_SCREEN_FADED_IN() && !CAM::IS_SCREEN_FADING_IN())
								CAM::DO_SCREEN_FADE_IN(500);
						
							MISC::SET_BIT(&Static_39, 19);
						}
					
						if (ENTITY::DOES_ENTITY_EXIST(Global_98926[0]))
						{
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98926[0], 1, 1);
							VEHICLE::DELETE_VEHICLE(&Global_98926[0]);
						}
					
						if (ENTITY::DOES_ENTITY_EXIST(Global_98926[1]))
						{
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98926[1], 1, 1);
							VEHICLE::DELETE_VEHICLE(&Global_98926[1]);
						}
					
						if (ENTITY::DOES_ENTITY_EXIST(Static_126))
							PED::DELETE_PED(&Static_126);
					
						if (IS_BIT_SET(Static_39, 2))
						{
							if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Trevor" /* GXT: Trevor */, joaat("PLAYER_TWO"))))
							{
								Static_130[2] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Trevor" /* GXT: Trevor */, joaat("PLAYER_TWO")));
								MISC::CLEAR_BIT(&Static_39, 2);
							}
						}
					
						if (IS_BIT_SET(Static_39, 3))
						{
							if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Michael" /* GXT: Michael */, joaat("PLAYER_ZERO"))))
							{
								Static_127 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Michael" /* GXT: Michael */, joaat("PLAYER_ZERO")));
								MISC::CLEAR_BIT(&Static_39, 3);
							}
						}
					
						if (!IS_BIT_SET(Static_39, 4))
						{
							if (CUTSCENE::GET_CUTSCENE_TIME() > 43160 && func_302(38) || CUTSCENE::GET_CUTSCENE_TIME() > 42740 && func_302(37))
							{
								func_116(2, 0, true);
								func_116(2, 1, true);
								MISC::SET_BIT(&Static_39, 4);
							}
						}
					
						if (func_100() == 0)
						{
							if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("TREVOR" /* GXT: Trevor */, joaat("PLAYER_TWO")))
							{
								if (!ENTITY::DOES_ENTITY_EXIST(Static_130[2]))
								{
									Static_130[2] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Trevor" /* GXT: Trevor */, joaat("PLAYER_TWO")));
								...
								if (!ENTITY::IS_ENTITY_DEAD(Static_130[2], 0))
								{
									PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_130[2], 1);
									PED::SET_PED_CONFIG_FLAG(Static_130[2], 208, 1);
									PED::SET_PED_CONFIG_FLAG(Static_130[2], 118, 0);
									PED::SET_PED_CONFIG_FLAG(Static_130[2], 213, 0);
								}
							}
						}
						else if (func_100() == 2)
						{
							if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MICHAEL" /* GXT: Michael */, joaat("PLAYER_ZERO")))
							{
								if (!ENTITY::DOES_ENTITY_EXIST(Static_127))
								{
									Static_127 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Michael" /* GXT: Michael */, joaat("PLAYER_ZERO")));
								...
								if (!ENTITY::IS_ENTITY_DEAD(Static_127, 0))
								{
									PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_127, 1);
									PED::SET_PED_CONFIG_FLAG(Static_127, 208, 1);
									PED::SET_PED_CONFIG_FLAG(Static_127, 118, 0);
									PED::SET_PED_CONFIG_FLAG(Static_127, 213, 0);
								}
							}
						}
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("LESTER", 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(Static_126))
							{
								ENTITY::SET_ENTITY_COORDS(Static_126, 1398.1981f, 3605.5999f, 37.9419f, 1, 0, 0, 1);
								ENTITY::SET_ENTITY_HEADING(Static_126, 194.2789f);
								PED::DELETE_PED(&Static_126);
							}
						}
						...
						{
							if (!IS_BIT_SET(Static_39, 0))
							{
								func_296();
								MISC::SET_BIT(&Static_39, 0);
							}
						
							MISC::CLEAR_AREA(1397.8835f, 3594.627f, 33.9271f, 50f, 1, 0, 0, 0);
							func_155(24);
							func_115(37, false);
							func_115(38, false);
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(Static_127, 0))
									ENTITY::SET_ENTITY_VISIBLE(Static_127, 0, 0);
							
								if (!ENTITY::IS_ENTITY_DEAD(Static_126, 0))
									ENTITY::SET_ENTITY_VISIBLE(Static_126, 0, 0);
							
								if (ENTITY::DOES_ENTITY_EXIST(Static_130[2]))
									ENTITY::SET_ENTITY_VISIBLE(Static_130[2], 0, 0);
							
								MISC::SET_BIT(&Static_39, 18);
							}
						}
					
						if (CUTSCENE::WAS_CUTSCENE_SKIPPED())
							MISC::SET_BIT(&Static_39, 20);
						else if (!CAM::IS_SCREEN_FADED_IN() && !CAM::IS_SCREEN_FADING_IN())
							CAM::DO_SCREEN_FADE_IN(800);
					
						if (IS_BIT_SET(Static_39, 20))
						{
...
void func_294(var uParam0) // Position - 0x1644E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_295(int iParam0, bool bParam1) // Position - 0x16536
{
	if (iParam0 == -1)
		return;
...
void func_296() // Position - 0x16572
{
	func_85(1, 2, true);
	func_85(2, 2, true);
	func_277(&Static_174);
...
bool func_297(char* sParam0) // Position - 0x16594
{
	bool bVar0;
...
void func_298() // Position - 0x165B9
{
	Global_102493 = true;
}

int func_299(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4) // Position - 0x165C6
{
	int iVar0;
...
void func_300(var uParam0, int iParam1) // Position - 0x166FD
{
	int iVar0;
...
bool func_301(int iParam0) // Position - 0x1674C
{
	return Global_44886 == iParam0;
}

bool func_302(int iParam0) // Position - 0x1675A
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_303(var uParam0, int iParam1) // Position - 0x16787
{
	var uVar0;
	var uVar3;

	*uParam0 = iParam1;
	uVar0 = { Global_98375[uParam0->f_1.f_1 /*15*/].f_3 };
	uVar3 = Global_98375[uParam0->f_1.f_1 /*15*/].f_6;
	uParam0->f_401 = { uVar0 };
	uParam0->f_404 = uVar3;
	uParam0->f_405 = { uVar0 + { 0f, -uParam0->f_1.f_8 * BUILTIN::COS(360f - uVar3), -uParam0->f_1.f_8 * BUILTIN::SIN(360f - uVar3) } };
	uParam0->f_408 = { -0.85f, 0f, uVar3 };
	MISC::SET_BIT(&(uParam0->f_449), 4);
...
void func_304(var uParam0, int iParam1) // Position - 0x16853
{
...
void func_305(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, bool bParam5) // Position - 0x16AE3
{
	var uVar0;

	if (uParam0->f_369 < 7)
	{
		TEXT_LABEL_ASSIGN_STRING(&uVar0, sParam2, 8);
		uParam0->f_386[uParam0->f_369] = iParam1;
		uParam0->f_371[uParam0->f_369 /*2*/] = iParam3;
		uParam0->f_371[uParam0->f_369 /*2*/].f_1 = iParam4;
		uParam0->f_280[uParam0->f_369 + 4 /*2*/] = { uVar0 };
...
void func_306(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x16B5C
{
	if (uParam0->f_33 < 20)
	{
...
void func_307(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0x16BA0
{
	var uVar0;

	if (uParam0->f_209 < 9)
	{
		TEXT_LABEL_ASSIGN_STRING(&uVar0, sParam3, 32);
		uParam0->f_248[uParam0->f_209] = iParam1;
		uParam0->f_258[uParam0->f_209] = iParam2;
		TEXT_LABEL_COPY(&uParam0->f_211[uParam0->f_209 /*4*/], { uVar0 }, 4);
		uParam0->f_209 = uParam0->f_209 + 1;
	}
}

void func_308(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x16BF0
{
	if (uParam0->f_117 < 22)
	{
...
void func_309(var uParam0, int iParam1, char* sParam2) // Position - 0x16C40
{
	var uVar0;
	...
	uParam0->f_304[iParam1 /*2*/] = { uVar0 };
}

void func_310(var uParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0x16C6C
{
	var uVar0;
	var uVar2;

	TEXT_LABEL_ASSIGN_STRING(&uVar0, sParam2, 8);
	TEXT_LABEL_ASSIGN_STRING(&uVar2, sParam3, 8);
	uParam0->f_304[iParam1 /*2*/] = { uVar0 };
	...
	if (!MISC::ARE_STRINGS_EQUAL(sParam3, ""))
	{
		...
		{
			case 10:
				uParam0->f_304[14 /*2*/] = { uVar2 };
				break;
		
			case 13:
				uParam0->f_304[16 /*2*/] = { uVar2 };
				break;
		
			case 12:
				uParam0->f_304[15 /*2*/] = { uVar2 };
				break;
		
			case 11:
				uParam0->f_304[17 /*2*/] = { uVar2 };
				break;
...
void func_311(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8) // Position - 0x16D06
{
	var uVar0;
	var uVar4;
	var uVar8;
	...
	TEXT_LABEL_ASSIGN_STRING(&uVar0, sParam1, 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar4, sParam2, 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar8, sParam3, 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar12, sParam4, 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar16, sParam5, 8);
	TEXT_LABEL_ASSIGN_STRING(&uVar18, sParam6, 8);
	TEXT_LABEL_ASSIGN_STRING(&uVar20, sParam7, 8);
	TEXT_LABEL_ASSIGN_STRING(&uVar22, sParam8, 8);
	uParam0->f_20[0 /*4*/] = { uVar0 };
	uParam0->f_20[1 /*4*/] = { uVar4 };
	uParam0->f_108[0 /*4*/] = { uVar8 };
	uParam0->f_108[1 /*4*/] = { uVar12 };
	uParam0->f_280[1 /*2*/] = { uVar16 };
	uParam0->f_280[2 /*2*/] = { uVar18 };
	uParam0->f_280[0 /*2*/] = { uVar20 };
	uParam0->f_280[3 /*2*/] = { uVar22 };
}

void func_312(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x16DAA
{
	uParam0->f_9 = fParam1;
...
void func_314(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0x16E92
{
	uParam0->f_1 = iParam1;
...
int func_315(int iParam0) // Position - 0x16EFE
{
	int iVar0;
	int iVar1;
...
void func_316() // Position - 0x16F55
{
	while (!func_317(&Static_174))
	{
		BUILTIN::WAIT(0);
	}
...
bool func_317(var uParam0) // Position - 0x16FFE
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_281(uParam0);
