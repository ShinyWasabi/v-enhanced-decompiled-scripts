	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			else if (!func_25())
			{
				...
				if (!IS_BIT_SET(Global_114931.f_18581.f_382, 5))
					MISC::SET_BIT(&(Global_114931.f_18581.f_382), 5);
...
void func_1() // Position - 0xF6
{
	...
	{
		case 0:
			if (MISC::GET_GAME_TIMER() - Static_185 > 5000 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Static_186, PLAYER::PLAYER_PED_ID(), 1))
			{
				if (func_3(&Static_20, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Static_186);
					Static_19 = 1;
				}
			}
			else if (MISC::GET_GAME_TIMER() - Static_185 > 12000 && BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Static_186, 1)) <= 900f)
			{
				if (func_3(&Static_20, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
					Static_19 = 1;
			}
		...
		case 1:
			if (!func_2())
			{
				Static_185 = MISC::GET_GAME_TIMER();
				Static_19 = 0;
			}
			break;
	}
...
bool func_8(int iParam0, int iParam1) // Position - 0x5B5
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_9(int iParam0) // Position - 0x5CD
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_10() // Position - 0x5DF
{
	return -1;
}

void func_11() // Position - 0x5E8
{
	int iVar0;
...
bool func_16(int iParam0) // Position - 0x810
{
	return Global_44886 == iParam0;
}

void func_17() // Position - 0x81E
{
	int iVar0;
...
bool func_18(int iParam0, int iParam1) // Position - 0x875
{
	switch (iParam0)
	{
		case 5:
...
void func_20(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x904
{
...
void func_21() // Position - 0x95A
{
	Static_185 = MISC::GET_GAME_TIMER();
	func_22(&Static_20, 2, PLAYER::PLAYER_PED_ID(), "TREVOR" /* GXT: Trevor */, 0, 1);
	func_22(&Static_20, 5, Static_186, "DINAPOLI", 0, 1);
	Static_18 = 1;
}

void func_22(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x989
{
...
bool func_23() // Position - 0xA24
{
	float fVar0;

	fVar0 = 200f;

	if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Static_186, 1)) >= fVar0 * fVar0 && !ENTITY::IS_ENTITY_ON_SCREEN(Static_186))
		return false;

	return true;
}

void func_24(int iParam0, bool bParam1) // Position - 0xA61
{
...
bool func_25() // Position - 0xAA6
{
	if (ENTITY::DOES_ENTITY_EXIST(Static_186))
		if (!PED::IS_PED_INJURED(Static_186))
			return true;

	return false;
}

int func_26() // Position - 0xAC6
{
	func_27();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_27() // Position - 0xADF
{
	int iVar0;

	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_30(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_29(PLAYER::PLAYER_PED_ID());
		
			if (func_28(iVar0) && !func_16(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != iVar0 && func_28(Global_114931.f_2370.f_539.f_4321))
...
bool func_28(int iParam0) // Position - 0xBDC
{
	return iParam0 < 3;
}

int func_29(var uParam0) // Position - 0xBE8
{
	int iVar0;
	int iVar1;
...
int func_30(int iParam0) // Position - 0xC25
{
	if (func_28(iParam0))
...
int func_31(int iParam0) // Position - 0xC4A
{
	return Global_2339[iParam0 /*29*/];
}

bool func_32() // Position - 0xC59
{
	var uVar0;
	int iVar17;
	int iVar18;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		for (iVar18 = 0; iVar18 <= iVar17 - 1; iVar18 = iVar18 + 1)
		{
...
void func_33() // Position - 0xCE7
{
	func_34(&Static_20, 1);

	if (ENTITY::DOES_ENTITY_EXIST(Static_186))
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&Static_186);

	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_34(var uParam0, int iParam1) // Position - 0xD09
{
