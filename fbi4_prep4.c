...
void main() // Position - 0x0
{
	...
	Static_186 = "FBIPRD";
	Static_192 = { 0f, 0f, 0f };
	Static_195 = { -1335.3142f, -1277.9427f, 3.8649f };
	Static_198 = { -1336.3777f, -1279.0555f, 3.855f };
	Static_203 = -1;
	Static_210 = "FBIPRAU";
	...
	if (func_308())
		func_307(-1339.7863f, -1277.5099f, 3.8874f, 261.2839f, 1, 0);

	if (func_306(false))
	{
		Global_114931.f_2370.f_539.f_2395[0] = -99;
		Global_114931.f_2370.f_539.f_2395[1] = -99;
		Global_114931.f_2370.f_539.f_2395[2] = -99;
		func_269();
	}
...
void func_1() // Position - 0x1D0
{
	switch (Static_79)
	{
		case 0:
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(Static_185))
			{
				if (MISC::ARE_STRINGS_EQUAL(Static_185, "PRE_FKICKOFF" /* GXT: Unable to purchase the required boiler suits. */))
				{
					while (MISC::GET_GAME_TIMER() - Static_203 < 3000)
					{
						BUILTIN::WAIT(0);
					}
				}
...
void func_4(int iParam0) // Position - 0x28C
{
	...
	if (Global_114931.f_9092 || func_306(false))
	{
		iVar0 = func_18();
...
bool func_5(int iParam0) // Position - 0x2D1
{
	...
	func_6(&(Global_114931.f_2370.f_539), iVar1);
...
void func_6(var uParam0, int iParam1) // Position - 0x3E1
{
	...
	for (iVar0 = 0; iVar0 < 3; iVar0 = iVar0 + 1)
	{
		...
		else
		{
			...
			if (!func_8(Global_114931.f_18540[iVar0], &uVar2, &fVar5))
			{
...
void func_12() // Position - 0x1062
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_16(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_14(iVar0) && !func_13(14) || Global_113879)
			{
...
int func_15(var uParam0) // Position - 0x1179
{
	int iVar0;
	int iVar1;
...
int func_17(int iParam0) // Position - 0x11DB
{
...
void func_22(var uParam0) // Position - 0x127C
{
...
void func_23() // Position - 0x129C
{
	...
	{
		case 0:
			if (func_97(Static_78, Static_26))
			{
		...
		case 1:
			if (func_96(PLAYER::PLAYER_PED_ID(), Static_198, 2f, 1) && func_89(21))
			{
			...
			{
				if (func_88("PRD_BUYM" /* GXT: Buy a mask for Michael. */, 0, 0) || func_88("PRD_BUYT" /* GXT: Buy a mask for Trevor. */, 0, 0) || func_88("PRD_BUYF" /* GXT: Buy a mask for Franklin. */, 0, 0))
					HUD::CLEAR_PRINTS();
			
				if (Static_188)
				{
					Static_202 = MISC::GET_GAME_TIMER();
					Static_79 = 2;
				}
				else if (!func_96(PLAYER::PLAYER_PED_ID(), Static_195, 75f, 1))
				{
					if (!Static_205)
					{
						func_22(&Static_190);
					...
					func_86(&Static_190, Static_198, 1, true, "PRD_SHOP" /* GXT: Shop */);
				}
				else if (func_96(PLAYER::PLAYER_PED_ID(), Static_198, 12f, 1))
				{
					if (Static_205)
					{
						func_22(&Static_190);
					...
					func_86(&Static_190, Static_198, 1, true, "PRD_BLIP" /* GXT: Masks */);
				
					if (HUD::DOES_BLIP_EXIST(Static_190))
					{
						HUD::SET_BLIP_COLOUR(Static_190, 2);
						HUD::SET_BLIP_ROUTE_COLOUR(Static_190, 2);
					}
				}
			}
			break;
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - Static_202 > 2000)
			{
				func_22(&Static_190);
			
				if (func_44(&Static_380, &Static_376, &Static_211))
				{
					func_43(false, -1);
				
					if (Global_114931.f_2370.f_539.f_2395[0] == 38 && Global_114931.f_2370.f_539.f_2395[1] == 33 && Global_114931.f_2370.f_539.f_2395[2] == 54)
						func_42(821);
		...
		case 3:
			Global_114931.f_2370.f_539.f_2395[0] = 38;
			Global_114931.f_2370.f_539.f_2395[1] = 33;
			Global_114931.f_2370.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			Static_79 = 2;
			break;
	}
...
void func_26(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x150C
{
	var uVar0;
...
bool func_27(var uParam0) // Position - 0x15B6
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
...
void func_28(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6) // Position - 0x15D7
{
	if (bParam0)
	{
...
bool func_33(int iParam0) // Position - 0x17E6
{
	int iVar0;
...
bool func_34(int iParam0) // Position - 0x1808
{
...
int func_36(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x1855
{
	int iVar0;
...
void func_40(bool bParam0, bool bParam1) // Position - 0x18E8
{
	...
	if (bParam0)
	{
		if (func_306(false) && Global_80552.f_1 == 1 && func_41(Global_80552))
		{
		}
		else
		{
		...
		case 0:
			if (func_84())
			{
				if (func_83(74) || func_83(75) && func_82())
				{
					...
					{
						func_79(uParam2, 0, 0, "MICHAEL" /* GXT: Michael */, 0, 1);
					
						if (func_61(uParam2, func_78(), func_11(), "FBIPRAU", func_77(), 9, 1, 0, 0, false))
						{
...
void func_51() // Position - 0x1D87
{
	...
	func_52(func_55(), 0, func_11(), func_78(), 9, 6000, 6000, -1, 0, -1, 0);
}

int func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1DDE
{
	int iVar0;
	int iVar15;
...
void func_53(int iParam0) // Position - 0x1F2F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_57(int iParam0, int iParam1) // Position - 0x2189
{
	return false;
}
...
int func_58(int iParam0) // Position - 0x21E2
{
	...
	return Global_99907[func_59(iParam0)];
}
...
bool func_61(var uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9) // Position - 0x22B4
{
	func_76(uParam0, iParam1, sParam3, iParam7, iParam8, 0);
	Global_8781 = iParam2;
	Global_23048 = false;
	Global_23007 = true;
	Global_23014 = false;
...
bool func_65(bool bParam0) // Position - 0x2684
{
	...
	return func_66(bParam0, 20);
}

bool func_66(bool bParam0, int iParam1) // Position - 0x26BB
{
	return IS_BIT_SET(Global_1892798[bParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_67(int iParam0) // Position - 0x26D3
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

bool func_68() // Position - 0x26E5
{
	return -1;
}

void func_69() // Position - 0x26EE
{
	int iVar0;
...
bool func_74(int iParam0, int iParam1) // Position - 0x2946
{
	switch (iParam0)
	{
		case 5:
...
void func_76(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29D5
{
...
void func_79(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2B6C
{
...
void func_80(int iParam0, bool bParam1) // Position - 0x2C07
{
...
void func_81(bool bParam0) // Position - 0x2C4C
{
	if (bParam0)
...
bool func_83(int iParam0) // Position - 0x2CE8
{
...
bool func_85(int iParam0) // Position - 0x2D5C
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_86(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, char* sParam6) // Position - 0x2D89
{
	if (!HUD::DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_87(uParam1, 5, iParam4);
...
int func_87(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x2DB8
{
	int iVar0;
...
bool func_88(char* sParam0, int iParam1, int iParam2) // Position - 0x2DE6
{
...
bool func_89(int iParam0) // Position - 0x2E04
{
	return func_90(iParam0, 6, true);
}

bool func_90(int iParam0, int iParam1, bool bParam2) // Position - 0x2E14
{
	if (iParam0 == -1)
		return false;
	...
	if (bParam2)
		...
		if (func_95() == 0)
			return IS_BIT_SET(func_91(func_94(iParam0), -1), iParam1);
	else
...
int func_91(int iParam0, int iParam1) // Position - 0x2E74
{
	var uVar0;
	int iVar1;
...
int func_92(int iParam0, int iParam1) // Position - 0x2EA3
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_93(iParam1));
}

int func_93(int iParam0) // Position - 0x2EB8
{
	int iVar0;
	int iVar1;
...
int func_94(int iParam0) // Position - 0x2EEC
{
	switch (iParam0)
	{
		case 0:
...
int func_95() // Position - 0x32D0
{
	return Global_33792;
}

bool func_96(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x32DB
{
	return BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, iParam5), uParam1) <= fParam4 * fParam4;
}

bool func_97(int iParam0, bool bParam1) // Position - 0x32F9
{
	func_102();
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_100(1, Static_192, 0))
			{
				return true;
			}
			break;
		...
		case 1:
			if (bParam1)
			{
				func_98(PLAYER::PLAYER_PED_ID(), -1339.7863f, -1277.5099f, 3.8874f, 261.2839f);
				Static_26 = false;
				func_24(1, 1, 1);
			}
			else
		...
		case 2:
			if (bParam1)
			{
				func_98(PLAYER::PLAYER_PED_ID(), Static_198, 261.2839f);
				Static_26 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_98(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x33A4
{
	if (func_268(uParam0))
		TASK::CLEAR_PED_TASKS(uParam0);

	func_99(uParam0, fParam1, fParam4, false, 1);
}

bool func_99(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, bool bParam5, int iParam6) // Position - 0x33CA
{
	bool bVar0;
	float fVar1;
...
bool func_100(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3426
{
	switch (iParam0)
	{
		case 0:
			if (func_101(uParam1, Static_192, 1056964608, false) && iParam4 == 0f)
				return true;
			break;
	
		case 1:
			HUD::REQUEST_ADDITIONAL_TEXT(Static_186, 0);
			HUD::REQUEST_ADDITIONAL_TEXT(Static_210, 6);
...
bool func_101(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, int iParam6, bool bParam7) // Position - 0x348E
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
void func_102() // Position - 0x3509
{
	func_103(&Static_211);
}

void func_103(var uParam0) // Position - 0x3517
{
	int iVar0;
	char* sVar1;
...
void func_104() // Position - 0x356D
{
	switch (Static_79)
	{
		...
		case 1:
			if (!Static_201)
			{
				if (func_96(PLAYER::PLAYER_PED_ID(), Static_195, 60f, 1))
				{
					func_109("PRD_GCLOTH" /* GXT: Buy three ~g~masks. */, &Static_187);
					func_22(&Static_190);
					func_86(&Static_190, Static_198, 1, true, "PRD_BLIP" /* GXT: Masks */);
		...
		case 3:
			func_98(PLAYER::PLAYER_PED_ID(), Static_198, 0f);
			func_24(1, 1, 1);
			Static_79 = 1;
			break;
	}
...
void func_105(bool bParam0) // Position - 0x36B8
{
	func_106(Static_78);
	Static_184 = Static_78;

	if (!bParam0)
		Static_78 = Static_184 + 1;
	else if (Static_184 > 0)
		Static_78 = Static_184 - 1;
...
void func_106(int iParam0) // Position - 0x36EB
{
	switch (iParam0)
	{
		case 0:
...
void func_107(int iParam0, bool bParam1) // Position - 0x3703
{
	int iVar0;
...
bool func_108(int iParam0) // Position - 0x374D
{
	return func_90(iParam0, 5, true);
}

void func_109(char* sParam0, var uParam1) // Position - 0x375D
{
	if (!*uParam1)
	{
		func_110(sParam0, 7500, 0);
		*uParam1 = 1;
	}
}

void func_110(char* sParam0, int iParam1, int iParam2) // Position - 0x377A
{
	iParam2 = iParam2;
	...
	switch (Static_79)
	{
		case 0:
			if (func_97(Static_78, false))
			{
				...
				if (func_308())
				{
					func_117(&uVar1, -1327.1753f, -1290.8113f, 3.8472f, 291.8355f, 0, 0, 0, 0, 0, joaat("ASTEROPE"), 0, 145, 1);
					func_114(0, -1, 1);
					uVar0 = MISC::GET_GAME_TIMER();
				
					while (!func_113(21) && MISC::GET_GAME_TIMER() - uVar0 < 2000)
					{
						BUILTIN::WAIT(0);
					}
...
void func_112(var uParam0) // Position - 0x38B8
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
bool func_113(int iParam0) // Position - 0x38F0
{
	return func_90(iParam0, 0, true);
}

void func_114(int iParam0, int iParam1, int iParam2) // Position - 0x3900
{
	if (func_308() && func_116())
	{
...
void func_115(int iParam0) // Position - 0x39C4
{
	if (iParam0 == 1)
...
bool func_116() // Position - 0x39ED
{
	return IS_BIT_SET(Global_102454.f_20, 13);
}

void func_117(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x39FE
{
	int iVar0;

	iVar0 = 1;

	if (!func_308() || !func_252())
		iVar0 = 0;

	if (iVar0 == 1)
		if (!func_249(iParam6, iParam7, iParam8, iParam13))
			iVar0 = 0;
	...
	if (iVar0 == 1)
	{
		...
		*uParam0 = func_220(fParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_219(fParam1, 0f, 0f, 0f, false))
		{
		...
		func_210(fParam1, 5f, 0);
	
		if (func_14(iParam12))
		{
			func_208(iParam12, 0);
		
			while (!func_118(uParam0, iParam12, fParam1, fParam4, true, 0))
			{
				BUILTIN::WAIT(0);
			}
		}
...
bool func_118(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, bool bParam6, int iParam7) // Position - 0x3B92
{
	var uVar0;
	var uVar1;
	int iVar5;
	...
	if (func_14(iParam1))
	{
		...
		iVar5.f_31 = 49;
		iVar5.f_81 = 2;
		func_207(iParam1, &iVar5, iParam7);
		...
		if (Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == iVar5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/], uParam2, fParam5, 0, 0, 0);
				...
				func_196(uParam0, &(Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == iVar5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/], uParam2, fParam5, 0, 0, 0);
				...
				func_196(uParam0, &(Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, iVar5.f_96);
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(iVar5))
			{
				...
				*uParam0 = VEHICLE::CREATE_VEHICLE(iVar5, uParam2, fParam5, 1, 1, 0);
				...
				func_196(uParam0, &(iVar5.f_31), &(iVar5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, iVar5.f_96);
				...
				else if (iParam1 == 0 && !Global_114931.f_2370.f_539.f_4316 && Global_114931.f_9092.f_99.f_58[131] && ENTITY::GET_ENTITY_MODEL(*uParam0) == joaat("TAILGATER"))
				{
					...
					func_119(iParam1, uParam0, 0, true);
				}
...
void func_119(int iParam0, var uParam1, int iParam2, bool bParam3) // Position - 0x49B8
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if (func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_124(*uParam1, false, &uVar0))
		{
			func_123(uParam1, &(Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114931.f_20125[iParam0 /*43*/].f_31 = func_122(*uParam1);
				...
				func_120(Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, true, &(Global_114931.f_20125[iParam0 /*43*/].f_1));
				...
				func_120(Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, false, &(Global_114931.f_20125[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_120(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4) // Position - 0x55CC
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	for (iVar0 = 0; func_121(iVar0, &uVar2, &iVar1, &iVar6, &iVar7); iVar0 = iVar0 + 1)
	{
...
bool func_121(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0x563F
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_122(var uParam0) // Position - 0x6B31
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_123(var uParam0, var uParam1, var uParam2) // Position - 0x6BE1
{
	int iVar0;
	int iVar1;
...
bool func_124(int iParam0, bool bParam1, var uParam2) // Position - 0x6DD4
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	if (!func_167(iVar0, bParam1, uParam2) && !func_166(PLAYER::PLAYER_ID()) && !func_139(iParam0))
		return false;
	...
	if (func_135(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0))
		bVar1 = true;

	if (VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_132(iParam0) && !bVar1 && !(func_131(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_130(PLAYER::PLAYER_ID())) && !(func_129(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_126(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_125(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("SENTINEL2") && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("ISSI2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_125(int iParam0) // Position - 0x6F5F
{
	int iVar0;
...
bool func_126(bool bParam0) // Position - 0x6F9A
{
	if (bParam0 != func_68())
		if (func_128(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658294[bParam0 /*468*/].f_325.f_8) == 32;

	return false;
}

int func_127(bool bParam0) // Position - 0x6FE1
{
	switch (bParam0)
	{
		case false:
...
bool func_128(bool bParam0, bool bParam1, bool bParam2) // Position - 0x754A
{
	bool bVar0;
...
bool func_129(int iParam0) // Position - 0x75AA
{
...
bool func_130(bool bParam0) // Position - 0x75C1
{
	if (bParam0 != func_68())
		if (func_128(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658294[bParam0 /*468*/].f_325.f_8) == 11;

	return false;
}

bool func_131(int iParam0) // Position - 0x7608
{
...
bool func_132(int iParam0) // Position - 0x764A
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
bool func_133(bool bParam0) // Position - 0x7712
{
	if (bParam0 != func_68())
		if (func_128(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658294[bParam0 /*468*/].f_325.f_8) == 26;

	return false;
}

bool func_134(bool bParam0) // Position - 0x7759
{
	if (bParam0 != func_68())
		if (func_128(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658294[bParam0 /*468*/].f_325.f_8) == 13;

	return false;
}

bool func_135(bool bParam0) // Position - 0x77A0
{
	if (bParam0 != func_68())
		if (func_128(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658294[bParam0 /*468*/].f_325.f_8) == 7;

	return false;
}

bool func_136(int iParam0) // Position - 0x77E6
{
	bool bVar0;
	...
	if (!func_138(PLAYER::PLAYER_ID()) && iParam0 != joaat("THRUSTER") && iParam0 != joaat("AVENGER") && iParam0 != func_137(true) && !bVar0)
		return false;

	return true;
}

int func_137(bool bParam0) // Position - 0x7877
{
	if (bParam0)
...
bool func_138(bool bParam0) // Position - 0x7891
{
	if (bParam0 != func_68())
...
bool func_139(int iParam0) // Position - 0x78B7
{
...
bool func_140(int iParam0) // Position - 0x78E6
{
	...
	if (func_143(PLAYER::PLAYER_ID()) && !func_136(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("OPENWHEEL1")) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("OPENWHEEL2")) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("FORMULA")) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("FORMULA2")))
		return false;
...
bool func_141(int iParam0) // Position - 0x7A4E
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_132(iParam0) || func_142(iVar0))
			return true;
...
bool func_142(int iParam0) // Position - 0x7ACB
{
	switch (iParam0)
	{
		case joaat("MULE"):
...
bool func_143(bool bParam0) // Position - 0x7B27
{
	if (bParam0 == func_68())
		return false;

	if (func_166(bParam0) && Global_2658294[bParam0 /*468*/].f_325.f_11 == bParam0)
		return true;

	return false;
}

bool func_144(int iParam0, bool bParam1) // Position - 0x7B60
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("TECHNICAL"):
		case joaat("INSURGENT"):
			if (func_146(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
				if (Global_2733138.f_307 == iParam0)
					return true;
				else if (func_145(iParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_145(int iParam0) // Position - 0x7BBB
{
	int iVar0;
...
bool func_146(int iParam0, int iParam1) // Position - 0x7BF4
{
	if (iParam1 == 0)
...
bool func_156(int iParam0) // Position - 0x84EB
{
	if (PLAYER::PLAYER_ID() != func_68())
	{
		if (func_162() || func_161(PLAYER::PLAYER_ID()))
			return false;
	
		if (func_160(PLAYER::PLAYER_ID(), true, false) && Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_39 > false || IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_37, 14) || IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_37, 11))
			return false;
	
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
					if (func_158() != -1 && func_158() < 607)
						if (!func_157(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1583772[func_158() /*143*/].f_66)
							return true;
...
bool func_157(int iParam0) // Position - 0x85F9
{
...
bool func_158() // Position - 0x8612
{
	return Global_2359296[func_159() /*5574*/].f_681.f_2;
}

int func_159() // Position - 0x862A
{
	int iVar0;
...
bool func_160(bool bParam0, bool bParam1, bool bParam2) // Position - 0x8637
{
	if (bParam0 == func_68())
		return false;
...
bool func_161(bool bParam0) // Position - 0x869B
{
	if (bParam0 != func_68() && func_128(bParam0, true, true))
		return IS_BIT_SET(Global_2658294[bParam0 /*468*/].f_325, 3);

	return false;
}

bool func_162() // Position - 0x86CC
{
	return func_163() != -1;
}

bool func_163() // Position - 0x86DA
{
	return Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

bool func_164(bool bParam0) // Position - 0x86F2
{
	if (bParam0 != func_68())
		if (func_128(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1 && Global_2658294[bParam0 /*468*/].f_325.f_11 != func_68())
				return func_127(Global_2658294[bParam0 /*468*/].f_325.f_8) == 5;

	return false;
}

bool func_165(bool bParam0) // Position - 0x8751
{
	if (bParam0 != func_68())
		if (func_128(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1 && Global_2658294[bParam0 /*468*/].f_325.f_11 != func_68())
				return func_127(Global_2658294[bParam0 /*468*/].f_325.f_8) == 8;

	return false;
}

bool func_166(bool bParam0) // Position - 0x87B1
{
	if (bParam0 != func_68())
		if (func_128(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658294[bParam0 /*468*/].f_325.f_8) == 9;

	return false;
}

bool func_167(int iParam0, bool bParam1, var uParam2) // Position - 0x87F8
{
	bool bVar0;
	...
	if (func_135(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0))
		bVar0 = true;
...
bool func_168(int iParam0) // Position - 0x8BDB
{
	switch (iParam0)
	{
		case joaat("TOWTRUCK"):
...
void func_169(int iParam0, int iParam1) // Position - 0x8C10
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	func_170(iParam0, &(Global_114931.f_32757.f_5510));
}

void func_170(int iParam0, var uParam1) // Position - 0x8E12
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_172(uParam1->f_66))
			uParam1->f_65 = 0;
		...
		for (iVar0 = 0; iVar0 <= 11; iVar0 = iVar0 + 1)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
				MISC::SET_BIT(&(uParam1->f_77), func_171(iVar0 + 1));
		}
...
int func_171(int iParam0) // Position - 0x90BD
{
	switch (iParam0)
	{
		case 1:
...
bool func_172(int iParam0) // Position - 0x916D
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_173(var uParam0) // Position - 0x918D
{
	int iVar0;
...
bool func_174(int iParam0) // Position - 0x923D
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0) || func_191(iParam0, 0, false) || func_191(iParam0, 1, false) || func_191(iParam0, 2, false) || func_190(iParam0) != 145 || func_189(iParam0) || func_188(iParam0) || func_125(iParam0) || func_187(iParam0) || !func_175(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		func_188(iParam0);
		func_188(iParam0);
...
bool func_175(bool bParam0) // Position - 0x931A
{
	if (bParam0 == false)
		return false;

	if (!func_176(bParam0, false, -1))
		return false;
...
bool func_176(bool bParam0, bool bParam1, int iParam2) // Position - 0x94D8
{
	int iVar0;
	var uVar1;
	...
	if (bParam0 == joaat("BLIMP"))
		if (!func_185() && !func_184() && !func_183() && !func_182() && !func_186())
			return false;

	if (bParam0 == joaat("HOTKNIFE") || bParam0 == joaat("CARBONRS") || bParam0 == joaat("KHAMELION"))
	{
		if (func_181() || MISC::IS_PC_VERSION() || func_180())
		{
		}
		else if (!func_183())
		{
...
bool func_177(int iParam0) // Position - 0x965D
{
	int iVar0;
	var uVar1;
	var uVar2;
...
bool func_179(bool bParam0, int iParam1) // Position - 0x9740
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!Global_2708659 && iParam1 >= 0 && iParam1 <= &func_3)
...
bool func_180() // Position - 0x9928
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

bool func_181() // Position - 0x993E
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

bool func_182() // Position - 0x9954
{
	return false;
}

bool func_183() // Position - 0x995D
{
	return true;
}

bool func_184() // Position - 0x9966
{
	return true;
}

bool func_185() // Position - 0x996F
{
...
bool func_187(int iParam0) // Position - 0x9A40
{
	bool bVar0;
	var uVar1;
	...
	if (!func_176(bVar0, false, -1))
		return true;

	return false;
}

bool func_188(int iParam0) // Position - 0x9A87
{
	int iVar0;
...
bool func_189(int iParam0) // Position - 0x9B03
{
	int iVar0;
...
int func_190(int iParam0) // Position - 0x9BEB
{
	int iVar0;
...
bool func_191(int iParam0, int iParam1, bool bParam2) // Position - 0x9C4E
{
	int iVar0;
	var uVar1;
	int iVar9;
	...
	for (iVar0 = 0; func_192(iParam1, iVar0, &uVar1, &iVar9); iVar0 = iVar0 + 1)
	{
...
bool func_192(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x9CBC
{
...
void func_193(int iParam0, int iParam1) // Position - 0x9D94
{
	int iVar0;
...
void func_194(var uParam0) // Position - 0x9E16
{
	if (!func_195(*uParam0))
		VEHICLE::SET_VEHICLE_EXTRA(*uParam0, 5, !Global_114931.f_9092.f_99.f_58[119]);
}

bool func_195(var uParam0) // Position - 0x9E41
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(uParam0, 5);
}

int func_196(var uParam0, var uParam1, var uParam2) // Position - 0x9E50
{
	int iVar0;
	int iVar1;
	...
	for (iVar0 = 0; iVar0 < *uParam1; iVar0 = iVar0 + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, iVar1) != uParam1->[iVar0] - 1)
		{
			...
			if (uParam1->[iVar0] > 0)
			{
				...
				else if (func_204(*uParam0, iVar1, uParam1->[iVar0] - 1))
				{
				}
				else
				{
	...
	if (func_201(ENTITY::GET_ENTITY_MODEL(*uParam0)) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_199(*uParam0, uParam1->[38] - 1))
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_199(*uParam0, uParam1->[38] - 1), 0);
...
bool func_197(var uParam0) // Position - 0xA04E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_198(var uParam0) // Position - 0xA12A
{
...
int func_199(var uParam0, int iParam1) // Position - 0xA195
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		iVar0 = func_200(uParam0, 38) + 1;
		iVar1 = func_200(uParam0, 24) + 1;
...
int func_200(var uParam0, int iParam1) // Position - 0xA27E
{
	int iVar0;
	...
	for (iVar0 = VEHICLE::GET_NUM_VEHICLE_MODS(uParam0, iParam1) - 1; iVar0 >= 0 && func_204(uParam0, iParam1, iVar0); iVar0 = iVar0 - 1)
	{
	}
...
bool func_201(int iParam0) // Position - 0xA2E0
{
...
bool func_202(var uParam0) // Position - 0xA30B
{
	var uVar0;
...
bool func_203(int iParam0) // Position - 0xA351
{
	switch (iParam0)
	{
		case joaat("BRIOSO"):
...
bool func_204(var uParam0, int iParam1, int iParam2) // Position - 0xA413
{
	if (!func_205() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2))
		return true;

	return false;
}

bool func_205() // Position - 0xA437
{
	return true;
}

bool func_206(var uParam0, var uParam1) // Position - 0xA444
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_207(int iParam0, var uParam1, int iParam2) // Position - 0xA485
{
	int iVar0;
...
void func_208(int iParam0, int iParam1) // Position - 0xA6E1
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 < 9; iVar0 = iVar0 + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99760[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99760[iVar0]) == func_209(iParam0, iParam1))
				{
...
int func_209(int iParam0, int iParam1) // Position - 0xA77F
{
	int iVar0;
	...
	if (func_14(iParam0))
	{
		...
		iVar0.f_31 = 49;
		iVar0.f_81 = 2;
		func_207(iParam0, &iVar0, iParam1);
		return iVar0;
	}
	else
	{
...
void func_210(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0xA7C1
{
	int iVar0;

	for (iVar0 = 0; iVar0 < 68; iVar0 = iVar0 + 1)
	{
		if (func_218(&Global_79095.f_555[0 /*21*/], iVar0))
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(uParam0, Global_79095.f_555[0 /*21*/], iParam4) <= fParam3)
				func_211(iVar0);
	}
}

void func_211(int iParam0) // Position - 0xA811
{
	bool bVar0;
	...
	if (func_218(&Global_79095.f_555[0 /*21*/], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_217(iParam0, 0) && Global_80004.f_66 == 0 && Global_114931.f_32757.f_1958[Global_79095.f_555[0 /*21*/].f_14] != 0 && Global_114931.f_32757.f_1958[Global_79095.f_555[0 /*21*/].f_14] > 3 && !func_215(0, Global_79095.f_555[0 /*21*/].f_12) || !func_215(1, Global_79095.f_555[0 /*21*/].f_12))
			{
				func_214(&Global_114931.f_32757.f_69[Global_79095.f_555[0 /*21*/].f_14 /*78*/], &Global_80004);
...
void func_212(int iParam0, bool bParam1) // Position - 0xA980
{
	if (iParam0 == -1)
		return;
	...
	if (bParam1)
	{
		...
		{
			func_213(iParam0, 1, false);
			func_213(iParam0, 2, false);
			func_213(iParam0, 3, false);
			func_213(iParam0, 4, false);
			func_213(iParam0, 0, true);
			Global_79095[iParam0] = 1;
		}
	}
	else
	{
		func_213(iParam0, 0, false);
	}
}

void func_213(int iParam0, int iParam1, bool bParam2) // Position - 0xA9DD
{
	if (iParam0 == -1)
		return;
...
void func_214(var uParam0, var uParam1) // Position - 0xAA18
{
...
bool func_215(int iParam0, int iParam1) // Position - 0xAAE4
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_216(&Global_114931.f_32757.f_5038[iVar0 /*157*/]))
		return false;

	return func_176(Global_114931.f_32757.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_216(var uParam0) // Position - 0xAB57
{
	return *uParam0;
}

bool func_217(int iParam0, int iParam1) // Position - 0xAB62
{
	if (iParam0 == -1)
		return false;
...
bool func_218(var uParam0, int iParam1) // Position - 0xAB82
{
	bool bVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_219(Global_114931.f_32757.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_219(Global_114931.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_219(Global_114931.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
bool func_219(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, bool bParam6) // Position - 0xC274
{
	if (bParam6)
...
int func_220(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xC2BB
{
	return func_221(&(Global_108474.f_2890), uParam0, fParam3, false);
}

int func_221(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, bool bParam5) // Position - 0xC2D5
{
	int iVar0;
	var uVar1;
	bool bVar4;
	...
	if (func_245(uParam0))
	{
		if (func_219(uParam1, 0f, 0f, 0f, false))
		{
			uParam1 = { *uParam0 };
			fParam4 = uParam0->f_6;
		}
		...
		if (func_244(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_225(iVar0, &(uParam0->f_12), false, true);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam5)
						if (VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(iVar0)))
							func_208(uParam0->f_11, 1);
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
							func_208(uParam0->f_11, 2);
					...
					func_193(iVar0, uParam0->f_11);
				}
				else if (!func_223(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_222(iVar0);
...
int func_222(int iParam0) // Position - 0xC587
{
	int iVar0;
	var uVar1;
	var uVar2;
...
bool func_223(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4) // Position - 0xC64A
{
	int iVar0;
	var uVar1;
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_224(iParam0, Global_79095.f_139[38], false))
			{
				func_211(38);
				return true;
			}
		...
		case joaat("FIRETRUK"):
			if (func_224(iParam0, Global_79095.f_139[43], true))
			{
				func_211(43);
				return true;
			}
		...
		case joaat("CUBAN800"):
			...
			{
				if (func_224(iParam0, uVar1[iVar6], true) && func_101(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_219(uParam1, 0f, 0f, 0f, false) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
bool func_224(int iParam0, int iParam1, bool bParam2) // Position - 0xC852
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void func_225(int iParam0, var uParam1, bool bParam2, bool bParam3) // Position - 0xC8B3
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		else if (uParam1->f_66 == joaat("SANDKING") || uParam1->f_66 == joaat("SANDKING2"))
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_171(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("FORMULA") || uParam1->f_66 == joaat("FORMULA2"))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_171(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_171(iVar2));
				}
			}
		}
		else if (uParam1->f_66 == joaat("OPENWHEEL1"))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_171(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_171(iVar3));
				}
			}
		}
		else if (uParam1->f_66 == joaat("OPENWHEEL2"))
		{
			for (iVar4 = 1; iVar4 <= 11; iVar4 = iVar4 + 1)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (IS_BIT_SET(uParam1->f_77, func_171(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_171(iVar4));
					}
				}
			}
		}
		else if (uParam1->f_66 == joaat("SURFER3"))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_171(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_171(iVar5));
				}
			}
		}
		else if (uParam1->f_66 == joaat("DINGHY5"))
		{
			if (IS_BIT_SET(uParam1->f_77, func_171(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_171(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_171(1));
		}
		...
		else if (uParam1->f_66 == joaat("HOTKNIFE"))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_171(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_171(iVar6));
				}
			}
		}
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_234(iParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_233())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_171(iVar7 + 1)))
		...
		if (func_227() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("AVENGER")) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_137(true)))
			if (!IS_BIT_SET(uParam1->f_77, 23))
				if (!IS_BIT_SET(uParam1->f_77, 22) && func_226(iParam0, 5f))
...
bool func_226(int iParam0, float fParam1) // Position - 0xCFD4
{
	var uVar0;
	var uVar3;
...
int func_227() // Position - 0xD045
{
	...
	if (func_230(7))
		if (func_229(Global_2673274.f_4.f_16) || func_228(Global_2673274.f_4.f_16))
			return 0;

	return 1;
}

bool func_228(bool bParam0) // Position - 0xD0D4
{
	bool bVar0;
...
bool func_229(bool bParam0) // Position - 0xD0F9
{
	bool bVar0;
	...
	if (bVar0 != -1)
		return func_66(bParam0, 9);

	return false;
}

bool func_230(int iParam0) // Position - 0xD117
{
	return func_231(&(Global_2673274.f_194), iParam0);
}

bool func_231(var uParam0, int iParam1) // Position - 0xD12B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_232(int iParam0, var uParam1) // Position - 0xD14E
{
	int iVar0;
	int iVar1;
...
bool func_233() // Position - 0xD1C6
{
	return DLC::IS_DLC_PRESENT(joaat("MPINDEPENDENCE"));
}

bool func_234(int iParam0) // Position - 0xD1D7
{
	int iVar0;
...
int func_235(var uParam0) // Position - 0xD21F
{
	if (!func_205() && func_236(uParam0))
		return 1;

	return 0;
}

bool func_236(int iParam0) // Position - 0xD23F
{
	switch (iParam0)
	{
		case 161:
...
bool func_237(int iParam0) // Position - 0xD292
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		if (!func_243(PLAYER::PLAYER_ID(), -1))
...
int func_238(int iParam0) // Position - 0xD319
{
...
int func_239(int iParam0) // Position - 0xD348
{
	if (func_242(iParam0) == 233)
		return func_240(iParam0);

	return -1;
}

int func_240(int iParam0) // Position - 0xD365
{
...
bool func_241(int iParam0, bool bParam1) // Position - 0xD388
{
	if (func_33(iParam0))
...
int func_242(int iParam0) // Position - 0xD3CC
{
	if (func_33(iParam0))
		if (func_241(iParam0, false))
...
bool func_243(var uParam0, int iParam1) // Position - 0xD3F8
{
	var uVar0;

	if (func_128(uParam0, true, true))
	{
...
bool func_244(var uParam0) // Position - 0xD445
{
	if (func_245(uParam0))
	{
...
bool func_245(var uParam0) // Position - 0xD47A
{
	if (uParam0->f_12.f_66 == 0)
		return 0;

	if (!func_176(uParam0->f_12.f_66, false, -1))
		return 0;

	if (uParam0->f_12.f_66 == joaat("STUNT") && func_101(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, false))
		return 0;

	return 1;
}

bool func_246() // Position - 0xD4DA
{
	return func_244(&(Global_108474.f_2890));
}

void func_247() // Position - 0xD4ED
{
	func_248(&(Global_108474.f_2890));
}

void func_248(var uParam0) // Position - 0xD500
{
	if (func_245(uParam0))
		STREAMING::REQUEST_MODEL(uParam0->f_12.f_66);
}

bool func_249(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xD51E
{
	...
	if (iParam2 == 0 && func_251(Global_108474.f_2890.f_12.f_66))
		return false;
...
bool func_251(int iParam0) // Position - 0xD621
{
	switch (iParam0)
	{
		case joaat("POLICE"):
...
bool func_252() // Position - 0xD6DB
{
	return func_245(&(Global_108474.f_2890));
}

void func_253(int iParam0) // Position - 0xD6EE
{
	Global_98284 = 0;
...
void func_254(int iParam0) // Position - 0xD77C
{
	MISC::SET_BIT(&Global_98284, iParam0);
}

void func_255() // Position - 0xD78E
{
	if (!Static_26 && Static_78 != 3)
	{
		if (Static_78 > 0)
		{
			if (!Static_188)
			{
				...
				{
					Static_203 = MISC::GET_GAME_TIMER();
					func_261(4);
					return;
				}
			}
			...
			if (!Static_188)
			{
				if (!func_96(PLAYER::PLAYER_PED_ID(), Static_195, 150f, 1))
				{
					func_261(2);
				}
				else if (!func_96(PLAYER::PLAYER_PED_ID(), Static_195, 75f, 1))
				{
					...
					{
						HUD::CLEAR_PRINTS();
						func_110("PRD_RETSHOP" /* GXT: Return to the ~y~store. */, 7500, 0);
						Static_204 = true;
					}
				}
			}
...
bool func_256() // Position - 0xD84B
{
	...
	if (Static_189 == 1)
		iVar0 = 100;
	else if (Static_189 == 2)
		iVar0 = 50;

	if (!func_257(Static_188, iVar0) && !Static_188)
		return false;

	return true;
}

bool func_257(bool bParam0, int iParam1) // Position - 0xD887
{
	int iVar0;
...
int func_258(int iParam0, int iParam1) // Position - 0xD8D3
{
	int iVar0;
...
int func_259(int iParam0) // Position - 0xD8E8
{
	return Global_62201[iParam0];
}

bool func_260(int iParam0) // Position - 0xD8F7
{
	return func_90(iParam0, 1, true);
}

void func_261(int iParam0) // Position - 0xD907
{
	HUD::CLEAR_PRINTS();
	func_262();
	...
	switch (iParam0)
	{
		...
		case 1:
			Static_185 = "PRD_FKICKOFF" /* GXT: Unable to purchase the required masks. */;
			break;
	
		case 2:
			Static_185 = "PRD_FLEFT" /* GXT: The mask shop was abandoned. */;
			break;
	
		case 3:
			Static_185 = "PRD_CASH" /* GXT: The required masks were not purchased due to insufficient funds. */;
			break;
	
		case 4:
			Static_185 = "PRD_COPS" /* GXT: The Cops were alerted. */;
			break;
	}
...
void func_262() // Position - 0xD969
{
	Global_21866 = 0;
	func_75();
}

bool func_263() // Position - 0xD979
{
	func_264();
...
void func_264() // Position - 0xD9BE
{
	if (func_266())
	{
		...
		{
			case 0:
				if (Global_114931.f_2370.f_539.f_2395[0] == -99)
					func_265(Static_206[0], Static_206[1], Static_206[2]);
				else if (Global_114931.f_2370.f_539.f_2395[1] == -99)
					func_265(Static_206[1], Static_206[0], Static_206[2]);
				else if (Global_114931.f_2370.f_539.f_2395[2] == -99)
					func_265(Static_206[2], Static_206[1], Static_206[0]);
				break;
		
			case 1:
				if (Global_114931.f_2370.f_539.f_2395[1] == -99)
					func_265(Static_206[1], Static_206[0], Static_206[2]);
				else if (Global_114931.f_2370.f_539.f_2395[0] == -99)
					func_265(Static_206[0], Static_206[1], Static_206[2]);
				else if (Global_114931.f_2370.f_539.f_2395[2] == -99)
					func_265(Static_206[2], Static_206[1], Static_206[0]);
				break;
			...
			case 2:
				if (Global_114931.f_2370.f_539.f_2395[2] == -99)
					func_265(Static_206[2], Static_206[1], Static_206[0]);
				else if (Global_114931.f_2370.f_539.f_2395[0] == -99)
					func_265(Static_206[0], Static_206[1], Static_206[2]);
				else if (Global_114931.f_2370.f_539.f_2395[1] == -99)
...
void func_265(var uParam0, var uParam1, var uParam2) // Position - 0xDB74
{
	if (func_88(uParam1, 0, 0) || func_88(uParam2, 0, 0))
		HUD::CLEAR_PRINTS();

	if (!func_88(uParam0, 0, 0))
		func_110(uParam0, 60000, 0);
}

bool func_266() // Position - 0xDBB0
{
	return MISC::GET_GAME_TIMER() <= Global_24546.f_6481 + 100;
}

int func_267() // Position - 0xDBC5
{
	int iVar0;
	int iVar1;
	...
	{
		if (Global_114931.f_2370.f_539.f_2395[iVar1] != -99)
			iVar0 = iVar0 + 1;
	}
...
bool func_268(var uParam0) // Position - 0xDC01
{
	if (func_27(uParam0))
...
void func_269() // Position - 0xDC21
{
	...
	if (func_259(iVar0) < 1500)
		func_270(func_11(), 96, 1500, false, false);
}

void func_270(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4) // Position - 0xDC71
{
	int iVar0;
	int iVar1;
	...
	func_271(func_305(iParam0), 1, iParam1, iParam2, false);
...
int func_271(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4) // Position - 0xDD43
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_272(bool bParam0) // Position - 0xE342
{
	int iVar0;
	int iVar1;
...
void func_273(int iParam0) // Position - 0xE5C4
{
	int iVar0;
...
void func_274(int iParam0) // Position - 0xE61E
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	if (func_281(iParam0))
	{
		func_282(func_280(iParam0), 0, -1, 1);
		return;
	}
	...
	if (func_279(iParam0))
	{
		...
		func_276(func_278(iParam0), iVar0 - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114931.f_20571.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_159() /*5574*/].f_681.f_10, iParam0))
	{
		bVar1 = true;
		MISC::CLEAR_BIT(&(Global_114931.f_20571.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_159() /*5574*/].f_681.f_10), iParam0);
	}
	...
	if (bVar1)
	{
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_275(iParam0));
		HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&uVar2, &uVar2, 1, 0, "", 0);
	}
}

char* func_275(int iParam0) // Position - 0xE7E9
{
	switch (iParam0)
	{
		case 0:
...
void func_276(int iParam0, int iParam1) // Position - 0xE91B
{
	int iVar0;
...
int func_277(int iParam0) // Position - 0xE937
{
	int iVar0;
	int iVar1;
...
int func_278(int iParam0) // Position - 0xE955
{
	switch (iParam0)
	{
		case 38:
...
bool func_279(int iParam0) // Position - 0xE977
{
	switch (iParam0)
	{
		case 38:
...
int func_280(int iParam0) // Position - 0xE994
{
	switch (iParam0)
	{
		case 18:
...
bool func_281(int iParam0) // Position - 0xEA99
{
	switch (iParam0)
	{
		case 18:
...
void func_282(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xEB28
{
	int iVar0;
...
void func_283(int iParam0, int iParam1, int iParam2) // Position - 0xEB56
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
void func_284(int iParam0) // Position - 0xEB74
{
	func_303(93, iParam0);
	func_303(29, iParam0);
	func_303(30, iParam0);
...
bool func_285(int iParam0) // Position - 0xEB94
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 8)
		return func_286(129, -1);

	if (iParam0 == 9)
		return func_286(135, -1);

	if (iParam0 == 10)
		return func_286(136, -1);

	if (iParam0 == 11)
		return func_286(137, -1);
	...
	if (func_281(iParam0))
	{
		...
		iVar13 = func_91(func_280(iParam0), -1);
	...
	if (func_279(iParam0))
	{
		iVar14 = func_277(func_278(iParam0));
	...
	if (iParam0 == 39)
		return func_286(7332, -1);

	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return IS_BIT_SET(Global_114931.f_20571.f_471, iParam0);

	return IS_BIT_SET(Global_2359296[func_159() /*5574*/].f_681.f_10, iParam0);
}

bool func_286(int iParam0, int iParam1) // Position - 0xED9F
{
	if (iParam1 == -1)
		iParam1 = func_32();
...
int func_287(bool bParam0) // Position - 0xEDBB
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_288(int iParam0, int iParam1) // Position - 0xEE72
{
	if (iParam0 >= 78)
		return 0;
...
int func_289(int iParam0, int iParam1) // Position - 0xEE8D
{
	if (func_13(14) && !func_300(iParam0))
		return 0;
	...
	if (func_299(&Global_4525144))
	{
		if (func_297(&Global_4525144, iParam0))
			return 0;
	
		if (func_290(&Global_4525144, iParam0))
			return 1;
	}
	else
	{
...
bool func_290(var uParam0, int iParam1) // Position - 0xEF2A
{
	int iVar0;
	var uVar1;
	...
	if (func_13(14) && !func_300(iParam1))
		return false;
...
int func_291(var uParam0, int iParam1) // Position - 0xEFDB
{
	int iVar0;
...
bool func_292(var uParam0, int iParam1) // Position - 0xF056
{
	return uParam0->[iParam1] == 78;
}

void func_293(var uParam0) // Position - 0xF067
{
	int iVar0;
	...
	func_295(uParam0, Global_4525143 - 0.5f);
}

void func_294(var uParam0, int iParam1) // Position - 0xF09B
{
	uParam0->[iParam1] = 78;
}

void func_295(var uParam0, int iParam1) // Position - 0xF0AB
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_296(var uParam0) // Position - 0xF0C8
{
	return uParam0->f_80;
}

bool func_297(var uParam0, int iParam1) // Position - 0xF0D4
{
	return func_298(uParam0, iParam1) != -1;
}

int func_298(var uParam0, int iParam1) // Position - 0xF0E6
{
	int iVar0;
...
bool func_299(var uParam0) // Position - 0xF113
{
	return uParam0->f_79 == 1;
}

bool func_300(int iParam0) // Position - 0xF121
{
	switch (iParam0)
	{
		case 60:
...
int func_301(int iParam0, int iParam1) // Position - 0xF171
{
	int iVar0;
...
void func_302(int iParam0, int iParam1) // Position - 0xF1C2
{
	int iVar0;
...
void func_303(int iParam0, int iParam1) // Position - 0xF1E5
{
	int iVar0;
...
int func_305(int iParam0) // Position - 0xF2B7
{
	return Global_2339[iParam0 /*29*/].f_17;
}

bool func_306(bool bParam0) // Position - 0xF2C8
{
...
void func_307(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0xF2F0
{
	if (func_308())
	{
...
void func_309() // Position - 0xF3A9
{
	func_310(joaat("PLAYER_ZERO"), 14, 31, true);
	func_310(joaat("PLAYER_ZERO"), 14, 32, true);
	func_310(joaat("PLAYER_ZERO"), 14, 33, true);
	func_310(joaat("PLAYER_ZERO"), 14, 34, true);
	func_310(joaat("PLAYER_ZERO"), 14, 35, true);
	func_310(joaat("PLAYER_ZERO"), 14, 36, true);
	func_310(joaat("PLAYER_ZERO"), 14, 37, true);
	func_310(joaat("PLAYER_ZERO"), 14, 38, true);
	func_310(joaat("PLAYER_ZERO"), 14, 39, true);
	func_310(joaat("PLAYER_ZERO"), 14, 40, true);
	func_310(joaat("PLAYER_ZERO"), 14, 41, true);
	func_310(joaat("PLAYER_ZERO"), 14, 42, true);
	func_310(joaat("PLAYER_ZERO"), 14, 43, true);
	func_310(joaat("PLAYER_ZERO"), 14, 44, true);
	func_310(joaat("PLAYER_ZERO"), 9, 9, true);
	func_310(joaat("PLAYER_ZERO"), 9, 10, true);
	func_310(joaat("PLAYER_ZERO"), 9, 11, true);
	func_310(joaat("PLAYER_ZERO"), 9, 12, true);
	func_310(joaat("PLAYER_ZERO"), 9, 13, true);
	func_310(joaat("PLAYER_ZERO"), 9, 14, true);
	func_310(joaat("PLAYER_ONE"), 14, 26, true);
	func_310(joaat("PLAYER_ONE"), 14, 27, true);
	func_310(joaat("PLAYER_ONE"), 14, 28, true);
	func_310(joaat("PLAYER_ONE"), 14, 29, true);
	func_310(joaat("PLAYER_ONE"), 14, 30, true);
	func_310(joaat("PLAYER_ONE"), 14, 31, true);
	func_310(joaat("PLAYER_ONE"), 14, 32, true);
	func_310(joaat("PLAYER_ONE"), 14, 33, true);
	func_310(joaat("PLAYER_ONE"), 14, 34, true);
	func_310(joaat("PLAYER_ONE"), 14, 35, true);
	func_310(joaat("PLAYER_ONE"), 14, 36, true);
	func_310(joaat("PLAYER_ONE"), 14, 37, true);
	func_310(joaat("PLAYER_ONE"), 14, 38, true);
	func_310(joaat("PLAYER_ONE"), 14, 39, true);
	func_310(joaat("PLAYER_ONE"), 9, 5, true);
	func_310(joaat("PLAYER_ONE"), 9, 6, true);
	func_310(joaat("PLAYER_ONE"), 9, 7, true);
	func_310(joaat("PLAYER_ONE"), 9, 8, true);
	func_310(joaat("PLAYER_ONE"), 9, 9, true);
	func_310(joaat("PLAYER_ONE"), 9, 10, true);
	func_310(joaat("PLAYER_TWO"), 14, 49, true);
	func_310(joaat("PLAYER_TWO"), 14, 50, true);
	func_310(joaat("PLAYER_TWO"), 14, 51, true);
	func_310(joaat("PLAYER_TWO"), 14, 52, true);
	func_310(joaat("PLAYER_TWO"), 14, 53, true);
	func_310(joaat("PLAYER_TWO"), 14, 54, true);
	func_310(joaat("PLAYER_TWO"), 14, 55, true);
	func_310(joaat("PLAYER_TWO"), 14, 56, true);
	func_310(joaat("PLAYER_TWO"), 14, 57, true);
	func_310(joaat("PLAYER_TWO"), 14, 58, true);
	func_310(joaat("PLAYER_TWO"), 14, 59, true);
	func_310(joaat("PLAYER_TWO"), 14, 60, true);
	func_310(joaat("PLAYER_TWO"), 9, 9, true);
	func_310(joaat("PLAYER_TWO"), 9, 10, true);
	func_310(joaat("PLAYER_TWO"), 9, 11, true);
	func_310(joaat("PLAYER_TWO"), 9, 12, true);
	func_310(joaat("PLAYER_TWO"), 9, 13, true);
	func_310(joaat("PLAYER_TWO"), 9, 14, true);
	func_310(joaat("PLAYER_TWO"), 9, 15, true);
	func_310(joaat("PLAYER_TWO"), 9, 16, true);
}

int func_310(int iParam0, int iParam1, int iParam2, bool bParam3) // Position - 0xF6F9
{
	Global_80088[1 /*14*/] = { func_312(iParam0, iParam1, iParam2, -1) };

	if (IS_BIT_SET(Global_80088[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_80088[1 /*14*/].f_6, 6))
	{
		if (bParam3)
			func_311(iParam1, Global_80088[1 /*14*/].f_5, Global_80088[1 /*14*/].f_2, 0, Global_80088[1 /*14*/].f_1, 1, 0);
		else
			func_311(iParam1, Global_80088[1 /*14*/].f_5, Global_80088[1 /*14*/].f_2, 0, Global_80088[1 /*14*/].f_1, 0, 1);
...
bool func_311(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xF78F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_312(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10636
{
	func_377();

	if (iParam0 == joaat("PLAYER_ZERO"))
		func_359(iParam1, iParam2);
...
void func_313(int iParam0, int iParam1) // Position - 0x10688
{
	switch (iParam0)
	{
		case 0:
...
void func_314(int iParam0) // Position - 0x10778
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		default:
			func_322(iVar10, iParam0, 155, -1);
			return;
	}

	func_315(&Global_80088[0 /*14*/], iVar10, iParam0, &uVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, false);
}

void func_315(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10) // Position - 0x119EF
{
	int iVar0;
	int iVar1;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_319(Global_2883588, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_6), 2);
		
			if (!func_319(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_311(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 1);
	
		if (func_311(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 2);
	
		if (!func_311(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			iVar0 = func_91(func_318(iParam1, iParam0->f_2), Global_80085);
		
			if (IS_BIT_SET(iVar0, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			iVar0 = func_91(func_317(iParam1, iParam0->f_2), Global_80085);
		
			if (IS_BIT_SET(iVar0, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_316(iParam1, iParam0->f_2, &iVar1))
			{
				iVar0 = func_91(iVar1, Global_80085);
...
bool func_316(int iParam0, int iParam1, var uParam2) // Position - 0x11D91
{
	*uParam2 = 979;
...
int func_317(int iParam0, int iParam1) // Position - 0x12196
{
	switch (iParam1)
	{
		case 0:
...
int func_318(int iParam0, int iParam1) // Position - 0x12591
{
	switch (iParam1)
	{
		case 0:
...
bool func_319(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4) // Position - 0x1298C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_320(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5) // Position - 0x129CA
{
	int iVar0;
...
int func_321(int iParam0) // Position - 0x15670
{
	switch (iParam0)
	{
		case -1:
...
void func_322(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x15744
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_315(&Global_80088[0 /*14*/], iParam0, iParam1, &(iVar2.f_7), 0, 0, iVar2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_315(&Global_80088[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_315(&Global_80088[0 /*14*/], iParam0, iParam1, &(iVar19.f_9), iVar19.f_3, iVar19.f_4, iVar19.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, iVar19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_80286)
		{
			...
			func_315(&Global_80088[0 /*14*/], iParam0, iParam1, &(iVar39.f_9), iVar39.f_3, iVar39.f_4, iVar39.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, iVar39.f_1 != 0);
			return;
		}
		...
		if (iVar56 >= 0)
		{
			iVar57 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 11, -1, 0, -1, func_323(iParam0));
...
int func_323(int iParam0) // Position - 0x159CB
{
	switch (iParam0)
	{
		case 0:
...
void func_324(int iParam0) // Position - 0x15A7B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_325(int iParam0) // Position - 0x15BD2
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_326(int iParam0) // Position - 0x160E0
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_327(int iParam0) // Position - 0x16155
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_328(int iParam0) // Position - 0x161C9
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_329(int iParam0) // Position - 0x162B0
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_330(int iParam0) // Position - 0x16613
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_331(int iParam0) // Position - 0x16824
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_332(int iParam0) // Position - 0x16A54
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_333(int iParam0) // Position - 0x16B64
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_334(int iParam0) // Position - 0x17503
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_335(int iParam0) // Position - 0x18078
{
	if (iParam0 < 136)
		func_337(iParam0);
	else
	...
	if (Global_80088[0 /*14*/].f_2 == -1)
		func_322(3, iParam0, 242, -1);
}

void func_336(int iParam0) // Position - 0x180AD
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_337(int iParam0) // Position - 0x18CB1
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_338(int iParam0) // Position - 0x19BBF
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_339(int iParam0) // Position - 0x19CEC
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_340(int iParam0, int iParam1) // Position - 0x19DEA
{
	switch (iParam0)
	{
		case 0:
...
void func_341(int iParam0) // Position - 0x19EDA
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_342(int iParam0) // Position - 0x1B3CB
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_343(int iParam0) // Position - 0x1B51C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_344(int iParam0) // Position - 0x1BA27
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_345(int iParam0) // Position - 0x1C097
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_346(int iParam0) // Position - 0x1C10B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_347(int iParam0) // Position - 0x1C1DB
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_348(int iParam0) // Position - 0x1C70B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_349(int iParam0) // Position - 0x1C8A2
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_350(int iParam0) // Position - 0x1D0A0
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_351(int iParam0) // Position - 0x1D1B0
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_352(int iParam0) // Position - 0x1E0DB
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_353(int iParam0) // Position - 0x1ED98
{
	if (iParam0 < 107)
		func_356(iParam0);
	else if (iParam0 < 227)
	...
	if (Global_80088[0 /*14*/].f_2 == -1)
		func_322(3, iParam0, 318, -1);
}

void func_354(int iParam0) // Position - 0x1EDDE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_355(int iParam0) // Position - 0x1F883
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_356(int iParam0) // Position - 0x20674
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_357(int iParam0) // Position - 0x212BD
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_358(int iParam0) // Position - 0x21536
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_359(int iParam0, int iParam1) // Position - 0x2167C
{
	switch (iParam0)
	{
		case 0:
...
void func_360(int iParam0) // Position - 0x2176C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_361(int iParam0) // Position - 0x224F6
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_362(int iParam0) // Position - 0x22670
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_363(int iParam0) // Position - 0x22BE7
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_364(int iParam0) // Position - 0x23111
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_365(int iParam0) // Position - 0x23185
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_366(int iParam0) // Position - 0x23255
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_367(int iParam0) // Position - 0x2372D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_368(int iParam0) // Position - 0x23996
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_369(int iParam0) // Position - 0x23C6C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_370(int iParam0) // Position - 0x23E35
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_371(int iParam0) // Position - 0x24B2D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_372(int iParam0) // Position - 0x25777
{
	if (iParam0 < 60)
		func_374(iParam0);
	else
	...
	if (Global_80088[0 /*14*/].f_2 == -1)
		func_322(3, iParam0, 181, -1);
}

void func_373(int iParam0) // Position - 0x257AC
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_374(int iParam0) // Position - 0x2654C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_375(int iParam0) // Position - 0x26BD8
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_376(int iParam0) // Position - 0x26CBF
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_377() // Position - 0x26DBD
{
...
void func_378() // Position - 0x26E36
{
	func_387();
	func_386();
	func_379();
...
void func_379() // Position - 0x26E4A
{
	var uVar0;

	uVar0 = 8;
	uVar0[0 /*3*/] = { 344.0985f, -1605.1539f, 28.2928f };
	uVar0[1 /*3*/] = { 365.6985f, -1580.435f, 28.2928f };
	uVar0[2 /*3*/] = { 407.9943f, -1616.2589f, 28.2928f };
	uVar0[3 /*3*/] = { 387.3322f, -1641.2583f, 29.0912f };
	func_380(&uVar0, 4);
}

void func_380(var uParam0, int iParam1) // Position - 0x26EB7
{
	int iVar0;
	...
	{
		func_384(&Static_80, uParam0->[iVar0 /*3*/]);
	}

	func_383(&Static_80);
	func_381(&Static_132, &Static_80, 50f);
}

void func_381(var uParam0, var uParam1, float fParam2) // Position - 0x26EFB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_382(uParam1, uParam1->[iVar1 /*3*/] + fVar9))
			fVar9 = { -fVar9 };
...
bool func_382(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x27008
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_383(var uParam0) // Position - 0x270C4
{
	int iVar0;
	float fVar1;
...
void func_384(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x27164
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_385(var uParam0) // Position - 0x27195
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
void func_386() // Position - 0x271BC
{
	Static_206[0] = "PRD_BUYM" /* GXT: Buy a mask for Michael. */;
	Static_206[1] = "PRD_BUYF" /* GXT: Buy a mask for Franklin. */;
	Static_206[2] = "PRD_BUYT" /* GXT: Buy a mask for Trevor. */;
}

void func_387() // Position - 0x271DC
{
}

void func_388() // Position - 0x271E4
{
	func_399(true);
	func_398();
	func_389(false);
...
void func_389(bool bParam0) // Position - 0x271FE
{
	bParam0;
	func_397(true, 1, 1);
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
	...
	if (CAM::DOES_CAM_EXIST(Static_191))
	{
		CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		CAM::DESTROY_CAM(Static_191, 0);
	}
}

void func_390() // Position - 0x27269
{
}

void func_391() // Position - 0x27271
{
	Global_21866 = 0;
	func_392();
}

void func_392() // Position - 0x27281
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
void func_393() // Position - 0x272A2
{
}

void func_394() // Position - 0x272AA
{
}

void func_395() // Position - 0x272B2
{
}

void func_396() // Position - 0x272BA
{
}

void func_397(bool bParam0, int iParam1, int iParam2) // Position - 0x272C2
{
	bool bVar0;
...
void func_398() // Position - 0x27321
{
	Global_98284 = 0;
}

void func_399(bool bParam0) // Position - 0x2732E
{
...
void func_400() // Position - 0x27375
{
	int iVar0;
...
bool func_401() // Position - 0x273E6
{
	if (Global_102454 == 13 || Global_102454 == 10 || Global_102454 == 11 || Global_102454 == 12)
		return false;
...
void func_402() // Position - 0x27424
{
	Global_114931.f_2370.f_539.f_2395[0] = -99;
	Global_114931.f_2370.f_539.f_2395[1] = -99;
	Global_114931.f_2370.f_539.f_2395[2] = -99;
