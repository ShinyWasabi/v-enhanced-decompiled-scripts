...
void func_11(var uParam0) // Position - 0x21C
{
	...
	iVar20 = { uParam0->[uParam0->f_57.f_2 /*14*/] };
	...
	switch (uParam0->f_57.f_4)
	{
			...
			if (func_51(PLAYER::PLAYER_PED_ID(), &uParam0->[uParam0->f_57.f_2 /*14*/]))
			{
				...
				else if (uParam0->f_57.f_5 == -1)
				{
					if (MISC::GET_GAME_TIMER() - uParam0->f_57.f_6 > 150)
						func_46(&(uParam0->f_57.f_5), 4, "MPJAC_SIT" /* GXT: Press ~INPUT_CONTEXT~ to sit down. */, 0, 0, 0, 0);
				}
		...
		case 5:
			...
			{
				uParam0->f_57.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_40(uParam0), func_39(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
		...
		case 6:
			...
			func_27(uParam0);
			func_18(uParam0);
			uVar42 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_57.f_1);
		...
		case 8:
			uVar43 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_57.f_1);
		...
		else
		{
			...
			if (!HUD::IS_PAUSE_MENU_ACTIVE() && !func_8(&(uParam0->f_57), 0) && !func_8(&(uParam0->f_57), 4) && !func_22() && !func_21() && !func_19(true) && uParam0->f_57.f_8.f_2 != 3)
			{
				if (uParam0->f_57.f_5 == -1)
					func_46(&(uParam0->f_57.f_5), 4, "MPJAC_EXIT" /* GXT: Press ~INPUT_CONTEXT~ to stand up. */, 0, 0, 0, 0);
...
Vector3 func_39(var uParam0) // Position - 0xF19
{
	...
	uVar0 = { uParam0->[uParam0->f_57.f_2 /*14*/].f_8.f_3 };
...
bool func_48(var uParam0) // Position - 0x13D1
{
	...
	for (iVar0 = 0; iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); iVar0 = iVar0 + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (uVar1 != PLAYER::PLAYER_ID() && func_49(uVar1, true, true) && func_51(PLAYER::GET_PLAYER_PED(uVar1), &uParam0->[uParam0->f_57.f_2 /*14*/]))
				return 1;
		}
	}
...
void func_57(var uParam0) // Position - 0x160F
{
	...
	func_58(&(uParam0->f_57), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_58(&(uParam0->f_57), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(uParam0, 451.6327f, 4829.453f, -54.97165f, 499.98096f, 4842.0337f, -50.679607f, 30.75f, 0, 1, 0);
}
...
bool func_71() // Position - 0x182E
{
	if (Global_1845136 != func_61())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_entrance_seats", Global_1845136, 1, 0))
			return false;
...
void func_72() // Position - 0x187A
{
	...
	uVar0[0] = 0;
	uVar0[1] = 1;
	func_73(0, &Static_124, &uVar0);
	uVar0[0] = 2;
	uVar0[1] = 3;
	func_73(1, &Static_124, &uVar0);
}
...
void func_73(int iParam0, var uParam1, var uParam2) // Position - 0x18B1
{
	...
	func_80(iParam0, &uVar0, &fVar3);

	for (iVar4 = 0; iVar4 < 2; iVar4 = iVar4 + 1)
	{
		uParam1->[uParam2->[iVar4] /*14*/] = 2;
		uParam1->[uParam2->[iVar4] /*14*/].f_8 = { func_76(func_77(iVar4), fVar3) + uVar0 };
		uParam1->[uParam2->[iVar4] /*14*/].f_8.f_3 = { 0f, 0f, fVar3 + 174f };
		uParam1->[uParam2->[iVar4] /*14*/].f_1 = { func_76(func_75(iVar4), fVar3) + uVar0 };
		uParam1->[uParam2->[iVar4] /*14*/].f_1.f_3 = { func_76(func_74(iVar4), fVar3) + uVar0 };
		uParam1->[uParam2->[iVar4] /*14*/].f_1.f_6 = 1.42f;
	}
}
...
int func_81(int iParam0, int iParam1, bool bParam2) // Position - 0x1C59
{
	int iVar0;
