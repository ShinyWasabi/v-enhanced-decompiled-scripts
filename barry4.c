...
void main() // Position - 0x0
{
	...
	{
		func_427("Force cleanup [TERMINATING]");
		func_404(true);
		func_387();
	}
	...
	if (func_386())
	{
		...
		while (!func_385(&Static_81))
		{
			BUILTIN::WAIT(0);
		}
	
		func_253(&uVar0, 236.1378f, -369.3902f, 43.2497f, 251.2f, 0, 0, 0, 1, 0, joaat("ASTEROPE"), 0, 145, 1);
		Global_80551 = 0;
	}
	...
	while (true)
	{
		...
		func_236(Static_81.f_9, 0, 0, 0, 0, 0);
...
void func_1() // Position - 0x121
{
	switch (Static_80)
	{
		case 0:
			if (func_386())
			{
				func_235(243.367f, -387.3153f, 44.4046f, 175.2f, 1, 0);
				func_233(0, -1, 1);
			}
		...
		case 1:
			...
			func_226(&Static_143, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN" /* GXT: Franklin */, 0, 1);
			func_226(&Static_143, 3, 0, "BARRY", 0, 1);
			Static_142 = false;
			Static_80 = 2;
			break;
		...
		case 2:
			if (!Static_142)
			{
				if (func_208(&Static_143, 49, "BARR4AU", "BAR4_RCM_LI", 11, 1, 0, 0, false))
				{
...
bool func_5(bool bParam0) // Position - 0x399
{
...
void func_10(int iParam0, int iParam1, int iParam2) // Position - 0x9C1
{
	if (iParam2 == -1)
		iParam2 = func_11();
...
bool func_32(int iParam0, int iParam1, bool bParam2) // Position - 0x148D
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool func_33(int iParam0, int iParam1, var uParam2) // Position - 0x164A
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1726
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(int iParam0, int iParam1, bool bParam2) // Position - 0x1F37
{
	bool bVar0;
	int iVar1;
...
bool func_37(int iParam0, int iParam1, bool bParam2) // Position - 0x1FC1
{
	if (iParam0 == joaat("PLAYER_ZERO"))
		if (iParam1 == 4)
...
bool func_38(int iParam0, int iParam1, bool bParam2) // Position - 0x209F
{
	Global_80088[1 /*14*/] = { func_85(iParam0, iParam1, bParam2, -1) };
	return IS_BIT_SET(Global_80088[1 /*14*/].f_6, 2);
}

bool func_39(int iParam0, bool bParam1, int iParam2, bool bParam3, var uParam4, int iParam5) // Position - 0x20C7
{
	var uVar0;
	int iVar10;
...
bool func_40(int iParam0, int iParam1, bool bParam2) // Position - 0x26CB
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_41(int iParam0, int iParam1, int iParam2) // Position - 0x2764
{
	bool bVar0;
	bool bVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (iParam1 == 12)
		{
			...
			{
				if (func_150(iParam0, iParam1, bVar0))
					return bVar0;
			}
		}
		else if (iParam1 == 13)
		{
			...
			{
				if (func_150(iParam0, iParam1, bVar1))
					return bVar1;
			}
...
int func_42(int iParam0, int iParam1, bool bParam2, var uParam3) // Position - 0x2805
{
	int iVar0;
...
bool func_43(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5) // Position - 0x2B0C
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_44(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) // Position - 0x36BF
{
	int iVar0;
...
bool func_45(int iParam0, bool bParam1, bool bParam2, int iParam3) // Position - 0x39A3
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3C6A
{
	bool bVar0;
	bool bVar1;
...
bool func_47(int iParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x3CA1
{
	bool bVar0;

	bVar0 = func_65(iParam0, iParam1);
...
bool func_48(int iParam0, bool bParam1, var uParam2) // Position - 0x3CCA
{
	*uParam2 = -99;
...
int func_49(int iParam0, int iParam1, bool bParam2, var uParam3) // Position - 0x3F94
{
	int iVar0;
...
bool func_50(int iParam0, bool bParam1, bool bParam2) // Position - 0x4220
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4377
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			bVar0 = func_56(iParam0, iParam2, iParam3, iParam1);
		
			if (func_52(ENTITY::GET_ENTITY_MODEL(iParam0), 14, bVar0, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
bool func_52(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x4411
{
	switch (iParam0)
	{
...
int func_53(int iParam0, bool bParam1, int iParam2, int iParam3) // Position - 0x44DF
{
	var uVar0;
	int iVar17;
	int iVar18;
...
bool func_56(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4A01
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_61(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x4DDB
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_62(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x5058
{
	if (iParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
bool func_63(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x547D
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_64(int iParam0, int iParam1) // Position - 0x5770
{
	int iVar0;
	var uVar1;
	...
	return func_56(iParam0, iVar0, uVar1, iParam1);
}

bool func_65(int iParam0, int iParam1) // Position - 0x57B7
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	return func_66(iParam0, uVar1, uVar2, iParam1);
}

int func_66(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x5817
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x86A5
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_75(int iParam0) // Position - 0x9548
{
	if (!IS_BIT_SET(Global_80088[1 /*14*/].f_6, 0))
		return false;
...
bool func_76(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x9590
{
	int iVar0;
...
int func_77(int iParam0) // Position - 0x963B
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(int iParam0, bool bParam1) // Position - 0x96EB
{
	int iVar0;
	var uVar1;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA01A
{
	int iVar0;
	var uVar1;
	int iVar16;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA144
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_81(int iParam0, bool bParam1) // Position - 0xA18C
{
	int iVar0;
	var uVar1;
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBFD4
{
	int iVar0;
	var uVar1;
	int iVar16;
...
int func_83(int iParam0) // Position - 0xC1BF
{
	switch (iParam0)
	{
		case 0:
...
void func_84(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC26F
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = bParam3;
...
struct<14> func_85(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0xC2E0
{
	func_149();
...
void func_86(int iParam0, bool bParam1) // Position - 0xC332
{
	switch (iParam0)
	{
		case 0:
...
void func_87(int iParam0) // Position - 0xC422
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10) // Position - 0xD650
{
	int iVar0;
	int iVar1;
...
bool func_89(int iParam0, int iParam1, var uParam2) // Position - 0xD9F1
{
	*uParam2 = 979;
...
int func_91(int iParam0, int iParam1) // Position - 0xE1F1
{
	switch (iParam1)
	{
		case 0:
...
bool func_92(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4) // Position - 0xE5EC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_93(int iParam0) // Position - 0xE62A
{
	return Global_44886 == iParam0;
}

int func_94(int iParam0) // Position - 0xE638
{
	switch (iParam0)
	{
		case -1:
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE70C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_96(int iParam0) // Position - 0xE992
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_97(int iParam0) // Position - 0xEADF
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_98(int iParam0) // Position - 0xEFEC
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_99(int iParam0) // Position - 0xF060
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_100(int iParam0) // Position - 0xF0D3
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_101(int iParam0) // Position - 0xF1BA
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_102(int iParam0) // Position - 0xF4FC
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_103(int iParam0) // Position - 0xF704
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_104(int iParam0) // Position - 0xF924
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_105(int iParam0) // Position - 0xFA2D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_106(int iParam0) // Position - 0x103C2
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_107(bool bParam0) // Position - 0x10F1A
{
	if (bParam0 < 136)
		func_109(bParam0);
	else
	...
	if (Global_80088[0 /*14*/].f_2 == -1)
		func_95(3, bParam0, 242, -1);
}

void func_108(int iParam0) // Position - 0x10F4F
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_109(int iParam0) // Position - 0x11B53
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_110(int iParam0) // Position - 0x12A53
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_111(int iParam0) // Position - 0x12B80
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_112(int iParam0, bool bParam1) // Position - 0x12C77
{
	switch (iParam0)
	{
		case 0:
...
void func_113(int iParam0) // Position - 0x12D67
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_114(int iParam0) // Position - 0x14236
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_115(int iParam0) // Position - 0x1437D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_116(int iParam0) // Position - 0x14887
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_117(int iParam0) // Position - 0x14EF0
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_118(int iParam0) // Position - 0x14F63
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_119(int iParam0) // Position - 0x15033
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_120(int iParam0) // Position - 0x1552E
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_121(int iParam0) // Position - 0x156BF
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_122(int iParam0) // Position - 0x15EAE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_123(int iParam0) // Position - 0x15FB7
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_124(int iParam0) // Position - 0x16EDA
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_125(bool bParam0) // Position - 0x17B87
{
	if (bParam0 < 107)
		func_128(bParam0);
	else if (bParam0 < 227)
	...
	if (Global_80088[0 /*14*/].f_2 == -1)
		func_95(3, bParam0, 318, -1);
}

void func_126(int iParam0) // Position - 0x17BCD
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_127(int iParam0) // Position - 0x18672
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_128(int iParam0) // Position - 0x19460
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_129(int iParam0) // Position - 0x1A09F
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_130(int iParam0) // Position - 0x1A317
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_131(int iParam0, bool bParam1) // Position - 0x1A453
{
	switch (iParam0)
	{
		case 0:
...
void func_132(int iParam0) // Position - 0x1A543
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_133(int iParam0) // Position - 0x1B2A1
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_134(int iParam0) // Position - 0x1B410
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_135(int iParam0) // Position - 0x1B981
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_136(int iParam0) // Position - 0x1BEA9
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_137(int iParam0) // Position - 0x1BF1C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_138(int iParam0) // Position - 0x1BFEC
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_139(int iParam0) // Position - 0x1C49D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_140(int iParam0) // Position - 0x1C6F8
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_141(int iParam0) // Position - 0x1C9B8
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_142(int iParam0) // Position - 0x1CB73
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_143(int iParam0) // Position - 0x1D6B9
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_144(bool bParam0) // Position - 0x1E2EB
{
	if (bParam0 < 60)
		func_146(bParam0);
	else
	...
	if (Global_80088[0 /*14*/].f_2 == -1)
		func_95(3, bParam0, 181, -1);
}

void func_145(int iParam0) // Position - 0x1E320
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_146(int iParam0) // Position - 0x1F0B3
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_147(int iParam0) // Position - 0x1F735
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_148(int iParam0) // Position - 0x1F81B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_149() // Position - 0x1F912
{
...
bool func_150(int iParam0, int iParam1, bool bParam2) // Position - 0x1F98A
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_151(int iParam0) // Position - 0x1FBE3
{
	int iVar0;
	int iVar1;
...
int func_152(int iParam0) // Position - 0x1FC20
{
	if (func_154(iParam0))
...
int func_153(int iParam0) // Position - 0x1FC45
{
	return Global_2339[iParam0 /*29*/];
}

bool func_154(int iParam0) // Position - 0x1FC54
{
	return iParam0 < 3;
}

void func_155(var uParam0, int iParam1) // Position - 0x1FC60
{
...
void func_157() // Position - 0x1FCF7
{
	int iVar0;
...
struct<2> func_158(int iParam0) // Position - 0x1FDF4
{
	var uVar0;
	var uVar2;
...
struct<2> func_159(int iParam0) // Position - 0x1FE2B
{
	var uVar0;
...
void func_160(int iParam0, bool bParam1) // Position - 0x20279
{
...
void func_161(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x202C3
{
...
void func_162(int iParam0, int iParam1, int iParam2) // Position - 0x20360
{
	var uVar0;
	var uVar32;
...
void func_163(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2039F
{
...
void func_164(int iParam0, var uParam1) // Position - 0x203E3
{
	switch (iParam0)
	{
		case 0:
...
int func_166(int iParam0) // Position - 0x21629
{
	switch (iParam0)
	{
		case 0:
...
void func_167(int iParam0) // Position - 0x2196F
{
	Global_45437 = MISC::GET_GAME_TIMER() + iParam0;
}

void func_168() // Position - 0x21981
{
	if (Global_99741)
	{
		func_157();
...
char* func_169(int iParam0) // Position - 0x219B3
{
	iParam0 = iParam0;
	return "";
}

void func_170() // Position - 0x219C2
{
	var uVar0;
...
bool func_171() // Position - 0x21A0F
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

bool func_172() // Position - 0x21A25
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_173(int iParam0, int iParam1) // Position - 0x21A3B
{
	Global_99736 = iParam0;
	Global_99737 = iParam1;
}

void func_174() // Position - 0x21A4F
{
	Global_80560 != 6;
...
void func_175(int iParam0) // Position - 0x21A87
{
	if (*iParam0 == -1)
		return;
...
void func_176(int iParam0, bool bParam1) // Position - 0x21AC4
{
	var uVar0;
	int iVar32;
	bool bVar33;
...
int func_177(int iParam0) // Position - 0x21C41
{
	switch (iParam0)
	{
		case 0:
...
void func_178(int iParam0) // Position - 0x21FC8
{
...
int func_179() // Position - 0x21FFE
{
	return Global_114931.f_10023.f_21 + Global_114931.f_18581.f_380;
}

void func_180(int iParam0, bool bParam1) // Position - 0x2201A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_181(int iParam0) // Position - 0x2233E
{
...
void func_182(int iParam0) // Position - 0x22371
{
	switch (iParam0)
	{
		case 30:
...
void func_183(int iParam0, bool bParam1) // Position - 0x223A6
{
	if (iParam0 == -1)
		return;
...
void func_184(int iParam0, int iParam1, bool bParam2) // Position - 0x22403
{
	if (iParam0 == -1)
		return;
...
bool func_185(int iParam0, int iParam1) // Position - 0x2243E
{
	if (iParam0 == -1)
		return false;
...
void func_186(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4) // Position - 0x2245E
{
	if (iParam0 != 198)
	{
		if (Global_80305)
...
void func_187(int iParam0, int iParam1) // Position - 0x224B6
{
	switch (iParam0)
	{
		case 12:
...
void func_188(int iParam0, bool bParam1) // Position - 0x2259F
{
	if (bParam1)
...
bool func_189(int iParam0, bool bParam1, int iParam2, bool bParam3) // Position - 0x225C8
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_190() // Position - 0x22F17
{
...
int func_191() // Position - 0x22F47
{
	return Global_33793;
}

int func_192(var uParam0, int iParam1) // Position - 0x22F52
{
	int iVar0;
...
int func_193(int iParam0) // Position - 0x266EE
{
	switch (iParam0)
	{
		case 46:
...
void func_194(int iParam0, bool bParam1) // Position - 0x267DD
{
	switch (iParam0)
	{
		case 46:
...
void func_195(int iParam0, bool bParam1) // Position - 0x2682E
{
	int iVar0;
...
void func_196(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x26894
{
	func_197(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_197(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x268B5
{
	int iVar0;
...
void func_198() // Position - 0x26A88
{
	int iVar0;
...
bool func_199(int iParam0) // Position - 0x26B9F
{
	int iVar0;
	int iVar1;
...
void func_200(char* sParam0) // Position - 0x26BDF
{
...
char* func_201(int iParam0) // Position - 0x26C03
{
	switch (iParam0)
	{
		case 0:
...
bool func_202(int iParam0) // Position - 0x26DD6
{
...
void func_203(int iParam0, int iParam1) // Position - 0x26E00
{
...
bool func_204(var uParam0) // Position - 0x26E3D
{
	int iVar0;
...
int func_205() // Position - 0x26E9D
{
	return func_206(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_206(var uParam0, int iParam1) // Position - 0x26EAE
{
	int iVar0;
	var uVar1;
	var uVar33;
...
bool func_207() // Position - 0x26EF7
{
	if (Global_23000 == 0)
		return true;
...
bool func_208(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8) // Position - 0x26F0E
{
	func_225(uParam0, iParam1, sParam2, iParam6, iParam7, 0);
	Global_23048 = false;
	Global_23007 = true;
	Global_23014 = false;
	Global_23009 = 0;
...
bool func_209(char* sParam0, int iParam1, bool bParam2) // Position - 0x26F6D
{
	Global_23001 = 0;
...
void func_210() // Position - 0x2723B
{
	if (!func_211())
		return;
...
bool func_211() // Position - 0x27272
{
...
bool func_212(bool bParam0) // Position - 0x272D5
{
	...
	return func_213(bParam0, 20);
}

bool func_213(bool bParam0, int iParam1) // Position - 0x2730C
{
	return IS_BIT_SET(Global_1892798[bParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_214(int iParam0) // Position - 0x27324
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

bool func_215() // Position - 0x27336
{
	return -1;
}

void func_216() // Position - 0x2733F
{
	int iVar0;
...
void func_217() // Position - 0x27370
{
...
bool func_218() // Position - 0x27405
{
...
bool func_219() // Position - 0x2742C
{
	int iVar0;
	int iVar1;
...
void func_220() // Position - 0x274C5
{
	if (func_93(14))
	{
...
int func_221() // Position - 0x27567
{
	func_157();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_222() // Position - 0x27580
{
	int iVar0;
...
bool func_223(int iParam0, int iParam1) // Position - 0x275D7
{
	switch (iParam0)
	{
		case 5:
...
void func_224() // Position - 0x2760F
{
...
void func_225(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27666
{
...
void func_226(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x276BC
{
...
void func_227() // Position - 0x27757
{
	Global_21866 = 0;
	func_228();
}

void func_228() // Position - 0x27767
{
...
void func_229() // Position - 0x2779E
{
	Global_21866 = 0;
	func_230();
}

void func_230() // Position - 0x277AE
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
bool func_231() // Position - 0x277CF
{
...
void func_232(int iParam0, bool bParam1) // Position - 0x277F1
{
...
void func_233(int iParam0, int iParam1, int iParam2) // Position - 0x2782D
{
	if (func_386() && func_234())
	{
...
bool func_234() // Position - 0x278F1
{
	return IS_BIT_SET(Global_102454.f_20, 13);
}

void func_235(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x27902
{
	if (func_386())
	{
...
void func_236(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x27997
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_80560 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				uVar4 = { func_238(Global_80561, Global_80563, iParam10) };
				fVar7 == -0.014f;
...
float func_237(var uParam0) // Position - 0x27C7C
{
...
struct<2> func_238(int iParam0, int iParam1, int iParam2) // Position - 0x27C8F
{
	var uVar0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					uVar0 = { func_245(iParam2) };
					break;
			
				case 8:
					uVar0 = { func_244(iParam2) };
					break;
			
				case 7:
					uVar0 = { func_243(iParam2) };
					break;
			
				case 10:
					uVar0 = { func_242(iParam2) };
					break;
			
				case 5:
					uVar0 = { func_241(iParam2) };
					break;
			
				case 4:
					uVar0 = { func_240(iParam2) };
					break;
			
				default:
					TEXT_LABEL_ASSIGN_STRING(&uVar0, func_239(iVar2), 8);
					break;
			}
			break;
...
char* func_239(int iParam0) // Position - 0x27D65
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_240(int iParam0) // Position - 0x27EB8
{
	var uVar0;
	var uVar2;
...
struct<2> func_241(int iParam0) // Position - 0x27EEB
{
	var uVar0;
	var uVar2;
...
struct<2> func_242(int iParam0) // Position - 0x27F1E
{
	var uVar0;
	var uVar2;
...
struct<2> func_243(int iParam0) // Position - 0x27F51
{
	var uVar0;
	var uVar2;
...
struct<2> func_244(int iParam0) // Position - 0x27F84
{
	var uVar0;
	var uVar2;
...
struct<2> func_245(int iParam0) // Position - 0x27FC1
{
	var uVar0;
	var uVar2;
...
struct<2> func_246(int iParam0) // Position - 0x27FF4
{
	var uVar0;
...
bool func_247(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2805E
{
	if (!func_250(0) || Global_80576 || Global_80564 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
	...
	switch (Global_80560)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_249(0) || func_248(true))
			{
			}
			else
			{
...
bool func_248(bool bParam0) // Position - 0x28176
{
	if (bParam0)
...
bool func_249(int iParam0) // Position - 0x2819F
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
bool func_250(int iParam0) // Position - 0x281F6
{
	if (Global_44886 == 15)
		return false;
...
bool func_251(int iParam0) // Position - 0x28218
{
	return func_252(iParam0, Global_44886);
}

bool func_252(int iParam0, int iParam1) // Position - 0x28229
{
	if (iParam1 == 15)
		return 1;
...
void func_253(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2840A
{
	int iVar0;

	iVar0 = 1;

	if (!func_386() || !func_384())
		iVar0 = 0;

	if (iVar0 == 1)
		if (!func_381(iParam6, iParam7, iParam8, iParam13))
			iVar0 = 0;
	...
	if (iVar0 == 1)
	{
		...
		*uParam0 = func_350(fParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_349(fParam1, 0f, 0f, 0f, false))
		{
		...
		func_343(fParam1, 5f, 0);
	
		if (func_154(iParam12))
		{
			func_341(iParam12, 0);
		
			while (!func_254(uParam0, iParam12, fParam1, fParam4, true, 0))
			{
				BUILTIN::WAIT(0);
			}
		}
...
bool func_254(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, bool bParam6, int iParam7) // Position - 0x2859E
{
	var uVar0;
	var uVar1;
	int iVar5;
	...
	if (func_154(iParam1))
	{
		...
		iVar5.f_31 = 49;
		iVar5.f_81 = 2;
		func_340(iParam1, &iVar5, iParam7);
		...
		if (Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == iVar5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/], uParam2, fParam5, 0, 0, 0);
				...
				func_329(uParam0, &(Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114931.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == iVar5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/], uParam2, fParam5, 0, 0, 0);
				...
				func_329(uParam0, &(Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114931.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, iVar5.f_96);
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(iVar5))
			{
				...
				*uParam0 = VEHICLE::CREATE_VEHICLE(iVar5, uParam2, fParam5, 1, 1, 0);
				...
				func_329(uParam0, &(iVar5.f_31), &(iVar5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, iVar5.f_96);
				...
				else if (iParam1 == 0 && !Global_114931.f_2370.f_539.f_4316 && Global_114931.f_9092.f_99.f_58[131] && ENTITY::GET_ENTITY_MODEL(*uParam0) == joaat("TAILGATER"))
				{
					...
					func_255(iParam1, uParam0, 0, true);
				}
...
void func_255(int iParam0, var uParam1, int iParam2, bool bParam3) // Position - 0x293C1
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if (func_154(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_260(*uParam1, false, &uVar0))
		{
			func_259(uParam1, &(Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114931.f_20125[iParam0 /*43*/].f_31 = func_258(*uParam1);
				...
				func_256(Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, true, &(Global_114931.f_20125[iParam0 /*43*/].f_1));
				...
				func_256(Global_114931.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, false, &(Global_114931.f_20125[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_256(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4) // Position - 0x29FD5
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	for (iVar0 = 0; func_257(iVar0, &uVar2, &iVar1, &iVar6, &iVar7); iVar0 = iVar0 + 1)
	{
...
bool func_257(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0x2A048
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_258(var uParam0) // Position - 0x2B53A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_259(var uParam0, var uParam1, var uParam2) // Position - 0x2B5EA
{
	int iVar0;
	int iVar1;
...
bool func_260(int iParam0, bool bParam1, var uParam2) // Position - 0x2B7DD
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	if (!func_303(iVar0, bParam1, uParam2) && !func_302(PLAYER::PLAYER_ID()) && !func_275(iParam0))
		return false;
	...
	if (func_271(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0))
		bVar1 = true;

	if (VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_268(iParam0) && !bVar1 && !(func_267(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_266(PLAYER::PLAYER_ID())) && !(func_265(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_262(PLAYER::PLAYER_ID())))
	{
	...
	{
		if (func_261(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("SENTINEL2") && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("ISSI2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_261(int iParam0) // Position - 0x2B968
{
	int iVar0;
...
bool func_262(bool bParam0) // Position - 0x2B9A3
{
	if (bParam0 != func_215())
		if (func_264(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_263(Global_2658294[bParam0 /*468*/].f_325.f_8) == 32;

	return false;
}

int func_263(bool bParam0) // Position - 0x2B9EA
{
	switch (bParam0)
	{
		case false:
...
bool func_264(bool bParam0, bool bParam1, bool bParam2) // Position - 0x2BF53
{
	bool bVar0;
...
bool func_265(int iParam0) // Position - 0x2BFB3
{
...
bool func_266(bool bParam0) // Position - 0x2BFCA
{
	if (bParam0 != func_215())
		if (func_264(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_263(Global_2658294[bParam0 /*468*/].f_325.f_8) == 11;

	return false;
}

bool func_267(int iParam0) // Position - 0x2C013
{
...
bool func_268(int iParam0) // Position - 0x2C055
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
bool func_269(bool bParam0) // Position - 0x2C11D
{
	if (bParam0 != func_215())
		if (func_264(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_263(Global_2658294[bParam0 /*468*/].f_325.f_8) == 26;

	return false;
}

bool func_270(bool bParam0) // Position - 0x2C164
{
	if (bParam0 != func_215())
		if (func_264(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_263(Global_2658294[bParam0 /*468*/].f_325.f_8) == 13;

	return false;
}

bool func_271(bool bParam0) // Position - 0x2C1AB
{
	if (bParam0 != func_215())
		if (func_264(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_263(Global_2658294[bParam0 /*468*/].f_325.f_8) == 7;

	return false;
}

bool func_272(int iParam0) // Position - 0x2C1F1
{
	bool bVar0;
	...
	if (!func_274(PLAYER::PLAYER_ID()) && iParam0 != joaat("THRUSTER") && iParam0 != joaat("AVENGER") && iParam0 != func_273(true) && !bVar0)
		return false;

	return true;
}

int func_273(bool bParam0) // Position - 0x2C282
{
	if (bParam0)
...
bool func_274(bool bParam0) // Position - 0x2C29C
{
	if (bParam0 != func_215())
...
bool func_275(int iParam0) // Position - 0x2C2C2
{
	if (func_301(PLAYER::PLAYER_ID()) || func_300(PLAYER::PLAYER_ID()))
		if (func_276(iParam0))
			return true;
...
bool func_276(int iParam0) // Position - 0x2C2F1
{
	...
	if (func_279(PLAYER::PLAYER_ID()) && !func_272(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("OPENWHEEL1")) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("OPENWHEEL2")) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("FORMULA")) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("FORMULA2")))
		return false;
...
bool func_277(int iParam0) // Position - 0x2C459
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_268(iParam0) || func_278(iVar0))
			return true;
...
bool func_278(int iParam0) // Position - 0x2C4D6
{
	switch (iParam0)
	{
		case joaat("MULE"):
...
bool func_279(bool bParam0) // Position - 0x2C532
{
	if (bParam0 == func_215())
		return false;

	if (func_302(bParam0) && Global_2658294[bParam0 /*468*/].f_325.f_11 == bParam0)
		return true;

	return false;
}

bool func_280(int iParam0, bool bParam1) // Position - 0x2C56B
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case joaat("TECHNICAL"):
		case joaat("INSURGENT"):
			if (func_282(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
				if (Global_2733138.f_307 == iParam0)
					return true;
				else if (func_281(iParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_281(int iParam0) // Position - 0x2C5C6
{
	int iVar0;
...
bool func_282(int iParam0, int iParam1) // Position - 0x2C5FF
{
	if (iParam1 == 0)
...
bool func_292(int iParam0) // Position - 0x2CEEC
{
	if (PLAYER::PLAYER_ID() != func_215())
	{
		if (func_298() || func_297(PLAYER::PLAYER_ID()))
			return false;
	
		if (func_296(PLAYER::PLAYER_ID(), true, false) && Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_39 > false || IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_37, 14) || IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_37, 11))
			return false;
	
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
					if (func_294() != -1 && func_294() < 607)
						if (!func_293(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1583772[func_294() /*143*/].f_66)
							return true;
...
bool func_293(int iParam0) // Position - 0x2CFFA
{
...
bool func_294() // Position - 0x2D013
{
	return Global_2359296[func_295() /*5574*/].f_681.f_2;
}

int func_295() // Position - 0x2D02B
{
	int iVar0;
...
bool func_296(bool bParam0, bool bParam1, bool bParam2) // Position - 0x2D038
{
	if (bParam0 == func_215())
		return false;
...
bool func_297(bool bParam0) // Position - 0x2D09C
{
	if (bParam0 != func_215() && func_264(bParam0, true, true))
		return IS_BIT_SET(Global_2658294[bParam0 /*468*/].f_325, 3);

	return false;
}

bool func_298() // Position - 0x2D0CD
{
	return func_299() != -1;
}

bool func_299() // Position - 0x2D0DB
{
	return Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

bool func_300(bool bParam0) // Position - 0x2D0F3
{
	if (bParam0 != func_215())
		if (func_264(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1 && Global_2658294[bParam0 /*468*/].f_325.f_11 != func_215())
				return func_263(Global_2658294[bParam0 /*468*/].f_325.f_8) == 5;

	return false;
}

bool func_301(bool bParam0) // Position - 0x2D152
{
	if (bParam0 != func_215())
		if (func_264(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1 && Global_2658294[bParam0 /*468*/].f_325.f_11 != func_215())
				return func_263(Global_2658294[bParam0 /*468*/].f_325.f_8) == 8;

	return false;
}

bool func_302(bool bParam0) // Position - 0x2D1B2
{
	if (bParam0 != func_215())
		if (func_264(bParam0, true, true))
			if (Global_2658294[bParam0 /*468*/].f_325.f_8 != -1)
				return func_263(Global_2658294[bParam0 /*468*/].f_325.f_8) == 9;

	return false;
}

bool func_303(int iParam0, bool bParam1, var uParam2) // Position - 0x2D1F9
{
	bool bVar0;
	...
	if (func_271(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0))
		bVar0 = true;
...
bool func_304(int iParam0) // Position - 0x2D5DC
{
	switch (iParam0)
	{
		case joaat("TOWTRUCK"):
...
void func_305(int iParam0, int iParam1) // Position - 0x2D611
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	func_306(iParam0, &(Global_114931.f_32757.f_5510));
}

void func_306(int iParam0, var uParam1) // Position - 0x2D813
{
	int iVar0;
...
int func_307(int iParam0) // Position - 0x2DABE
{
	switch (iParam0)
	{
		case 1:
...
bool func_308(int iParam0) // Position - 0x2DB6E
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
bool func_309(int iParam0) // Position - 0x2DB8E
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0) || func_324(iParam0, 0, false) || func_324(iParam0, 1, false) || func_324(iParam0, 2, false) || func_323(iParam0) != 145 || func_322(iParam0) || func_321(iParam0) || func_261(iParam0) || func_320(iParam0) || !func_310(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		func_321(iParam0);
		func_321(iParam0);
		func_324(iParam0, 0, false);
		func_324(iParam0, 1, false);
		func_324(iParam0, 2, false);
		func_323(iParam0) != 145;
		return false;
	}
...
bool func_310(int iParam0) // Position - 0x2DC6B
{
	if (iParam0 == 0)
		return false;

	if (!func_311(iParam0, false, -1))
		return false;
...
bool func_311(int iParam0, bool bParam1, int iParam2) // Position - 0x2DE29
{
	int iVar0;
	var uVar1;
	...
	if (iParam0 == joaat("BLIMP"))
		if (!func_318() && !func_317() && !func_316() && !func_315() && !func_319())
			return false;
...
bool func_312(int iParam0) // Position - 0x2DFAE
{
	int iVar0;
	var uVar1;
	var uVar2;
...
bool func_313() // Position - 0x2E07A
{
...
bool func_314(bool bParam0, int iParam1) // Position - 0x2E091
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_315() // Position - 0x2E279
{
	return false;
}

bool func_316() // Position - 0x2E282
{
	return true;
}

bool func_317() // Position - 0x2E28B
{
	return true;
}

bool func_318() // Position - 0x2E294
{
...
bool func_319() // Position - 0x2E2AD
{
	var uVar0;
...
bool func_320(int iParam0) // Position - 0x2E365
{
	int iVar0;
	var uVar1;
	...
	if (!func_311(iVar0, false, -1))
		return true;

	return false;
}

bool func_321(int iParam0) // Position - 0x2E3AC
{
	int iVar0;
...
bool func_322(int iParam0) // Position - 0x2E428
{
	int iVar0;
...
int func_323(int iParam0) // Position - 0x2E510
{
	int iVar0;
...
bool func_324(int iParam0, int iParam1, bool bParam2) // Position - 0x2E573
{
	int iVar0;
	var uVar1;
	int iVar9;
	...
	for (iVar0 = 0; func_325(iParam1, iVar0, &uVar1, &iVar9); iVar0 = iVar0 + 1)
	{
...
bool func_325(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x2E5E1
{
...
void func_326(int iParam0, int iParam1) // Position - 0x2E6B9
{
	int iVar0;
...
void func_327(var uParam0) // Position - 0x2E73B
{
	if (!func_328(*uParam0))
		VEHICLE::SET_VEHICLE_EXTRA(*uParam0, 5, !Global_114931.f_9092.f_99.f_58[119]);
}

bool func_328(var uParam0) // Position - 0x2E766
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(uParam0, 5);
}

int func_329(var uParam0, var uParam1, var uParam2) // Position - 0x2E775
{
	int iVar0;
	int iVar1;
	...
	for (iVar0 = 0; iVar0 < *uParam1; iVar0 = iVar0 + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, iVar1) != uParam1->[iVar0] - 1)
		{
			...
			if (uParam1->[iVar0] > 0)
			{
				...
				else if (func_337(*uParam0, iVar1, uParam1->[iVar0] - 1))
				{
				}
				else
				{
	...
	if (func_334(ENTITY::GET_ENTITY_MODEL(*uParam0)) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_332(*uParam0, uParam1->[38] - 1))
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_332(*uParam0, uParam1->[38] - 1), 0);
...
bool func_330(var uParam0) // Position - 0x2E973
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_331(var uParam0) // Position - 0x2EA4F
{
...
int func_332(var uParam0, int iParam1) // Position - 0x2EABA
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		iVar0 = func_333(uParam0, 38) + 1;
		iVar1 = func_333(uParam0, 24) + 1;
...
int func_333(var uParam0, int iParam1) // Position - 0x2EBA3
{
	int iVar0;
	...
	for (iVar0 = VEHICLE::GET_NUM_VEHICLE_MODS(uParam0, iParam1) - 1; iVar0 >= 0 && func_337(uParam0, iParam1, iVar0); iVar0 = iVar0 - 1)
	{
	}
...
bool func_334(int iParam0) // Position - 0x2EC05
{
...
bool func_335(var uParam0) // Position - 0x2EC30
{
	var uVar0;
...
bool func_336(int iParam0) // Position - 0x2EC76
{
	switch (iParam0)
	{
		case joaat("BRIOSO"):
...
bool func_337(var uParam0, int iParam1, int iParam2) // Position - 0x2ED38
{
	if (!func_338() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2))
		return true;

	return false;
}

bool func_338() // Position - 0x2ED5C
{
	return true;
}

bool func_339(var uParam0, var uParam1) // Position - 0x2ED69
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_340(int iParam0, var uParam1, int iParam2) // Position - 0x2EDAA
{
	int iVar0;
...
void func_341(int iParam0, int iParam1) // Position - 0x2F006
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 < 9; iVar0 = iVar0 + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99760[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99760[iVar0]) == func_342(iParam0, iParam1))
				{
...
int func_342(int iParam0, int iParam1) // Position - 0x2F0A4
{
	int iVar0;
	...
	if (func_154(iParam0))
	{
		...
		iVar0.f_31 = 49;
		iVar0.f_81 = 2;
		func_340(iParam0, &iVar0, iParam1);
		return iVar0;
	}
	else
	{
...
void func_343(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0x2F0E6
{
	int iVar0;

	for (iVar0 = 0; iVar0 < 68; iVar0 = iVar0 + 1)
	{
		if (func_348(&Global_79095.f_555[0 /*21*/], iVar0))
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(uParam0, Global_79095.f_555[0 /*21*/], iParam4) <= fParam3)
				func_344(iVar0);
	}
}

void func_344(int iParam0) // Position - 0x2F136
{
	bool bVar0;
	...
	if (func_348(&Global_79095.f_555[0 /*21*/], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_185(iParam0, 0) && Global_80004.f_66 == 0 && Global_114931.f_32757.f_1958[Global_79095.f_555[0 /*21*/].f_14] != 0 && Global_114931.f_32757.f_1958[Global_79095.f_555[0 /*21*/].f_14] > 3 && !func_346(0, Global_79095.f_555[0 /*21*/].f_12) || !func_346(1, Global_79095.f_555[0 /*21*/].f_12))
			{
				func_345(&Global_114931.f_32757.f_69[Global_79095.f_555[0 /*21*/].f_14 /*78*/], &Global_80004);
...
void func_345(var uParam0, var uParam1) // Position - 0x2F2A5
{
...
bool func_346(int iParam0, int iParam1) // Position - 0x2F371
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_347(&Global_114931.f_32757.f_5038[iVar0 /*157*/]))
		return false;

	return func_311(Global_114931.f_32757.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_347(var uParam0) // Position - 0x2F3E4
{
	return *uParam0;
}

bool func_348(var uParam0, int iParam1) // Position - 0x2F3EF
{
	bool bVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_349(Global_114931.f_32757.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_349(Global_114931.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_349(Global_114931.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
bool func_349(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, bool bParam6) // Position - 0x30ADF
{
	if (bParam6)
...
int func_350(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x30B26
{
	return func_351(&(Global_108474.f_2890), uParam0, fParam3, false);
}

int func_351(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, bool bParam5) // Position - 0x30B40
{
	int iVar0;
	var uVar1;
	bool bVar4;
	...
	if (func_377(uParam0))
	{
		if (func_349(uParam1, 0f, 0f, 0f, false))
		{
			uParam1 = { *uParam0 };
			fParam4 = uParam0->f_6;
		}
		...
		if (func_376(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_356(iVar0, &(uParam0->f_12), false, true);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam5)
						if (VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(iVar0)))
							func_341(uParam0->f_11, 1);
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
							func_341(uParam0->f_11, 2);
					...
					func_326(iVar0, uParam0->f_11);
				}
				else if (!func_353(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_352(iVar0);
...
int func_352(int iParam0) // Position - 0x30DF2
{
	int iVar0;
	var uVar1;
	var uVar2;
...
bool func_353(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4) // Position - 0x30EB5
{
	int iVar0;
	var uVar1;
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_355(iParam0, Global_79095.f_139[38], false))
			{
				func_344(38);
				return true;
			}
		...
		case joaat("FIRETRUK"):
			if (func_355(iParam0, Global_79095.f_139[43], true))
			{
				func_344(43);
				return true;
			}
		...
		case joaat("CUBAN800"):
			...
			{
				if (func_355(iParam0, uVar1[iVar6], true) && func_354(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_349(uParam1, 0f, 0f, 0f, false) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
bool func_354(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, int iParam6, bool bParam7) // Position - 0x310BD
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
bool func_355(int iParam0, int iParam1, bool bParam2) // Position - 0x31138
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void func_356(int iParam0, var uParam1, bool bParam2, bool bParam3) // Position - 0x31199
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		else if (uParam1->f_66 == joaat("CASCO"))
		{
			...
			if (IS_BIT_SET(uParam1->f_77, func_307(iVar0 + 1)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("SANDKING") || uParam1->f_66 == joaat("SANDKING2"))
		{
			...
			if (IS_BIT_SET(uParam1->f_77, func_307(iVar1 + 1)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("FORMULA") || uParam1->f_66 == joaat("FORMULA2"))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_307(iVar2)))
				{
				}
				else
				{
		...
		else if (uParam1->f_66 == joaat("OPENWHEEL1"))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_307(iVar3)))
				{
				}
				else
				{
		...
		else if (uParam1->f_66 == joaat("OPENWHEEL2"))
		{
			for (iVar4 = 1; iVar4 <= 11; iVar4 = iVar4 + 1)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (IS_BIT_SET(uParam1->f_77, func_307(iVar4)))
					{
					}
					else
					{
		...
		else if (uParam1->f_66 == joaat("SURFER3"))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_307(iVar5)))
				{
				}
				else
				{
		...
		{
			if (IS_BIT_SET(uParam1->f_77, func_307(4)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("HOTKNIFE"))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_307(iVar6)))
				{
				}
				else
				{
		...
		{
			if (func_366(uParam1->f_5) || func_366(uParam1->f_6))
			{
			}
			else
			{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_365(iParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_364())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			{
				if (IS_BIT_SET(uParam1->f_77, func_307(iVar7 + 1)))
		...
		if (func_358() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("AVENGER")) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_273(true)))
			if (!IS_BIT_SET(uParam1->f_77, 23))
				if (!IS_BIT_SET(uParam1->f_77, 22) && func_357(iParam0, 5f))
...
bool func_357(int iParam0, float fParam1) // Position - 0x318BA
{
	var uVar0;
	var uVar3;
...
int func_358() // Position - 0x3192B
{
	...
	if (func_361(7))
		if (func_360(Global_2673274.f_4.f_16) || func_359(Global_2673274.f_4.f_16))
			return 0;

	return 1;
}

bool func_359(bool bParam0) // Position - 0x319BA
{
	bool bVar0;
...
bool func_360(bool bParam0) // Position - 0x319DF
{
	bool bVar0;
	...
	if (bVar0 != -1)
		return func_213(bParam0, 9);

	return false;
}

bool func_361(int iParam0) // Position - 0x319FD
{
	return func_362(&(Global_2673274.f_194), iParam0);
}

bool func_362(var uParam0, int iParam1) // Position - 0x31A11
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_363(int iParam0, var uParam1) // Position - 0x31A34
{
	int iVar0;
	int iVar1;
...
bool func_364() // Position - 0x31AAC
{
	return DLC::IS_DLC_PRESENT(joaat("MPINDEPENDENCE"));
}

bool func_365(int iParam0) // Position - 0x31ABD
{
	int iVar0;
...
int func_366(var uParam0) // Position - 0x31B05
{
	if (!func_338() && func_367(uParam0))
		return 1;

	return 0;
}

bool func_367(int iParam0) // Position - 0x31B25
{
	switch (iParam0)
	{
		case 161:
...
bool func_368(int iParam0) // Position - 0x31B78
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		if (!func_375(PLAYER::PLAYER_ID(), -1))
	...
	if (func_370(PLAYER::PLAYER_ID()) == 3)
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_369(int iParam0) // Position - 0x31BFF
{
...
int func_370(int iParam0) // Position - 0x31C2E
{
	if (func_374(iParam0) == 233)
		return func_371(iParam0);

	return -1;
}

int func_371(int iParam0) // Position - 0x31C4B
{
...
bool func_372(int iParam0, bool bParam1) // Position - 0x31C6E
{
	if (func_373(iParam0))
...
bool func_373(int iParam0) // Position - 0x31CB2
{
	int iVar0;
...
int func_374(int iParam0) // Position - 0x31CD4
{
	if (func_373(iParam0))
		if (func_372(iParam0, false))
...
bool func_375(var uParam0, int iParam1) // Position - 0x31D00
{
	var uVar0;

	if (func_264(uParam0, true, true))
	{
...
bool func_376(var uParam0) // Position - 0x31D4D
{
	if (func_377(uParam0))
	{
...
bool func_377(var uParam0) // Position - 0x31D82
{
	if (uParam0->f_12.f_66 == 0)
		return 0;

	if (!func_311(uParam0->f_12.f_66, false, -1))
		return 0;

	if (uParam0->f_12.f_66 == joaat("STUNT") && func_354(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, false))
		return 0;

	return 1;
}

bool func_378() // Position - 0x31DE2
{
	return func_376(&(Global_108474.f_2890));
}

void func_379() // Position - 0x31DF5
{
	func_380(&(Global_108474.f_2890));
}

void func_380(var uParam0) // Position - 0x31E08
{
	if (func_377(uParam0))
		STREAMING::REQUEST_MODEL(uParam0->f_12.f_66);
}

bool func_381(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x31E26
{
	...
	if (iParam2 == 0 && func_383(Global_108474.f_2890.f_12.f_66))
		return false;
...
bool func_382() // Position - 0x31EB4
{
	float fVar0;
...
bool func_383(int iParam0) // Position - 0x31F29
{
	switch (iParam0)
	{
		case joaat("POLICE"):
...
bool func_384() // Position - 0x31FE3
{
	return func_377(&(Global_108474.f_2890));
}

bool func_385(var uParam0) // Position - 0x31FF6
{
	uParam0->f_16 = 3;
...
bool func_386() // Position - 0x32021
{
...
void func_387() // Position - 0x32045
{
	func_403();
	func_388(&Static_81, 1, false, false);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_388(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x32061
{
	func_399(uParam0, iParam1);
	func_393(uParam0, bParam2);
	func_389(uParam0, bParam3);
}

void func_389(var uParam0, bool bParam1) // Position - 0x32081
{
	func_390(&(uParam0->f_41), bParam1);
}

void func_390(var uParam0, bool bParam1) // Position - 0x32093
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 <= *uParam0 - 1; iVar0 = iVar0 + 1)
	{
		if (bParam1)
			...
			func_391(&uParam0->[iVar0], false);
	}
}

void func_391(var uParam0, bool bParam1) // Position - 0x320D1
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_392(var uParam0) // Position - 0x3210C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_393(var uParam0, bool bParam1) // Position - 0x32137
{
	func_394(&(uParam0->f_35), bParam1);
}

void func_394(var uParam0, bool bParam1) // Position - 0x32149
{
	int iVar0;
...
void func_395(var uParam0) // Position - 0x32186
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_396(var uParam0) // Position - 0x321BE
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
bool func_397(var uParam0) // Position - 0x3225A
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
			return true;
...
bool func_398(var uParam0) // Position - 0x3227B
{
	if (func_397(uParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
...
void func_399(var uParam0, int iParam1) // Position - 0x322A5
{
	func_400(&(uParam0->f_28), iParam1);
}

void func_400(var uParam0, int iParam1) // Position - 0x322B7
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 <= *uParam0 - 1; iVar0 = iVar0 + 1)
	{
		if (iParam1 == 1)
			...
			func_401(&uParam0->[iVar0], 0, 1, 0);
	}
}

void func_401(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x322F8
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_402(var uParam0) // Position - 0x32348
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
bool func_403() // Position - 0x32389
{
	int iVar0;
...
void func_404(bool bParam0) // Position - 0x3242A
{
	int iVar0;
	...
	if (!func_425())
	{
		...
		{
			func_162(iVar0, 1, 0);
			func_405(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_114018[iVar0 /*10*/].f_9 == -1)
...
void func_405(char* sParam0, int iParam1) // Position - 0x324FA
{
	if (Global_102454 != 12)
		if (func_406(sParam0, 6, iParam1))
			Global_102454.f_1 = iParam1;
}

bool func_406(char* sParam0, int iParam1, int iParam2) // Position - 0x32522
{
	var uVar0;
	var uVar1;
	int iVar33;
	...
	if (func_412())
	{
		...
		{
			iVar33 = func_407(SCRIPT::GET_THIS_SCRIPT_NAME());
...
int func_407(char* sParam0) // Position - 0x326B1
{
...
int func_408() // Position - 0x32707
{
	int iVar0;
	int iVar1;

	iVar0 = func_409(&(Global_102454.f_3), false);
	iVar1 = 0;
...
int func_409(char* sParam0, bool bParam1) // Position - 0x3272B
{
	var uVar0;
	int iVar1;

	uVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_410(uVar0, true);
	iVar1 == -1 && !bParam1;
	return iVar1;
}

int func_410(var uParam0, bool bParam1) // Position - 0x32755
{
	int iVar0;
...
bool func_411() // Position - 0x3278B
{
...
bool func_412() // Position - 0x327DB
{
	...
	if (Global_102454.f_11 == 5)
		if (func_407(&(Global_102454.f_3)) > -1)
			return true;

	return false;
}

void func_413(int iParam0) // Position - 0x32847
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_414(int iParam0) // Position - 0x3285B
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_415(int iParam0) // Position - 0x32895
{
	if (iParam0 == 1)
	{
...
void func_416() // Position - 0x328CF
{
	Global_24407.f_5 = 1;
}

void func_417() // Position - 0x328DD
{
	Global_24407.f_5 = 0;
}

void func_418(bool bParam0) // Position - 0x328EB
{
	if (bParam0)
	{
		func_419();
...
void func_419() // Position - 0x3294E
{
...
void func_420(int iParam0) // Position - 0x32977
{
	if (func_423())
		return;
...
void func_421(bool bParam0, bool bParam1) // Position - 0x32A01
{
	if (bParam0)
	{
		if (func_249(0))
...
bool func_422() // Position - 0x32A75
{
	return IS_BIT_SET(Global_1964705, 5);
}

bool func_423() // Position - 0x32A83
{
	return IS_BIT_SET(Global_1964705, 19);
}

void func_424() // Position - 0x32A92
{
	Global_96605 = 0;
	Global_96606 = false;
}

bool func_425() // Position - 0x32AA4
{
	if (Global_102454 == 13 || Global_102454 == 10 || Global_102454 == 11 || Global_102454 == 12)
		return false;
...
void func_426() // Position - 0x32AE2
{
	Global_102489 = 1;
...
void func_427(char* sParam0) // Position - 0x32BCF
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

void func_428() // Position - 0x32BE1
{
	int iVar0;
...
void func_429(var uParam0) // Position - 0x32C01
{
	func_430(&(uParam0->f_28));
	func_430(&(uParam0->f_35));
	func_430(&(uParam0->f_41));
}

void func_430(var uParam0) // Position - 0x32C21
{
	int iVar0;
...
int func_431(int iParam0) // Position - 0x32C5B
{
	if (!func_154(iParam0))
		return func_153(iParam0);
	else
