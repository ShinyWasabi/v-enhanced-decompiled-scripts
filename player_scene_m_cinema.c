...
void main() // Position - 0x0
{
	...
	while (Static_70 && func_7(1, Static_71[0]))
	{
		BUILTIN::WAIT(0);
...
bool func_2() // Position - 0x10C
{
	...
	{
		func_3(Static_71[iVar0], iVar0);
	}

	if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Static_103) > 100f)
		return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		switch (Static_81[iParam1])
		{
			case 0:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(uParam0, joaat("SCRIPT_TASK_WANDER_STANDARD")) != 1)
				{
					TASK::TASK_WANDER_STANDARD(uParam0, 1193033728, 0);
					PED::SET_PED_KEEP_TASK(Static_71[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&Static_86[iParam1 /*4*/]))
				{
					BUILTIN::START_NEW_SCRIPT_WITH_ARGS(&Static_86[iParam1 /*4*/], &Static_71[iParam1], 1, 1424);
					Static_81[iParam1] = 4;
					return 0;
				}
				...
				{
					TASK::TASK_START_SCENARIO_IN_PLACE(uParam0, sVar0, 0, 1);
					PED::SET_PED_KEEP_TASK(Static_71[iParam1], 1);
				}
				break;
		
			case 2:
				for (iVar1 = 0; iVar1 < Static_81; iVar1 = iVar1 + 1)
				{
					if (iParam1 != iVar1)
						if (Static_81[iVar1] < 2 && Static_81[iParam1] >= 0)
							Static_81[iVar1] = 2;
				}
			...
			case 3:
				...
				if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 50f * 50f)
				{
					Static_81[iParam1] = 0;
					return 1;
				}
...
bool func_4(var uParam0) // Position - 0x33E
{
	...
	for (iVar0 = 0; iVar0 < Static_71; iVar0 = iVar0 + 1)
	{
		if (uParam0 != Static_71[iVar0])
			if (Static_81[iVar0] < 0)
				return true;
	}
...
int func_7(int iParam0, int iParam1) // Position - 0x431
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_8(Global_102175) && iParam1 != 0)
		{
			Global_102175 = 0;
		}
	}
...
int func_8(int iParam0) // Position - 0x515
{
	return iParam0;
}
...
void func_11() // Position - 0x574
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_14(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(iVar0) && !func_16(14) || Global_113879)
			{
...
int func_13(var uParam0) // Position - 0x67D
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0) // Position - 0x6DF
{
...
void func_21() // Position - 0x769
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		for (iVar0 = 0; iVar0 < Static_76; iVar0 = iVar0 + 1)
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Static_86[iVar0 /*4*/]))
			{
				SCRIPT::REQUEST_SCRIPT(&Static_86[iVar0 /*4*/]);
			
				if (!SCRIPT::HAS_SCRIPT_LOADED(&Static_86[iVar0 /*4*/]))
					bVar2 = false;
			}
		}
	...
	for (iVar0 = 0; iVar0 < Static_71; iVar0 = iVar0 + 1)
	{
		if (Static_76[iVar0] != 0)
		{
			Static_71[iVar0] = PED::CREATE_PED(4, Static_76[iVar0], Static_103 + Static_107[iVar0 /*3*/], 0, 1, 1);
			ENTITY::SET_ENTITY_HEADING(Static_71[iVar0], Static_106 + Static_120[iVar0]);
			...
			PED::SET_PED_CAN_RAGDOLL(Static_71[iVar0], 0);
		}
	}
}
...
void func_22() // Position - 0x896
{
	...
	func_26(Static_69, &Static_103, &Static_106, &uVar0);
	iVar8.f_1 = -1;
	iVar8.f_17 = 4;
	iVar8.f_17.f_8 = 4;
	iVar8.f_17.f_13 = 4;
	...
	{
		case 97:
			Static_107[0 /*3*/] = { { 45.5004f, -205.8167f, -1416.5402f } - Static_103 };
			Static_107[1 /*3*/] = { { 45.5004f, -207.5375f, -1423.8984f } - Static_103 };
			Static_107[2 /*3*/] = { { 45.5004f, -210.4254f, -1428.5013f } - Static_103 };
			Static_107[3 /*3*/] = { { 45.5004f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1416.5402f, -1428.5013f) } - Static_103 };
			Static_120[0] = 5.8017f - Static_106;
			Static_120[1] = 2.582f - Static_106;
			Static_120[2] = -47.7025f - Static_106;
			Static_120[3] = 65.2818f - Static_106;
			Static_76[0] = joaat("A_F_M_TOURIST_01");
			TEXT_LABEL_ASSIGN_STRING(&Static_86[0 /*4*/], "", 16);
			Static_76[1] = joaat("A_M_Y_HIPSTER_01");
			TEXT_LABEL_ASSIGN_STRING(&Static_86[1 /*4*/], "", 16);
			Static_76[2] = joaat("A_M_M_BEVHILLS_01");
			TEXT_LABEL_ASSIGN_STRING(&Static_86[2 /*4*/], "", 16);
			Static_76[3] = joaat("A_M_M_GENFAT_01");
			TEXT_LABEL_ASSIGN_STRING(&Static_86[3 /*4*/], "", 16);
			Static_81[0] = 0;
			Static_81[1] = 0;
			Static_81[2] = 0;
			Static_81[3] = 0;
		...
		case 158:
			Static_107[0 /*3*/] = { 1.2712f, 6.071f, -0.75f };
			Static_107[1 /*3*/] = { 3.8061f, 5.7599f, -0.5f };
			Static_107[2 /*3*/] = { 4.541f, 7.8487f, -0.4f };
			Static_107[3 /*3*/] = { 3.1051f, 13.7474f, -0.3463f };
			Static_120[0] = 123.059f;
			Static_120[1] = 134.0498f;
			Static_120[2] = 58.663f;
			Static_120[3] = 89.5592f;
			Static_76[0] = joaat("S_F_Y_HOOKER_01");
			TEXT_LABEL_ASSIGN_STRING(&Static_86[0 /*4*/], "pb_prostitute", 16);
			Static_76[1] = joaat("S_F_Y_HOOKER_01");
			TEXT_LABEL_ASSIGN_STRING(&Static_86[1 /*4*/], "pb_prostitute", 16);
			Static_76[2] = joaat("S_F_Y_HOOKER_01");
			TEXT_LABEL_ASSIGN_STRING(&Static_86[2 /*4*/], "pb_prostitute", 16);
			Static_76[3] = joaat("S_F_Y_HOOKER_01");
			TEXT_LABEL_ASSIGN_STRING(&Static_86[3 /*4*/], "pb_prostitute", 16);
			Static_81[0] = 1;
			Static_81[1] = 1;
			Static_81[2] = 1;
			Static_81[3] = 1;
		...
		default:
			Static_107[0 /*3*/] = { 0f, 0f, 0f };
			Static_107[1 /*3*/] = { 0f, 0f, 0f };
			Static_107[2 /*3*/] = { 0f, 0f, 0f };
			Static_107[3 /*3*/] = { 0f, 0f, 0f };
			Static_120[0] = 0f;
			Static_120[1] = 0f;
			Static_120[2] = 0f;
			Static_120[3] = 0f;
