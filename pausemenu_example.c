...
void main() // Position - 0x0
{
	switch (ScriptArg_0)
	{
		...
		case 0:
		case 1:
			if (ScriptArg_0.f_1 == joaat("PM_REPLAY"))
			{
				func_2(1, 0, -1705870862, 25, true, "PM_PANE_AUD" /* GXT: Audio */, 0, 0);
				func_2(1, 1, -1705870862, 50, true, "PM_PANE_DIS" /* GXT: Display */, 0, 0);
				func_1(1);
			}
		
			ScriptArg_0.f_1 == -1705871862;
			break;
	
		case 2:
			switch (ScriptArg_0.f_1)
			{
				case joaat("PM_REPLAY"):
					break;
			
				case -1705871862:
					switch (ScriptArg_0.f_3)
					{
						case 25:
							break;
