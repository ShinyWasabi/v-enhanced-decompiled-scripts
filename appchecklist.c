		...
		if (Global_21627.f_1 != 9)
		{
			switch (Global_21627.f_1)
			{
				...
				case 8:
					...
					if (func_9(2, Global_21595, 0))
					{
						func_8();
						Global_21605 = true;
					
						if (Static_117 == 2 || Static_117 == 1)
						{
							func_33(Global_21608, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
							func_30();
...
void func_4() // Position - 0x1E2
{
	...
	if (Global_21623 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(18), BUILTIN::TO_FLOAT(Static_113), BUILTIN::TO_FLOAT(0), -1f, -1f, &Static_129[iVar0 /*6*/], 0, 0, 0, 0);
			Static_118[Static_113] = iVar0;
	...
	if (Global_21623 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Static_129[iVar1 /*6*/].f_5 > 0)
			{
				if (Static_160[iVar1] == 0)
				{
					func_7(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(18), BUILTIN::TO_FLOAT(Static_113), BUILTIN::TO_FLOAT(0), -1f, -1f, &Static_129[iVar1 /*6*/], 0, 0, 0, 0);
					Static_118[Static_113] = iVar1;
					Static_113 = Static_113 + 1;
					Static_160[iVar1] = 1;
				}
			}
	...
	if (Static_113 == 0)
		func_7(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(18), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(0), -1f, -1f, "CELL_3092" /* GXT: No progress made. */, 0, 0, 0, 0);
	else
		Static_128 = true;

	func_33(Global_21608, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_21608, "SET_HEADER", "CELL_23" /* GXT: Check List */, 0, 0, 0, 0);

	if (Global_21615)
	{
		func_7(Global_21608, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /* GXT: SELECT */, 0, 0, 0, 0);
		func_7(Global_21608, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /* GXT: BACK */, 0, 0, 0, 0);
		func_7(Global_21608, "SET_SOFT_KEYS", 1f, 0f, 15f, -1f, -1f, "CELL_227" /* GXT: SORT */, 0, 0, 0, 0);
		MISC::SET_BIT(&Global_9463, 17);
	}
	else
	{
		func_7(Global_21608, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
		func_7(Global_21608, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
		func_7(Global_21608, "SET_SOFT_KEYS", 1f, 0f, 15f, -1f, -1f, 0, 0, 0, 0, 0);
		MISC::SET_BIT(&Global_9463, 17);
	}
...
void func_10() // Position - 0x5B3
{
	...
	{
		if (func_9(2, Global_21596, 0))
		{
			func_12();
			Global_21605 = true;
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21608, "GET_CURRENT_SELECTION");
			Static_127 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		
			while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(Static_127))
			{
				BUILTIN::WAIT(0);
			}
		
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(Static_127);
			Static_115 = Static_118[iVar0];
			...
			HUD::ADD_TEXT_COMPONENT_INTEGER(Static_124);
			GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21608, "SET_DATA_SLOT");
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(18);
			...
			HUD::ADD_TEXT_COMPONENT_INTEGER(Static_125);
			GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			func_33(Global_21608, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_5(Global_21608, "SET_HEADER", &Static_129[Static_115 /*6*/], 0, 0, 0, 0);
			func_7(Global_21608, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
			func_7(Global_21608, "SET_SOFT_KEYS", 1f, 0f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
...
void func_11() // Position - 0x743
{
	...
	{
		case 0:
			Static_124 = Global_114650;
			Static_125 = Global_114667;
			break;
	
		case 1:
			Static_124 = Global_114651 + Global_114652;
			Static_125 = Global_114668 + Global_114669;
			break;
	
		case 2:
			Static_124 = Global_114653;
			Static_125 = Global_114670;
			break;
	
		case 3:
			Static_124 = Global_114654;
			Static_125 = Global_114671;
			break;
	
		case 4:
			Static_124 = Global_114655 + Global_114656;
			Static_125 = Global_114672 + Global_114673;
			break;
...
void func_15() // Position - 0x858
{
	if (Global_21605 == false)
	{
		if (func_9(2, Global_21596, 0))
		{
			...
			Static_126 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(Static_127);
...
void func_16() // Position - 0x8CD
{
	...
	if (func_17(0))
	{
		func_7(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(18), BUILTIN::TO_FLOAT(iVar0), BUILTIN::TO_FLOAT(0), -1f, -1f, "CELL_229" /* GXT: On Active Mission */, 0, 0, 0, 0);
	}
	else
	{
		while (iVar0 < Global_97430)
		{
			func_7(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(18), BUILTIN::TO_FLOAT(iVar0), BUILTIN::TO_FLOAT(0), -1f, -1f, &Global_97221[iVar0 /*4*/], 0, 0, 0, 0);
			Static_113 = Static_113 + 1;
			Static_18[iVar0] = iVar0;
			iVar0 = iVar0 + 1;
		}
	}
	...
	Static_18[1] == 99;
	func_33(Global_21608, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_21608, "SET_HEADER", "CELL_3301" /* GXT: Open Missions */, 0, 0, 0, 0);

	if (func_17(0) || Global_97430 == 0)
	{
		func_7(Global_21608, "SET_SOFT_KEYS", 2f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
		MISC::CLEAR_BIT(&Global_9463, 17);
	...
	{
		func_7(Global_21608, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, "CELL_205" /* GXT: SELECT */, 0, 0, 0, 0);
		func_7(Global_21608, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /* GXT: BACK */, 0, 0, 0, 0);
		func_7(Global_21608, "SET_SOFT_KEYS", 1f, 0f, 15f, -1f, -1f, "CELL_227" /* GXT: SORT */, 0, 0, 0, 0);
	}
	else
...
{
	return func_19(iParam0, Global_44886);
}
...
void func_20() // Position - 0xCE1
{
	...
	for (iVar0 = 0; iVar0 < 7; iVar0 = iVar0 + 1)
	{
		if (Global_93181[iVar0 /*5*/] != -1)
		{
			if (Global_97430 < 52)
			{
				iVar1 = Global_80576.f_109[Global_93181[iVar0 /*5*/] /*4*/];
				TEXT_LABEL_COPY(&Global_97221[Global_97430 /*4*/], { func_24(iVar1) }, 4);
				Global_97430 = Global_97430 + 1;
			}
			else
			{
				return;
	...
	{
		if (IS_BIT_SET(Global_114931.f_18581[iVar0 /*6*/], 0) && IS_BIT_SET(Global_114931.f_18581[iVar0 /*6*/], 1) && !IS_BIT_SET(Global_114931.f_18581[iVar0 /*6*/], 3))
		{
			if (Global_97430 < 52)
			{
				TEXT_LABEL_COPY(&Global_97221[Global_97430 /*4*/], { func_22(iVar0) }, 4);
				Global_97430 = Global_97430 + 1;
			}
			else
			{
	...
	{
		if (IS_BIT_SET(Global_114931.f_9092.f_99.f_219[0], iVar0))
		{
			if (Global_97430 < 52)
			{
				TEXT_LABEL_ASSIGN_STRING(&Global_97221[Global_97430 /*4*/], func_21(iVar0), 16);
				Global_97430 = Global_97430 + 1;
			}
			else
			{
...
{
	func_33(Global_21608, "SET_INPUT_EVENT", BUILTIN::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
{
	func_33(Global_21608, "SET_INPUT_EVENT", BUILTIN::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21616, 1);
	func_29();
}
...
{
	func_33(Global_21608, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_7(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(18), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(0), -1f, -1f, "CELL_3301" /* GXT: Open Missions */, 0, 0, 0, 0);
	func_7(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(18), BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(0), -1f, -1f, "CELL_3302" /* GXT: Progress */, 0, 0, 0, 0);
	Static_113 = 2;
	func_33(Global_21608, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_21608, "SET_HEADER", "CELL_23" /* GXT: Check List */, 0, 0, 0, 0);
...
{
	func_32(0, "CELL_3001" /* GXT: Missions */, 1, Global_114667);
	func_32(1, "CELL_3008" /* GXT: Hobbies and Pastimes */, 3, Global_114667);
	func_32(2, "CELL_3004" /* GXT: Strangers and Freaks */, 7, Global_114670);
	func_32(3, "CELL_3005" /* GXT: Random Events */, 9, Global_114671);
	func_32(4, "CELL_3007" /* GXT: Miscellaneous */, 11, Global_114672);
}

void func_32(int iParam0, char* sParam1, int iParam2, int iParam3) // Position - 0x1741
{
	TEXT_LABEL_ASSIGN_STRING(&Static_129[iParam0 /*6*/], sParam1, 16);
	Static_129[iParam0 /*6*/].f_4 = iParam2;
	Static_129[iParam0 /*6*/].f_5 = iParam3;
	Static_129[0 /*6*/].f_4 == 1;
}
