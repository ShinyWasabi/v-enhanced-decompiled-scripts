...
void main() // Position - 0x0
{
	...
	iVar7 = 0;
	Static_49 = 3;
	Static_224 = { ScriptArg_0.f_1[0 /*3*/] };
	Static_227[0 /*3*/] = { 1283.85f, -1622.501f, 53.2255f };
	Static_237[0] = 198.9926f;
	Static_227[1 /*3*/] = { 1286.6545f, -1627f, 53.225f };
	Static_237[1] = 22.3073f;
	Static_227[2 /*3*/] = { 1286.4518f, -1624.7819f, 53.225f };
	Static_237[2] = 49.6773f;
	uVar14 = { 1298.3907f, -1580.895f, 50.7937f };
	fVar17 = 332.006f;
	Static_241 = { 1277.7249f, -1617.8971f, 53.2254f };
	iVar18 = 3;

	if (func_165())
	{
		uVar1[0] = joaat("G_M_Y_MEXGOON_02");
		uVar1[1] = joaat("G_M_Y_MEXGOON_02");
		uVar1[2] = joaat("G_M_Y_MEXGOON_02");
		uVar1.f_4 = joaat("A_F_Y_EASTSA_03");
	}
	else
	{
		uVar1[0] = joaat("G_M_Y_MEXGOON_02");
	...
	uVar1.f_5 = "amb_sit_wall_m";

	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
		func_153(uVar1, iVar13, &iVar18, uVar22);

	if (func_120(Static_224, -1, 0, false, false))
		func_117(-1);
	else
	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				iVar23 = 0;
				PED::ADD_SCENARIO_BLOCKING_AREA(Static_241 - { 10f, 30f, 30f }, Static_241 + { 10f, 30f, 30f }, 0, 1, 1, 1, 1);
				PED::SET_PED_NON_CREATION_AREA(Static_241 - { 50f, 50f, 50f }, Static_241 + { 100f, 100f, 100f });
				VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Static_241 - { 15f, 15f, 15f }, Static_241 + { 15f, 15f, 15f }, 0, 1);
				MISC::SET_BIT(&iVar8, 4);
				MISC::SET_BIT(&iVar8, 1);
				MISC::SET_BIT(&iVar8, 5);
				PED::ADD_RELATIONSHIP_GROUP("GangOne", &Static_47);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Static_47, joaat("PLAYER"));
				uVar22 = PED::CREATE_PED(12, uVar1.f_4, uVar14, fVar17, 1, 1);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uVar22, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(uVar1.f_4);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(uVar22, Static_47);
				...
				if (func_89() == 0)
					func_88(&Static_53, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL" /* GXT: Michael */, 0, 1);
				else if (func_89() == 1)
					func_88(&Static_53, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN" /* GXT: Franklin */, 0, 1);
				else if (func_89() == 2)
					func_88(&Static_53, 0, PLAYER::PLAYER_PED_ID(), "TREVOR" /* GXT: Trevor */, 0, 1);
			
				func_88(&Static_53, 3, uVar22, "REGIFemale", 0, 1);
				func_88(&Static_53, 4, iVar18[2], "REGIMale", 0, 1);
				TASK::TASK_PLAY_ANIM(uVar22, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 49, 0, 0, 0, 0);
				!HUD::DOES_BLIP_EXIST(Static_222);
			
				for (iVar24 = 0; iVar24 <= Static_49 - 1; iVar24 = iVar24 + 1)
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iVar18[iVar24]))
					{
						iVar18[iVar24] = PED::CREATE_PED(12, uVar1[iVar24], Static_227[iVar24 /*3*/], Static_237[iVar24], 1, 1);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iVar18[iVar24], 1);
						STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(uVar1[iVar24]);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(iVar18[iVar24], Static_47);
						PED::SET_PED_CONFIG_FLAG(iVar18[iVar24], 42, 1);
						WEAPON::GIVE_WEAPON_TO_PED(iVar18[iVar24], func_87(), -1, 1, 1);
				...
				Static_50 = PED::CREATE_SYNCHRONIZED_SCENE(1283.205f, -1622.71f, 54.299f, 0f, 0f, 103.68f, 2);
			
				if (!PED::IS_PED_INJURED(iVar18[0]))
					TASK::TASK_SYNCHRONIZED_SCENE(iVar18[0], Static_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
			
				if (!PED::IS_PED_INJURED(iVar18[1]))
					TASK::TASK_SYNCHRONIZED_SCENE(iVar18[1], Static_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
			
				if (!PED::IS_PED_INJURED(iVar18[2]))
					TASK::TASK_SYNCHRONIZED_SCENE(iVar18[2], Static_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
			
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(Static_50, 1);
				Static_247 = true;
				iVar0 = 5;
				break;
			...
			case 5:
				...
				if (iVar7 < 3)
				{
					if (func_80(&iVar18, &uVar11, &uVar10, &uVar9, iVar8, bVar12, 1075838976, 0) || func_79(iVar18[0], 0) || func_79(iVar18[1], 0) || func_79(iVar18[2], 0) || MISC::IS_BULLET_IN_AREA(Static_227[0 /*3*/], 40f, 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(Static_227[0 /*3*/] - { 25f, 25f, 25f }, Static_227[0 /*3*/] + { 25f, 25f, 25f }, joaat("WEAPON_SMOKEGRENADE"), 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(Static_227[0 /*3*/] - { 25f, 25f, 25f }, Static_227[0 /*3*/] + { 25f, 25f, 25f }, joaat("WEAPON_GRENADE"), 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(Static_227[0 /*3*/] - { 25f, 25f, 25f }, Static_227[0 /*3*/] + { 25f, 25f, 25f }, joaat("WEAPON_GRENADELAUNCHER"), 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(Static_227[0 /*3*/] - { 25f, 25f, 25f }, Static_227[0 /*3*/] + { 25f, 25f, 25f }, joaat("WEAPON_STICKYBOMB"), 1))
					{
						for (iVar25 = 0; iVar25 < iVar18; iVar25 = iVar25 + 1)
						{
							if (!PED::IS_PED_INJURED(iVar18[iVar25]))
							{
								...
								if (!PED::IS_PED_INJURED(iVar18[iVar25]))
								{
									...
									TASK::OPEN_SEQUENCE_TASK(&Static_48);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000, 2048, 2);
									TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
									TASK::CLOSE_SEQUENCE_TASK(Static_48);
									TASK::TASK_PERFORM_SEQUENCE(iVar18[iVar25], Static_48);
									TASK::CLEAR_SEQUENCE_TASK(&Static_48);
						...
						if (!PED::IS_PED_INJURED(uVar22))
						{
							if (!PED::IS_PED_INJURED(uVar22))
							{
								TASK::CLEAR_PED_TASKS(uVar22);
								TASK::OPEN_SEQUENCE_TASK(&Static_48);
								TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000, 2048, 2);
								TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								TASK::CLOSE_SEQUENCE_TASK(Static_48);
								TASK::TASK_PERFORM_SEQUENCE(uVar22, Static_48);
								TASK::CLEAR_SEQUENCE_TASK(&Static_48);
				...
				{
					for (iVar26 = 0; iVar26 < iVar18; iVar26 = iVar26 + 1)
					{
				...
				if (iVar0 != 6)
				{
					if (func_1(&iVar7, uVar1, uVar22, &iVar18, &iVar23, &iVar13) || Static_246)
					{
						iVar0 = 6;
						break;
					}
...
int func_1(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x8FE
{
	...
	if (*uParam0 >= 3)
		if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(Static_51))
			if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Static_255, 9f, 9f, 9f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, 0, 1, 0) || TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
				*uParam0 = 6;

	switch (*uParam0)
	{
		case 0:
			if (func_61(uParam7, uParam8))
			{
				if (Static_254)
					*uParam0 = 2;
				...
				if (!PED::IS_PED_INJURED(uParam7))
				{
					...
					if (!func_79(uParam7, 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uParam7, 15f, 15f, 15f, 0, 1, 0))
						{
							if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::CAN_PED_SEE_HATED_PED(uParam7, PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								...
								{
									TASK::CLEAR_PED_SECONDARY_TASK(uParam7);
									TASK::TASK_LOOK_AT_ENTITY(uParam7, PLAYER::PLAYER_PED_ID(), 5000, 1024, 2);
									func_77();
									BUILTIN::WAIT(1000);
									func_45(&Static_53, "REGIAU", "REGIN_ARM", 4, 0, 0, 0);
								
									for (iVar0 = 0; iVar0 < *uParam8; iVar0 = iVar0 + 1)
									{
										if (!PED::IS_PED_INJURED(uParam8->[iVar0]))
										{
											TASK::CLEAR_PED_SECONDARY_TASK(uParam8->[iVar0]);
											TASK::TASK_SMART_FLEE_PED(uParam8->[iVar0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
											PED::SET_PED_KEEP_TASK(uParam8->[iVar0], 1);
										}
									}
								
									if (!PED::IS_PED_INJURED(uParam7))
									{
										TASK::TASK_SMART_FLEE_PED(uParam7, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
				...
				if (PED::IS_PED_INJURED(uParam7))
					...
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(uParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 3))
						TASK::STOP_ANIM_TASK(uParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", -1056964608);
			}
			else
			{
				*uParam0 = 9;
		...
		case 2:
			GRAPHICS::DRAW_DEBUG_LINE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Static_241, 0, 0, 255, 255);
			TASK::TASK_PAUSE(PLAYER::PLAYER_PED_ID(), 1000);
			Static_255 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
		
			if (!PED::IS_PED_INJURED(uParam8->[1]))
			{
				!HUD::DOES_BLIP_EXIST(Static_218[1]);
				AUDIO::TRIGGER_MUSIC_EVENT("RE28_OS");
				Static_51 = PED::CREATE_SYNCHRONIZED_SCENE(1283.205f, -1622.71f, 54.299f, 0f, 0f, 103.68f, 2);
			
				if (!PED::IS_PED_INJURED(uParam8->[0]))
					TASK::TASK_SYNCHRONIZED_SCENE(uParam8->[0], Static_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
			
				if (!PED::IS_PED_INJURED(uParam8->[1]))
					TASK::TASK_SYNCHRONIZED_SCENE(uParam8->[1], Static_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
			
				if (!PED::IS_PED_INJURED(uParam8->[2]))
					TASK::TASK_SYNCHRONIZED_SCENE(uParam8->[2], Static_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
		...
		case 3:
			*uParam9 = 0;
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Static_51))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Static_51) > 0.3f)
				{
					if (!PED::IS_PED_INJURED(uParam8->[0]))
					{
						PED::SET_PED_RESET_FLAG(uParam8->[0], 156, 1);
						TASK::OPEN_SEQUENCE_TASK(&Static_48);
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - { 0f, 0f, 1f }, PLAYER::PLAYER_PED_ID(), 2f, 0, 3.5f, 5f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
						TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 25000, 0);
						TASK::CLOSE_SEQUENCE_TASK(Static_48);
						TASK::TASK_PERFORM_SEQUENCE(uParam8->[0], Static_48);
						TASK::CLEAR_SEQUENCE_TASK(&Static_48);
						Static_48 = 0;
					}
				}
			
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Static_51) > 0.35f)
				{
					if (!PED::IS_PED_INJURED(uParam8->[1]))
					{
						PED::SET_PED_RESET_FLAG(uParam8->[1], 156, 1);
						TASK::OPEN_SEQUENCE_TASK(&Static_48);
						TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 2f, 0, 5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 25000, 0);
						TASK::CLOSE_SEQUENCE_TASK(Static_48);
						TASK::TASK_PERFORM_SEQUENCE(uParam8->[1], Static_48);
						TASK::CLEAR_SEQUENCE_TASK(&Static_48);
						Static_48 = 0;
					}
				}
			
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Static_51) > 0.275f)
				{
					if (!PED::IS_PED_INJURED(uParam8->[2]))
					{
						PED::SET_PED_RESET_FLAG(uParam8->[2], 156, 1);
						TASK::OPEN_SEQUENCE_TASK(&Static_48);
						TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 2f, 0, 3.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
						TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 25000, 0);
						TASK::CLOSE_SEQUENCE_TASK(Static_48);
						TASK::TASK_PERFORM_SEQUENCE(uParam8->[2], Static_48);
						TASK::CLEAR_SEQUENCE_TASK(&Static_48);
						Static_48 = 0;
					}
				}
			...
			if (!PED::IS_PED_INJURED(uParam8->[2]))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(uParam8->[2], PLAYER::PLAYER_PED_ID(), 4f, 4f, 2f, 0, 1, 0))
				{
					func_41(Static_222);
					func_41(Static_223);
					func_37(uParam8);
					...
					Static_249 = MISC::GET_GAME_TIMER();
					*uParam0 = 4;
				}
			}
			break;
		...
		case 6:
			if (!Static_248)
			{
				func_77();
				BUILTIN::WAIT(0);
				func_45(&Static_53, "REGIAU", "REGIN_WARN2", 4, 0, 0, 0);
				...
				*uParam10 = 1;
				...
				if (!PED::IS_PED_INJURED(uParam7))
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uParam7, 8f, 8f, 8f, 0, 1, 0))
						func_45(&Static_53, "REGIAU", "REGIN_SORRY", 4, 0, 0, 0);
			
				!HUD::DOES_BLIP_EXIST(Static_223);
...
bool func_4(bool bParam0) // Position - 0x10EE
{
...
void func_5(int iParam0, int iParam1) // Position - 0x1116
{
	...
	if (iParam1 <= func_28(iParam0))
	{
		...
		if (func_13(iParam0, iParam1) != 322)
			func_7(func_13(iParam0, iParam1), Static_44, Static_44.f_1);
...
void func_11(int iParam0, int iParam1, bool bParam2) // Position - 0x1828
{
	if (bParam2 == -1)
		bParam2 = func_12();
...
int func_23(var uParam0) // Position - 0x20A1
{
	int iVar0;
	int iVar1;
...
int func_25(int iParam0) // Position - 0x2103
{
...
void func_34(var uParam0) // Position - 0x2491
{
	...
	if (Static_252 == 0)
	{
		for (iVar2 = 0; iVar2 <= Static_49 - 1; iVar2 = iVar2 + 1)
		{
...
bool func_35(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x24FD
{
	...
	{
		case 0:
			if (func_36(Static_249, 0))
			{
				if (!func_76())
				{
					if (func_89() == 0)
					{
						func_45(&Static_53, "REGIAU", "REGIN_MONEYM", 4, 0, 0, 0);
						Static_250 = 1;
					}
					else if (func_89() == 1)
					{
						func_45(&Static_53, "REGIAU", "REGIN_MONEYF", 4, 0, 0, 0);
						Static_250 = 1;
					}
					else if (func_89() == 2)
					{
						func_45(&Static_53, "REGIAU", "REGIN_MONEYT", 4, 0, 0, 0);
						Static_250 = 1;
					}
				}
		...
		case 1:
			...
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(uParam6, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7 || ENTITY::IS_ENTITY_AT_ENTITY(uParam6, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (!func_76())
					{
						func_45(&Static_53, "REGIAU", "REGIN_KILL", 4, 0, 0, 0);
						BUILTIN::SETTIMERA(0);
						Static_52 = true;
						Static_250 = 4;
					}
		...
		case 2:
			if (!PED::IS_PED_INJURED(uParam7->[2]))
			{
				if (!PED::IS_PED_INJURED(uParam7->[0]))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Static_227[0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
					TASK::TASK_ACHIEVE_HEADING(0, Static_237[0], 0);
					TASK::TASK_PLAY_ANIM_ADVANCED(0, uParam0.f_5, "sit_down_idle_01", Static_227[0 /*3*/], 0f, 0f, Static_237[0], 1000f, -4f, -1, 1, 0, 2, 0);
					TASK::CLOSE_SEQUENCE_TASK(Static_48);
					TASK::TASK_PERFORM_SEQUENCE(uParam7->[0], Static_48);
					TASK::CLEAR_SEQUENCE_TASK(&Static_48);
					Static_48 = 0;
				}
				...
				if (!PED::IS_PED_INJURED(uParam7->[1]))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Static_227[1 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
					TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
					TASK::CLOSE_SEQUENCE_TASK(Static_48);
					TASK::TASK_PERFORM_SEQUENCE(uParam7->[1], Static_48);
					TASK::CLEAR_SEQUENCE_TASK(&Static_48);
					Static_48 = 0;
				}
				...
				if (!PED::IS_PED_INJURED(uParam7->[2]))
				{
					...
					TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
					TASK::CLOSE_SEQUENCE_TASK(Static_48);
					TASK::TASK_PERFORM_SEQUENCE(uParam7->[2], Static_48);
					TASK::CLEAR_SEQUENCE_TASK(&Static_48);
					Static_48 = 0;
				}
			}
		...
		case 3:
			...
			{
				if (func_89() == 0)
					func_45(&Static_53, "REGIAU", "REGIN_REALM", 4, 0, 0, 0);
				else if (func_89() == 1)
					func_45(&Static_53, "REGIAU", "REGIN_REALF", 4, 0, 0, 0);
				else if (func_89() == 2)
					func_45(&Static_53, "REGIAU", "REGIN_REALT", 4, 0, 0, 0);
...
void func_37(var uParam0) // Position - 0x27DE
{
	...
	for (iVar0 = 0; iVar0 <= *uParam0 - 1; iVar0 = iVar0 + 1)
	{
		if (!HUD::DOES_BLIP_EXIST(Static_218[iVar0]))
		{
			if (!PED::IS_PED_INJURED(uParam0->[iVar0]))
			{
				Static_218[iVar0] = func_38(uParam0->[iVar0], true, 145);
...
int func_38(var uParam0, bool bParam1, int iParam2) // Position - 0x2837
{
	...
	iVar0 = func_39(uParam0, !bParam1, false);
...
void func_42(var uParam0, var uParam1) // Position - 0x2953
{
	...
	{
		TASK::CLEAR_PED_SECONDARY_TASK(uParam1);
		TASK::TASK_COWER(uParam1, -1);
...
bool func_50(int iParam0, int iParam1) // Position - 0x2E1A
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_51(int iParam0) // Position - 0x2E32
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_52() // Position - 0x2E44
{
	return -1;
}

void func_53() // Position - 0x2E4D
{
	int iVar0;
...
bool func_59(int iParam0, int iParam1) // Position - 0x30CE
{
	switch (iParam0)
	{
		case 5:
...
void func_60(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x3106
{
...
bool func_61(var uParam0, var uParam1) // Position - 0x315C
{
	switch (Static_253)
	{
		case 0:
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1272.8779f, -1532.8402f, 36.4104f, 1339.482f, -1623.6365f, 71.4792f, 105.1875f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(uParam0) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0, 15f, 15f, 15f, 0, 1, 0))
				{
					if (!func_115())
						func_65(true);
				
					if (HUD::DOES_BLIP_EXIST(Static_222))
						func_41(Static_222);
				
					if (!HUD::DOES_BLIP_EXIST(Static_223))
					{
						Static_223 = func_38(uParam0, false, 145);
						HUD::SHOW_HEIGHT_ON_BLIP(Static_223, 0);
					}
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()))
						{
							if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) < 5f)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0, 10f, 10f, 10f, 0, 1, 0))
								{
									...
									TASK::CLOSE_SEQUENCE_TASK(Static_48);
									TASK::TASK_PERFORM_SEQUENCE(uParam0, Static_48);
									TASK::CLEAR_SEQUENCE_TASK(&Static_48);
								
									if (HUD::DOES_BLIP_EXIST(Static_223))
										HUD::SHOW_HEIGHT_ON_BLIP(Static_223, 1);
									...
									if (PED::IS_PED_FACING_PED(uParam0, PLAYER::PLAYER_PED_ID(), 45f))
									{
										func_43();
										BUILTIN::WAIT(0);
										func_45(&Static_53, "REGIAU", "REGIN_LR1F", 4, 0, 0, 0);
										Static_253 = 1;
									}
								}
							}
							else if (Static_244 == 0)
							{
								func_45(&Static_53, "REGIAU", "REGIN_CAR", 4, 0, 0, 0);
						...
						else
						{
							func_43();
							BUILTIN::WAIT(0);
							func_45(&Static_53, "REGIAU", "REGIN_POLICE", 4, 0, 0, 0);
						
							if (!PED::IS_PED_INJURED(uParam0))
							{
								TASK::CLEAR_PED_TASKS(uParam0);
								TASK::TASK_SMART_FLEE_PED(uParam0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
			...
			if (!PED::IS_PED_INJURED(uParam1->[2]))
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1273.098f, -1604.1722f, 53.1535f, 1276.5682f, -1615.1274f, 56.7879f, 10f, 0, 1, 0) && !func_64())
					Static_253 = 3;
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1298.5461f, -1617.742f, 53.2254f, 1262.868f, -1629.3601f, 64.2894f, 30.4375f, 0, 1, 0))
		...
		case 1:
			...
			{
				MISC::CLEAR_AREA_OF_VEHICLES(Static_241, 13f, 0, 0, 0, 0, 0, 0, 0);
				TASK::CLEAR_PED_SECONDARY_TASK(uParam0);
			
				if (!PED::IS_PED_INJURED(uParam0))
				{
					TASK::OPEN_SEQUENCE_TASK(&Static_48);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Static_241, 2f, 20000, 0.25f, 0, 32.2195f);
					...
					TASK::CLEAR_SEQUENCE_TASK(&Static_48);
					Static_48 = 0;
					WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0, 6f, 6f, 6f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0);
				}
		...
		case 2:
			if (!PED::IS_PED_INJURED(uParam0) && !func_76())
			{
				if (func_45(&Static_53, "REGIAU", "REGIN_LR1G", 4, 0, 0, 0))
				{
					BUILTIN::SETTIMERA(0);
					Static_253 = 3;
				}
		...
		case 3:
			...
			{
				if (BUILTIN::TIMERA() > 8000 && ENTITY::IS_ENTITY_AT_COORD(uParam0, Static_241, 3f, 3f, 3f, 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(uParam0, PLAYER::PLAYER_PED_ID(), 60f))
					{
						if (func_165())
							TASK::TASK_PLAY_ANIM(uParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_a", 2f, -2f, -1, 48, 0, 0, 0, 0);
						else
							TASK::TASK_PLAY_ANIM(uParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 0, 0, 0, 0, 0);
					
						func_45(&Static_53, "REGIAU", "REGIN_HERE", 4, 0, 0, 0);
						BUILTIN::SETTIMERA(0);
					}
				}
			
				if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::CAN_PED_SEE_HATED_PED(uParam0, PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		...
		case 4:
			if (!PED::IS_PED_INJURED(uParam0))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Static_241, 2f, 20000, 1048576000, 0, 1193033728);
				TASK::CLOSE_SEQUENCE_TASK(Static_48);
				TASK::CLEAR_SEQUENCE_TASK(&Static_48);
				Static_48 = 0;
			}
			...
			if (!func_76())
			{
				func_45(&Static_53, "REGIAU", "REGIN_THRT", 4, 0, 0, 0);
				Static_253 = 5;
			}
			break;
...
void func_62(var uParam0) // Position - 0x383F
{
	if (!PED::IS_PED_INJURED(uParam0))
	{
		TASK::CLEAR_PED_TASKS(uParam0);
...
void func_63(var uParam0, var uParam1) // Position - 0x38A8
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 < *uParam1; iVar0 = iVar0 + 1)
	{
		...
		{
			if (PED::CAN_PED_SEE_HATED_PED(uParam1->[iVar0], PLAYER::PLAYER_PED_ID()) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), uParam1->[iVar0]) || PED::CAN_PED_SEE_HATED_PED(uParam0, PLAYER::PLAYER_PED_ID()))
			{
				func_77();
				...
				if (!PED::IS_PED_INJURED(uParam1->[iVar0]))
				{
					...
					TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(Static_48);
					TASK::TASK_PERFORM_SEQUENCE(uParam1->[iVar0], Static_48);
					TASK::CLEAR_SEQUENCE_TASK(&Static_48);
...
int func_65(bool bParam0) // Position - 0x3AE3
{
	if (func_69())
	{
		Global_114921 = true;
...
void func_66(int iParam0) // Position - 0x3B36
{
	switch (iParam0)
	{
		case 0:
...
void func_67(char* sParam0, int iParam1) // Position - 0x3C11
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

char* func_68(int iParam0) // Position - 0x3C28
{
	char* sVar0;
...
bool func_69() // Position - 0x3C6C
{
	switch (func_70(&Global_33852, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_70(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4) // Position - 0x3CA2
{
	int iVar0;
	...
	if (*uParam0 == -1)
	{
		...
		*uParam0 = Global_44850;
		...
		if (iParam4 != 0)
			func_71(uParam0, iParam4);
	}

	return 2;
}

void func_71(var uParam0, int iParam1) // Position - 0x3DD9
{
	int iVar0;
...
bool func_72(int iParam0) // Position - 0x3E28
{
	return func_73(iParam0, Global_44886);
}

bool func_73(int iParam0, int iParam1) // Position - 0x3E39
{
	if (iParam1 == 15)
		return 1;
...
bool func_74(int iParam0) // Position - 0x401B
{
	if (Global_44886 == 15)
		return false;
...
bool func_75(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x403D
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), uParam0) > (float)iParam3)
			return true;

	return false;
}

bool func_76() // Position - 0x406E
{
...
void func_77() // Position - 0x4090
{
	Global_21866 = 0;
	func_78();
}

void func_78() // Position - 0x40A0
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
bool func_79(var uParam0, int iParam1) // Position - 0x40C1
{
...
bool func_80(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, int iParam6, int iParam7) // Position - 0x410E
{
	int iVar0;
	...
	if (!bParam5)
	{
		...
		{
			if (func_81(uParam0->[iVar0], uParam2, uParam3, iParam4, bParam5, iParam6, iParam7))
			{
				*uParam1 = iVar0;
				return true;
			}
...
bool func_81(var uParam0, var uParam1, var uParam2, int iParam3, bool bParam4, int iParam5, int iParam6) // Position - 0x4157
{
	float fVar0;
	int iVar1;
	bool bVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0) && !bParam4)
		{
			...
			{
				if (func_79(uParam0, iParam6))
				{
					func_86("FUNC BOOL HAS_PLAYER_AGGROED_PED\\n");
					func_86("	aggroReason = EAggro_Attacked\\n");
					*uParam1 = 3;
					func_85(uParam0);
					return true;
				}
			...
			if (!IS_BIT_SET(iParam3, 1))
			{
				...
				{
					func_86("FUNC BOOL HAS_PLAYER_AGGROED_PED\\n");
					func_86("	aggroReason = EAggro_ShotNear\\n");
					*uParam1 = 1;
					func_85(uParam0);
					return true;
				}
				...
				if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
				{
					if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uParam0) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uParam0))
					{
						if (fVar9 < fVar0)
						{
							...
							{
								func_86("FUNC BOOL HAS_PLAYER_AGGROED_PED\\n");
								func_86("	aggro Ped knows player is pointing gun\\n");
								func_82("		lockOnTimer = ", *uParam2);
								func_86("\\n");
								func_82("		time since not LockedOn = ", MISC::GET_GAME_TIMER() - Static_43);
								func_86("\\n");
								bVar2 = true;
							
								if (MISC::GET_GAME_TIMER() > Static_43 + *uParam2)
								{
									func_86("			aggroReason = EAggro_HostileOrEnemy\\n");
									*uParam1 = 2;
									func_85(uParam0);
									return true;
								}
			...
			if (!IS_BIT_SET(iParam3, 0))
			{
				...
				{
					func_86("FUNC BOOL HAS_PLAYER_AGGROED_PED\\n");
					func_86("			aggroReason = EAggro_Danger\\n");
					*uParam1 = 0;
					func_85(uParam0);
					return true;
				}
	...
	if (!bVar2)
		Static_43 = MISC::GET_GAME_TIMER();

	return false;
}

void func_82(char* sParam0, int iParam1) // Position - 0x43A9
{
	func_84(sParam0);
	func_83(iParam1);
}

void func_83(int iParam0) // Position - 0x43BD
{
	iParam0 > 0;
}

void func_84(char* sParam0) // Position - 0x43CB
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
}

void func_85(var uParam0) // Position - 0x43DE
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(uParam0);
}

void func_86(char* sParam0) // Position - 0x43EC
{
	func_84(sParam0);
}

int func_87() // Position - 0x43FA
{
	int iVar0;
...
void func_88(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x445B
{
...
int func_89() // Position - 0x44F6
{
	func_20();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_90(bool bParam0) // Position - 0x450F
{
	bParam0;
}

bool func_91(int iParam0) // Position - 0x451C
{
	if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		if (func_92(iParam0))
			return true;
...
bool func_92(int iParam0) // Position - 0x4539
{
	switch (iParam0)
	{
		case 0:
...
bool func_93(int iParam0) // Position - 0x45AB
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_101() || Global_113978 || Global_33795 || func_100() || func_59(8, -1) || func_99() || func_98() || func_97() || func_96() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_101() || Global_33795 || func_100() || func_59(8, -1) || func_97() || func_99() || func_98() || func_96() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_101() || Global_113978 || Global_33795 || func_100() || func_59(8, -1) || func_97() || func_99() || func_98() || func_96() || Global_114931.f_7695.f_919[iVar0] == 5 || Global_45433 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_101() || Global_113978 || Global_33795 || func_100() || func_59(8, -1) || func_99() || func_98() || func_96() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 4:
						if (func_101() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_59(8, -1) || func_96() || func_95() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 5:
						if (func_59(8, -1) || func_99() || func_98() || func_95() || func_94())
							return false;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_101() || Global_33795 || func_100() || func_59(8, -1) || func_98() || func_97() || func_96() || Global_114931.f_7695.f_919[iVar0] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_101() || func_98() || Global_113978 || Global_33795 || func_100() || Global_46111 || func_59(8, -1) || func_97() || func_95() || func_96() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_101() || Global_113978 || Global_33795 || func_100() || func_59(8, -1) || func_97() || func_95() || func_99() || func_98() || func_96())
							return false;
						break;
				}
			}
...
bool func_94() // Position - 0x4CC8
{
	return Global_102493.f_1;
}

bool func_95() // Position - 0x4CD6
{
	if (Global_99351 != -1)
...
bool func_98() // Position - 0x4D3D
{
	return Global_102506.f_418 > 0;
}

bool func_99() // Position - 0x4D4E
{
	return Global_102506.f_417 > 0;
}

bool func_100() // Position - 0x4D5F
{
	return Global_1575092;
}

bool func_101() // Position - 0x4D6B
{
...
bool func_102() // Position - 0x4D87
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Static_44) < 75f * 75f)
			return true;
	
		if (BUILTIN::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_113())
			return false;
	}
	...
	if (func_103(100f, true) != -1)
		return true;

	return false;
}

int func_103(float fParam0, bool bParam1) // Position - 0x4E0D
{
	var uVar0;
	int iVar32;
	int iVar33;
...
void func_104(int iParam0, var uParam1) // Position - 0x4EBE
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_105(uParam1, "Barry3A", func_107(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_106(iParam0), 0, 1);
			break;
		...
		case 8:
			func_105(uParam1, "Dreyfuss1", func_107(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_106(iParam0), 0, 0);
			break;
		...
		case 38:
			func_105(uParam1, "Nigel1A", func_107(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_106(iParam0), 1, 1);
			break;
		...
		case 49:
			func_105(uParam1, "Paparazzo3A", func_107(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_106(iParam0), 0, 1);
			break;
		...
		case 58:
			func_105(uParam1, "Tonya1", func_107(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_106(iParam0), 0, 1);
			break;
...
int func_106(int iParam0) // Position - 0x6196
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_107(int iParam0) // Position - 0x64DC
{
	var uVar0;
	var uVar2;

	TEXT_LABEL_ASSIGN_STRING(&uVar0, "", 8);
	uVar2 = { func_108(iParam0) };
...
struct<2> func_108(int iParam0) // Position - 0x6514
{
	var uVar0;
...
bool func_109() // Position - 0x6961
{
	if (func_112() && !func_113())
		return true;
...
bool func_110() // Position - 0x6993
{
	return Global_114649 > 0;
}

bool func_111() // Position - 0x69A1
{
	if (Global_99351 != -1)
		return true;
...
bool func_116(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x6A83
{
	int iVar0;

	if (iParam0 == 1)
	{
		for (iVar0 = 0; iVar0 <= Static_49 - 1; iVar0 = iVar0 + 1)
		{
			STREAMING::REQUEST_MODEL(uParam1[iVar0]);
		}
		...
		for (iVar0 = 0; iVar0 <= Static_49 - 1; iVar0 = iVar0 + 1)
		{
			if (!STREAMING::HAS_MODEL_LOADED(uParam1[iVar0]))
				return false;
		}
	...
	else
	{
		for (iVar0 = 0; iVar0 <= Static_49 - 1; iVar0 = iVar0 + 1)
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(uParam1[iVar0]);
		}
...
void func_117(int iParam0) // Position - 0x6B38
{
	if (iParam0 == -1)
		iParam0 = func_29();
...
void func_119(int iParam0) // Position - 0x6BAB
{
	Global_114920 = iParam0;
}

bool func_120(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) // Position - 0x6BB9
{
	bool bVar0;
	var uVar1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !bParam6)
			if (uVar1.f_2 - Static_44.f_2 > 50f)
				return false;
		...
		if (func_22(func_89()))
			if (func_149(func_89()) == 4 || func_149(func_89()) == 5)
				return false;
	
		if (func_22(func_89()))
			if (!func_148(iParam3, iParam4, 145))
				return false;
	
		if (!func_147(Global_114931.f_25002.f_43[iParam3]))
			return false;
		...
		if (func_22(func_89()))
		{
			for (iVar4 = 0; iVar4 < 3; iVar4 = iVar4 + 1)
			{
				...
				if (func_144(iVar8))
					if (func_122(iVar4))
						if (!func_121(uVar5, 0f, 0f, 0f, false))
...
bool func_121(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, bool bParam6) // Position - 0x6F53
{
	if (bParam6)
...
bool func_122(int iParam0) // Position - 0x6F9A
{
	int iVar0;
...
bool func_123(int iParam0) // Position - 0x6FBB
{
	return func_124(iParam0, 1);
}

int func_124(int iParam0, int iParam1) // Position - 0x6FCA
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_125(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x701D
{
	func_126(func_137(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_126(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x703B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = iVar3 - 1;
		iVar0 = BUILTIN::ROUND(func_127(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
...
float func_127(float fParam0, float fParam1, float fParam2) // Position - 0x723C
{
	float fVar0;
...
int func_128(int iParam0, int iParam1) // Position - 0x727E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_129(int iParam0) // Position - 0x7320
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_130(int iParam0) // Position - 0x7333
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_131(int iParam0) // Position - 0x7346
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_132(int iParam0) // Position - 0x7359
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_133(int iParam0) // Position - 0x736B
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_134(bool bParam0, var uParam1, var uParam2) // Position - 0x738D
{
	if (bParam0)
		return uParam1;
...
int func_135(int iParam0) // Position - 0x73A4
{
	return iParam0 & 15;
}

bool func_136(int iParam0, int iParam1) // Position - 0x73B1
{
	int iVar0;
	int iVar1;
...
void func_138(var uParam0, int iParam1) // Position - 0x7503
{
	if (iParam1 <= 0)
		return;
...
void func_139(var uParam0, int iParam1) // Position - 0x7589
{
...
void func_140(var uParam0, int iParam1) // Position - 0x75BC
{
	int iVar0;
	int iVar1;
...
void func_142(var uParam0, int iParam1) // Position - 0x7647
{
...
void func_143(var uParam0, int iParam1) // Position - 0x7682
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
bool func_144(int iParam0) // Position - 0x76BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_145(int iParam0, int iParam1) // Position - 0x779A
{
...
bool func_147(int iParam0) // Position - 0x77E2
{
	return func_136(func_137(), iParam0);
}

bool func_148(int iParam0, int iParam1, int iParam2) // Position - 0x77F4
{
	bool bVar0;
	int iVar1;
...
int func_149(int iParam0) // Position - 0x78D8
{
	if (!func_22(iParam0))
		return 7;
...
bool func_150(int iParam0) // Position - 0x78FC
{
	int iVar0;
	bool bVar1;
...
void func_153(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8) // Position - 0x7A50
{
	int iVar0;
	...
	if (Static_247)
	{
		...
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Static_241 - { 10f, 10f, 10f }, Static_241 + { 10f, 10f, 10f }, 1, 1);
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
		func_41(Static_218[0]);
		func_41(Static_218[1]);
		func_41(Static_218[2]);
	
		for (iVar0 = 0; iVar0 <= Static_49 - 1; iVar0 = iVar0 + 1)
		{
			!PED::IS_PED_INJURED(uParam7->[iVar0]);
		}
...
void func_154(int iParam0) // Position - 0x7B01
{
	var uVar0;
	...
	if (func_115())
	{
		...
		func_157(30000);
		TEXT_LABEL_ASSIGN_STRING(&uVar0, func_156(Global_114920, true), 64);
	...
	func_155(&Global_33852);
	Global_114921 = false;
	func_119(-1);
}

void func_155(var uParam0) // Position - 0x7BB3
{
	if (*uParam0 == -1)
		return;
...
char* func_156(int iParam0, bool bParam1) // Position - 0x7BF0
{
	switch (iParam0)
	{
		case 0:
...
void func_157(int iParam0) // Position - 0x7E39
{
	Global_45437 = MISC::GET_GAME_TIMER() + iParam0;
}

void func_158(int iParam0) // Position - 0x7E4B
{
	func_159(iParam0, 0, func_164(iParam0));
}

void func_159(int iParam0, int iParam1, int iParam2) // Position - 0x7E60
{
	int iVar0;
	var uVar1;

	iVar0 = func_137();
	func_162(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_161(iParam0, &iVar0);
	uVar1 = { func_160(&iVar0) };
}

struct<16> func_160(var uParam0) // Position - 0x7E8F
{
	var uVar0;
	int iVar16;
	...
	TEXT_LABEL_APPEND_STRING(&uVar0, "/", 64);
	TEXT_LABEL_APPEND_INT(&uVar0, func_133(*uParam0), 64);
	return uVar0;
}

void func_161(int iParam0, var uParam1) // Position - 0x7F60
{
	Global_114931.f_25002.f_43[iParam0] = *uParam1;
}

void func_162(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x7F78
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	for (iVar6 = func_128(iVar1, iVar0); iVar2 > iVar6; iVar6 = func_128(iVar1, iVar0))
	{
		iVar1 = iVar1 + 1;
		iVar2 = iVar2 - iVar6;
	...
	iVar0 = iVar0 + iParam6;
	func_163(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

void func_163(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x80FB
{
...
int func_164(int iParam0) // Position - 0x8133
{
	int iVar0;
