...
bool func_2() // Position - 0x11B
{
	...
	if (!func_3(&uVar0))
	{
		uVar1 = { ENTITY::GET_ENTITY_COORDS(Static_71, 0) };
		fVar4 = BUILTIN::VDIST2(Static_175 + Static_180, uVar1);
	
		if (fVar4 < 4.5f * 4.5f)
		{
			TASK::TASK_VEHICLE_DRIVE_WANDER(Static_71, Static_73, Static_178, 786599);
			return true;
		}
	}
...
bool func_3(var uParam0) // Position - 0x16F
{
	...
	if (!PED::IS_PED_INJURED(Static_71))
	{
	}
	else
	{
...
bool func_4() // Position - 0x1B6
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99759))
		{
			...
			fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_99759);
		
			if (!func_5(Global_102175, Static_73, 2))
				if (fVar1 >= 0.9f)
					PED::SET_PED_INTO_VEHICLE(Global_102175, Static_73, 2);
		
			if (!Static_179)
			{
				ENTITY::FREEZE_ENTITY_POSITION(Static_71, 0);
				Static_179 = true;
			}
		
			TASK::TASK_VEHICLE_TEMP_ACTION(Static_71, Static_73, 6, 50);
		}
		else
		{
			if (!func_5(Global_102175, Static_73, 2))
			...
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Static_73, -8f, 1);
			BUILTIN::WAIT(100);
		
			if (!func_3(&uVar0))
			{
				TASK::OPEN_SEQUENCE_TASK(&uVar2);
				TASK::TASK_VEHICLE_TEMP_ACTION(0, Static_73, 24, 50);
				TASK::TASK_PAUSE(0, 2000);
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, Static_73, Static_175 + Static_180, Static_178, 0, Static_74, 786599, (4.5f / 2f) - 1f, 10f);
				TASK::CLOSE_SEQUENCE_TASK(uVar2);
				TASK::TASK_PERFORM_SEQUENCE(Static_71, uVar2);
...
int func_8(int iParam0, int iParam1) // Position - 0x36D
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_102175) && iParam1 != 0)
		{
			Global_102175 = 0;
		}
	}
...
int func_9(int iParam0) // Position - 0x451
{
	return iParam0;
}
...
void func_12() // Position - 0x4B0
{
	...
	{
		if (func_15(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_14(PLAYER::PLAYER_PED_ID());
		
			if (func_13(iVar0) && !func_17(14) || Global_113879)
			{
...
int func_14(var uParam0) // Position - 0x5B9
{
	int iVar0;
	int iVar1;
...
int func_16(int iParam0) // Position - 0x61B
{
...
void func_22() // Position - 0x6A5
{
	...
	STREAMING::REQUEST_MODEL(Static_72);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Static_72, 1);
	Static_73 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Static_180 + Static_172, 15f, Static_74, 2);
	iVar0 = 0;

	while (!ENTITY::DOES_ENTITY_EXIST(Global_102175) || !ENTITY::DOES_ENTITY_EXIST(Static_73) || !STREAMING::HAS_MODEL_LOADED(Static_72) && iVar0 < 400)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Static_73))
			Static_73 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Static_180 + Static_172, 15f, Static_74, 2);
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_102175, Global_97433);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_102175, "A_F_Y_BevHills_01_White_FULL_01");
	}

	if (!ENTITY::IS_ENTITY_DEAD(Static_73, 0))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(Static_73, 1, 1, 0);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(Static_73, 2);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Static_73, 1084227584);
		Static_71 = PED::CREATE_PED_INSIDE_VEHICLE(Static_73, 4, Static_72, -1, 1, 1);
		PED::SET_PED_RANDOM_COMPONENT_VARIATION(Static_71, 0);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Static_72);
	}
}
...
void func_23() // Position - 0x7A1
{
	...
	func_44(Static_69, &Static_180, &Static_183, &uVar0);
	Static_72 = joaat("A_M_M_EASTSA_02");
	func_29(1, Static_69, &Static_74, &Static_172, &uVar8, &Static_175, &Static_178);
	iVar9.f_1 = -1;
	iVar9.f_17 = 4;
	iVar9.f_17.f_8 = 4;
	iVar9.f_17.f_13 = 4;
	...
	iVar9 = 0;
	iVar9.f_2 = Static_69;
	iVar9.f_3 = Global_99907.f_45;
	func_26(iVar9, &uVar118);
	func_24(Static_69, &Static_184, &Static_200, &Static_200, &uVar238, &uVar239);
}
...
int func_31(int iParam0, var uParam1, int iParam2) // Position - 0x7A5F
{
	...
	if (!func_32(Global_101858[iParam0 /*98*/], false, -1))
	{
		func_30(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
bool func_32(bool bParam0, bool bParam1, int iParam2) // Position - 0x7C97
{
	int iVar0;
	var uVar1;
...
bool func_33(bool bParam0) // Position - 0x7E1C
{
	int iVar0;
	var uVar1;
	var uVar2;
...
bool func_35(bool bParam0, int iParam1) // Position - 0x7EFF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_36() // Position - 0x80E9
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

bool func_37() // Position - 0x80FF
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

bool func_38() // Position - 0x8115
{
	return false;
}

bool func_39() // Position - 0x811E
{
	return true;
}

bool func_40() // Position - 0x8127
{
	return true;
}

bool func_41() // Position - 0x8130
{
...
bool func_43(int iParam0) // Position - 0x8201
{
...
int func_44(int iParam0, var uParam1, var uParam2, char* sParam3) // Position - 0x8481
{
	int iVar0;
...
bool func_45(var uParam0) // Position - 0x867C
{
	int iVar0;
	var uVar1;
	float fVar4;
	...
	if (func_46(uVar1, 0f, 0f, 0f, false))
...
bool func_46(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, bool bParam6) // Position - 0x8734
{
	if (bParam6)
...
bool func_47(int iParam0, var uParam1, char* sParam2) // Position - 0x877B
{
	var uVar0;
	int iVar3;
	var uVar4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114931.f_2370.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_51(Global_114931.f_2370.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114931.f_2370.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_51(Global_114931.f_2370.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114931.f_2370.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_51(Global_114931.f_2370.f_539.f_2314[2]), 32);
			return true;
	
		case 11:
			if (func_50(iParam0, &uVar0, uParam1))
			{
...
bool func_48(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0xAD7D
{
	switch (iParam1)
	{
		case 0:
...
bool func_50(int iParam0, var uParam1, var uParam2) // Position - 0xCCEA
{
	switch (iParam0)
	{
		case 11:
...
char* func_51(int iParam0) // Position - 0xD659
{
	switch (iParam0)
	{
...
void func_52() // Position - 0xD6EC
{
	if (!ENTITY::IS_ENTITY_DEAD(Static_71, 0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Static_71, 1))
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&Static_71);

	if (!ENTITY::IS_ENTITY_DEAD(Static_73, 0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Static_73, 1))
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&Static_73);

	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Static_72, 0);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Static_72);
