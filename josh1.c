...
void main() // Position - 0x0
{
	...
	Static_30 = 180f;
	Static_33 = 3;
	Static_78 = func_352(58);
	Static_79 = joaat("FELON2");
	Static_148 = { -1106.999f, 288.96f, 63.4f };
	Static_151 = { 0f, 0f, 12.06f };
	...
	if (func_315())
	{
		...
		while (!func_303(&Static_81))
		{
			BUILTIN::WAIT(0);
		}
	
		func_302(&Static_81, 0, true);
		Global_80551 = false;
	}

	if (func_301(PLAYER::PLAYER_PED_ID()))
		Static_326 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());

	if (func_300(Static_81.f_28[0]))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Static_81.f_28[0], Static_326);
	...
	while (true)
	{
		...
		BUILTIN::WAIT(0);
		func_284(Static_81.f_9, 0, 0, 0, 0, 0);
...
void func_1() // Position - 0x17C
{
	...
	{
		case 0:
			func_249("Doing setup for leadout");
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && STREAMING::HAS_MODEL_LOADED(joaat("P_AMB_PHONE_01")))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(Static_145))
				{
					...
					Static_145 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("PROP_LRGGATE_01C_L"), 1, 0, 1);
				}
		...
		case 1:
			if (Static_156 == 1)
			{
				func_249("Skip detected, waiting 500ms...");
			
				if (MISC::GET_GAME_TIMER() - Static_157 >= 500)
				{
					func_237(1, 1, 1);
					Static_156 = 0;
				}
			...
			if (!Static_158)
			{
				if (func_301(Static_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Static_145))
				{
					Static_147 = PED::CREATE_SYNCHRONIZED_SCENE(Static_148, Static_151, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(Static_81.f_28[0], Static_147, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Static_145, Static_147, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
					ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(Static_145);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Static_81.f_28[0], 1, 0);
					func_249("Done Josh leadout anim");
					Static_158 = true;
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Static_147))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Static_147) > 0.29f)
				{
					if (!Static_159)
					{
						func_236(&Static_161, 2, PLAYER::PLAYER_PED_ID(), "Trevor" /* GXT: Trevor */, 0, 1);
						func_236(&Static_161, 5, Static_81.f_28[0], "Josh", 0, 1);
					
						if (func_220(&Static_161, "JOSH1AU", "JOSH1_OUT", 8, 0, 0, 0))
						{
							func_249("Leadout convo done");
							Static_159 = true;
						}
					}
				}
			
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Static_147) > 0.98f)
				{
					func_249("Leadout done, end mission");
					Static_143 = 2;
				}
			
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.1068f, 290.4275f, 62.9487f, -1102.038f, 291.34207f, 66.278946f, 2f, 0, 1, 0))
				{
					func_249("Too close, stopping scene");
				
					if (func_300(Static_81.f_28[0]))
					{
						TASK::CLEAR_PED_TASKS(Static_81.f_28[0]);
						func_249("Stopping Josh?");
					}
				
					if (ENTITY::DOES_ENTITY_EXIST(Static_145))
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Static_145, -8f, 1);
				
					Static_160 = 1;
				}
			
				if (func_219(Static_81.f_28[0], PLAYER::PLAYER_PED_ID(), 1) > 17.5f)
				{
					if (func_300(Static_81.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Static_81.f_28[0], -8f, 1);
						TASK::CLEAR_PED_TASKS(Static_81.f_28[0]);
					}
				...
				if (PED::IS_PED_INJURED(Static_81.f_28[0]) || FIRE::IS_ENTITY_ON_FIRE(Static_81.f_28[0]) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Static_81.f_28[0], 1), 5f))
				{
					if (func_300(Static_81.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Static_81.f_28[0], -8f, 1);
			...
			{
				func_249("Leadout ended early, end mission");
				Static_143 = 2;
			}
			break;
	
		case 2:
			func_302(&Static_81, 0, false);
			...
			if (func_300(Static_81.f_28[0]))
			{
				...
				TASK::TASK_PERFORM_SEQUENCE(Static_81.f_28[0], Static_144);
				TASK::CLEAR_SEQUENCE_TASK(&Static_144);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_81.f_28[0], 0);
			
				if (Static_160 == 0)
					PED::FORCE_PED_MOTION_STATE(Static_81.f_28[0], joaat("MOTIONSTATE_WALK"), 0, 0, 1);
			}
			...
			if (Static_160 == 0)
			{
				...
				func_249("Josh 4: PROP_LRGGATE_01c_L - Closed");
			}
...
bool func_5(bool bParam0) // Position - 0x7FD
{
...
void func_10(int iParam0, int iParam1, bool bParam2) // Position - 0xE25
{
	if (bParam2 == -1)
		bParam2 = func_11();
...
void func_22(int iParam0) // Position - 0x1006
{
	int iVar0;
	int iVar1;
...
bool func_32(int iParam0, int iParam1, bool bParam2) // Position - 0x18F6
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool func_33(int iParam0, int iParam1, var uParam2) // Position - 0x1AB3
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1B8F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(int iParam0, int iParam1, bool bParam2) // Position - 0x23A0
{
	bool bVar0;
	int iVar1;
...
bool func_37(int iParam0, int iParam1, bool bParam2) // Position - 0x242A
{
	if (iParam0 == joaat("PLAYER_ZERO"))
		if (iParam1 == 4)
...
bool func_38(int iParam0, int iParam1, bool bParam2) // Position - 0x2508
{
	Global_80088[1 /*14*/] = { func_85(iParam0, iParam1, bParam2, -1) };
	return IS_BIT_SET(Global_80088[1 /*14*/].f_6, 2);
}

bool func_39(int iParam0, bool bParam1, int iParam2, bool bParam3, var uParam4, int iParam5) // Position - 0x2530
{
	var uVar0;
	int iVar10;
...
bool func_40(int iParam0, int iParam1, bool bParam2) // Position - 0x2B34
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_41(var uParam0, int iParam1, int iParam2) // Position - 0x2BCD
{
	bool bVar0;
	bool bVar1;
...
int func_42(int iParam0, int iParam1, bool bParam2, var uParam3) // Position - 0x2C6E
{
	int iVar0;
...
bool func_43(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5) // Position - 0x2F75
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_44(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) // Position - 0x3B28
{
	int iVar0;
...
bool func_45(int iParam0, bool bParam1, bool bParam2, int iParam3) // Position - 0x3E0C
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x40D5
{
	bool bVar0;
	bool bVar1;
...
bool func_47(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x410C
{
	bool bVar0;
...
bool func_48(int iParam0, bool bParam1, var uParam2) // Position - 0x4135
{
	*uParam2 = -99;
...
int func_49(int iParam0, int iParam1, bool bParam2, var uParam3) // Position - 0x43FF
{
	int iVar0;
...
bool func_50(int iParam0, bool bParam1, bool bParam2) // Position - 0x4689
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
void func_51(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x47E0
{
	bool bVar0;
...
bool func_52(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x487A
{
	switch (iParam0)
	{
...
int func_53(int iParam0, bool bParam1, int iParam2, int iParam3) // Position - 0x4948
{
	var uVar0;
	int iVar17;
	int iVar18;
...
bool func_56(var uParam0, bool bParam1, bool bParam2, int iParam3) // Position - 0x4E6A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_61(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x5244
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_62(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x54C1
{
	if (iParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
bool func_63(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x58E6
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_64(var uParam0, int iParam1) // Position - 0x5BD9
{
	int iVar0;
	var uVar1;
...
bool func_65(var uParam0, int iParam1) // Position - 0x5C20
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void func_68(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) // Position - 0x5D83
{
	bool bVar0;
	var uVar1;
	int iVar2;
...
void func_69(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x5DCB
{
	int iVar0;
...
int func_70(int iParam0, bool bParam1) // Position - 0x5DF9
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(bParam1));
}

bool func_71(bool bParam0) // Position - 0x5E0E
{
	bool bVar0;
	bool bVar1;
...
int func_72(int iParam0, bool bParam1) // Position - 0x5E42
{
	var uVar0;
	int iVar1;
...
bool func_73(bool bParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5) // Position - 0x5E71
{
	int iVar0;
...
bool func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8B0D
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_75(int iParam0) // Position - 0x99B0
{
	if (!IS_BIT_SET(Global_80088[1 /*14*/].f_6, 0))
		return false;
...
bool func_76(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x99F8
{
	int iVar0;
...
int func_77(int iParam0) // Position - 0x9AA3
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(int iParam0, bool bParam1) // Position - 0x9B53
{
	int iVar0;
	var uVar1;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA482
{
	int iVar0;
	var uVar1;
	int iVar16;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA5AC
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_81(int iParam0, bool bParam1) // Position - 0xA5F4
{
	int iVar0;
	var uVar1;
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC43E
{
	int iVar0;
	var uVar1;
	int iVar16;
...
int func_83(int iParam0) // Position - 0xC628
{
	switch (iParam0)
	{
		case 0:
...
void func_84(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC6D8
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = bParam3;
...
struct<14> func_85(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0xC749
{
	func_149();
...
void func_86(int iParam0, int iParam1) // Position - 0xC79B
{
	switch (iParam0)
	{
		case 0:
...
void func_87(int iParam0) // Position - 0xC88B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10) // Position - 0xDB02
{
	int iVar0;
	int iVar1;
...
bool func_89(int iParam0, int iParam1, var uParam2) // Position - 0xDEA4
{
	*uParam2 = 979;
...
int func_90(int iParam0, int iParam1) // Position - 0xE2A9
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1) // Position - 0xE6A4
{
	switch (iParam1)
	{
		case 0:
...
bool func_92(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) // Position - 0xEA9F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_93(int iParam0) // Position - 0xEADD
{
	return Global_44886 == iParam0;
}

int func_94(int iParam0) // Position - 0xEAEB
{
	switch (iParam0)
	{
		case -1:
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xEBBF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_96(int iParam0) // Position - 0xEE46
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_97(int iParam0) // Position - 0xEF9D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_98(int iParam0) // Position - 0xF4AB
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_99(int iParam0) // Position - 0xF520
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_100(int iParam0) // Position - 0xF594
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_101(int iParam0) // Position - 0xF67B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_102(int iParam0) // Position - 0xF9DE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_103(int iParam0) // Position - 0xFBEF
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_104(int iParam0) // Position - 0xFE1F
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_105(int iParam0) // Position - 0xFF2F
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
bool func_150(int iParam0, int iParam1, bool bParam2) // Position - 0x20107
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_153(int iParam0) // Position - 0x203C2
{
...
void func_160(int iParam0, bool bParam1) // Position - 0x209F6
{
...
char* func_169(int iParam0) // Position - 0x221C4
{
	iParam0 = iParam0;
	return "";
}
...
bool func_204(var uParam0) // Position - 0x2770D
{
	int iVar0;
...
void func_208(int iParam0) // Position - 0x278DF
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (bParam2)
		{
			if (!Global_80305)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_10156[iParam1 /*4*/] = { func_212(iParam0) };
					...
					{
						Global_10107[1 /*6*/] = { func_212(iParam0) };
...
bool func_225(int iParam0, int iParam1) // Position - 0x281FC
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_226(int iParam0) // Position - 0x28214
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_227() // Position - 0x28226
{
	return -1;
}

void func_228() // Position - 0x2822F
{
	int iVar0;
...
void func_229() // Position - 0x28261
{
...
bool func_230() // Position - 0x282F6
{
...
bool func_231() // Position - 0x2831D
{
	int iVar0;
	int iVar1;
...
void func_232() // Position - 0x283B6
{
	int iVar0;
...
bool func_233(int iParam0, int iParam1) // Position - 0x2840E
{
	switch (iParam0)
	{
		case 5:
...
void func_234() // Position - 0x28446
{
...
void func_235(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2849D
{
...
void func_236(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x284F3
{
...
void func_237(int iParam0, int iParam1, int iParam2) // Position - 0x2858E
{
	func_239(0, 0, iParam2, 1);
...
void func_238(int iParam0, bool bParam1) // Position - 0x285C2
{
...
void func_239(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x285FE
{
	var uVar0;
	...
	func_240(false, true, false, 0, false, false, false);
...
void func_240(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6) // Position - 0x286A8
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_245(PLAYER::PLAYER_ID()) && !func_242(PLAYER::PLAYER_ID(), 0) && !func_241() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0, 0);
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_245(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5)
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0, 0);
...
bool func_241() // Position - 0x287F7
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

bool func_242(int iParam0, int iParam1) // Position - 0x28811
{
	bool bVar0;
...
bool func_243(bool bParam0, bool bParam1) // Position - 0x2886A
{
	bool bVar0;
	bool bVar1;
...
bool func_244(int iParam0) // Position - 0x288AB
{
	int iVar0;
...
bool func_245(int iParam0) // Position - 0x288CD
{
...
bool func_246() // Position - 0x2890C
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_247(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x2891A
{
	int iVar0;
...
void func_248(int iParam0) // Position - 0x2894D
{
	if (iParam0 == 1)
...
void func_249(char* sParam0) // Position - 0x28970
{
	sParam0 = sParam0;
}

void func_250() // Position - 0x2897C
{
	var uVar0;
	var uVar1;
	float fVar4;
	...
	{
		func_249("Trying to set Josh component variation");
	
		if (func_300(Static_81.f_28[0]))
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Josh", Static_81.f_28[0], 0);
	}

	switch (Static_143)
	{
		case 0:
			if (func_266(1, 1093140480, 0))
			{
				STREAMING::REQUEST_ANIM_DICT("rcmjosh1@impatient");
				VEHICLE::REQUEST_VEHICLE_RECORDING(500, "Josh1Driveaway");
			
				if (func_300(Static_81.f_28[0]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_81.f_28[0], "Josh", 0, 0, 0);
			
				if (func_300(PLAYER::PLAYER_PED_ID()))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Trevor" /* GXT: Trevor */, 0, 0, 0);
			
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(-1140.8501f, 263.47137f, 63.357758f, -1205.4403f, 412.15738f, 78.258896f, 43.75f, 0, 0, 1);
				MISC::CLEAR_AREA_OF_VEHICLES(-1146.306f, 295.98312f, 66.136116f, 9f, 0, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1143.2444f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1152.426f, 313.61572f, 67.104294f, 12f, 0, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1165.9656f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_AREA_OF_VEHICLES(-1178.7288f, 346.45724f, 70.046745f, 12f, 0, 0, 0, 0, 0, 0, 0);
				MISC::CLEAR_ANGLED_AREA_OF_VEHICLES(-1140.8501f, 263.47137f, 63.357758f, -1205.4403f, 412.15738f, 78.258896f, 43.75f, 0, 0, 0, 0, 0, 0, 0);
				uVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
			
				if (func_265(uVar0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0, -1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, 0, 1, 0))
					{
						uVar1 = { -1098.87f, 280.88f, 63.47f };
						fVar4 = 85.98f;
					}
					else
					{
				...
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("PROP_LRGGATE_01C_L"), 0))
				{
					func_249("Locked left gate open?");
					OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("PROP_LRGGATE_01C_L"), -1107.01f, 289.38f, 64.76f, 1, 90f, 0);
				}
			
				func_255(-1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, uVar1, fVar4, 3f, 6f, 3f, true, true, true, false, false);
				func_252(-1104.93f, 291.25f, 64.3f, 1, 1, 1, 1, 1, true, true, true, 1, true);
				Static_143 = 1;
			}
			break;
		...
		case 1:
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor" /* GXT: Trevor */, 0))
			{
				...
				func_249("Done Trevor exit");
			}
		
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				func_249("Exit state for Josh...");
			
				if (!Static_158)
				{
					func_249("Played lead-out on Josh exit state");
					func_251(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, false, 1);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					{
						Static_147 = PED::CREATE_SYNCHRONIZED_SCENE(Static_148, Static_151, 2);
						TASK::TASK_SYNCHRONIZED_SCENE(Static_81.f_28[0], Static_147, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Static_145, Static_147, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						func_249("Done Josh leadout anim on Josh exit state");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(Static_145);
						PED::FORCE_PED_MOTION_STATE(Static_81.f_28[0], joaat("MOTIONSTATE_IDLE"), 0, 1, 1);
						Static_158 = true;
					}
				}
			}
			...
			{
				func_249("Exit state for camera...");
			
				if (!Static_158)
				{
					func_249("Played lead-out on camera exit state");
					func_251(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, false, 1);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					if (func_301(Static_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Static_145))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(Static_81.f_28[0], Static_147, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Static_145, Static_147, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						func_249("Done Josh leadout anim on cam exit state cutscene");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(Static_145);
						PED::FORCE_PED_MOTION_STATE(Static_81.f_28[0], joaat("MOTIONSTATE_IDLE"), 0, 1, 1);
						Static_158 = true;
					}
			...
			{
				func_249("cutscene not active...");
			
				if (!Static_158)
				{
					func_249("Played lead-out on not cutscene active");
					func_251(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, false, 1);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					{
						Static_147 = PED::CREATE_SYNCHRONIZED_SCENE(Static_148, Static_151, 2);
						TASK::TASK_SYNCHRONIZED_SCENE(Static_81.f_28[0], Static_147, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Static_145, Static_147, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						func_249("Done Josh leadout anim on non active cutscene");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(Static_145);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Static_81.f_28[0], 0, 0);
						Static_158 = true;
					}
				}
...
bool func_251(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, bool bParam5, int iParam6) // Position - 0x29003
{
	bool bVar0;
	float fVar1;
...
void func_252(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12) // Position - 0x2905F
{
	var uVar0;
...
Vector3 func_253(var uParam0) // Position - 0x2921D
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

void func_254(bool bParam0) // Position - 0x29230
{
	var uVar0;
	...
	func_240(true, true, false, 0, false, false, false);
}

void func_255(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18) // Position - 0x2926F
{
	func_256(fParam0, fParam3, fParam6, uParam7, fParam10, fParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_256(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18) // Position - 0x29299
{
	var uVar0;
	bool bVar1;
	bool bVar2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				if (uVar10.f_2 > uParam0.f_2 && uVar10.f_2 < uParam3.f_2 || uVar10.f_2 > uParam3.f_2 && uVar10.f_2 < uParam0.f_2)
					if (func_260(uVar0, uParam0, uParam3, fParam6))
						bVar1 = true;
			}
			...
			if (bParam16)
				if (func_258(uVar0, func_218(), true))
					bVar1 = false;
		
			if (bVar1)
			{
				if (!func_257(fParam11))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
					{
...
bool func_257(float fParam0, var uParam1, var uParam2) // Position - 0x2968F
{
...
bool func_258(var uParam0, int iParam1, bool bParam2) // Position - 0x296B9
{
	int iVar0;
	var uVar1;
	int iVar9;
	...
	for (iVar0 = 0; func_259(iParam1, iVar0, &uVar1, &iVar9); iVar0 = iVar0 + 1)
	{
...
bool func_259(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x29727
{
...
bool func_260(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29800
{
	float fVar0;
	var uVar3;
	var uVar6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		fVar0 = { func_262(uParam1 - uParam4) };
		uVar3 = { fVar0 };
		uVar18 = 4;
		fVar0 = -uVar3.f_1;
		fVar0.f_1 = uVar3;
		...
		if (func_261(uVar18[0 /*3*/], uVar18[1 /*3*/], uVar6, uVar9) || func_261(uVar18[0 /*3*/], uVar18[1 /*3*/], uVar9, uVar15) || func_261(uVar18[0 /*3*/], uVar18[1 /*3*/], uVar12, uVar15) || func_261(uVar18[0 /*3*/], uVar18[1 /*3*/], uVar6, uVar12) || func_261(uVar18[1 /*3*/], uVar18[3 /*3*/], uVar6, uVar9) || func_261(uVar18[1 /*3*/], uVar18[3 /*3*/], uVar9, uVar15) || func_261(uVar18[1 /*3*/], uVar18[3 /*3*/], uVar12, uVar15) || func_261(uVar18[1 /*3*/], uVar18[3 /*3*/], uVar6, uVar12) || func_261(uVar18[3 /*3*/], uVar18[2 /*3*/], uVar6, uVar9) || func_261(uVar18[3 /*3*/], uVar18[2 /*3*/], uVar9, uVar15) || func_261(uVar18[3 /*3*/], uVar18[2 /*3*/], uVar12, uVar15) || func_261(uVar18[3 /*3*/], uVar18[2 /*3*/], uVar6, uVar12) || func_261(uVar18[2 /*3*/], uVar18[0 /*3*/], uVar6, uVar9) || func_261(uVar18[2 /*3*/], uVar18[0 /*3*/], uVar9, uVar15) || func_261(uVar18[2 /*3*/], uVar18[0 /*3*/], uVar12, uVar15) || func_261(uVar18[2 /*3*/], uVar18[0 /*3*/], uVar6, uVar12))
			return true;
	}
...
bool func_261(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x29AF6
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_262(float fParam0, var uParam1, var uParam2) // Position - 0x29BAA
{
	float fVar0;
	float fVar1;
...
void func_263(var uParam0) // Position - 0x29BE9
{
...
void func_264() // Position - 0x29C4E
{
	int iVar0;
...
bool func_265(var uParam0) // Position - 0x29C6E
{
	if (func_300(uParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
...
bool func_266(int iParam0, int iParam1, int iParam2) // Position - 0x29C98
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_272(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, true, false))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				...
				if (!func_271(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
...
bool func_267() // Position - 0x29D6C
{
	bool bVar0;
...
void func_268() // Position - 0x29D8F
{
	Global_21866 = 0;
	func_234();
}

bool func_269() // Position - 0x29D9F
{
...
void func_270() // Position - 0x29DC1
{
...
bool func_271(var uParam0, int iParam1) // Position - 0x29E12
{
	if (func_301(uParam0))
...
bool func_272(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) // Position - 0x29E45
{
	func_274(bParam5, bParam6);
	func_273(uParam0);
...
void func_273(var uParam0) // Position - 0x29E9C
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
...
void func_274(bool bParam0, bool bParam1) // Position - 0x29EC8
{
...
void func_275() // Position - 0x2A019
{
	func_276();
	...
	{
		case 0:
			if (!func_5(false) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.0707f, 279.6581f, 62.421844f, -1092.4285f, 284.13983f, 67.31652f, 15.75f, 0, 1, 0))
			{
				func_249("Doing setup for leadin");
				func_236(&Static_161, 2, PLAYER::PLAYER_PED_ID(), "Trevor" /* GXT: Trevor */, 0, 1);
				func_236(&Static_161, 5, Static_81.f_28[0], "Josh", 0, 1);
				STREAMING::REQUEST_ANIM_DICT("rcmjosh1leadinout");
			...
			{
				func_249("Skipping setup for leadin (wrong area)");
				STREAMING::REQUEST_ANIM_DICT("rcmjosh1leadinout");
		...
		case 1:
			if (!func_5(false))
			{
				if (!Static_154)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.0707f, 279.6581f, 62.421844f, -1092.4285f, 284.13983f, 67.31652f, 15.75f, 0, 1, 0))
					{
						if (func_301(Static_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Static_145))
						{
							Static_146 = PED::CREATE_SYNCHRONIZED_SCENE(Static_148, Static_151, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(Static_81.f_28[0], Static_146, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Static_145, Static_146, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
							TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_81.f_28[0], -1, 0, 2);
							TASK::TASK_LOOK_AT_ENTITY(Static_81.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, 2060, 2);
							func_249("Done Josh leadin anim");
							Static_154 = true;
						}
					}
					else
					{
						if (!func_5(false) && !Static_154)
						{
							func_249("Cannot play lead-in, re-requesting cutscene with new sections");
							CUTSCENE::REMOVE_CUTSCENE();
							CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("JOSH_1_INT_CONCAT", 13, 8);
						}
					
						func_249("Replay in progress, skipping leadin");
						Static_143 = 2;
					}
				}
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Static_146))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Static_146) > 0.15f)
					{
						if (!Static_155)
						{
							if (func_220(&Static_161, "JOSH1AU", "JOSH1_LEADIN", 8, 0, 0, 0))
							{
								func_249("Leadin convo done");
								Static_155 = true;
							}
						}
					}
				
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Static_146) > 0.9f)
					{
						func_249("Leadin anim done, launch cutscene");
						Static_143 = 2;
					}
				
					if (func_219(PLAYER::PLAYER_PED_ID(), Static_81.f_28[0], 1) <= 2.5f)
					{
				...
				{
					func_249("Leadin not playing, launch cutscene");
					Static_143 = 2;
				}
			}
			else
...
void func_276() // Position - 0x2A3A9
{
	func_278(0);
	func_270();
	func_277();
...
void func_277() // Position - 0x2A3BE
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			if (func_272(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, true, false))
				if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) != 1)
					TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}

void func_278(int iParam0) // Position - 0x2A416
{
	if (func_283())
		return;
...
void func_279(int iParam0) // Position - 0x2A449
{
	if (func_283())
		return;
...
void func_280(bool bParam0, bool bParam1) // Position - 0x2A4D3
{
	if (bParam0)
	{
		if (func_282(0))
...
bool func_281() // Position - 0x2A547
{
	return IS_BIT_SET(Global_1964705, 5);
}

bool func_282(int iParam0) // Position - 0x2A555
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
bool func_283() // Position - 0x2A5AC
{
	return IS_BIT_SET(Global_1964705, 19);
}

void func_284(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2A5BB
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_80560 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				uVar4 = { func_286(Global_80561, Global_80563, iParam10) };
				fVar7 == -0.014f;
...
float func_285(var uParam0) // Position - 0x2A8A0
{
...
struct<2> func_286(int iParam0, int iParam1, int iParam2) // Position - 0x2A8B3
{
	var uVar0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					uVar0 = { func_293(iParam2) };
					break;
			
				case 8:
					uVar0 = { func_292(iParam2) };
					break;
			
				case 7:
					uVar0 = { func_291(iParam2) };
					break;
			
				case 10:
					uVar0 = { func_290(iParam2) };
					break;
			
				case 5:
					uVar0 = { func_289(iParam2) };
					break;
			
				case 4:
					uVar0 = { func_288(iParam2) };
					break;
			
				default:
					TEXT_LABEL_ASSIGN_STRING(&uVar0, func_287(iVar2), 8);
					break;
			}
			break;
...
char* func_287(int iParam0) // Position - 0x2A98A
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_288(int iParam0) // Position - 0x2AADD
{
	var uVar0;
	var uVar2;
...
struct<2> func_289(int iParam0) // Position - 0x2AB11
{
	var uVar0;
	var uVar2;
...
struct<2> func_290(int iParam0) // Position - 0x2AB45
{
	var uVar0;
	var uVar2;
...
struct<2> func_291(int iParam0) // Position - 0x2AB79
{
	var uVar0;
	var uVar2;
...
struct<2> func_292(int iParam0) // Position - 0x2ABAD
{
	var uVar0;
	var uVar2;
...
struct<2> func_293(int iParam0) // Position - 0x2ABEB
{
	var uVar0;
	var uVar2;
...
struct<2> func_294(int iParam0) // Position - 0x2AC1F
{
	var uVar0;
...
bool func_295(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2AC88
{
	if (!func_297(0) || Global_80576 || Global_80564 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
	...
	switch (Global_80560)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_282(0) || func_296(true))
			{
			}
			else
			{
...
bool func_296(bool bParam0) // Position - 0x2ADA0
{
	if (bParam0)
...
bool func_297(int iParam0) // Position - 0x2ADC9
{
	if (Global_44886 == 15)
		return false;
...
bool func_298(int iParam0) // Position - 0x2ADEB
{
	return func_299(iParam0, Global_44886);
}

bool func_299(int iParam0, int iParam1) // Position - 0x2ADFC
{
	if (iParam1 == 15)
		return 1;
...
bool func_300(var uParam0) // Position - 0x2AFDD
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
			return true;
...
bool func_301(var uParam0) // Position - 0x2AFFE
{
	if (func_300(uParam0))
		if (!PED::IS_PED_INJURED(uParam0))
			return true;
...
void func_302(var uParam0, int iParam1, bool bParam2) // Position - 0x2B01E
{
	int iVar0;

	for (iVar0 = 0; iVar0 < 6; iVar0 = iVar0 + 1)
	{
		if (func_300(uParam0->f_28[iVar0]))
...
bool func_303(var uParam0) // Position - 0x2B114
{
	int iVar0;
	int iVar3;
	bool bVar4;
	...
	switch (Static_77)
	{
		case 0:
			...
			func_314(&(uParam0->f_48), "rcmjosh1", "idle", 0);
			Static_77 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_308(&uParam0->f_28[0], 58, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
					bVar4 = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_305(&uParam0->f_35[0], true);
		
			if (!func_304(true, true))
				bVar4 = false;
...
bool func_304(bool bParam0, bool bParam1) // Position - 0x2B281
{
	int iVar0;
...
void func_305(var uParam0, bool bParam1) // Position - 0x2B2EF
{
	var uVar0;
	float fVar3;
	...
	func_306(uParam0, Static_79, uVar0, fVar3);
...
void func_306(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x2B363
{
	func_307(uParam0);
...
void func_307(var uParam0) // Position - 0x2B3A6
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
bool func_308(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B442
{
	if (func_309(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
bool func_309(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, bool bParam6) // Position - 0x2B49E
{
	int iVar0;
...
int func_310(int iParam0, int iParam1) // Position - 0x2B52C
{
	int iVar0;
...
bool func_311(var uParam0) // Position - 0x2B572
{
	if (func_312(uParam0))
	{
...
bool func_312(var uParam0) // Position - 0x2B59C
{
...
bool func_313(var uParam0) // Position - 0x2B5C1
{
	int iVar0;
...
void func_314(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x2B5F2
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
bool func_315() // Position - 0x2B62E
{
...
void func_316() // Position - 0x2B652
{
	func_264();

	if (func_329())
		func_249("...Random Character Script was triggered so additional cleanup required");

	func_328(&Static_81.f_28[0], 1, 1, 1);
	func_317(&Static_81, 1, false, false);
...
void func_317(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x2B6DC
{
...
void func_318(var uParam0, bool bParam1) // Position - 0x2B6FC
{
	func_319(&(uParam0->f_41), bParam1);
}

void func_319(var uParam0, bool bParam1) // Position - 0x2B70E
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 <= *uParam0 - 1; iVar0 = iVar0 + 1)
	{
		if (bParam1)
			...
			func_320(&uParam0->[iVar0], false);
	}
}

void func_320(var uParam0, bool bParam1) // Position - 0x2B74C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_321(var uParam0) // Position - 0x2B787
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_322(var uParam0, bool bParam1) // Position - 0x2B7B2
{
	func_323(&(uParam0->f_35), bParam1);
}

void func_323(var uParam0, bool bParam1) // Position - 0x2B7C4
{
	int iVar0;
...
void func_324(var uParam0) // Position - 0x2B801
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_325(var uParam0, int iParam1) // Position - 0x2B839
{
	func_326(&(uParam0->f_28), iParam1);
}

void func_326(var uParam0, int iParam1) // Position - 0x2B84B
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 <= *uParam0 - 1; iVar0 = iVar0 + 1)
	{
		if (iParam1 == 1)
			...
			func_328(&uParam0->[iVar0], 0, 1, 0);
	}
}

void func_327(var uParam0) // Position - 0x2B88C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
void func_328(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B8CD
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!PED::IS_PED_INJURED(*uParam0))
...
bool func_329() // Position - 0x2B91D
{
	int iVar0;
...
void func_330(bool bParam0) // Position - 0x2B9BE
{
	int iVar0;
	...
	if (!func_347())
	{
		...
		{
			func_162(iVar0, 1, 0);
			func_331(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_114018[iVar0 /*10*/].f_9 == -1)
...
void func_331(char* sParam0, int iParam1) // Position - 0x2BA8E
{
	if (Global_102454 != 12)
...
bool func_332(char* sParam0, int iParam1, int iParam2) // Position - 0x2BAB6
{
	var uVar0;
	var uVar1;
	int iVar33;
...
int func_333(char* sParam0) // Position - 0x2BC45
{
...
int func_334() // Position - 0x2BC9B
{
	int iVar0;
	int iVar1;

	iVar0 = func_335(&(Global_102454.f_3), false);
	iVar1 = 0;
...
int func_335(char* sParam0, bool bParam1) // Position - 0x2BCBF
{
	var uVar0;
	int iVar1;

	uVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_336(uVar0, true);
	iVar1 == -1 && !bParam1;
	return iVar1;
}

int func_336(var uParam0, bool bParam1) // Position - 0x2BCE9
{
	int iVar0;
...
bool func_337() // Position - 0x2BD1F
{
...
bool func_338() // Position - 0x2BD6F
{
...
void func_339(int iParam0) // Position - 0x2BDDB
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_340(int iParam0) // Position - 0x2BDEF
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_341(int iParam0) // Position - 0x2BE29
{
	if (iParam0 == 1)
	{
...
void func_342() // Position - 0x2BE63
{
	Global_24407.f_5 = 1;
}

void func_343() // Position - 0x2BE71
{
	Global_24407.f_5 = 0;
}

void func_344(bool bParam0) // Position - 0x2BE7F
{
	if (bParam0)
	{
		func_345();
...
void func_345() // Position - 0x2BEE2
{
...
void func_346() // Position - 0x2BF0B
{
	Global_96605 = 0;
	Global_96606 = false;
}

bool func_347() // Position - 0x2BF1D
{
...
void func_348() // Position - 0x2BF5B
{
	Global_102489 = 1;
...
void func_349(char* sParam0) // Position - 0x2C04B
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

void func_350(var uParam0) // Position - 0x2C05D
{
...
void func_351(var uParam0) // Position - 0x2C07D
{
	int iVar0;
...
int func_352(int iParam0) // Position - 0x2C0B7
{
	if (!func_154(iParam0))
		return func_153(iParam0);
	else
