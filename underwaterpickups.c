...
void main() // Position - 0x0
{
	...
	func_24(uVar0);
	Static_24 = func_4();
	Static_25 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0) };
	func_1();
...
void func_1() // Position - 0x5C
{
	...
	{
		if (func_3(iVar0, &iVar1, &uVar2, &uVar5, &uVar9))
		{
			if (func_2(uVar5, 0f, 0f, 0f, false))
			{
				iVar8 = 0;
				...
				if (iVar1 == joaat("PICKUP_MONEY_CASE"))
					if (Static_24)
						Static_3[iVar0] = OBJECT::CREATE_PICKUP(iVar1, uVar2, iVar8, uVar9, 1, 0);
				else if (BUILTIN::VDIST2(uVar2, Static_25) > 400f)
					if (iVar1 == joaat("PICKUP_ARMOUR_STANDARD"))
						...
						if (Static_24)
							Static_3[iVar0] = OBJECT::CREATE_PICKUP(iVar1, uVar2, iVar8, -1, 1, 0);
					else
						Static_3[iVar0] = OBJECT::CREATE_PICKUP(iVar1, uVar2, iVar8, -1, 1, 0);
			}
			else
			{
				...
				if (iVar1 == joaat("PICKUP_MONEY_CASE"))
					if (Static_24)
						Static_3[iVar0] = OBJECT::CREATE_PICKUP_ROTATE(iVar1, uVar2, uVar5, iVar8, 10000, 2, 1, 0);
				else if (BUILTIN::VDIST2(uVar2, Static_25) > 400f)
					if (iVar1 == joaat("PICKUP_ARMOUR_STANDARD"))
						Static_3[iVar0] = OBJECT::CREATE_PICKUP_ROTATE(iVar1, uVar2, uVar5, iVar8, -1, 2, 1, 0);
					else if (iVar1 == joaat("PICKUP_WEAPON_GRENADELAUNCHER") || iVar1 == joaat("PICKUP_WEAPON_RPG") || iVar1 == joaat("PICKUP_WEAPON_MG"))
						if (Static_24)
							Static_3[iVar0] = OBJECT::CREATE_PICKUP_ROTATE(iVar1, uVar2, uVar5, iVar8, -1, 2, 1, 0);
					else
...
void func_15(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1B49
{
	...
	for (iVar6 = func_14(iVar1, iVar0); iVar2 > iVar6; iVar6 = func_14(iVar1, iVar0))
	{
		iVar1 = iVar1 + 1;
		iVar2 = iVar2 - iVar6;
...
void func_24(var uParam0, var uParam1, var uParam2) // Position - 0x1F04
{
	...
	uVar0 = 12;
	uVar0[0 /*3*/] = { -1029f, 6517f, -21f };
	uVar0[1 /*3*/] = { 3265f, 6407f, -47f };
	uVar0[2 /*3*/] = { 4215f, 3603f, -48f };
	uVar0[3 /*3*/] = { -3247f, 3669f, -28f };
	uVar0[4 /*3*/] = { -3192f, 3029f, -35f };
	uVar0[5 /*3*/] = { -2838f, -446f, -38f };
	uVar0[6 /*3*/] = { 3156f, -307f, -17f };
	uVar0[7 /*3*/] = { 2695f, -1334f, -26f };
	uVar0[8 /*3*/] = { 264f, -2280f, -8f };
	uVar0[9 /*3*/] = { 1804f, -2993f, -46f };
	uVar0[10 /*3*/] = { -131f, -2867f, -10f };
	uVar0[11 /*3*/] = { 3595f, 3041f, -15f };

	for (iVar37 = 0; iVar37 <= 12 - 1; iVar37 = iVar37 + 1)
	{
		if (func_25(uParam0, uVar0[iVar37 /*3*/], 1056964608, false))
		{
			Static_2 = iVar37;
			return;
		}
...
void func_27() // Position - 0x20DE
{
	...
	for (iVar0 = 0; iVar0 < 20; iVar0 = iVar0 + 1)
	{
		if (OBJECT::DOES_PICKUP_EXIST(Static_3[iVar0]))
			OBJECT::REMOVE_PICKUP(Static_3[iVar0]);
	}
}
