...
void main() // Position - 0x0
{
	...
	Static_30 = 180f;
	Static_33 = 3;
	Static_78 = func_395(64);
	Static_79 = func_395(63);
	Static_80 = joaat("U_M_M_ALDINAPOLI");
	Static_81 = joaat("PREMIER");
	Static_94 = { ScriptArg_0 };
	func_393(&Static_94);
	...
	if (func_355())
	{
		...
		while (!func_345(&Static_94))
		{
			BUILTIN::WAIT(0);
		}
	
		func_344(&Static_94, 0, true);
		Global_80551 = false;
	}
	...
	while (true)
	{
		...
		func_325(Static_94.f_9, 0, 0, 0, 0, 0);
...
void func_1() // Position - 0x12C
{
	switch (Static_321)
	{
		case 0:
			Static_322 = false;
			func_233(&Static_155, 2, PLAYER::PLAYER_PED_ID(), "TREVOR" /* GXT: Trevor */, 0, 1);
			Static_321 = 1;
			break;
	
		case 1:
			if (!Static_322)
				Static_322 = func_217(&Static_155, "NIG1AAU", "NIG1A_COMM", 7, 0, 0, 0);
			else if (!func_216())
				Static_321 = 2;
			break;
...
bool func_5(bool bParam0) // Position - 0x336
{
...
void func_10(int iParam0, int iParam1, bool bParam2) // Position - 0x95E
{
	if (bParam2 == -1)
		bParam2 = func_11();
...
bool func_32(int iParam0, int iParam1, bool bParam2) // Position - 0x142A
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
bool func_33(int iParam0, bool bParam1, var uParam2) // Position - 0x15E7
{
	int iVar0;
...
int func_34(bool bParam0) // Position - 0x1688
{
	switch (bParam0)
	{
...
int func_35(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x16C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(bool bParam0, int iParam1, bool bParam2) // Position - 0x1ED4
{
	bool bVar0;
	int iVar1;
...
bool func_37(bool bParam0, int iParam1, bool bParam2) // Position - 0x1F5E
{
	if (bParam0 == joaat("PLAYER_ZERO"))
		if (iParam1 == 4)
...
bool func_38(bool bParam0, int iParam1, bool bParam2) // Position - 0x203C
{
	Global_80088[1 /*14*/] = { func_85(bParam0, iParam1, bParam2, -1) };
	return IS_BIT_SET(Global_80088[1 /*14*/].f_6, 2);
}

bool func_39(bool bParam0, bool bParam1, int iParam2, bool bParam3, var uParam4, int iParam5) // Position - 0x2064
{
	var uVar0;
	int iVar10;
...
bool func_40(int iParam0, int iParam1, bool bParam2) // Position - 0x2668
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_41(var uParam0, int iParam1, int iParam2) // Position - 0x2701
{
	bool bVar0;
	bool bVar1;
...
int func_42(bool bParam0, int iParam1, bool bParam2, var uParam3) // Position - 0x27A2
{
	int iVar0;
...
bool func_43(var uParam0, bool bParam1, int iParam2, bool bParam3, int iParam4, int iParam5) // Position - 0x2AA9
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_44(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) // Position - 0x365C
{
	int iVar0;
...
bool func_45(bool bParam0, bool bParam1, bool bParam2, int iParam3) // Position - 0x3940
{
	int iVar0;
...
bool func_46(bool bParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3C07
{
	bool bVar0;
	bool bVar1;
...
bool func_47(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x3C3E
{
	bool bVar0;
...
bool func_48(bool bParam0, bool bParam1, var uParam2) // Position - 0x3C67
{
	*uParam2 = -99;
...
int func_49(bool bParam0, int iParam1, bool bParam2, var uParam3) // Position - 0x3F31
{
	int iVar0;
...
bool func_50(bool bParam0, bool bParam1, bool bParam2) // Position - 0x41BC
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
void func_51(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x4313
{
	bool bVar0;
...
bool func_52(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x43AD
{
	switch (bParam0)
	{
...
int func_53(bool bParam0, bool bParam1, int iParam2, int iParam3) // Position - 0x447B
{
	var uVar0;
	int iVar17;
	int iVar18;
...
int func_54(bool bParam0, int iParam1) // Position - 0x4595
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_55(bool bParam0) // Position - 0x493C
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_56(var uParam0, bool bParam1, bool bParam2, int iParam3) // Position - 0x499D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_61(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x4D77
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_62(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x4FF4
{
	if (bParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
bool func_63(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x5419
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_64(var uParam0, int iParam1) // Position - 0x570C
{
	int iVar0;
	var uVar1;
...
bool func_65(var uParam0, int iParam1) // Position - 0x5753
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void func_68(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) // Position - 0x58B6
{
	bool bVar0;
	var uVar1;
	int iVar2;
...
void func_69(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x58FE
{
	int iVar0;
...
int func_70(int iParam0, bool bParam1) // Position - 0x592C
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(bParam1));
}

bool func_71(bool bParam0) // Position - 0x5941
{
	bool bVar0;
	bool bVar1;
...
int func_72(int iParam0, bool bParam1) // Position - 0x5975
{
	var uVar0;
	int iVar1;
...
bool func_73(bool bParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5) // Position - 0x59A4
{
	int iVar0;
...
bool func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x863F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_75(int iParam0) // Position - 0x94E2
{
	if (!IS_BIT_SET(Global_80088[1 /*14*/].f_6, 0))
		return false;
...
bool func_76(int iParam0, bool bParam1, var uParam2, int iParam3) // Position - 0x952A
{
	int iVar0;
...
int func_77(int iParam0) // Position - 0x95D5
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_78(bool bParam0, bool bParam1) // Position - 0x9685
{
	int iVar0;
	var uVar1;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9FB4
{
	int iVar0;
	var uVar1;
	int iVar16;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA0DE
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_81(bool bParam0, bool bParam1) // Position - 0xA126
{
	int iVar0;
	var uVar1;
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBF6E
{
	int iVar0;
	var uVar1;
	int iVar16;
...
int func_83(int iParam0) // Position - 0xC15D
{
	switch (iParam0)
	{
		case 0:
...
void func_84(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC20D
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = bParam3;
...
struct<14> func_85(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0xC27E
{
	func_149();
...
void func_86(int iParam0, int iParam1) // Position - 0xC2D0
{
	switch (iParam0)
	{
		case 0:
...
void func_87(int iParam0) // Position - 0xC3C0
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10) // Position - 0xD5ED
{
	int iVar0;
	int iVar1;
...
bool func_89(int iParam0, int iParam1, var uParam2) // Position - 0xD98E
{
	*uParam2 = 979;
...
int func_90(int iParam0, int iParam1) // Position - 0xDD93
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1) // Position - 0xE18E
{
	switch (iParam1)
	{
		case 0:
...
bool func_92(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) // Position - 0xE589
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_93(int iParam0) // Position - 0xE5C7
{
	return Global_44886 == iParam0;
}

int func_94(int iParam0) // Position - 0xE5D5
{
	switch (iParam0)
	{
		case -1:
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE6A9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_96(int iParam0) // Position - 0xE92F
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_97(int iParam0) // Position - 0xEA7C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_98(int iParam0) // Position - 0xEF89
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_99(int iParam0) // Position - 0xEFFD
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_100(int iParam0) // Position - 0xF070
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_101(int iParam0) // Position - 0xF157
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_102(int iParam0) // Position - 0xF499
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_103(int iParam0) // Position - 0xF6A1
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_104(int iParam0) // Position - 0xF8C1
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_105(int iParam0) // Position - 0xF9CA
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_106(int iParam0) // Position - 0x1035D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_108(int iParam0) // Position - 0x10EEA
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_109(int iParam0) // Position - 0x11AEE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_110(int iParam0) // Position - 0x129EE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_111(int iParam0) // Position - 0x12B1B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_112(int iParam0, int iParam1) // Position - 0x12C12
{
	switch (iParam0)
	{
		case 0:
...
void func_113(int iParam0) // Position - 0x12D02
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_114(int iParam0) // Position - 0x141D1
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_115(int iParam0) // Position - 0x14318
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_116(int iParam0) // Position - 0x14822
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_117(int iParam0) // Position - 0x14E8B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_118(int iParam0) // Position - 0x14EFE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_119(int iParam0) // Position - 0x14FCE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_120(int iParam0) // Position - 0x154C9
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_121(int iParam0) // Position - 0x1565A
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_122(int iParam0) // Position - 0x15E49
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_123(int iParam0) // Position - 0x15F52
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_124(int iParam0) // Position - 0x16E75
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_125(int iParam0) // Position - 0x17B22
{
	if (iParam0 < 107)
		func_128(iParam0);
	else if (iParam0 < 227)
...
void func_126(int iParam0) // Position - 0x17B68
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_127(int iParam0) // Position - 0x1860D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_128(int iParam0) // Position - 0x193FB
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_129(int iParam0) // Position - 0x1A03A
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_130(int iParam0) // Position - 0x1A2B2
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_131(int iParam0, int iParam1) // Position - 0x1A3EE
{
	switch (iParam0)
	{
		case 0:
...
void func_132(int iParam0) // Position - 0x1A4DE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_133(int iParam0) // Position - 0x1B23C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_134(int iParam0) // Position - 0x1B3AB
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_135(int iParam0) // Position - 0x1B91C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_136(int iParam0) // Position - 0x1BE44
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_137(int iParam0) // Position - 0x1BEB7
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_138(int iParam0) // Position - 0x1BF87
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
bool func_150(int iParam0, int iParam1, bool bParam2) // Position - 0x1F975
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int func_153(int iParam0) // Position - 0x1FC30
{
...
char* func_169(int iParam0) // Position - 0x2199D
{
	iParam0 = iParam0;
	return "";
}
...
bool func_204(var uParam0) // Position - 0x26E28
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_80305)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_10156[iParam1 /*4*/] = { func_209(iParam0) };
					...
					{
						Global_10107[1 /*6*/] = { func_209(iParam0) };
...
bool func_216() // Position - 0x27287
{
...
bool func_222(int iParam0, int iParam1) // Position - 0x27696
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_223(int iParam0) // Position - 0x276AE
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_224() // Position - 0x276C0
{
	return -1;
}

void func_225() // Position - 0x276C9
{
	int iVar0;
...
void func_226() // Position - 0x276FA
{
...
bool func_227() // Position - 0x2778F
{
...
bool func_228() // Position - 0x277B6
{
	int iVar0;
	int iVar1;
...
void func_229() // Position - 0x2784F
{
	int iVar0;
...
bool func_230(int iParam0, int iParam1) // Position - 0x278A6
{
	switch (iParam0)
	{
		case 5:
...
void func_231() // Position - 0x278DE
{
...
void func_232(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27935
{
...
void func_233(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2798B
{
...
void func_234() // Position - 0x27A26
{
		...
		case 1:
			switch (Static_324)
			{
				case 0:
					...
					{
						if (func_315(Static_94.f_28[0]))
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_94.f_28[0], "Nigel", 0, 0, 0);
					
						if (func_315(Static_94.f_28[1]))
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_94.f_28[1], "MRS_Thornhill", 0, 0, 0);
					
						func_314();
						RECORDING::REPLAY_START_EVENT(1);
						CUTSCENE::START_CUTSCENE(0);
						Static_324 = Static_324 + 1;
					}
					break;
				...
				case 1:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						func_257(-1107.0227f, 788.9111f, 163.0734f, 187.0703f, 0, 145);
					
						if (func_315(PLAYER::PLAYER_PED_ID()))
							MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 1, 1, 0, 0);
					
						func_254(-1098.9072f, 787.6641f, 163.0641f, 1, 1, 1, 1, 1, true, true, true, 1, true);
						func_253(500, false);
						Static_324 = Static_324 + 1;
					}
					break;
				...
				case 2:
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (!func_315(Static_94.f_35[0]))
							func_238(&Static_94.f_35[0], -1084.4558f, 787.2556f, 163.986f, 100.8542f, 0, 1);
					
						if (func_315(Static_94.f_35[0]))
						{
							func_237(Static_94.f_35[0], -1094.4845f, 785.5936f, 163.2927f, 102.2748f, false, 1);
							VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Static_94.f_35[0], 1084227584);
							VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(Static_94.f_35[0], 1);
						
							if (func_315(Static_94.f_28[0]))
							{
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Static_94.f_28[0], joaat("PLAYER"));
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(Static_94.f_28[0]);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_94.f_28[0], 1);
								PED::SET_PED_INTO_VEHICLE(Static_94.f_28[0], Static_94.f_35[0], -1);
								PED::SET_PED_KEEP_TASK(Static_94.f_28[0], 1);
							}
						
							if (func_315(Static_94.f_28[1]))
							{
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Static_94.f_28[1], joaat("PLAYER"));
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(Static_94.f_28[1]);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_94.f_28[1], 1);
								PED::SET_PED_INTO_VEHICLE(Static_94.f_28[1], Static_94.f_35[0], 0);
								PED::SET_PED_KEEP_TASK(Static_94.f_28[1], 1);
							}
						
							VEHICLE::SET_VEHICLE_ENGINE_ON(Static_94.f_35[0], 1, 1, 0);
							TASK::TASK_VEHICLE_DRIVE_WANDER(Static_94.f_28[0], Static_94.f_35[0], 20f, 786603);
						}
					
						RECORDING::REPLAY_STOP_EVENT();
						func_236(&Static_94.f_28[0], 1, 0, 1);
						func_236(&Static_94.f_28[1], 1, 0, 1);
						func_235(&Static_94.f_35[0]);
						Static_320 = 1;
						Static_321 = 0;
					}
					break;
...
void func_235(var uParam0) // Position - 0x27D33
{
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x27D6B
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!PED::IS_PED_INJURED(*uParam0))
...
bool func_237(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, bool bParam5, int iParam6) // Position - 0x27DBB
{
	bool bVar0;
	float fVar1;
...
int func_238(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x27E17
{
	STREAMING::REQUEST_MODEL(Static_81);

	if (iParam6 == 1)
	{
		while (!STREAMING::HAS_MODEL_LOADED(Static_81))
		{
			BUILTIN::WAIT(0);
		}
	}
	else if (!STREAMING::HAS_MODEL_LOADED(Static_81))
	{
		return 0;
	}

	func_239(uParam0, Static_81, fParam1, fParam4);

	if (func_315(*uParam0))
	{
		VEHICLE::SET_VEHICLE_COLOURS(*uParam0, 65, 0);
		VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(*uParam0, 5, 0);
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Static_81);
	return 1;
}

void func_239(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x27EA2
{
	func_240(uParam0);
...
void func_240(var uParam0) // Position - 0x27EE5
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
bool func_241(var uParam0) // Position - 0x27F81
{
	if (func_315(uParam0))
...
void func_242(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x27FAB
{
	var uVar0;
	...
	func_244(false, true, false, 0, false, false, false);
...
bool func_243(var uParam0) // Position - 0x28055
{
	if (func_315(uParam0))
		if (!PED::IS_PED_INJURED(uParam0))
			return true;
...
void func_244(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6) // Position - 0x28075
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_249(PLAYER::PLAYER_ID()) && !func_246(PLAYER::PLAYER_ID(), 0) && !func_245() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
bool func_245() // Position - 0x281C4
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

bool func_246(int iParam0, int iParam1) // Position - 0x281DE
{
	bool bVar0;
...
bool func_247(bool bParam0, bool bParam1) // Position - 0x28237
{
	bool bVar0;
	bool bVar1;
...
bool func_248(int iParam0) // Position - 0x28278
{
	int iVar0;
...
bool func_249(int iParam0) // Position - 0x2829A
{
...
bool func_250() // Position - 0x282D9
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_251(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x282E7
{
	int iVar0;
...
void func_252(int iParam0) // Position - 0x2831A
{
	if (iParam0 == 1)
...
void func_253(int iParam0, bool bParam1) // Position - 0x2833D
{
...
void func_254(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12) // Position - 0x28379
{
	var uVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
			MISC::CLEAR_AREA_OF_PEDS(func_255(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
...
Vector3 func_255(var uParam0) // Position - 0x28537
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

void func_256(bool bParam0) // Position - 0x2854A
{
	var uVar0;
	...
	func_244(true, true, false, 0, false, false, false);
}

void func_257(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x28589
{
	var uVar0;
	float fVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105490.f_4))
	{
		...
		{
			if (func_305(24) != Global_105490.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_302(ENTITY::GET_ENTITY_COORDS(Global_105490.f_4, 1), iParam5, &uVar0, &fVar3))
					{
						fParam0 = { uVar0 };
						fParam3 = fVar3;
					}
				...
				func_258(Global_105490.f_4, fParam0, fParam3, 24, false);
			}
		}
	}
}

void func_258(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, bool bParam6) // Position - 0x28604
{
	var uVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_292(iParam5, &uVar0, uParam1, fParam4, func_295(iParam0));
		func_259(iParam5, iParam0, 0);
	}
}

void func_259(int iParam0, int iParam1, int iParam2) // Position - 0x2872D
{
	int iVar0;
	...
	if (!func_289(&Global_79095.f_555[0 /*21*/], iParam0))
		return;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
				Global_114931.f_32757.f_4801 = func_278();
...
void func_260(int iParam0, int iParam1) // Position - 0x28844
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	func_297(iParam0, &(Global_114931.f_32757.f_5510));
}

bool func_261(int iParam0) // Position - 0x28A46
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0) || func_276(iParam0, 0, false) || func_276(iParam0, 1, false) || func_276(iParam0, 2, false) || func_295(iParam0) != 145 || func_275(iParam0) || func_274(iParam0) || func_273(iParam0) || func_272(iParam0) || !func_262(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		func_274(iParam0);
		func_274(iParam0);
...
bool func_262(int iParam0) // Position - 0x28B23
{
	if (iParam0 == 0)
		return false;

	if (!func_263(iParam0, false, -1))
		return false;
...
bool func_263(int iParam0, bool bParam1, int iParam2) // Position - 0x28CE1
{
	int iVar0;
	var uVar1;
...
bool func_264(int iParam0) // Position - 0x28E66
{
	int iVar0;
	var uVar1;
	var uVar2;
...
bool func_265() // Position - 0x28F32
{
	if (MISC::IS_PC_VERSION())
...
bool func_266(bool bParam0, int iParam1) // Position - 0x28F49
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_267() // Position - 0x29131
{
	return false;
}

bool func_268() // Position - 0x2913A
{
	return true;
}

bool func_269() // Position - 0x29143
{
	return true;
}

bool func_270() // Position - 0x2914C
{
...
bool func_271() // Position - 0x29165
{
	var uVar0;
...
bool func_272(int iParam0) // Position - 0x2921D
{
	int iVar0;
	var uVar1;
	...
	if (!func_263(iVar0, false, -1))
		return true;

	return false;
}

bool func_273(int iParam0) // Position - 0x29264
{
	int iVar0;
...
bool func_274(int iParam0) // Position - 0x2929F
{
	int iVar0;
...
bool func_275(int iParam0) // Position - 0x2931B
{
	int iVar0;
...
bool func_276(int iParam0, int iParam1, bool bParam2) // Position - 0x29403
{
	int iVar0;
	var uVar1;
	int iVar9;
...
bool func_277(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x29471
{
...
void func_279(var uParam0, int iParam1) // Position - 0x2958F
{
	if (iParam1 <= 0)
		return;
...
void func_280(var uParam0, int iParam1) // Position - 0x29615
{
...
void func_281(var uParam0, int iParam1) // Position - 0x29648
{
	int iVar0;
	int iVar1;
...
int func_282(int iParam0, int iParam1) // Position - 0x29699
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_283(int iParam0) // Position - 0x2973B
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_284(bool bParam0, var uParam1, var uParam2) // Position - 0x2975D
{
	if (bParam0)
		return uParam1;
...
int func_285(int iParam0) // Position - 0x29774
{
	return iParam0 & 15;
}

void func_286(var uParam0, int iParam1) // Position - 0x29781
{
...
void func_287(var uParam0, int iParam1) // Position - 0x297BB
{
...
void func_288(var uParam0, int iParam1) // Position - 0x297F6
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
bool func_289(var uParam0, int iParam1) // Position - 0x29832
{
	bool bVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_296(Global_114931.f_32757.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_296(Global_114931.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_296(Global_114931.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
int func_290(int iParam0, int iParam1) // Position - 0x2AF20
{
	int iVar0;
	...
	if (func_154(iParam0))
	{
		...
		iVar0.f_31 = 49;
		iVar0.f_81 = 2;
		func_291(iParam0, &iVar0, iParam1);
		return iVar0;
	}
	else
	{
...
void func_291(int iParam0, var uParam1, int iParam2) // Position - 0x2AF62
{
	int iVar0;
...
void func_292(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x2B1BE
{
	if (func_289(&Global_79095.f_555[0 /*21*/], iParam0))
	{
		...
		{
			func_294(iParam0);
			func_293(uParam1, &Global_114931.f_32757.f_69[Global_79095.f_555[0 /*21*/].f_14 /*78*/]);
...
void func_293(var uParam0, var uParam1) // Position - 0x2B2B7
{
...
void func_294(int iParam0) // Position - 0x2B383
{
	if (iParam0 == -1)
		return;
...
int func_295(int iParam0) // Position - 0x2B3FA
{
	int iVar0;
...
bool func_296(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, bool bParam6) // Position - 0x2B45D
{
	if (bParam6)
...
void func_297(int iParam0, var uParam1) // Position - 0x2B4A4
{
	int iVar0;
...
int func_298(int iParam0) // Position - 0x2B74F
{
	switch (iParam0)
	{
		case 1:
...
int func_299(var uParam0, var uParam1, var uParam2) // Position - 0x2B7FF
{
	int iVar0;
	int iVar1;
...
bool func_300(int iParam0) // Position - 0x2B9F2
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_301(int iParam0) // Position - 0x2BA12
{
...
bool func_302(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) // Position - 0x2BA39
{
	int iVar0;

	iVar0 = func_303(uParam0, iParam3, 1);
...
int func_303(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x2BB4F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_304(int iParam0) // Position - 0x2BBDE
{
	return IS_BIT_SET(Global_114931.f_7236[iParam0], 0);
}

int func_305(int iParam0) // Position - 0x2BBF3
{
	if (iParam0 == -1)
		return 0;
...
void func_306(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18) // Position - 0x2BC0F
{
	func_307(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_307(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18) // Position - 0x2BC39
{
	var uVar0;
	bool bVar1;
	bool bVar2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				if (uVar10.f_2 > uParam0.f_2 && uVar10.f_2 < uParam3.f_2 || uVar10.f_2 > uParam3.f_2 && uVar10.f_2 < uParam0.f_2)
					if (func_309(uVar0, uParam0, uParam3, fParam6))
						bVar1 = true;
			}
			...
			if (bParam16)
				if (func_276(uVar0, func_215(), true))
					bVar1 = false;
		
			if (bVar1)
			{
				if (!func_308(fParam11))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
					{
...
bool func_308(float fParam0, var uParam1, var uParam2) // Position - 0x2C031
{
...
bool func_309(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x2C05B
{
	float fVar0;
	var uVar3;
	var uVar6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		fVar0 = { func_311(uParam1 - uParam4) };
		uVar3 = { fVar0 };
		uVar18 = 4;
		fVar0 = -uVar3.f_1;
		fVar0.f_1 = uVar3;
		...
		if (func_310(uVar18[0 /*3*/], uVar18[1 /*3*/], uVar6, uVar9) || func_310(uVar18[0 /*3*/], uVar18[1 /*3*/], uVar9, uVar15) || func_310(uVar18[0 /*3*/], uVar18[1 /*3*/], uVar12, uVar15) || func_310(uVar18[0 /*3*/], uVar18[1 /*3*/], uVar6, uVar12) || func_310(uVar18[1 /*3*/], uVar18[3 /*3*/], uVar6, uVar9) || func_310(uVar18[1 /*3*/], uVar18[3 /*3*/], uVar9, uVar15) || func_310(uVar18[1 /*3*/], uVar18[3 /*3*/], uVar12, uVar15) || func_310(uVar18[1 /*3*/], uVar18[3 /*3*/], uVar6, uVar12) || func_310(uVar18[3 /*3*/], uVar18[2 /*3*/], uVar6, uVar9) || func_310(uVar18[3 /*3*/], uVar18[2 /*3*/], uVar9, uVar15) || func_310(uVar18[3 /*3*/], uVar18[2 /*3*/], uVar12, uVar15) || func_310(uVar18[3 /*3*/], uVar18[2 /*3*/], uVar6, uVar12) || func_310(uVar18[2 /*3*/], uVar18[0 /*3*/], uVar6, uVar9) || func_310(uVar18[2 /*3*/], uVar18[0 /*3*/], uVar9, uVar15) || func_310(uVar18[2 /*3*/], uVar18[0 /*3*/], uVar12, uVar15) || func_310(uVar18[2 /*3*/], uVar18[0 /*3*/], uVar6, uVar12))
			return true;
	}
...
bool func_310(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x2C351
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_311(float fParam0, var uParam1, var uParam2) // Position - 0x2C405
{
	float fVar0;
	float fVar1;
...
void func_312(var uParam0) // Position - 0x2C444
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
...
Vector3 func_313() // Position - 0x2C4A9
{
	return 2.55f, 5.665f, 2.55f;
}

void func_314() // Position - 0x2C4C0
{
	int iVar0;
...
bool func_315(var uParam0) // Position - 0x2C4E0
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
...
bool func_316(int iParam0, int iParam1, int iParam2) // Position - 0x2C501
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_321(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, true, false))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_317() // Position - 0x2C5D5
{
	bool bVar0;
...
void func_318() // Position - 0x2C5F8
{
	Global_21866 = 0;
	func_231();
}

void func_319() // Position - 0x2C608
{
...
bool func_320(var uParam0, int iParam1) // Position - 0x2C659
{
	if (func_243(uParam0))
...
bool func_321(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) // Position - 0x2C68C
{
...
void func_322(var uParam0) // Position - 0x2C6E3
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
...
void func_323(bool bParam0, bool bParam1) // Position - 0x2C70F
{
...
void func_324(char* sParam0, bool bParam1) // Position - 0x2C860
{
	func_256(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_325(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2C876
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_80560 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				uVar4 = { func_327(Global_80561, Global_80563, iParam10) };
				fVar7 == -0.014f;
...
float func_326(var uParam0) // Position - 0x2CB5B
{
...
struct<2> func_327(int iParam0, int iParam1, int iParam2) // Position - 0x2CB6E
{
	var uVar0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				case 10:
					uVar0 = { func_331(iParam2) };
					break;
			
				case 5:
					uVar0 = { func_330(iParam2) };
					break;
			
				case 4:
					uVar0 = { func_329(iParam2) };
					break;
			
				default:
					TEXT_LABEL_ASSIGN_STRING(&uVar0, func_328(iVar2), 8);
					break;
			}
			break;
...
char* func_328(int iParam0) // Position - 0x2CC44
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_329(int iParam0) // Position - 0x2CD97
{
	var uVar0;
	var uVar2;
...
struct<2> func_330(int iParam0) // Position - 0x2CDCA
{
	var uVar0;
	var uVar2;
...
struct<2> func_331(int iParam0) // Position - 0x2CDFD
{
	var uVar0;
	var uVar2;
...
struct<2> func_332(int iParam0) // Position - 0x2CE30
{
	var uVar0;
	var uVar2;
...
struct<2> func_333(int iParam0) // Position - 0x2CE63
{
	var uVar0;
	var uVar2;
...
struct<2> func_334(int iParam0) // Position - 0x2CEA0
{
	var uVar0;
	var uVar2;
...
struct<2> func_335(int iParam0) // Position - 0x2CED3
{
	var uVar0;
...
bool func_336(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2CF3C
{
	if (!func_339(0) || Global_80576 || Global_80564 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
bool func_337(bool bParam0) // Position - 0x2D054
{
	if (bParam0)
...
bool func_338(int iParam0) // Position - 0x2D07D
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
bool func_339(int iParam0) // Position - 0x2D0D4
{
	if (Global_44886 == 15)
		return false;
...
bool func_340(int iParam0) // Position - 0x2D0F6
{
	return func_341(iParam0, Global_44886);
}

bool func_341(int iParam0, int iParam1) // Position - 0x2D107
{
	if (iParam1 == 15)
		return 1;
...
bool func_345(var uParam0) // Position - 0x2D437
{
	int iVar0;
	int iVar4;
	var uVar5;
	...
	switch (Static_77)
	{
		case 0:
			...
			func_354(&Static_82, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			Static_77 = 1;
			break;
		...
		case 2:
			...
			{
				func_239(&uParam0->f_35[0], Static_81, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
...
void func_346(int iParam0, bool bParam1) // Position - 0x2D6D8
{
	switch (iParam0)
	{
		case 37:
		...
		case 38:
			if (bParam1)
			{
				Static_93 = PED::ADD_SCENARIO_BLOCKING_AREA(-577.27405f, 270.65054f, 77f, -543.17926f, 315.29727f, 94f, 0, 1, 1, 1, 1);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", 0);
		...
		case 39:
			if (bParam1)
			{
				Static_93 = PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.328316f, -966.24f, 411.05f, 84.820435f, 0, 1, 1, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				Static_93 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.2018f, 48.5724f, 51.4652f, -1076.2333f, 92.1041f, 60.0617f, 0, 1, 1, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				Static_93 = PED::ADD_SCENARIO_BLOCKING_AREA(-1319.5663f, -650.07697f, 23.53715f, -1301.7892f, -634.0721f, 38.18122f, 0, 1, 1, 1, 1);
...
void func_347(bool bParam0) // Position - 0x2DAF2
{
	var uVar0;
	var uVar3;
	var uVar6;
...
bool func_348(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2DB83
{
	if (func_349(uParam0, iParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
bool func_349(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, bool bParam6) // Position - 0x2DBDF
{
	int iVar0;
...
int func_350(int iParam0, int iParam1) // Position - 0x2DC6D
{
	int iVar0;
...
bool func_351(var uParam0) // Position - 0x2DCB3
{
	if (func_352(uParam0))
	{
...
bool func_352(var uParam0) // Position - 0x2DCDD
{
...
bool func_353(var uParam0) // Position - 0x2DD02
{
	int iVar0;
...
void func_354(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x2DD33
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
bool func_355() // Position - 0x2DD6F
{
...
void func_356() // Position - 0x2DD93
{
	func_314();
	func_368();
	func_347(true);
	func_367(&Static_155, 2);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(Static_323, 0);
	PED::CLEAR_PED_NON_CREATION_AREA();
	func_357(&Static_94, 1, false, false);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_357(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x2DDCB
{
...
void func_358(var uParam0, bool bParam1) // Position - 0x2DDEB
{
	func_359(&(uParam0->f_41), bParam1);
}

void func_359(var uParam0, bool bParam1) // Position - 0x2DDFD
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 <= *uParam0 - 1; iVar0 = iVar0 + 1)
	{
		if (bParam1)
			...
			func_360(&uParam0->[iVar0], false);
	}
}

void func_360(var uParam0, bool bParam1) // Position - 0x2DE3B
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_361(var uParam0) // Position - 0x2DE76
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_362(var uParam0, bool bParam1) // Position - 0x2DEA1
{
	func_363(&(uParam0->f_35), bParam1);
}

void func_363(var uParam0, bool bParam1) // Position - 0x2DEB3
{
	int iVar0;
...
void func_364(var uParam0, int iParam1) // Position - 0x2DEF0
{
	func_365(&(uParam0->f_28), iParam1);
}

void func_365(var uParam0, int iParam1) // Position - 0x2DF02
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 <= *uParam0 - 1; iVar0 = iVar0 + 1)
	{
		if (iParam1 == 1)
			...
			func_236(&uParam0->[iVar0], 0, 1, 0);
	}
}

void func_366(var uParam0) // Position - 0x2DF43
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
...
void func_367(var uParam0, int iParam1) // Position - 0x2DF84
{
	if (uParam0->[iParam1 /*10*/].f_7 == 1)
		uParam0->[iParam1 /*10*/].f_7 = 0;
}

bool func_368() // Position - 0x2DFA1
{
	int iVar0;
...
void func_369(bool bParam0) // Position - 0x2E042
{
	int iVar0;
...
void func_370(char* sParam0, int iParam1) // Position - 0x2E112
{
	if (Global_102454 != 12)
...
bool func_371(char* sParam0, int iParam1, int iParam2) // Position - 0x2E13A
{
	var uVar0;
	var uVar1;
	int iVar33;
...
int func_372(char* sParam0) // Position - 0x2E2C9
{
...
int func_373() // Position - 0x2E31F
{
	int iVar0;
	int iVar1;

	iVar0 = func_374(&(Global_102454.f_3), false);
	iVar1 = 0;
...
int func_374(char* sParam0, bool bParam1) // Position - 0x2E343
{
	var uVar0;
	int iVar1;

	uVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_375(uVar0, true);
	iVar1 == -1 && !bParam1;
	return iVar1;
}

int func_375(var uParam0, bool bParam1) // Position - 0x2E36D
{
	int iVar0;
...
bool func_376() // Position - 0x2E3A3
{
...
bool func_377() // Position - 0x2E3F3
{
	...
	if (Global_102454.f_11 == 5)
		if (func_372(&(Global_102454.f_3)) > -1)
			return true;

	return false;
}

void func_378(int iParam0) // Position - 0x2E45F
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_379(int iParam0) // Position - 0x2E473
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_380(int iParam0) // Position - 0x2E4AD
{
	if (iParam0 == 1)
	{
...
void func_381() // Position - 0x2E4E7
{
	Global_24407.f_5 = 1;
}

void func_382() // Position - 0x2E4F5
{
	Global_24407.f_5 = 0;
}

void func_383(bool bParam0) // Position - 0x2E503
{
	if (bParam0)
	{
		func_384();
...
void func_384() // Position - 0x2E566
{
...
void func_385(int iParam0) // Position - 0x2E58F
{
	if (func_388())
		return;
...
void func_386(bool bParam0, bool bParam1) // Position - 0x2E619
{
	if (bParam0)
	{
		if (func_338(0))
...
bool func_387() // Position - 0x2E68D
{
	return IS_BIT_SET(Global_1964705, 5);
}

bool func_388() // Position - 0x2E69B
{
	return IS_BIT_SET(Global_1964705, 19);
}

void func_389() // Position - 0x2E6AA
{
	Global_96605 = 0;
	Global_96606 = false;
}

bool func_390() // Position - 0x2E6BC
{
...
void func_391() // Position - 0x2E6FA
{
	Global_102489 = 1;
...
void func_392(char* sParam0) // Position - 0x2E7E7
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

void func_393(var uParam0) // Position - 0x2E7F9
{
...
void func_394(var uParam0) // Position - 0x2E819
{
	int iVar0;
...
int func_395(int iParam0) // Position - 0x2E853
{
	if (!func_154(iParam0))
		return func_153(iParam0);
	else
