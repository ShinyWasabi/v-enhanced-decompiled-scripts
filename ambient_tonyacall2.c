...
bool func_1() // Position - 0x1BA
{
	...
	if (BUILTIN::VDIST2(uVar0, uVar3) > 10000f || ENTITY::IS_ENTITY_DEAD(Static_36, 0) || func_28())
		return true;
	...
	switch (Static_38)
	{
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(Static_36) && !ENTITY::IS_ENTITY_DEAD(Static_36, 0))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(Static_36, Static_55, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					TASK::TASK_PERFORM_SEQUENCE(Static_36, uVar7);
					TASK::CLEAR_SEQUENCE_TASK(&uVar7);
					Static_38 = 1;
				}
			}
			...
			if (ENTITY::DOES_ENTITY_EXIST(Static_36) && !ENTITY::IS_ENTITY_DEAD(Static_36, 0))
			{
				if (TASK::GET_SEQUENCE_PROGRESS(Static_36) == 1)
				{
					if (!ENTITY::DOES_ENTITY_EXIST(Static_37))
					{
						...
						{
							fVar8 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Static_36, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
				...
				else if (TASK::GET_SEQUENCE_PROGRESS(Static_36) == 2)
				{
					...
					if (iVar6 == 0)
						if (func_4(&Static_61, "TOWAUD", "TONYA_CALL3", 8, 0, 0, 0))
							Static_38 = 2;
					else if (func_4(&Static_61, "TOWAUD", "TONYA_CALL4", 8, 0, 0, 0))
						Static_38 = 2;
				}
			}
			break;
		...
		case 3:
			...
			if (BUILTIN::VDIST2(uVar0, uVar3) < 25f)
			{
				...
				{
					if (func_4(&Static_61, "TOWAUD", "TOW_MESS2", 8, 0, 0, 0))
					{
						BUILTIN::SETTIMERA(0);
						Static_38 = 4;
					}
...
bool func_9(int iParam0, int iParam1) // Position - 0x8EC
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_10(int iParam0) // Position - 0x904
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_11() // Position - 0x916
{
	return -1;
}

void func_12() // Position - 0x91F
{
	int iVar0;
...
void func_18() // Position - 0xB60
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_21(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_19(iVar0) && !func_23(14) || Global_113879)
			{
...
bool func_19(int iParam0) // Position - 0xC5D
{
	return iParam0 < 3;
}

int func_20(var uParam0) // Position - 0xC69
{
	int iVar0;
	int iVar1;
...
int func_22(int iParam0) // Position - 0xCCB
{
	return Global_2339[iParam0 /*29*/];
}

bool func_23(int iParam0) // Position - 0xCDA
{
	return Global_44886 == iParam0;
}

void func_24() // Position - 0xCE8
{
	int iVar0;
...
bool func_25(int iParam0, int iParam1) // Position - 0xD3F
{
	switch (iParam0)
	{
		case 5:
...
void func_27(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDCE
{
...
bool func_30(float fParam0, var uParam1, var uParam2) // Position - 0xF7C
{
...
void func_32(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x105F
{
...
bool func_33(int iParam0, int iParam1) // Position - 0x10FA
{
	bool bVar0;
