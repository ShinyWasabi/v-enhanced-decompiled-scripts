...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(uParam0, 355.60925f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.999474f, 15f, 0, 1, 0);
}
...
bool func_71() // Position - 0x182E
{
	if (Global_1845136 != func_61())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1845136, 1, 0))
			return false;
...
void func_72() // Position - 0x187A
{
	...
	uVar0[0] = 0;
	uVar0[1] = 1;
	func_73(5, &Static_124, &uVar0);
	uVar0[0] = 2;
	uVar0[1] = 3;
	func_73(6, &Static_124, &uVar0);
}
