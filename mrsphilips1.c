...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_239(Static_77.f_9, 0, 0, 0, 0, 0);
			...
			switch (Static_140)
			{
				case 0:
					if (func_228(1, 1093140480, 0))
					{
						...
						if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(joaat("DOORHASH_T_TRAILER_CS")))
						{
							...
							OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(joaat("DOORHASH_T_TRAILER_CS"), 0, 1, 0);
						}
					
						CUTSCENE::START_CUTSCENE(0);
						RECORDING::REPLAY_START_EVENT(1);
						func_226(500, false);
						Static_140 = Static_140 + 1;
					}
					break;
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							func_221(PLAYER::PLAYER_PED_ID(), 1974.513f, 3814.579f, 32.4266f, 270f, false, 1);
							PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MOTIONSTATE_WALK"), 0, 1, 0);
							PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 1f, 4000, 0, 1, 0, 0);
...
bool func_5(bool bParam0) // Position - 0x443
{
...
void func_10(int iParam0, int iParam1, bool bParam2) // Position - 0xA6B
{
	if (bParam2 == -1)
		bParam2 = func_11();
...
bool func_32(int iParam0, int iParam1, bool bParam2) // Position - 0x1537
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
bool func_33(int iParam0, bool bParam1, var uParam2) // Position - 0x16F4
{
	int iVar0;
...
int func_34(bool bParam0) // Position - 0x1795
{
	switch (bParam0)
	{
...
int func_35(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17D0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(bool bParam0, int iParam1, bool bParam2) // Position - 0x1FE1
{
	bool bVar0;
	int iVar1;
...
bool func_37(bool bParam0, int iParam1, bool bParam2) // Position - 0x206B
{
	if (bParam0 == joaat("PLAYER_ZERO"))
		if (iParam1 == 4)
...
bool func_38(bool bParam0, int iParam1, bool bParam2) // Position - 0x2149
{
	Global_80088[1 /*14*/] = { func_85(bParam0, iParam1, bParam2, -1) };
	return IS_BIT_SET(Global_80088[1 /*14*/].f_6, 2);
}

bool func_39(bool bParam0, bool bParam1, int iParam2, bool bParam3, var uParam4, int iParam5) // Position - 0x2171
{
	var uVar0;
	int iVar10;
...
bool func_40(int iParam0, int iParam1, bool bParam2) // Position - 0x2775
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_41(var uParam0, int iParam1, int iParam2) // Position - 0x280E
{
	bool bVar0;
	bool bVar1;
...
int func_42(bool bParam0, int iParam1, bool bParam2, var uParam3) // Position - 0x28AF
{
	int iVar0;
...
bool func_43(var uParam0, bool bParam1, int iParam2, bool bParam3, int iParam4, int iParam5) // Position - 0x2BB6
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_44(int iParam0, bool bParam1, bool bParam2, bool bParam3, var uParam4) // Position - 0x3769
{
	int iVar0;
...
bool func_45(bool bParam0, bool bParam1, bool bParam2, int iParam3) // Position - 0x3A4D
{
	int iVar0;
...
bool func_46(bool bParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D14
{
	bool bVar0;
	bool bVar1;
...
bool func_47(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x3D4B
{
	bool bVar0;
...
bool func_48(bool bParam0, bool bParam1, var uParam2) // Position - 0x3D74
{
	*uParam2 = -99;
...
int func_49(bool bParam0, int iParam1, bool bParam2, var uParam3) // Position - 0x403F
{
	int iVar0;
...
bool func_50(bool bParam0, bool bParam1, bool bParam2) // Position - 0x42C9
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
void func_51(var uParam0, int iParam1, bool bParam2, bool bParam3) // Position - 0x4420
{
	bool bVar0;
...
bool func_52(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x44BA
{
	switch (bParam0)
	{
...
int func_53(bool bParam0, bool bParam1, int iParam2, int iParam3) // Position - 0x4588
{
	var uVar0;
	int iVar17;
	int iVar18;
...
int func_54(bool bParam0, int iParam1) // Position - 0x46A2
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_55(bool bParam0) // Position - 0x4A49
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_56(var uParam0, bool bParam1, bool bParam2, int iParam3) // Position - 0x4AAA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_61(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x4E84
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_62(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x5101
{
	if (bParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
bool func_63(bool bParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x5526
{
	switch (bParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_64(var uParam0, int iParam1) // Position - 0x5819
{
	int iVar0;
	var uVar1;
...
bool func_65(var uParam0, int iParam1) // Position - 0x5860
{
	int iVar0;
	var uVar1;
	var uVar2;
...
void func_68(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) // Position - 0x59C3
{
	bool bVar0;
	var uVar1;
	int iVar2;
...
void func_69(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x5A0B
{
	int iVar0;
...
int func_70(int iParam0, bool bParam1) // Position - 0x5A39
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(bParam1));
}

bool func_71(bool bParam0) // Position - 0x5A4E
{
	bool bVar0;
	bool bVar1;
...
int func_72(int iParam0, bool bParam1) // Position - 0x5A82
{
	var uVar0;
	int iVar1;
...
bool func_73(bool bParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5) // Position - 0x5AB1
{
	int iVar0;
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10) // Position - 0xD726
{
	int iVar0;
	int iVar1;
...
bool func_89(int iParam0, int iParam1, var uParam2) // Position - 0xDAC7
{
	*uParam2 = 979;
...
int func_90(int iParam0, int iParam1) // Position - 0xDECC
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1) // Position - 0xE2C7
{
	switch (iParam1)
	{
		case 0:
...
bool func_92(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) // Position - 0xE6C2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_93(int iParam0) // Position - 0xE700
{
	return Global_44886 == iParam0;
}

int func_94(int iParam0) // Position - 0xE70E
{
	switch (iParam0)
	{
		case -1:
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE7E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_96(int iParam0) // Position - 0xEA68
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_97(int iParam0) // Position - 0xEBB5
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_98(int iParam0) // Position - 0xF0C2
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_99(int iParam0) // Position - 0xF136
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_100(int iParam0) // Position - 0xF1A9
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_101(int iParam0) // Position - 0xF290
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_102(int iParam0) // Position - 0xF5D2
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_103(int iParam0) // Position - 0xF7DA
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_104(int iParam0) // Position - 0xF9FA
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_105(int iParam0) // Position - 0xFB03
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_106(int iParam0) // Position - 0x10496
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_107(int iParam0) // Position - 0x10FEE
{
	if (iParam0 < 136)
		func_109(iParam0);
	else
...
void func_108(int iParam0) // Position - 0x11023
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_109(int iParam0) // Position - 0x11C27
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_110(int iParam0) // Position - 0x12B27
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_111(int iParam0) // Position - 0x12C54
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_112(int iParam0, int iParam1) // Position - 0x12D4B
{
	switch (iParam0)
	{
		case 0:
...
void func_113(int iParam0) // Position - 0x12E3B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_114(int iParam0) // Position - 0x1430A
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_115(int iParam0) // Position - 0x14451
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_116(int iParam0) // Position - 0x1495B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_117(int iParam0) // Position - 0x14FC4
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_118(int iParam0) // Position - 0x15037
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_119(int iParam0) // Position - 0x15107
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_120(int iParam0) // Position - 0x15602
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_121(int iParam0) // Position - 0x15793
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_122(int iParam0) // Position - 0x15F82
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_123(int iParam0) // Position - 0x1608B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_124(int iParam0) // Position - 0x16FAE
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_125(int iParam0) // Position - 0x17C5B
{
	if (iParam0 < 107)
		func_128(iParam0);
	else if (iParam0 < 227)
...
void func_126(int iParam0) // Position - 0x17CA1
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_127(int iParam0) // Position - 0x18746
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_128(int iParam0) // Position - 0x19534
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_129(int iParam0) // Position - 0x1A173
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_130(int iParam0) // Position - 0x1A3EB
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_131(int iParam0, int iParam1) // Position - 0x1A527
{
	switch (iParam0)
	{
		case 0:
...
void func_132(int iParam0) // Position - 0x1A617
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_133(int iParam0) // Position - 0x1B375
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_134(int iParam0) // Position - 0x1B4E4
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_135(int iParam0) // Position - 0x1BA55
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_136(int iParam0) // Position - 0x1BF7D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_137(int iParam0) // Position - 0x1BFF0
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_138(int iParam0) // Position - 0x1C0C1
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_139(int iParam0) // Position - 0x1C571
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_140(int iParam0) // Position - 0x1C7CC
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_141(int iParam0) // Position - 0x1CA8C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_142(int iParam0) // Position - 0x1CC47
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_143(int iParam0) // Position - 0x1D78D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_144(int iParam0) // Position - 0x1E3BF
{
	if (iParam0 < 60)
		func_146(iParam0);
	else
...
void func_145(int iParam0) // Position - 0x1E3F4
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_146(int iParam0) // Position - 0x1F187
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_147(int iParam0) // Position - 0x1F809
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_148(int iParam0) // Position - 0x1F8EF
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_149() // Position - 0x1F9E6
{
...
bool func_150(int iParam0, int iParam1, bool bParam2) // Position - 0x1FA5E
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int func_151(int iParam0) // Position - 0x1FCB7
{
	int iVar0;
	int iVar1;
...
int func_152(int iParam0) // Position - 0x1FCF4
{
	if (func_154(iParam0))
...
int func_153(int iParam0) // Position - 0x1FD19
{
	return Global_2339[iParam0 /*29*/];
}

bool func_154(int iParam0) // Position - 0x1FD28
{
	return iParam0 < 3;
}

void func_155(var uParam0, int iParam1) // Position - 0x1FD34
{
...
void func_157() // Position - 0x1FDCB
{
	int iVar0;
...
struct<2> func_158(int iParam0) // Position - 0x1FEC8
{
	var uVar0;
	var uVar2;
...
struct<2> func_159(int iParam0) // Position - 0x1FEFF
{
	var uVar0;
...
bool func_208(var uParam0) // Position - 0x271B4
{
...
bool func_214(bool bParam0, bool bParam1) // Position - 0x27461
{
	bool bVar0;
	bool bVar1;
...
Vector3 func_223(var uParam0) // Position - 0x277A8
{
...
bool func_228(int iParam0, int iParam1, int iParam2) // Position - 0x2786F
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_235(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, true, false))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_232() // Position - 0x279CD
{
	...
	if (Global_80560 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				uVar4 = { func_241(Global_80561, Global_80563, iParam10) };
				fVar7 == -0.014f;
...
struct<2> func_241(int iParam0, int iParam1, int iParam2) // Position - 0x27F55
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					uVar0 = { func_248(iParam2) };
					break;
			
				case 8:
					uVar0 = { func_247(iParam2) };
					break;
			
				case 7:
					uVar0 = { func_246(iParam2) };
					break;
				...
				default:
					TEXT_LABEL_ASSIGN_STRING(&uVar0, func_242(iVar2), 8);
					break;
			}
			break;
...
{
	if (!func_253(0) || Global_80576 || Global_80564 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
{
	return func_255(iParam0, Global_44886);
}
...
void func_256() // Position - 0x286D1
{
	func_227();
	func_271();
	func_257(&Static_77, 1, false, false);
...
int func_276() // Position - 0x28D76
{
	...
	iVar0 = func_277(&(Global_102454.f_3), false);
	iVar1 = 0;
...
bool func_280() // Position - 0x28E4A
{
	...
	if (Global_102454.f_11 == 5)
		if (func_275(&(Global_102454.f_3)) > -1)
			return true;
