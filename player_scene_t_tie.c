...
bool func_2() // Position - 0x108
{
	...
	func_3(&Static_71, &Static_111);
	fVar0 = BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Static_81);
...
int func_3(var uParam0, var uParam1) // Position - 0x142
{
	...
	for (iVar1 = 0; iVar1 < *uParam0; iVar1 = iVar1 + 1)
	{
		if (!PED::IS_PED_INJURED(uParam0->[iVar1]))
		{
			switch (uParam1->[iVar1])
			{
				case 0:
					break;
		...
		{
			ENTITY::DOES_ENTITY_EXIST(uParam0->[iVar1]);
		}
	}
...
int func_6(int iParam0, int iParam1) // Position - 0x217
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_7(Global_102175) && iParam1 != 0)
		{
			Global_102175 = 0;
		}
	}
...
int func_7(int iParam0) // Position - 0x2FB
{
	return iParam0;
}
...
void func_10() // Position - 0x35A
{
	...
	{
		if (func_13(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_12(PLAYER::PLAYER_PED_ID());
		
			if (func_11(iVar0) && !func_15(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != iVar0 && func_11(Global_114931.f_2370.f_539.f_4321))
...
int func_12(var uParam0) // Position - 0x463
{
	int iVar0;
	int iVar1;
...
int func_14(int iParam0) // Position - 0x4C5
{
...
void func_20() // Position - 0x54F
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		for (iVar0 = 0; iVar0 < Static_76; iVar0 = iVar0 + 1)
		{
			if (Static_76[iVar0] != 0)
			{
				STREAMING::REQUEST_MODEL(Static_76[iVar0]);
			
				if (!STREAMING::HAS_MODEL_LOADED(Static_76[iVar0]))
				{
					STREAMING::REQUEST_MODEL(Static_76[iVar0]);
					bVar2 = false;
				}
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&Static_116))
		{
			STREAMING::REQUEST_ANIM_DICT(&Static_116);
		
			if (!STREAMING::HAS_ANIM_DICT_LOADED(&Static_116))
			{
				STREAMING::REQUEST_ANIM_DICT(&Static_116);
				bVar2 = false;
			}
	...
	for (iVar0 = 0; iVar0 < Static_71; iVar0 = iVar0 + 1)
	{
		if (Static_76[iVar0] != 0)
		{
			Static_71[iVar0] = PED::CREATE_PED(26, Static_76[iVar0], Static_81 + Static_85[iVar0 /*3*/], 0, 1, 1);
			ENTITY::SET_ENTITY_ROTATION(Static_71[iVar0], { Static_84, 0f, 0f } + Static_98[iVar0 /*3*/], 2, 1);
			PED::SET_PED_RANDOM_COMPONENT_VARIATION(Static_71[iVar0], 0);
		
			if (Static_69 == 288)
			{
				PED::SET_PED_COMPONENT_VARIATION(Static_71[iVar0], 3, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(Static_71[iVar0], 4, 0, 0, 0);
			}
			else
			{
				PED::SET_PED_RANDOM_COMPONENT_VARIATION(Static_71[iVar0], 0);
			...
			PED::SET_PED_COMBAT_ATTRIBUTES(Static_71[iVar0], 13, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(Static_71[iVar0], 17, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_71[iVar0], 1);
			PED::SET_PED_CAN_BE_TARGETTED(Static_71[iVar0], 0);
			TASK::TASK_PLAY_ANIM_ADVANCED(Static_71[iVar0], &Static_116, &Static_124[iVar0 /*8*/], Static_81 + Static_85[iVar0 /*3*/], { Static_84, 0f, 0f } + Static_98[iVar0 /*3*/], 1000f, -8f, -1, Static_157, 0, 2, 0);
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Static_71[iVar0], 0, 0);
			PED::SET_PED_KEEP_TASK(Static_71[iVar0], 1);
			PED::SET_PED_RESET_FLAG(Static_71[iVar0], 55, 1);
		
			if (Static_165[iVar0] > 0)
			{
				PED::APPLY_PED_BLOOD_BY_ZONE(Static_71[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(Static_71[iVar0], 1, 0.81f, 0.733f, 4);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(Static_71[iVar0], 0, 0.94f, 0.59f, 3);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(Static_71[iVar0], 3, 0.24f, 0.62f, 4);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(Static_71[iVar0], 2, 0f, 0.15f, 2);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(Static_71[iVar0], 5, 0.46f, 0.853f, 3);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(Static_71[iVar0], 4, 0.308f, 0.786f, 3);
				PED::APPLY_PED_BLOOD_SPECIFIC(Static_71[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(Static_71[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(Static_71[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(Static_71[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(Static_71[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
	}

	for (iVar0 = 0; iVar0 < Static_158; iVar0 = iVar0 + 1)
	{
		if (Static_165[iVar0] > 0)
		{
			uVar3 = { 0f, 0f, -1f };
			uVar6 = { func_21(0f, 1f, 0f) };
			fVar9 = 1.5f;
			fVar10 = 1.5f;
			fVar11 = 0.196f;
			fVar12 = 0f;
			...
			fVar14 = 1f;
			fVar15 = -1f;
			Static_158[iVar0] = GRAPHICS::ADD_DECAL(Static_165[iVar0], Static_81 + Static_172[iVar0 /*3*/], uVar3, uVar6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			BUILTIN::WAIT(0);
		}
	}
}
...
void func_22() // Position - 0x916
{
	...
	func_26(Static_69, &Static_81, &Static_84, &uVar0);
	iVar8.f_1 = -1;
	iVar8.f_17 = 4;
	iVar8.f_17.f_8 = 4;
	iVar8.f_17.f_13 = 4;
	...
	func_23(iVar8, &uVar117);

	switch (Static_69)
	{
		case 280:
			TEXT_LABEL_ASSIGN_STRING(&Static_116, "DEAD", 32);
			TEXT_LABEL_ASSIGN_STRING(&Static_124[0 /*8*/], "Dead_A", 32);
			TEXT_LABEL_ASSIGN_STRING(&Static_124[1 /*8*/], "Dead_D", 32);
			TEXT_LABEL_ASSIGN_STRING(&Static_124[2 /*8*/], "Dead_E", 32);
			TEXT_LABEL_ASSIGN_STRING(&Static_124[3 /*8*/], "Dead_G", 32);
			Static_85[0 /*3*/] = { 14.613f, 8.4563f, 0.9751f };
			Static_85[1 /*3*/] = { 10.6489f, 8.6708f, 0.7701f };
			Static_85[2 /*3*/] = { 6.3982f, 1.4604f, 1.1f };
			Static_85[3 /*3*/] = { 4.2327f, 5.864f, 0.9f - 0.15f };
			Static_98[0 /*3*/] = { 0f, 0f, 23.047f };
			Static_98[1 /*3*/] = { 0f, 0f, 97.2582f };
			Static_98[2 /*3*/] = { 0f, 0f, 34.2158f };
			Static_98[3 /*3*/] = { 0f, 0f, 61.2158f };
			Static_76[0] = joaat("G_M_Y_LOST_01");
			Static_76[1] = joaat("G_M_Y_LOST_01");
			Static_76[2] = joaat("G_M_Y_LOST_02");
			Static_76[3] = joaat("G_M_Y_LOST_03");
			Static_157 = 2621440;
			Static_111[0] = 1;
			Static_111[1] = 1;
			Static_111[2] = 1;
			...
			Static_165[2] = 1110;
			Static_165[3] = 1110;
			Static_172[0 /*3*/] = { ({ 0.37364f, -1445.5344f, 2803.7603f } - Static_81) + { 0.1f, 0f, 0f } };
			Static_172[1 /*3*/] = { ({ 0.28778f, -1444.8633f, 2800.022f } - Static_81) + { 0.1f, 0f, 0f } };
			Static_172[2 /*3*/] = { ({ 0.6045f, -1452.4043f, 2795.9336f } - Static_81) + { 0.1f, 0f, 0f } };
			Static_172[3 /*3*/] = { ({ 0.28483f, -1448.0331f, 2794.3005f } - Static_81) + { 0.1f, 0f, 0f } };
			Static_165[4] = joaat("XMAS_LIVERY_8");
			Static_165[5] = joaat("XMAS_LIVERY_8");
			Static_172[4 /*3*/] = { ((Static_172[0 /*3*/] + Static_172[2 /*3*/]) / { 2f, 2f, 2f }) + { 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f) } };
			Static_172[5 /*3*/] = { ((Static_172[1 /*3*/] + Static_172[2 /*3*/]) / { 2f, 2f, 2f }) + { 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f) } };
			break;
	
		default:
			TEXT_LABEL_ASSIGN_STRING(&Static_116, "", 32);
			TEXT_LABEL_ASSIGN_STRING(&Static_124[0 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&Static_124[1 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&Static_124[2 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&Static_124[3 /*8*/], "", 32);
			Static_76[0] = 0;
			Static_85[0 /*3*/] = { 0f, 0f, 0f };
			Static_98[0 /*3*/] = { 0f, 0f, 0f };
			Static_76[1] = 0;
			Static_85[1 /*3*/] = { 0f, 0f, 0f };
			Static_98[1 /*3*/] = { 0f, 0f, 0f };
			Static_76[2] = 0;
			Static_85[2 /*3*/] = { 0f, 0f, 0f };
			Static_98[2 /*3*/] = { 0f, 0f, 0f };
			Static_76[3] = 0;
			Static_85[3 /*3*/] = { 0f, 0f, 0f };
			Static_98[3 /*3*/] = { 0f, 0f, 0f };
			Static_157 = 0;
			Static_111[0] = -1;
			Static_111[1] = -1;
			Static_111[2] = -1;
...
bool func_27(var uParam0) // Position - 0x42C5
{
	...
	if (func_28(uVar1, 0f, 0f, 0f, false))
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114931.f_2370.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_114931.f_2370.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114931.f_2370.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_114931.f_2370.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114931.f_2370.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_114931.f_2370.f_539.f_2314[2]), 32);
			return true;
	
		case 11:
			if (func_32(iParam0, &uVar0, uParam1))
			{
...
void func_34() // Position - 0x91FB
{
	...
	{
		if (Static_76[iVar0] != 0)
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Static_76[iVar0]);
	}

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Static_116))
		STREAMING::REMOVE_ANIM_DICT(&Static_116);

	for (iVar0 = 0; iVar0 < Static_158; iVar0 = iVar0 + 1)
	{
		GRAPHICS::IS_DECAL_ALIVE(Static_158[iVar0]);
	}
