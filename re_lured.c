...
void main() // Position - 0x0
{
	...
	Static_39 = 49;
	Static_40 = 64;
	Static_47 = { ScriptArg_0.f_1[0 /*3*/] };

	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
		func_187();

	if (func_145(Static_47, -1, 0, false, false))
		func_142(-1);
	else
	...
	while (true)
	{
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || Static_241)
		{
			if (!func_141())
				if (func_140())
					func_187();
			...
			switch (Static_44)
			{
				...
				case 1:
					if (!Static_241)
					{
						...
						if (!PED::IS_PED_INJURED(Static_67))
							PED::SET_PED_RESET_FLAG(Static_67, 247, 1);
					}
					else
					{
					...
					if (!PED::IS_PED_INJURED(Static_68))
						PED::SET_PED_RESET_FLAG(Static_68, 156, 1);
...
void func_1() // Position - 0x191
{
	if (Static_241)
	{
		if (PED::IS_PED_INJURED(Static_68))
			...
			if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_68, 100f, 100f, 100f, 0, 1, 0))
				func_2();
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_68, 100f, 100f, 100f, 0, 1, 0))
			func_3();
	}
	else
	{
		if (!PED::IS_PED_INJURED(Static_67))
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Static_67, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Static_67))
				func_2();
		...
		if (PED::IS_PED_INJURED(Static_67))
		{
			if (!PED::IS_PED_INJURED(Static_68))
			{
				TASK::OPEN_SEQUENCE_TASK(&Static_73);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
				TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(Static_73);
				TASK::TASK_PERFORM_SEQUENCE(Static_68, Static_73);
				PED::SET_PED_KEEP_TASK(Static_68, 1);
			}
		...
		if (PED::IS_PED_INJURED(Static_68))
		{
			if (!PED::IS_PED_INJURED(Static_67))
			{
				TASK::CLEAR_PED_TASKS(Static_67);
				TASK::OPEN_SEQUENCE_TASK(&Static_73);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
				TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(Static_73);
				TASK::TASK_PERFORM_SEQUENCE(Static_67, Static_73);
				PED::SET_PED_KEEP_TASK(Static_67, 1);
			}
	...
	if (PED::IS_PED_INJURED(Static_68))
		if (HUD::DOES_BLIP_EXIST(Static_70))
			HUD::REMOVE_BLIP(&Static_70);
}
...
void func_7(int iParam0, int iParam1) // Position - 0x3C2
{
	...
	if (iParam1 <= func_30(iParam0))
	{
		...
		if (func_15(iParam0, iParam1) != 322)
			func_9(func_15(iParam0, iParam1), Static_41, Static_41.f_1);
...
void func_13(int iParam0, int iParam1, bool bParam2) // Position - 0xAD3
{
	if (bParam2 == -1)
		bParam2 = func_14();
...
void func_22() // Position - 0x1233
{
	...
	{
		if (func_26(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_25(PLAYER::PLAYER_PED_ID());
		
			if (func_24(iVar0) && !func_23(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != iVar0 && func_24(Global_114931.f_2370.f_539.f_4321))
...
int func_25(var uParam0) // Position - 0x134A
{
	int iVar0;
	int iVar1;
...
int func_27(int iParam0) // Position - 0x13AC
{
...
void func_36() // Position - 0x16F1
{
	if (!Static_241)
	{
		if (func_57())
		{
			...
			if (!PED::IS_PED_INJURED(Static_68))
			{
				TASK::CLEAR_PED_TASKS(Static_68);
				TASK::OPEN_SEQUENCE_TASK(&Static_73);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
				TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(Static_73);
	...
	else if (!Static_244 && !Static_242)
	{
		if (func_57() || WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Static_68, 0), 12f, 12f, 5f, 0, 1, 0))
		{
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Static_66, joaat("PLAYER"));
		
			if (!PED::IS_PED_INJURED(Static_68))
			{
				TASK::CLEAR_PED_TASKS(Static_68);
				TASK::TASK_COMBAT_PED(Static_68, PLAYER::PLAYER_PED_ID(), 0, 16);
			
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_68, 15f, 15f, 15f, 0, 1, 0))
				{
					func_55();
					BUILTIN::WAIT(0);
					func_37(&Static_74, "lurinau", "lurin_fucked", 4, 0, 0, 0);
				}
			}
			...
			{
				TASK::CLEAR_PED_TASKS(Static_67);
				TASK::TASK_COMBAT_PED(Static_67, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
...
bool func_42(int iParam0, int iParam1) // Position - 0x1C5B
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_43(int iParam0) // Position - 0x1C73
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_44() // Position - 0x1C85
{
	return -1;
}

void func_45() // Position - 0x1C8E
{
	int iVar0;
...
int func_50() // Position - 0x1EB6
{
	func_22();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_51() // Position - 0x1ECF
{
	int iVar0;
...
bool func_52(int iParam0, int iParam1) // Position - 0x1F26
{
	switch (iParam0)
	{
		case 5:
...
void func_54(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1FB5
{
...
void func_55() // Position - 0x200B
{
	Global_21866 = 0;
	func_56();
}

void func_56() // Position - 0x201B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
bool func_57() // Position - 0x203C
{
	...
	if (!PED::IS_PED_INJURED(Static_67) && !PED::IS_PED_INJURED(Static_68))
	{
		if (MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(Static_67, 31086, 0f, 0f, 0f), 30f, 1))
			return true;
	
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_67, 30f, 30f, 30f, 0, 1, 0) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Static_67) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Static_68) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Static_67) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Static_68))
			{
				if (PED::CAN_PED_SEE_HATED_PED(Static_67, PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(Static_68, PLAYER::PLAYER_PED_ID()))
				{
					func_55();
					BUILTIN::WAIT(0);
					func_37(&Static_74, "lurinau", "lurin_gun", 4, 0, 0, 0);
					return true;
				}
			}
		}
	
		uVar0 = { uVar0 + PED::GET_PED_BONE_COORDS(Static_67, 31086, 0f, 0f, 0f) };
		uVar3 = { uVar3 + PED::GET_PED_BONE_COORDS(Static_67, 31086, 0f, 0f, 0f) };
	
		if (MISC::IS_PROJECTILE_TYPE_IN_AREA(uVar3, uVar0, joaat("WEAPON_SMOKEGRENADE"), 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(uVar3, uVar0, joaat("WEAPON_GRENADE"), 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(uVar3, uVar0, joaat("WEAPON_STICKYBOMB"), 1))
			return true;
	
		if (GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(PED::GET_PED_BONE_COORDS(Static_67, 31086, 0f, 0f, 0f), 3f))
			return true;
	
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("BULLDOZER")))
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Static_67) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Static_68))
					return true;
		...
		if (PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(Static_67, 0) - Static_53, ENTITY::GET_ENTITY_COORDS(Static_67, 0) + Static_53) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(Static_67, 0) - Static_53, ENTITY::GET_ENTITY_COORDS(Static_67, 0) + Static_53))
			return true;
	}

	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 894.1762f, -1048.2943f, 41.828f, 15f, 21.5625f, 10f, 0, 1, 0))
	{
		func_55();
		BUILTIN::WAIT(0);
		func_37(&Static_74, "lurinau", "lurin_other", 4, 0, 0, 0);
		return true;
	}

	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Static_47, 15f, 15f, 15f, 0, 1, 0))
	{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Static_47, 40f, 40f, 40f, 0, 1, 0))
	...
	if (ENTITY::DOES_ENTITY_EXIST(Static_67))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Static_67, PLAYER::PLAYER_PED_ID(), 1))
		{
			func_55();
			return true;
		}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Static_68))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Static_68, PLAYER::PLAYER_PED_ID(), 1))
		{
			func_55();
			return true;
		}
...
void func_59() // Position - 0x2489
{
	if (!Static_242)
	{
		if (!PED::IS_PED_INJURED(Static_68))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(Static_68, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) == 7 && ENTITY::IS_ENTITY_AT_ENTITY(Static_68, PLAYER::PLAYER_PED_ID(), 2.8f, 2.8f, 2.8f, 0, 1, 0))
			{
				if (!Static_243)
				{
					Static_248 = 500;
					...
					if (func_98(func_50()) >= Static_248)
					{
						func_60(func_50(), 1, Static_248);
						Static_249 = Static_248;
						func_37(&Static_74, "lurinau", "lurin_mugtha", 4, 0, 0, 0);
					}
					else if (func_98(func_50()) <= 0)
					{
						Static_249 = 0;
						func_37(&Static_74, "lurinau", "lurin_mugnom", 4, 0, 0, 0);
					}
					else
					{
						Static_249 = func_98(func_50());
						func_60(func_50(), 1, func_98(func_50()));
						func_37(&Static_74, "lurinau", "lurin_mugtha", 4, 0, 0, 0);
					}
				
					if (!PED::IS_PED_INJURED(Static_68))
						PED::SET_PED_MONEY(Static_68, Static_249);
...
int func_60(int iParam0, int iParam1, int iParam2) // Position - 0x260D
{
	...
	return func_61(func_97(iParam0), 0, iParam1, iParam2, false);
}

int func_61(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4) // Position - 0x2641
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_62(bool bParam0) // Position - 0x2C40
{
	int iVar0;
	int iVar1;
...
void func_63(int iParam0) // Position - 0x2EC2
{
	int iVar0;
...
void func_64(int iParam0) // Position - 0x2F1C
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	if (func_72(iParam0))
	{
		func_73(func_71(iParam0), 0, -1, 1);
		return;
	}

	if (func_70(iParam0))
	{
		iVar0 = func_68(func_69(iParam0));
		func_67(func_69(iParam0), iVar0 - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114931.f_20571.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_66() /*5574*/].f_681.f_10, iParam0))
	{
		bVar1 = true;
		MISC::CLEAR_BIT(&(Global_114931.f_20571.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_66() /*5574*/].f_681.f_10), iParam0);
	}
...
char* func_65(int iParam0) // Position - 0x30E5
{
	switch (iParam0)
	{
		case 0:
...
void func_67(int iParam0, int iParam1) // Position - 0x3219
{
	int iVar0;
...
int func_68(int iParam0) // Position - 0x3235
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0) // Position - 0x3253
{
	switch (iParam0)
	{
		case 38:
...
bool func_70(int iParam0) // Position - 0x3275
{
	switch (iParam0)
	{
		case 38:
...
int func_71(int iParam0) // Position - 0x3292
{
	switch (iParam0)
	{
		case 18:
...
bool func_72(int iParam0) // Position - 0x3397
{
	switch (iParam0)
	{
		case 18:
...
void func_73(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3426
{
	int iVar0;
...
int func_74(int iParam0, int iParam1) // Position - 0x3454
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_75(iParam1));
}

bool func_75(bool bParam0) // Position - 0x3469
{
	bool bVar0;
	bool bVar1;
...
void func_76(int iParam0) // Position - 0x349D
{
	func_95(93, iParam0);
	func_95(29, iParam0);
	func_95(30, iParam0);
...
bool func_77(int iParam0) // Position - 0x34BD
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_72(iParam0))
	{
		...
		iVar13 = func_78(func_71(iParam0), -1);
	...
	if (func_70(iParam0))
	{
		iVar14 = func_68(func_69(iParam0));
	...
	if (iParam0 == 39)
		return func_79(7332, -1);

	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return IS_BIT_SET(Global_114931.f_20571.f_471, iParam0);

	return IS_BIT_SET(Global_2359296[func_66() /*5574*/].f_681.f_10, iParam0);
}

int func_78(int iParam0, int iParam1) // Position - 0x36C8
{
	var uVar0;
	int iVar1;
...
bool func_79(int iParam0, bool bParam1) // Position - 0x36F7
{
	if (bParam1 == -1)
		bParam1 = func_14();
...
int func_80(bool bParam0) // Position - 0x3713
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_81(int iParam0, int iParam1) // Position - 0x37CA
{
	if (iParam0 >= 78)
		return 0;
...
int func_82(int iParam0, int iParam1) // Position - 0x37E5
{
	if (func_23(14) && !func_93(iParam0))
		return 0;
	...
	if (func_92(&Global_4525144))
	{
		if (func_90(&Global_4525144, iParam0))
			return 0;
	
		if (func_83(&Global_4525144, iParam0))
			return 1;
	}
	else
	{
...
bool func_83(var uParam0, int iParam1) // Position - 0x3882
{
	int iVar0;
	var uVar1;
...
int func_84(var uParam0, int iParam1) // Position - 0x3933
{
	int iVar0;
...
bool func_85(var uParam0, int iParam1) // Position - 0x39AE
{
	return uParam0->[iParam1] == 78;
}

void func_86(var uParam0) // Position - 0x39BF
{
	int iVar0;
	...
	func_88(uParam0, Global_4525143 - 0.5f);
}

void func_87(var uParam0, int iParam1) // Position - 0x39F3
{
	uParam0->[iParam1] = 78;
}

void func_88(var uParam0, int iParam1) // Position - 0x3A03
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_89(var uParam0) // Position - 0x3A20
{
	return uParam0->f_80;
}

bool func_90(var uParam0, int iParam1) // Position - 0x3A2C
{
	return func_91(uParam0, iParam1) != -1;
}

int func_91(var uParam0, int iParam1) // Position - 0x3A3E
{
	int iVar0;
...
bool func_92(var uParam0) // Position - 0x3A6B
{
	return uParam0->f_79 == 1;
}

bool func_93(int iParam0) // Position - 0x3A79
{
	switch (iParam0)
	{
		case 60:
...
void func_94(int iParam0, int iParam1) // Position - 0x3AC9
{
	int iVar0;
...
void func_95(int iParam0, int iParam1) // Position - 0x3AEC
{
	int iVar0;
...
int func_97(int iParam0) // Position - 0x3BBE
{
	return Global_2339[iParam0 /*29*/].f_17;
}

int func_98(int iParam0) // Position - 0x3BCF
{
	int iVar0;
...
void func_99() // Position - 0x3C27
{
	if (!PED::IS_PED_INJURED(Static_68))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 873.9561f, -1050.8057f, 33.0066f, 4.75f, 1.9f, 1f, 0, 1, 0))
		{
			if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				TASK::TASK_LOOK_AT_ENTITY(Static_68, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
				PED::SET_PED_DUCKING(Static_68, 0);
				WEAPON::GIVE_WEAPON_TO_PED(Static_68, joaat("WEAPON_PISTOL"), 200, 1, 1);
				...
				else
				{
					...
					TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 2f, 0, 2.3f, 4f, 1, 1, joaat("FIRING_PATTERN_FULL_AUTO"));
					TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 500, 0);
					TASK::CLOSE_SEQUENCE_TASK(Static_73);
				}
			
				TASK::TASK_PERFORM_SEQUENCE(Static_68, Static_73);
				TASK::CLEAR_SEQUENCE_TASK(&Static_73);
				HUD::SET_BLIP_AS_FRIENDLY(Static_69, 0);
				Static_70 = func_107(Static_68, true, 145);
				AUDIO::TRIGGER_MUSIC_EVENT("RE35_OS");
				BUILTIN::WAIT(500);
			
				if (!PED::IS_PED_INJURED(Static_67))
				{
					TASK::TASK_LOOK_AT_ENTITY(Static_67, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					WEAPON::GIVE_WEAPON_TO_PED(Static_67, joaat("WEAPON_PISTOL"), 200, 1, 1);
					TASK::OPEN_SEQUENCE_TASK(&Static_73);
					TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Static_62, PLAYER::PLAYER_PED_ID(), 2f, 0, 0f, 4f, 1, 512, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&Static_73);
					TASK::TASK_LOOK_AT_ENTITY(0, Static_68, -1, 2048, 2);
					TASK::TASK_PAUSE(0, 1000);
					TASK::CLOSE_SEQUENCE_TASK(Static_73);
					TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), Static_73);
					TASK::CLEAR_SEQUENCE_TASK(&Static_73);
					func_100(true);
				}
				...
				func_55();
				BUILTIN::WAIT(0);
				func_37(&Static_74, "lurinau", "lurin_mugger", 4, 0, 0, 0);
				BUILTIN::SETTIMERA(0);
				Static_241 = true;
			}
			else
...
void func_100(bool bParam0) // Position - 0x3EC6
{
	if (bParam0)
	{
		func_106();
...
void func_101(int iParam0) // Position - 0x3F29
{
	if (func_104())
		return;
...
void func_102(bool bParam0, bool bParam1) // Position - 0x3FB3
{
	if (bParam0)
	{
		if (func_105(0))
...
bool func_103() // Position - 0x4028
{
	return IS_BIT_SET(Global_1964705, 5);
}

bool func_104() // Position - 0x4036
{
	return IS_BIT_SET(Global_1964705, 19);
}

bool func_105(int iParam0) // Position - 0x4045
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
int func_107(var uParam0, bool bParam1, int iParam2) // Position - 0x40C5
{
	int iVar0;

	iVar0 = func_108(uParam0, !bParam1, false);
...
int func_108(var uParam0, bool bParam1, bool bParam2) // Position - 0x410F
{
	int iVar0;
...
var func_109(bool bParam0, var uParam1, var uParam2) // Position - 0x41B3
{
	if (bParam0)
		return uParam1;
...
void func_110() // Position - 0x41CA
{
	if (!ENTITY::IS_ENTITY_DEAD(Static_67, 0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_67, 15f, 15f, 15f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!func_34())
				{
					if (Static_247 == 0)
					{
						func_37(&Static_74, "lurinau", "lurin_girlta", 4, 0, 0, 0);
						TASK::TASK_LOOK_AT_ENTITY(Static_67, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						Static_247 = Static_247 + 1;
						BUILTIN::SETTIMERB(0);
					}
				
					if (BUILTIN::TIMERB() > 3500 && Static_247 == 1 && !func_34())
					{
						func_37(&Static_74, "lurinau", "lurin_girltb", 4, 0, 0, 0);
						TASK::TASK_LOOK_AT_ENTITY(Static_67, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						Static_247 = Static_247 + 1;
						BUILTIN::SETTIMERB(0);
					}
				
					if (BUILTIN::TIMERB() > 7000 && Static_247 == 2 && !func_34())
					{
						BUILTIN::SETTIMERB(0);
						TASK::TASK_LOOK_AT_ENTITY(Static_67, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						func_37(&Static_74, "lurinau", "lurin_girlch", 4, 0, 0, 0);
					}
				}
			}
			else
...
void func_111() // Position - 0x42E2
{
	if (!PED::IS_PED_INJURED(Static_67))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::CAN_PED_SEE_HATED_PED(Static_67, PLAYER::PLAYER_PED_ID()))
			{
				TASK::CLEAR_PED_TASKS(Static_67);
				TASK::OPEN_SEQUENCE_TASK(&Static_73);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
...
void func_112() // Position - 0x43F0
{
	if (!func_141())
	{
		if (!ENTITY::IS_ENTITY_DEAD(Static_67, 0))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Static_47, 65f, 60f, 60f, 0, 1, 0) || Global_114926)
			{
				if (HUD::DOES_BLIP_EXIST(Static_71))
					HUD::REMOVE_BLIP(&Static_71);
			
				Static_69 = func_107(Static_67, false, 145);
				HUD::SHOW_HEIGHT_ON_BLIP(Static_69, 0);
	...
	if (!Static_239)
	{
		if (!PED::IS_PED_INJURED(Static_67))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_67, 25f, 25f, 25f, 0, 1, 0) && func_141())
			{
				if (func_37(&Static_74, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&Static_73);
	...
	if (!ENTITY::IS_ENTITY_DEAD(Static_67, 0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_67, 15f, 15f, 15f, 0, 1, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), 1);
	
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Static_67, 8f, 8f, 8f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				Static_240 = true;
				...
				if (HUD::DOES_BLIP_EXIST(Static_69))
					HUD::SHOW_HEIGHT_ON_BLIP(Static_69, 1);
			
				TASK::CLEAR_PED_TASKS(Static_67);
				func_37(&Static_74, "lurinau", "lurin_help", 4, 0, 0, 0);
			
				if (!ENTITY::IS_ENTITY_DEAD(Static_67, 0))
				{
					BUILTIN::SETTIMERB(0);
					TASK::CLEAR_PED_SECONDARY_TASK(Static_67);
					TASK::OPEN_SEQUENCE_TASK(&Static_73);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2064, 2);
					TASK::TASK_STAND_STILL(0, 1000);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Static_59, 2f, -1, 0.25f, 512, 80.1325f);
					TASK::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 1, 0, 0, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(Static_73);
					TASK::TASK_PERFORM_SEQUENCE(Static_67, Static_73);
					TASK::CLEAR_SEQUENCE_TASK(&Static_73);
					Static_53 = { 40f, 40f, 30f };
				}
			}
			else if (!Static_246)
			{
				...
				if (!func_34())
				{
					if (!PED::IS_PED_INJURED(Static_67))
					{
						func_37(&Static_74, "lurinau", "lurin_girlca", 4, 0, 0, 0);
						TASK::OPEN_SEQUENCE_TASK(&Static_73);
...
void func_113() // Position - 0x468F
{
	Global_21866 = 0;
	func_114();
}

void func_114() // Position - 0x469F
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_115(bool bParam0) // Position - 0x46C3
{
	if (func_119())
	{
		Global_114921 = true;
		...
		if (func_16(Global_114920))
			func_116(0);
	
		HUD::SET_MISSION_NAME(1, "RE_TITLE" /* GXT: Random Event */);
	
		if (bParam0 && func_16(Global_114920))
...
void func_116(int iParam0) // Position - 0x4716
{
	switch (iParam0)
	{
		case 0:
...
void func_117(char* sParam0, int iParam1) // Position - 0x47F1
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

char* func_118(int iParam0) // Position - 0x4808
{
	char* sVar0;
...
bool func_119() // Position - 0x484B
{
	switch (func_120(&Global_33852, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_120(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4) // Position - 0x4881
{
	int iVar0;
...
void func_121(var uParam0, int iParam1) // Position - 0x49B8
{
	int iVar0;
...
bool func_122(int iParam0) // Position - 0x4A07
{
	return func_123(iParam0, Global_44886);
}

bool func_123(int iParam0, int iParam1) // Position - 0x4A18
{
	if (iParam1 == 15)
		return 1;
...
bool func_124(int iParam0) // Position - 0x4BF9
{
	if (Global_44886 == 15)
		return false;
...
void func_125() // Position - 0x4C1B
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(Static_47 - { 10f, 30f, 30f }, Static_47 + { 10f, 30f, 30f }, 0, 1, 1, 1, 1);
	PED::ADD_RELATIONSHIP_GROUP("mugger", &Static_66);
	Static_67 = PED::CREATE_PED(19, joaat("A_F_M_SKIDROW_01"), Static_56, 79.765f, 1, 1);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_67, 1);
	PED::SET_PED_CONFIG_FLAG(Static_67, 185, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(Static_67, 128, 1);
	AUDIO::STOP_PED_SPEAKING(Static_67, 1);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(Static_67, Static_66);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Static_66, joaat("PLAYER"));
	TASK::OPEN_SEQUENCE_TASK(&Static_73);
	TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 3076, 2);
	...
	TASK::TASK_PERFORM_SEQUENCE(Static_67, Static_73);
	TASK::CLEAR_SEQUENCE_TASK(&Static_73);
	Static_68 = PED::CREATE_PED(7, joaat("A_M_M_TRAMP_01"), Static_50, Static_65, 1, 1);
	AUDIO::SET_AMBIENT_VOICE_NAME(Static_68, "A_M_M_TRAMP_01_BLACK_MINI_01");
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_68, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(Static_68, 128, 1);
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(Static_68, 1, 0);
	AUDIO::STOP_PED_SPEAKING(Static_68, 1);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(Static_68, Static_66);
	TASK::TASK_LOOK_AT_ENTITY(Static_68, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
	func_126(&Static_74, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN" /* GXT: Franklin */, 0, 1);
	func_126(&Static_74, 4, Static_67, "HOBOFEMALE", 0, 1);
	func_126(&Static_74, 5, Static_68, "HOBOMALE", 0, 1);
	Static_45 = true;
}

void func_126(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x4E08
{
...
void func_127() // Position - 0x4EA3
{
	Static_50 = { 879.8144f, -1047.4327f, 32.0067f };
	Static_65 = 237.0934f;
	Static_56 = { 862.9633f, -1049.8569f, 28.5362f };
	Static_53 = { 15f, 15f, 15f };
	Static_59 = { 881.1367f, -1050.706f, 32.0067f };
	Static_62 = { 876.7977f, -1052.5198f, 32.0067f };
}

bool func_128() // Position - 0x4F11
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (BUILTIN::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_139())
			return false;
	}
	...
	if (func_129(100f, true) != -1)
		return true;

	return false;
}

int func_129(float fParam0, bool bParam1) // Position - 0x4F97
{
	var uVar0;
	int iVar32;
	int iVar33;
...
void func_130(int iParam0, var uParam1) // Position - 0x5048
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_131(uParam1, "Barry3A", func_133(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /* GXT: Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry. */, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		...
		case 8:
			func_131(uParam1, "Dreyfuss1", func_133(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /* GXT: The killer's identity and location have been revealed. */, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_132(iParam0), 0, 0);
			break;
		...
		case 38:
			func_131(uParam1, "Nigel1A", func_133(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /* GXT: Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill. */, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_132(iParam0), 1, 1);
			break;
		...
		case 49:
			func_131(uParam1, "Paparazzo3A", func_133(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /* GXT: Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly. */, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		...
		case 58:
			func_131(uParam1, "Tonya1", func_133(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /* GXT: Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~ */, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
...
void func_131(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, float fParam7, float fParam8, float fParam9, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24) // Position - 0x61FD
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { uParam2 };
...
int func_132(int iParam0) // Position - 0x628E
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_133(int iParam0) // Position - 0x65D4
{
	var uVar0;
	var uVar2;

	TEXT_LABEL_ASSIGN_STRING(&uVar0, "", 8);
	uVar2 = { func_134(iParam0) };
...
struct<2> func_134(int iParam0) // Position - 0x660B
{
	var uVar0;
...
bool func_136() // Position - 0x6A89
{
	return Global_114649 > 0;
}

bool func_137() // Position - 0x6A97
{
	if (Global_99351 != -1)
		return true;
...
bool func_141() // Position - 0x6B4E
{
	if (Global_114920 == func_31() && MISC::GET_RANDOM_EVENT_FLAG() && Global_114921)
		return true;

	return false;
}

void func_142(int iParam0) // Position - 0x6B79
{
	if (iParam0 == -1)
		iParam0 = func_31();
...
void func_144(int iParam0) // Position - 0x6BEC
{
	Global_114920 = iParam0;
}

bool func_145(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6) // Position - 0x6BFA
{
	bool bVar0;
	var uVar1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (func_24(func_50()))
			if (func_183(func_50()) == 4 || func_183(func_50()) == 5)
				return false;
	
		if (func_24(func_50()))
			if (!func_182(iParam3, iParam4, 145))
				return false;
	
		if (!func_181(Global_114931.f_25002.f_43[iParam3]))
			return false;
		...
		if (func_170(iParam3, iParam4) && !bParam5)
			return false;
		...
		if (iParam3 == 9 && iParam4 == 2 || iParam4 == 5 && !func_170(0, 0))
			return false;
	
		if (Global_33939)
			return false;
	
		if (func_184(30) && !func_170(30, 0))
			if (iParam3 != 30)
		...
		if (func_24(func_50()))
		{
			for (iVar4 = 0; iVar4 < 3; iVar4 = iVar4 + 1)
			{
				...
				if (func_169(iVar8))
					if (func_147(iVar4))
						if (!func_146(uVar5, 0f, 0f, 0f, false))
...
bool func_146(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, bool bParam6) // Position - 0x6F94
{
	if (bParam6)
...
bool func_147(int iParam0) // Position - 0x6FDB
{
	int iVar0;
...
bool func_148(int iParam0) // Position - 0x6FFC
{
	return func_149(iParam0, 1);
}

int func_149(int iParam0, int iParam1) // Position - 0x700B
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_150(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x705E
{
	func_151(func_162(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_151(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x707C
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_161(iParam0, iParam1))
	{
		...
		iVar4 = func_157(iParam0) - func_157(iParam1);
		iVar5 = func_156(iParam0) - func_156(iParam1);
	...
	else
	{
		...
		iVar4 = func_157(iParam1) - func_157(iParam0);
		iVar5 = func_156(iParam1) - func_156(iParam0);
	...
	while (iVar4 < 0)
	{
		...
		iVar4 = iVar4 + func_153(iVar0, iVar1);
		iVar3 = iVar3 - 1;
		iVar0 = BUILTIN::ROUND(func_152(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
...
float func_152(float fParam0, float fParam1, float fParam2) // Position - 0x727D
{
	float fVar0;
...
int func_153(int iParam0, int iParam1) // Position - 0x72BF
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_154(int iParam0) // Position - 0x7361
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_155(int iParam0) // Position - 0x7374
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_156(int iParam0) // Position - 0x7387
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_157(int iParam0) // Position - 0x739A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_158(int iParam0) // Position - 0x73AC
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_159(bool bParam0, var uParam1, var uParam2) // Position - 0x73CE
{
	if (bParam0)
		return uParam1;
...
int func_160(int iParam0) // Position - 0x73E5
{
	return iParam0 & 15;
}

bool func_161(int iParam0, int iParam1) // Position - 0x73F2
{
	int iVar0;
	int iVar1;

	if (!func_169(iParam1) || !func_169(iParam0))
		return 1;
...
void func_163(var uParam0, int iParam1) // Position - 0x7544
{
	if (iParam1 <= 0)
		return;
...
void func_164(var uParam0, int iParam1) // Position - 0x75CA
{
...
void func_165(var uParam0, int iParam1) // Position - 0x75FD
{
	int iVar0;
	int iVar1;
...
void func_166(var uParam0, int iParam1) // Position - 0x764E
{
...
void func_167(var uParam0, int iParam1) // Position - 0x7688
{
...
void func_168(var uParam0, int iParam1) // Position - 0x76C3
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
bool func_169(int iParam0) // Position - 0x76FF
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar5 = func_157(iParam0);

	if (iVar5 < 1 || iVar5 > func_153(iVar4, iVar3))
		return false;

	return true;
}

bool func_170(int iParam0, int iParam1) // Position - 0x77DB
{
...
bool func_171(int iParam0) // Position - 0x77FB
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_179() || Global_113978 || Global_33795 || func_178() || func_52(8, -1) || func_177() || func_176() || func_175() || func_174() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_179() || Global_33795 || func_178() || func_52(8, -1) || func_175() || func_177() || func_176() || func_174() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_179() || Global_113978 || Global_33795 || func_178() || func_52(8, -1) || func_175() || func_177() || func_176() || func_174() || Global_114931.f_7695.f_919[iVar0] == 5 || Global_45433 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_179() || Global_113978 || Global_33795 || func_178() || func_52(8, -1) || func_177() || func_176() || func_174() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 4:
						if (func_179() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_52(8, -1) || func_174() || func_173() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 5:
						if (func_52(8, -1) || func_177() || func_176() || func_173() || func_172())
							return false;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_179() || Global_33795 || func_178() || func_52(8, -1) || func_176() || func_175() || func_174() || Global_114931.f_7695.f_919[iVar0] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_179() || func_176() || Global_113978 || Global_33795 || func_178() || Global_46111 || func_52(8, -1) || func_175() || func_173() || func_174() || Global_114931.f_7695.f_919[iVar0] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_179() || Global_113978 || Global_33795 || func_178() || func_52(8, -1) || func_175() || func_173() || func_177() || func_176() || func_174())
							return false;
						break;
				}
			}
...
bool func_172() // Position - 0x7F18
{
	return Global_102493.f_1;
}

bool func_173() // Position - 0x7F26
{
	if (Global_99351 != -1)
...
bool func_176() // Position - 0x7F8D
{
	return Global_102506.f_418 > 0;
}

bool func_177() // Position - 0x7F9E
{
	return Global_102506.f_417 > 0;
}

bool func_178() // Position - 0x7FAF
{
	return Global_1575092;
}

bool func_179() // Position - 0x7FBB
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
bool func_181(int iParam0) // Position - 0x7FFF
{
	return func_161(func_162(), iParam0);
}

bool func_182(int iParam0, int iParam1, int iParam2) // Position - 0x8012
{
	bool bVar0;
	int iVar1;
...
int func_183(int iParam0) // Position - 0x80F6
{
	if (!func_24(iParam0))
		return 7;
...
bool func_184(int iParam0) // Position - 0x811A
{
	int iVar0;
	bool bVar1;
...
void func_187() // Position - 0x826E
{
	if (Static_46)
	{
		...
		OBJECT::DELETE_OBJECT(&Static_72);
...
void func_188(int iParam0) // Position - 0x832E
{
	var uVar0;
	...
	if (func_141())
	{
		...
		func_191(30000);
		TEXT_LABEL_ASSIGN_STRING(&uVar0, func_190(Global_114920, true), 64);
	
		if (func_30(Global_114920) > 0)
		{
	...
	func_189(&Global_33852);
	Global_114921 = false;
	func_144(-1);
}

void func_189(var uParam0) // Position - 0x83E0
{
	if (*uParam0 == -1)
		return;
...
char* func_190(int iParam0, bool bParam1) // Position - 0x841D
{
	switch (iParam0)
	{
		case 0:
...
void func_191(int iParam0) // Position - 0x8666
{
	Global_45437 = MISC::GET_GAME_TIMER() + iParam0;
}

void func_192(int iParam0) // Position - 0x8678
{
	func_193(iParam0, 0, func_198(iParam0));
}

void func_193(int iParam0, int iParam1, int iParam2) // Position - 0x868D
{
	int iVar0;
	var uVar1;

	iVar0 = func_162();
	func_196(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_195(iParam0, &iVar0);
	uVar1 = { func_194(&iVar0) };
}

struct<16> func_194(var uParam0) // Position - 0x86BC
{
	var uVar0;
	int iVar16;
	...
	TEXT_LABEL_APPEND_STRING(&uVar0, "/", 64);
	TEXT_LABEL_APPEND_INT(&uVar0, func_158(*uParam0), 64);
	return uVar0;
}

void func_195(int iParam0, var uParam1) // Position - 0x878C
{
	Global_114931.f_25002.f_43[iParam0] = *uParam1;
}

void func_196(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x87A4
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar2 = func_157(*uParam0);
	iVar3 = func_156(*uParam0);
	...
	for (iVar6 = func_153(iVar1, iVar0); iVar2 > iVar6; iVar6 = func_153(iVar1, iVar0))
	{
		iVar1 = iVar1 + 1;
		iVar2 = iVar2 - iVar6;
...
void func_197(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8926
{
...
int func_198(int iParam0) // Position - 0x895E
{
	int iVar0;
