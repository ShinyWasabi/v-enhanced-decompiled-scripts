...
void main() // Position - 0x0
{
	...
	Static_42 = 49;
	Static_43 = 64;
	Static_53 = joaat("CS_DRFRIEDLANDER");
	Static_54 = joaat("IG_DRFRIEDLANDER");
	Static_55 = joaat("COMET2");
	Static_56 = joaat("EXEMPLAR");
	Static_57 = joaat("V_ILEV_P_EASYCHAIR");
	TEXT_LABEL_ASSIGN_STRING(&Static_405, "Michael" /* GXT: Michael */, 24);
	TEXT_LABEL_ASSIGN_STRING(&Static_411, "Therapist", 24);
	Static_417 = { -1907.785f, -574.8f, 18.616f };
	Static_420 = { -1895.5337f, -564.2134f, 11.3497f };
	Static_423 = 179f;
	Static_424 = 314.381f;
	Static_425 = 54.08f;
	MISC::SET_MISSION_FLAG(1);
	TEXT_LABEL_ASSIGN_STRING(&uVar14, "DrfAud", 16);
	Static_430 = func_285() ? 0 : 1;
	Static_431 = func_285() ? 0 : 1;
	Static_432 = func_285() ? 0 : 1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		...
		if (bVar23)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Static_398) && PED::IS_PED_INJURED(Static_398))
			{
				func_282(80, 1);
				STATS::STAT_SET_BOOL(joaat("SP_KILLED_DR_FRIEDLANDER"), 1, 1);
			}
		...
		func_265(&Static_397, &Static_400, Static_402, Static_58);
	}

	Static_80 = func_264();
	func_263(&Static_59, Static_80);
	...
	while (true)
	{
		...
		switch (Static_58)
		{
			case 0:
				...
				func_257(&Static_46, Static_53, Static_54, Static_55, Static_56, Static_57, func_264());
				...
				uVar12 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), -1896.5294f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				uVar13 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), -1896.8657f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				CAM::SET_CAM_ACTIVE_WITH_INTERP(uVar13, uVar12, 5000, 1, 1);
			...
			case 1:
				if (!bVar4)
				{
					if (func_253(&Static_46))
					{
						func_243(&Static_397, Static_53, Static_417, Static_423, Static_430, Static_431, Static_432);
						func_233(&Static_59, func_264());
						func_255(&Static_246);
						bVar4 = true;
					}
				}
					...
					if (!bVar5)
					{
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
								func_146(&Static_405, PLAYER::PLAYER_PED_ID(), 0, 2);
						
							if (!ENTITY::IS_ENTITY_DEAD(Static_397, 0))
								func_146(&Static_411, Static_397, 0, 2);
				...
				if (func_144(&uVar6) > 6f && func_143())
				{
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(Static_397, 0))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &Static_405, 0, 0, 0);
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Static_397, &Static_411, 0, 0, 0);
					}
			...
			case 2:
				if (CAM::DOES_CAM_EXIST(uVar12))
					CAM::DESTROY_CAM(uVar12, 0);
			
				if (CAM::DOES_CAM_EXIST(uVar13))
					CAM::DESTROY_CAM(uVar13, 0);
			
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&Static_405, 0))
					func_141(Static_397, true, false);
			
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&Static_411, 0))
					func_141(Static_397, false, true);
			
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					func_140(Static_397, &Static_399, &Static_400, &Static_402, &Static_81, Static_420, Static_425, Static_55);
					func_138(func_264());
					func_255(&Static_249);
					func_137(&Static_273, false, false, false, true);
					func_136(&Static_273, "SHRINK_ACCEPT" /* GXT: Accept advice */, 2, 201, 1, 1, 0);
					func_136(&Static_273, "SHRINK_REJECT" /* GXT: Reject advice */, 2, 202, 1, 1, 0);
					bVar5 = false;
					PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
					Static_58 = 3;
			...
			case 3:
				...
				if (CAM::IS_SCREEN_FADED_OUT() || bVar24)
				{
					...
					while (func_144(&Static_249) < 0.4f)
					{
						BUILTIN::WAIT(0);
						func_129();
					}
				...
				if (!bVar2)
				{
					if (!Static_433 && !CUTSCENE::IS_CUTSCENE_ACTIVE())
					{
						Static_59.f_20 = 0;
						func_116(&(Static_59.f_12), &Static_59, func_264());
						Static_433 = true;
					}
				
					if (func_106(&Static_249, &Static_273, &bVar1))
					{
						if (bVar1)
						{
							Static_59.f_20 = 0;
					...
					else if (func_144(&Static_249) >= 14f)
					{
						Static_59.f_20 = 2;
						bVar2 = true;
						HUD::CLEAR_HELP(1);
					}
					else if (!bVar3 && func_144(&Static_249) >= 7f)
					{
						TEXT_LABEL_ASSIGN_STRING(&uVar18, "DRF_PROMPT", 16);
						func_105(&Static_81, &uVar14, &uVar18, 9, 0, 0, 0);
						bVar3 = true;
					}
				}
				else if (func_144(&Static_249) > 5f && func_143() || CUTSCENE::HAS_CUTSCENE_LOADED() && Static_59.f_20 != 1 || func_144(&Static_249) > fVar22 || func_102(Static_80, Static_397, &Static_402))
				{
					func_99();
					...
					CUTSCENE::START_CUTSCENE(0);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Static_57);
					Static_58 = 14;
				}
			...
			case 14:
				if (CAM::DOES_CAM_EXIST(Static_402))
				{
					CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
					CAM::DESTROY_CAM(Static_402, 0);
				}
			
				if (func_98() && CUTSCENE::IS_CUTSCENE_PLAYING() && !CAM::IS_SCREEN_FADING_OUT() && !CAM::IS_SCREEN_FADED_OUT())
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					...
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							ENTITY::SET_ENTITY_COLLISION(PLAYER::PLAYER_PED_ID(), 1, 0);
							ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 0);
							func_95(PLAYER::PLAYER_PED_ID(), -1902.6094f, -559.9267f, 10.7916f);
							ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), Static_424);
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
							CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
							func_86(false, true, true, 0, false, false, false);
							Static_400 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
						
							if (ENTITY::DOES_ENTITY_EXIST(Static_400))
							{
								if (!ENTITY::IS_ENTITY_DEAD(Static_400, 0))
								{
									ENTITY::SET_ENTITY_COORDS(Static_400, func_85(Static_400), 1, 0, 0, 1);
									ENTITY::SET_ENTITY_HEADING(Static_400, 231f);
								}
							}
							...
							if (CAM::IS_SCREEN_FADED_OUT())
							{
								if (!Static_434)
								{
									STREAMING::NEW_LOAD_SCENE_START(-1903.8698f, -562.9188f, 12.8354f, func_84({ 12.8015f, -560.0015f, -1901.3314f } - { 12.8354f, -562.9188f, -1903.8698f }), 100f, 0);
									Static_434 = true;
									BUILTIN::WAIT(0);
								}
				...
				else
				{
					if (!Static_434)
					{
						...
						{
							if (Static_80 == 4)
								STREAMING::NEW_LOAD_SCENE_START(-1905.4998f, -557.8768f, 12.4125f, func_84({ 11.9712f, -560.4745f, -1903.8552f } - { 12.4125f, -557.8768f, -1905.4998f }), 100f, 0);
							else
								STREAMING::NEW_LOAD_SCENE_START(-1903.8698f, -562.9188f, 12.8354f, func_84({ 12.8015f, -560.0015f, -1901.3314f } - { 12.8354f, -562.9188f, -1903.8698f }), 100f, 0);
					...
					if (!Static_435)
					{
						if (CUTSCENE::GET_CUTSCENE_CONCAT_SECTION_PLAYING() >= 16)
						{
							...
							else if (func_144(&uVar9) > func_82(func_264()))
							{
								if (func_264() == 4)
								{
									Static_398 = PED::CREATE_PED(26, Static_54, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
									PED::SET_PED_COMPONENT_VARIATION(Static_398, 3, Static_430, Static_431, 0);
									PED::SET_PED_COMPONENT_VARIATION(Static_398, 4, 0, Static_432, 0);
									PED::SET_PED_MONEY(Static_398, 2000 + MISC::GET_RANDOM_INT_IN_RANGE(5, 301));
									ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Static_398, 1, 1);
									func_81(&Static_81, 1, Static_398, "FRIEDLANDER", 0, 1);
								}
			...
			case 15:
				...
				if (ENTITY::IS_ENTITY_DEAD(Static_398, 0))
				{
					func_282(80, true);
					STATS::STAT_SET_BOOL(joaat("SP_KILLED_DR_FRIEDLANDER"), 1, 1);
					func_105(&Static_81, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
				
					if (HUD::DOES_BLIP_EXIST(Static_401))
						HUD::SET_BLIP_COLOUR(Static_401, 1);
				
					Static_58 = 17;
				}
				else if (!ENTITY::DOES_ENTITY_EXIST(Static_398) || func_80(Static_398, PLAYER::PLAYER_PED_ID(), 1) > 300f)
				{
					func_105(&Static_81, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
				
					if (HUD::DOES_BLIP_EXIST(Static_401))
						HUD::SET_BLIP_COLOUR(Static_401, 3);
				
					if (ENTITY::DOES_ENTITY_EXIST(Static_398))
						MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(Static_398, 1), 10f, 0);
				...
				{
					func_62();
					PED::SET_PED_CONFIG_FLAG(Static_398, 26, 1);
				
					if (func_83(&Static_264))
					{
						if (func_144(&Static_264) > 2.5f)
						{
							PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 2f, 1000, 0, 1, 0, 0);
							PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
							func_142(&Static_264);
						}
					}
					...
					if (!Static_437)
					{
						...
						if (func_144(&Static_261) > 2f)
						{
							switch (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE())
							{
								case 0:
									uVar26 = { -1905.289f, -560.9047f, 12.5379f };
									uVar29 = { -8.9999f, 0f, -99.8165f };
									break;
							
								case 1:
									uVar26 = { -1908.0061f, -560.4351f, 12.6592f };
									uVar29 = { -3f, 0f, -99.8148f };
									break;
							
								case 2:
									uVar26 = { -1908.7588f, -558.642f, 13.4942f };
									uVar29 = { -12.0007f, 0f, -115.8697f };
									break;
							
								case 4:
									uVar26 = { -1904.6583f, -560.0228f, 12.4975f };
									uVar29 = { -10.0948f, 0.0099f, -128.3421f };
									break;
							...
							Static_402 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), uVar26, uVar29, 50f, 0, 2);
							CAM::SET_CAM_ACTIVE_WITH_INTERP(Static_402, Static_403, 2660, 1, 1);
						
							if (ENTITY::DOES_ENTITY_EXIST(Static_400) && !ENTITY::IS_ENTITY_DEAD(Static_400, 0))
							{
								VEHICLE::SET_VEHICLE_FIXED(Static_400);
								ENTITY::SET_ENTITY_INVINCIBLE(Static_400, 0, 0);
								VEHICLE::SET_VEHICLE_CAN_BREAK(Static_400, 1);
							}
					...
					else if (CAM::DOES_CAM_EXIST(Static_403))
					{
						if (func_144(&Static_261) >= 2.66f)
						{
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 2 ? -16f : 0f);
							CAM::RENDER_SCRIPT_CAMS(0, 1, 340, 0, 0, 0);
							CAM::DESTROY_CAM(Static_403, 0);
						}
						else
						{
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					if (Static_436 && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
					{
						if (func_59(&Static_255, 0.5f))
						{
							...
							if (!HUD::DOES_BLIP_EXIST(Static_401))
							{
								if (!ENTITY::IS_ENTITY_DEAD(Static_398, 0))
								{
									Static_401 = HUD::ADD_BLIP_FOR_ENTITY(Static_398);
									HUD::SET_BLIP_COLOUR(Static_401, 1);
									func_128(&Static_255);
								}
							}
							else if (HUD::GET_BLIP_COLOUR(Static_401) != 3)
							{
								HUD::SET_BLIP_COLOUR(Static_401, 3);
							
								if (func_83(&Static_258))
								{
									if (func_144(&Static_258) < 7500f / 1000f)
									{
										func_58("SHRINK_KILL_B" /* GXT: Take out ~b~Dr. Friedlander~s~ or let him go. */, 7500, 1);
									}
									else
									{
							...
							else
							{
								...
								if (func_83(&Static_258))
								{
									if (func_144(&Static_258) < 7500f / 1000f)
									{
										func_58("SHRINK_KILL_R" /* GXT: Take out ~r~Dr. Friedlander~s~ or let him go. */, 7500, 1);
									}
									else
									{
										HUD::CLEAR_SMALL_PRINTS();
					...
					{
						func_56(&Static_255, 0.3f);
					}
				
					if (!PED::IS_PED_INJURED(Static_398))
					{
						if (ENTITY::DOES_ENTITY_EXIST(Static_399))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(Static_398, 0))
								bVar0 = true;
						
							if (!PED::IS_PED_FLEEING(Static_398))
								if (!VEHICLE::IS_VEHICLE_DRIVEABLE(Static_399, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Static_399, 1) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Static_399, 0, 2000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Static_399, 1, 2000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Static_399, 2, 2000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Static_399, 3, 2000) || bVar0 && !PED::IS_PED_IN_ANY_VEHICLE(Static_398, 0) || func_55(Static_399) || func_51(Static_399))
									TASK::TASK_SMART_FLEE_PED(Static_398, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
						}
						else if (!PED::IS_PED_FLEEING(Static_398))
						{
							TASK::TASK_SMART_FLEE_PED(Static_398, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
						}
					
						if (!bVar25 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(Static_398, -1892.139f, -567.19403f, 10.5f, -1904.9349f, -556.44226f, 13.5f, 4.73f, 0, 1, 0))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_398, 0);
							bVar25 = true;
						}
					}
				}
			...
			case 16:
				if (!func_83(&Static_252))
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					func_255(&Static_252);
				}
				else if (func_144(&Static_252) > 2f)
				{
					func_2(func_45(), 24, func_44(Static_80));
					func_283();
			...
			case 17:
				...
				if (func_144(&Static_252) > 4f || CAM::IS_SCREEN_FADED_OUT())
				{
					HUD::REMOVE_BLIP(&Static_401);
					...
					{
						if (ENTITY::DOES_ENTITY_EXIST(Static_398))
							if (ENTITY::DOES_ENTITY_EXIST(Static_399) && PED::IS_PED_IN_VEHICLE(Static_398, Static_399, 0))
								VEHICLE::DELETE_VEHICLE(&Static_399);
					
						PED::DELETE_PED(&Static_398);
					}
...
int func_2(int iParam0, int iParam1, int iParam2) // Position - 0x1128
{
	...
	return func_3(func_43(iParam0), 0, iParam1, iParam2, false);
}
...
void func_6(int iParam0) // Position - 0x1A37
{
	...
	if (func_12(iParam0))
	{
		...
		func_9(func_11(iParam0), iVar0 - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114931.f_20571.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_8() /*5574*/].f_681.f_10, iParam0))
	{
		bVar1 = true;
		MISC::CLEAR_BIT(&(Global_114931.f_20571.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_8() /*5574*/].f_681.f_10), iParam0);
	}
...
void func_9(int iParam0, int iParam1) // Position - 0x1D36
{
	int iVar0;
...
int func_10(int iParam0) // Position - 0x1D52
{
	int iVar0;
	int iVar1;
...
int func_11(int iParam0) // Position - 0x1D70
{
	switch (iParam0)
	{
		case 38:
...
void func_15(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1F43
{
	int iVar0;
...
int func_16(int iParam0, int iParam1) // Position - 0x1F71
{
...
void func_19(int iParam0, int iParam1, int iParam2) // Position - 0x1FC6
{
	if (iParam2 == -1)
		iParam2 = func_18();
...
bool func_21(int iParam0) // Position - 0x2004
{
	...
	if (func_14(iParam0))
	{
		...
		iVar13 = func_22(func_13(iParam0), -1);
	...
	if (func_12(iParam0))
	{
		iVar14 = func_10(func_11(iParam0));
	...
	if (iParam0 == 39)
		return func_23(7332, -1);

	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return IS_BIT_SET(Global_114931.f_20571.f_471, iParam0);

	return IS_BIT_SET(Global_2359296[func_8() /*5574*/].f_681.f_10, iParam0);
}
...
bool func_23(int iParam0, int iParam1) // Position - 0x223E
{
	if (iParam1 == -1)
		iParam1 = func_18();
...
int func_26(int iParam0, int iParam1) // Position - 0x232C
{
	...
	if (func_36(&Global_4525144))
	{
		if (func_34(&Global_4525144, iParam0))
			return 0;
	
		if (func_27(&Global_4525144, iParam0))
			return 1;
	}
	else
	{
...
void func_30(var uParam0) // Position - 0x2506
{
	...
	func_32(uParam0, Global_4525143 - 0.5f);
}
...
int func_39(int iParam0, int iParam1) // Position - 0x261E
{
	int iVar0;
...
void func_40(int iParam0, int iParam1) // Position - 0x266F
{
	int iVar0;
...
int func_43(int iParam0) // Position - 0x2764
{
...
void func_46() // Position - 0x27E9
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_49(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_47(iVar0) && !func_38(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != iVar0 && func_47(Global_114931.f_2370.f_539.f_4321))
...
bool func_47(int iParam0) // Position - 0x28E6
{
	return iParam0 < 3;
}

int func_48(int iParam0) // Position - 0x28F2
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0) // Position - 0x292F
{
	if (func_47(iParam0))
...
int func_50(int iParam0) // Position - 0x2954
{
	return Global_2339[iParam0 /*29*/];
}

bool func_51(var uParam0) // Position - 0x2963
{
	var uVar0;
	int iVar1;

	if (func_54(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_52(uParam0))
	{
		...
		if (func_52(uVar0))
		{
			...
			if (iVar1 == joaat("CARGOBOB") || iVar1 == joaat("CARGOBOB2") || iVar1 == joaat("CARGOBOB3") || iVar1 == joaat("CARGOBOB5"))
				if (VEHICLE::DOES_CARGOBOB_HAVE_PICK_UP_ROPE(uVar0))
					if (VEHICLE::IS_VEHICLE_ATTACHED_TO_CARGOBOB(uVar0, uParam0))
						return true;
		}
	}
...
bool func_52(var uParam0) // Position - 0x29F4
{
	if (func_53(uParam0))
...
bool func_53(var uParam0) // Position - 0x2A1E
{
...
int func_54(var uParam0) // Position - 0x2A3F
{
	if (func_53(uParam0))
...
bool func_55(var uParam0) // Position - 0x2A5F
{
	var uVar0;
	int iVar1;
...
void func_56(var uParam0, float fParam1) // Position - 0x2ACB
{
	uParam0->f_1 = func_57(IS_BIT_SET(*uParam0, 4)) - fParam1;
...
void func_58(char* sParam0, int iParam1, int iParam2) // Position - 0x2B4E
{
	iParam2 = iParam2;
...
bool func_59(var uParam0, float fParam1) // Position - 0x2B67
{
...
bool func_60(var uParam0, float fParam1) // Position - 0x2B85
{
	if (func_83(uParam0))
...
void func_62() // Position - 0x2BBE
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Static_398) || ENTITY::IS_ENTITY_DEAD(Static_398, 0) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		return;

	if (!func_83(&Static_267))
		func_255(&Static_267);

	if (!func_83(&Static_270))
		func_255(&Static_270);

	fVar6 = BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Static_398, 1));

	if (Static_427 < 7)
	{
		if (Static_427 <= 0)
		{
			if (func_144(&Static_267) > 0.2f)
			{
				iVar4 = MISC::GET_RANDOM_INT_IN_RANGE(0, 7);
				MISC::SET_BIT(&Static_426, iVar4);
				TEXT_LABEL_ASSIGN_STRING(&uVar0, "DRF_RUNOFF_", 16);
				TEXT_LABEL_APPEND_INT(&uVar0, iVar4 + 1, 16);
				func_63(&Static_81, "DrfAud", "DRF_RUNOFF", &uVar0, 8, 0, 0);
				Static_427 = 1;
				func_128(&Static_267);
			}
		}
		else if (func_144(&Static_267) > 12f)
		{
			if (fVar6 <= 144f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()))
			{
				iVar4 = MISC::GET_RANDOM_INT_IN_RANGE(0, 7 - Static_427);
			
				while (iVar5 >= 0 && iVar5 < 7)
				{
					if (!IS_BIT_SET(Static_426, iVar5))
					{
						if (iVar4 == 0)
						{
							MISC::SET_BIT(&Static_426, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
				...
				TEXT_LABEL_APPEND_INT(&uVar0, iVar4 + 1, 16);
				func_63(&Static_81, "DrfAud", "DRF_RUNOFF", &uVar0, 8, 0, 0);
				Static_427 = Static_427 + 1;
				func_128(&Static_267);
			}
			else
			{
				func_56(&Static_267, 6f);
			}
		}
	}
	...
	if (Static_429 < 8)
	{
		if (Static_429 <= 0)
		{
			if (func_144(&Static_270) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(Static_398))
			{
				iVar4 = MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
				MISC::SET_BIT(&Static_428, iVar4);
				TEXT_LABEL_ASSIGN_STRING(&uVar0, "DRF_CHASE_", 16);
				TEXT_LABEL_APPEND_INT(&uVar0, iVar4 + 1, 16);
				func_63(&Static_81, "DrfAud", "DRF_CHASE", &uVar0, 8, 0, 0);
				Static_429 = 1;
				func_128(&Static_270);
			}
		}
		else if (func_144(&Static_270) > 10.3f)
		{
			if (fVar6 <= 2500f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(Static_398))
			{
				iVar4 = MISC::GET_RANDOM_INT_IN_RANGE(0, 8 - Static_429);
			
				for (iVar5 = 0; iVar5 >= 0; iVar5 = iVar5 + 1)
				{
					if (!IS_BIT_SET(Static_428, iVar5))
					{
						if (iVar4 == 0)
						{
							MISC::SET_BIT(&Static_428, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
				...
				TEXT_LABEL_APPEND_INT(&uVar0, iVar4 + 1, 16);
				func_63(&Static_81, "DrfAud", "DRF_CHASE", &uVar0, 8, 0, 0);
				Static_429 = Static_429 + 1;
				func_128(&Static_270);
			}
			else
			{
				func_56(&Static_270, 5f);
			}
		}
	}

	if (!Static_436 && Static_427 >= 1 && Static_429 >= 1 && !HUD::IS_MESSAGE_BEING_DISPLAYED())
		Static_436 = true;
}
...
bool func_67(int iParam0) // Position - 0x3245
{
...
bool func_68(int iParam0, int iParam1) // Position - 0x327C
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_69(int iParam0) // Position - 0x3294
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_70() // Position - 0x32A6
{
	return -1;
}

void func_71() // Position - 0x32AF
{
	int iVar0;
...
bool func_77(int iParam0, int iParam1) // Position - 0x352E
{
	switch (iParam0)
	{
		case 5:
...
void func_79(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x35BD
{
...
float func_80(int iParam0, var uParam1, int iParam2) // Position - 0x3613
{
	var uVar0;
	var uVar3;
...
void func_81(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3671
{
...
float func_82(int iParam0) // Position - 0x370C
{
	switch (iParam0)
	{
		case 0:
...
bool func_83(var uParam0) // Position - 0x3746
{
	return IS_BIT_SET(*uParam0, 1);
}

Vector3 func_84(float fParam0, var uParam1, var uParam2) // Position - 0x3753
{
	float fVar0;
	float fVar1;
...
Vector3 func_85(var uParam0) // Position - 0x3792
{
	var uVar0;
	var uVar3;
	var uVar6;
	...
	ENTITY::GET_ENTITY_MATRIX(uParam0, &uVar0, &uVar3, &uVar6, &uVar9);
	MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(uParam0), &uVar12, &fVar15);
	return { 10.7548f, -555.7014f, -1900.2925f } - ({ fVar15, fVar15, fVar15 } * { 0f, -0.7771f, -0.6293f }) - ({ fVar15.f_1, fVar15.f_1, fVar15.f_1 } * { 0f, -0.6293f, 0.7771f });
}

void func_86(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6) // Position - 0x37F7
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_93(0, iParam3, bParam2, 0);
	
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_91(PLAYER::PLAYER_ID()) && !func_88(PLAYER::PLAYER_ID(), 0) && !func_87() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0, 0);
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_91(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5)
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0, 0);
...
bool func_87() // Position - 0x3946
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

bool func_88(int iParam0, int iParam1) // Position - 0x3960
{
	bool bVar0;
...
int func_89(int iParam0, bool bParam1) // Position - 0x39B9
{
	int iVar0;
	int iVar1;
...
bool func_90(int iParam0) // Position - 0x39FA
{
	int iVar0;
...
bool func_91(int iParam0) // Position - 0x3A1C
{
...
bool func_92() // Position - 0x3A5B
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_93(int iParam0, int iParam1, bool bParam2, int iParam3) // Position - 0x3A69
{
	int iVar0;
...
void func_94(int iParam0) // Position - 0x3A9C
{
	if (iParam0 == 1)
...
Vector3 func_95(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x3ABF
{
	var uVar0;
...
bool func_96(var uParam0) // Position - 0x3B05
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0))
		return false;
...
void func_97() // Position - 0x3B23
{
	float fVar0;

	if (!VEHICLE::IS_VEHICLE_DRIVEABLE(Static_399, 0))
	{
		VEHICLE::DELETE_VEHICLE(&Static_399);
		Static_399 = VEHICLE::CREATE_VEHICLE(Static_55, Static_420, Static_425, 1, 1, 0);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Static_399, 6);
	}

	if (ENTITY::DOES_ENTITY_EXIST(Static_397))
		PED::DELETE_PED(&Static_397);

	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(Static_399, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(Static_399, 0))
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1907.8273f, -560.0641f, 10.8064f, 1, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 260.195f);
		ENTITY::SET_ENTITY_COORDS(Static_399, Static_420, 1, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(Static_399, Static_425);
		...
		if (ENTITY::DOES_ENTITY_EXIST(Static_400))
		{
			...
			{
				VEHICLE::SET_VEHICLE_FIXED(Static_400);
				ENTITY::SET_ENTITY_INVINCIBLE(Static_400, 1, 0);
				VEHICLE::SET_VEHICLE_CAN_BREAK(Static_400, 0);
				ENTITY::SET_ENTITY_COORDS(Static_400, func_85(Static_400), 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(Static_400, 231f);
			}
		}
		...
		if (!Static_435 || !ENTITY::DOES_ENTITY_EXIST(Static_398) || ENTITY::IS_ENTITY_DEAD(Static_398, 0))
		{
			Static_398 = PED::CREATE_PED(26, Static_54, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
			PED::SET_PED_COMPONENT_VARIATION(Static_398, 3, Static_430, Static_431, 0);
			PED::SET_PED_COMPONENT_VARIATION(Static_398, 4, 0, Static_432, 0);
			PED::SET_PED_MONEY(Static_398, 2000 + MISC::GET_RANDOM_INT_IN_RANGE(5, 301));
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Static_398, 1, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Static_398, 1);
			func_81(&Static_81, 1, Static_398, "FRIEDLANDER", 0, 1);
			Static_435 = true;
		}
		else
		{
			ENTITY::SET_ENTITY_COORDS(Static_398, -1899.7f, -562.2f, 10.7945f, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(Static_398, 217.9453f);
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(Static_398);
			TASK::TASK_STAND_STILL(Static_398, -1);
		}
		...
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			if (!Static_434)
			{
				STREAMING::NEW_LOAD_SCENE_START(-1905.4998f, -557.8768f, 12.4125f, func_84({ 12.4748f, -560.2881f, -1904.7095f } - { 12.4125f, -557.8768f, -1905.4998f }), 100f, 0);
				Static_434 = true;
				BUILTIN::WAIT(0);
			}
		
			while (!STREAMING::IS_NEW_LOAD_SCENE_LOADED() || !PED::IS_PED_INJURED(Static_398) && !PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(Static_398))
			{
				BUILTIN::WAIT(0);
			}
		...
		if (!PED::IS_PED_INJURED(Static_398) && !ENTITY::IS_ENTITY_DEAD(Static_399, 0))
		{
			TASK::OPEN_SEQUENCE_TASK(&Static_404);
			TASK::TASK_ENTER_VEHICLE(0, Static_399, -1, -1, fVar0, 1, 0);
			TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, Static_399, -1783.7303f, -629.1945f, 9.89f, 20f, 0, ENTITY::GET_ENTITY_MODEL(Static_399), 786484, 10f, 12f);
			TASK::TASK_VEHICLE_DRIVE_WANDER(0, Static_399, 19f, 786484);
			TASK::CLOSE_SEQUENCE_TASK(Static_404);
			TASK::TASK_PERFORM_SEQUENCE(Static_398, Static_404);
			PED::FORCE_PED_MOTION_STATE(Static_398, joaat("MOTIONSTATE_RUN"), 1, 1, 1);
		}
		...
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		Static_403 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), -1904.6146f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
		CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
		HUD::DISPLAY_RADAR(0);
		HUD::DISPLAY_HUD(0);
	}

	MISC::CLEAR_AREA(-1886.8839f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, 0);
	VEHICLE::CREATE_VEHICLE(Static_56, -1886.8839f, -571.1942f, 11.3828f, -40.83f, 1, 1, 0);
}

int func_98() // Position - 0x3ED5
{
...
void func_99() // Position - 0x3F07
{
	func_100();
}

void func_100() // Position - 0x3F13
{
	Global_21866 = 0;
	func_101();
}

void func_101() // Position - 0x3F23
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
bool func_102(int iParam0, int iParam1, var uParam2) // Position - 0x3F44
{
	int iVar0;
	var uVar1;
	var uVar9;
	...
	iVar0 = 522;
	TEXT_LABEL_ASSIGN_STRING(&uVar1, "missdrfriedlanderdrf_idles", 32);
	TEXT_LABEL_ASSIGN_STRING(&uVar9, "facials@drf", 16);
	uVar13 = { func_104(iParam0) };
	TEXT_LABEL_ASSIGN_STRING(&uVar21, "drf_idle_drf", 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar25, "michael_concerned_01", 24);
	TEXT_LABEL_ASSIGN_STRING(&uVar31, "drfriedlander_idle_01", 24);

	if (func_103())
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iParam1))
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uVar1, &uVar13, 3))
			{
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &uVar1, &uVar13, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(iParam1, &uVar1, &uVar21, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &uVar9, &uVar25, 2f, -1000f, -1, 32 | iVar0, 0, 0, 4, 0);
				TASK::TASK_PLAY_ANIM(iParam1, &uVar9, &uVar31, 2f, -1000f, -1, 32 | iVar0, 0, 0, 0, 0);
				...
				if (!CAM::DOES_CAM_EXIST(*uParam2))
					*uParam2 = CAM::CREATE_CAMERA(joaat("DEFAULT_SCRIPTED_CAMERA"), 0);
			...
			else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), &uVar1, &uVar13) >= 0.99f)
			{
				return true;
			}
		}
...
struct<8> func_104(int iParam0) // Position - 0x40DE
{
	...
	{
		case 0:
			TEXT_LABEL_ASSIGN_STRING(&uVar0, "hand2chin_michael", 32);
			break;
		...
		case 4:
			TEXT_LABEL_ASSIGN_STRING(&uVar0, "leanback_michael", 32);
			break;
	
		default:
			TEXT_LABEL_ASSIGN_STRING(&uVar0, "uneasy_michael", 32);
			break;
	}
...
int func_105(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4130
{
...
bool func_106(var uParam0, var uParam1, var uParam2) // Position - 0x417E
{
	bool bVar0;
	bool bVar1;

	if (func_83(uParam0) && func_144(uParam0) > 1.3f)
	{
		...
		if (bVar0 || bVar1)
		{
			...
			if (func_115("SHRINK_ACCEPT" /* GXT: Accept advice */))
				HUD::CLEAR_HELP(1);
	...
	func_107(uParam1, 1128792064, 1, false, true, 1065353216);
	return false;
}

void func_107(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5) // Position - 0x41FC
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	if (!func_112(uParam0->f_1, 256) || func_112(uParam0->f_1, 8192) && PAD::HAVE_CONTROLS_CHANGED(2))
	{
		...
		for (iVar6 = 0; iVar6 < uParam0->f_123; iVar6 = iVar6 + 1)
		{
			...
			if (bVar4)
			{
				if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "SET_DATA_SLOT"))
				{
					...
					for (iVar7 = 0; iVar7 < uParam0->f_2[iVar6 /*15*/].f_14; iVar7 = iVar7 + 1)
					{
						...
						if (!IS_BIT_SET(uParam0->f_2[iVar6 /*15*/].f_12, iVar7))
							uVar3 = PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(uVar0, uVar1, bVar2);
						else
							uVar3 = PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(uVar0, uVar1, bVar2);
		...
		fVar8 = bParam4 ? func_112(uParam0->f_1, 32) ? 1f : 0f : -1f;
		...
		func_108(&(uParam0->f_1), 128);
	}

	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(*uParam0, 255, 255, 255, 0, 0);
}

void func_108(var uParam0, int iParam1) // Position - 0x44B6
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
}

void func_109(var uParam0, int iParam1) // Position - 0x44CB
{
	*uParam0 = *uParam0 || iParam1;
}

void func_110(var uParam0) // Position - 0x44DC
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(uParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_111(var uParam0) // Position - 0x44EE
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(uParam0);
}

bool func_112(int iParam0, int iParam1) // Position - 0x44FC
{
	return iParam0 && iParam1 != false;
}

bool func_113(var uParam0) // Position - 0x450B
{
	if (*uParam0 != 0)
	{
...
void func_114(var uParam0) // Position - 0x4532
{
	if (*uParam0 != 0)
	{
...
bool func_115(char* sParam0) // Position - 0x4555
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_116(var uParam0, var uParam1, int iParam2) // Position - 0x4568
{
	bool bVar0;

	bVar0 = func_127(uParam1->f_20);
	bVar0 = bVar0 | 4;
	bVar0 = bVar0 || func_117(uParam1, iParam2);
	bVar0 = bVar0 | 98304;
	CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST(uParam0, bVar0, 8);
}

bool func_117(var uParam0, int iParam1) // Position - 0x45A0
{
	var uVar0;
	var uVar1;

	uVar1 = { func_118(uParam0, &uVar0, iParam1, true) };

	if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX01"))
		return 8;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX02"))
		return 16;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX03"))
		return 32;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX04"))
		return 64;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX05"))
		return 128;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX06"))
		return 256;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX07"))
		return 512;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX08"))
		return 1024;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX09"))
		return 2048;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX10"))
		return 4096;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX11"))
		return 8192;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTSX12"))
		return 16384;

	return 8;
}

struct<4> func_118(var uParam0, var uParam1, int iParam2, bool bParam3) // Position - 0x46B9
{
	var uVar0;
	int iVar4;
	...
	if (func_126() <= 0)
		if (!func_125())
			iVar4 = func_122(1, 2, 3, 4, 12);
		else if (func_121() >= 1)
			iVar4 = func_122(5, 6, 7, 0, 0);
		else
			iVar4 = func_122(5, 7, 0, 0, 0);
	else if (func_126() >= 2)
		iVar4 = func_122(10, 11, 0, 0, 0);
	else if (!func_125())
		if (iParam2 != 4)
			iVar4 = func_122(8, 9, 0, 0, 0);
		else
			iVar4 = 9;
	else if (iParam2 != 4)
		iVar4 = func_122(8, 9, 10, 0, 0);
	else
		iVar4 = func_122(9, 10, 0, 0, 0);

	func_120(uParam0, iVar4);

	if (bParam3)
		func_119(&(Global_114931.f_19968), iVar4, true);

	TEXT_LABEL_ASSIGN_STRING(&uVar0, "OBTSX", 16);

	if (iVar4 < 10)
		TEXT_LABEL_APPEND_STRING(&uVar0, "0", 16);

	TEXT_LABEL_APPEND_INT(&uVar0, iVar4, 16);
	return uVar0;
}

void func_119(var uParam0, int iParam1, bool bParam2) // Position - 0x479C
{
...
void func_120(var uParam0, int iParam1) // Position - 0x47DB
{
	uParam0->f_19 = iParam1;
}

int func_121() // Position - 0x47E9
{
	int iVar0;
	int iVar1;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x4817
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	for (iVar0 = 0; iVar0 < 13; iVar0 = iVar0 + 1)
	{
		uVar2[iVar0] = iVar0;
	}

	if (iParam0 > 0 && iParam0 < 13 && !func_124(&(Global_114931.f_19968), iParam0))
		uVar2[iParam0] = 0;
	else if (iParam1 > 0 && iParam1 < 13 && !func_124(&(Global_114931.f_19968), iParam1))
		uVar2[iParam1] = 0;
	else if (iParam2 > 0 && iParam2 < 13 && !func_124(&(Global_114931.f_19968), iParam2))
		uVar2[iParam2] = 0;
	else if (iParam3 > 0 && iParam3 < 13 && !func_124(&(Global_114931.f_19968), iParam3))
		uVar2[iParam3] = 0;
	else if (iParam4 > 0 && iParam4 < 13 && !func_124(&(Global_114931.f_19968), iParam4))
		uVar2[iParam4] = 0;

	iVar1 = func_123(&uVar2, 13, 1, 13);
...
int func_123(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x49D9
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	for (iVar2 = 0; bVar0 && iVar2 < 50; iVar2 = iVar2 + 1)
	{
		bVar0 = false;
...
bool func_124(var uParam0, int iParam1) // Position - 0x4A4C
{
	if (iParam1 < 0 || iParam1 > 12)
		return false;
...
bool func_125() // Position - 0x4A77
{
	return Global_98896 > 0;
}

int func_126() // Position - 0x4A85
{
	int iVar0;
	int iVar1;
...
bool func_127(int iParam0) // Position - 0x4AB3
{
	if (iParam0 == 0)
		return 1;
	else if (iParam0 == 1)
...
void func_128(var uParam0) // Position - 0x4AE0
{
	func_56(uParam0, 0f);
}

void func_129() // Position - 0x4AEF
{
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
	func_130(0);
...
void func_130(int iParam0) // Position - 0x4B1C
{
	if (func_135())
		return;
...
void func_131(int iParam0) // Position - 0x4B4F
{
	if (func_135())
		return;
...
void func_132(bool bParam0, bool bParam1) // Position - 0x4BD9
{
	if (bParam0)
	{
		if (func_134(0))
...
bool func_133() // Position - 0x4C4D
{
	return IS_BIT_SET(Global_1964705, 5);
}

bool func_134(int iParam0) // Position - 0x4C5B
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
bool func_135() // Position - 0x4CB2
{
	return IS_BIT_SET(Global_1964705, 19);
}

int func_136(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4CC1
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 < 8)
	{
		...
		uParam0->f_2[iVar1 /*15*/].f_14 = uParam0->f_2[iVar1 /*15*/].f_14 + 1;
...
void func_137(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4) // Position - 0x4D8A
{
	if (*uParam0 == 0)
	...
	if (MISC::IS_PC_VERSION())
		if (bParam3)
			func_109(&(uParam0->f_1), 4096);

	if (bParam4)
		func_109(&(uParam0->f_1), 8192);
}

void func_138(int iParam0) // Position - 0x4E04
{
	switch (iParam0)
	{
		case 0:
...
void func_139(int iParam0) // Position - 0x4E5E
{
	if (Global_99351 != -1)
	{
...
void func_140(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8, int iParam9) // Position - 0x4E82
{
	var uVar0;
	int iVar1;
	...
	*uParam2 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam2))
	{
		...
		{
			uVar0 = ENTITY::GET_ENTITY_MODEL(*uParam2);
		
			if (VEHICLE::IS_THIS_MODEL_A_BOAT(uVar0) || VEHICLE::IS_THIS_MODEL_A_TRAIN(uVar0))
			{
				*uParam2 = 0;
			}
			else
			{
				iVar1 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam2, -1, 0);
	...
	{
		*uParam1 = Global_98926[0];
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(*uParam1, 1, 1);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
	{
		...
		else
		{
			...
			ENTITY::FREEZE_ENTITY_POSITION(*uParam1, 0);
		}
	}

	if (!ENTITY::DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = VEHICLE::CREATE_VEHICLE(iParam9, uParam5, fParam8, 1, 1, 0);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*uParam1, 6);
	}

	if (ENTITY::DOES_ENTITY_EXIST(*uParam2))
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*uParam2))
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(*uParam2, 1, 0);

	func_81(uParam4, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL" /* GXT: Michael */, 0, 1);
	func_81(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);

	if (CAM::DOES_CAM_EXIST(*uParam3))
		CAM::DESTROY_CAM(*uParam3, 0);

	if (!CAM::DOES_CAM_EXIST(*uParam3))
		*uParam3 = CAM::CREATE_CAMERA(joaat("DEFAULT_SCRIPTED_CAMERA"), 0);
...
void func_141(int iParam0, bool bParam1, bool bParam2) // Position - 0x501C
{
	int iVar0;
	var uVar1;
	var uVar9;
	...
	TEXT_LABEL_ASSIGN_STRING(&uVar1, "missdrfriedlanderdrf_idles", 32);
	TEXT_LABEL_ASSIGN_STRING(&uVar9, "facials@drf", 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar13, "idle_michael", 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar17, "drf_idle_drf", 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar21, "michael_idle_01", 16);
	TEXT_LABEL_ASSIGN_STRING(&uVar25, "drfriedlander_idle_01", 24);

	if (bParam1 && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1907.39f, -577.33f, 17.64f, 1, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 318.6574f);
		TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &uVar1, &uVar13, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &uVar9, &uVar21, 1000f, -2f, -1, 32 | iVar0, 0, 0, 4, 0);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
	}

	if (bParam2 && !PED::IS_PED_INJURED(iParam0))
	{
		ENTITY::SET_ENTITY_COORDS(iParam0, -1907.69f, -574.77f, 17.67f, 1, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(iParam0, 177f);
		TASK::TASK_PLAY_ANIM(iParam0, &uVar1, &uVar17, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		TASK::TASK_PLAY_ANIM(iParam0, &uVar9, &uVar25, 1000f, -2f, -1, 32 | iVar0, 0, 0, 0, 0);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iParam0, 0, 0);
	}
}

void func_142(var uParam0) // Position - 0x5151
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_144(var uParam0) // Position - 0x518A
{
	if (func_83(uParam0))
		if (func_145(uParam0))
			return uParam0->f_2;
		else
			return func_57(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1;

	return uParam0->f_1;
}

bool func_145(var uParam0) // Position - 0x51C6
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_146(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x51D3
{
	var uVar0;
	int iVar65;
	...
	uVar0.f_39 = 9;
	uVar0.f_49 = 9;
	func_147(iParam1, &uVar0, iParam3);

	for (iVar65 = 0; iVar65 < 12; iVar65 = iVar65 + 1)
	{
		CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION(uParam0, iVar65, uVar0.f_13[iVar65], uVar0[iVar65], iParam2);
	}
	...
	for (iVar65 = 0; iVar65 < 9; iVar65 = iVar65 + 1)
	{
		if (uVar0.f_39[iVar65] == -1 || uVar0.f_39[iVar65] == 255)
			...
			CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION(uParam0, iVar65, uVar0.f_39[iVar65], uVar0.f_49[iVar65], iParam2);
	}
}

void func_147(int iParam0, var uParam1, int iParam2) // Position - 0x528E
{
	int iVar0;
	var uVar1;
	var uVar2;
	...
	func_228(iParam0, &uVar2, 0, -1);
	func_228(iParam0, uParam1, iParam2, -1);
	iVar82 = 0;
	iVar83 = 0;
	...
	for (iVar0 = 0; iVar0 < 12; iVar0 = iVar0 + 1)
	{
		...
		{
			if (func_225(iVar81, func_227(iVar0), func_226(iParam0, uVar2.f_13[iVar0], uVar2[iVar0], func_227(iVar0)), &uVar1))
			{
				uVar67 = { func_159(iVar81, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = uVar67.f_3;
				uParam1->[2] = uVar67.f_4;
				iVar82 = 1;
			}
		
			if (func_157(iVar81, func_227(iVar0), func_226(iParam0, uVar2.f_13[iVar0], uVar2[iVar0], func_227(iVar0)), &uVar1))
			{
				uVar67 = { func_159(iVar81, 1, uParam1->f_62, -1) };
	...
	for (iVar0 = 0; iVar0 < 9; iVar0 = iVar0 + 1)
	{
		...
		{
			if (func_225(iVar81, 14, func_149(iParam0, uVar2.f_39[iVar0], uVar2.f_49[iVar0], iVar0), &uVar1))
			{
				uVar67 = { func_159(iVar81, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = uVar67.f_3;
				uParam1->[2] = uVar67.f_4;
			...
			if (func_157(iVar81, 14, func_149(iParam0, uVar2.f_39[iVar0], uVar2.f_49[iVar0], iVar0), &uVar1))
			{
				uVar67 = { func_159(iVar81, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = uVar67.f_3;
				uParam1->[1] = uVar67.f_4;
	...
	if (iVar83 || iVar82)
	{
		iVar84 = func_226(iParam0, uParam1->f_13[1], uParam1->[1], 1);
		iVar85 = func_226(iParam0, uParam1->f_13[2], uParam1->[2], 2);
		iVar86 = func_148(iVar81, iVar85, iVar84);
	
		if (iVar86 != -99)
		{
			uVar67 = { func_159(iVar81, 0, iVar86, -1) };
...
int func_148(int iParam0, int iParam1, int iParam2) // Position - 0x5503
{
	switch (iParam0)
	{
...
int func_149(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x565A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar1 != -1 && iVar1 != 0)
		if (iVar0 == joaat("MP_M_FREEMODE_01"))
			return func_151(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 3);
		else if (iVar0 == joaat("MP_F_FREEMODE_01"))
			return func_151(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 4);
	...
	for (iVar4 = 0; iVar4 <= iVar2 - 1; iVar4 = iVar4 + 1)
	{
		...
		else
		{
			for (iVar5 = 0; iVar5 <= iVar6 - 1; iVar5 = iVar5 + 1)
			{
				...
				{
					iVar3 = iVar3 + func_150(iParam0, iParam3);
					return iVar3;
				}
				else
				{
...
int func_150(int iParam0, int iParam1) // Position - 0x5756
{
	int iVar0;
...
int func_151(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5894
{
	var uVar0;
	int iVar15;
	int iVar16;
	...
	if (iParam2 == 12)
	{
		...
		for (iVar15 = 0; iVar15 < iVar16; iVar15 = iVar15 + 1)
		{
			...
			if (uVar0.f_1 == iParam1)
				return func_155(uParam0) + iVar15;
		}
	}
	else if (iParam2 == 13)
	{
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar17 != -1)
			return func_154(uParam0) + iVar17;
	}
	else
	{
		EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, 0, -1, func_153(iParam2));
		iVar18 = EXTRAMETADATA::GET_SHOP_PED_QUERY_COMPONENT_INDEX(iParam1);
	
		if (iVar18 != -1)
			return func_152(uParam0, func_153(iParam2)) + iVar18;
	}

	return -99;
}

int func_152(int iParam0, int iParam1) // Position - 0x594F
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_153(int iParam0) // Position - 0x5CF6
{
	switch (iParam0)
	{
		case 0:
...
int func_154(int iParam0) // Position - 0x5DA6
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_155(int iParam0) // Position - 0x5E07
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
int func_156(int iParam0) // Position - 0x5E66
{
	switch (iParam0)
	{
		case 0:
...
bool func_157(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x5EEC
{
	int iVar0;
...
int func_158(int iParam0) // Position - 0x6176
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
struct<14> func_159(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x61B1
{
	func_224();
...
void func_160(int iParam0, int iParam1) // Position - 0x6203
{
	switch (iParam0)
	{
		case 0:
...
void func_161(int iParam0) // Position - 0x62F3
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	func_162(&Global_80088[0 /*14*/], iVar10, iParam0, &uVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, false);
}

void func_162(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10) // Position - 0x756A
{
	int iVar0;
	int iVar1;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_167(Global_2883588, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_6), 2);
		
			if (!func_167(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_166(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 1);
	
		if (func_166(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 2);
	
		if (!func_166(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			iVar0 = func_22(func_165(iParam1, iParam0->f_2), Global_80085);
		
			if (IS_BIT_SET(iVar0, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			iVar0 = func_22(func_164(iParam1, iParam0->f_2), Global_80085);
		
			if (IS_BIT_SET(iVar0, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_163(iParam1, iParam0->f_2, &iVar1))
			{
				iVar0 = func_22(iVar1, Global_80085);
...
bool func_163(int iParam0, int iParam1, var uParam2) // Position - 0x790C
{
	*uParam2 = 979;
...
int func_164(int iParam0, int iParam1) // Position - 0x7D11
{
	switch (iParam1)
	{
		case 0:
...
int func_165(int iParam0, int iParam1) // Position - 0x810D
{
	switch (iParam1)
	{
		case 0:
...
bool func_166(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8508
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_167(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4) // Position - 0x93AB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_168(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		iVar3 = func_22(iVar2, iVar0);
...
bool func_168(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5) // Position - 0x93E9
{
	int iVar0;
...
int func_169(int iParam0) // Position - 0xC092
{
	switch (iParam0)
	{
		case -1:
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC166
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_162(&Global_80088[0 /*14*/], iParam0, iParam1, &(iVar2.f_7), 0, 0, iVar2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_162(&Global_80088[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_162(&Global_80088[0 /*14*/], iParam0, iParam1, &(iVar19.f_9), iVar19.f_3, iVar19.f_4, iVar19.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, iVar19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_80286)
		{
			...
			func_162(&Global_80088[0 /*14*/], iParam0, iParam1, &(iVar39.f_9), iVar39.f_3, iVar39.f_4, iVar39.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, iVar39.f_1 != 0);
			return;
		}
		...
		if (iVar56 >= 0)
		{
			iVar57 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 11, -1, 0, -1, func_153(iParam0));
...
void func_171(int iParam0) // Position - 0xC3ED
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_172(int iParam0) // Position - 0xC544
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_173(int iParam0) // Position - 0xCA52
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_174(int iParam0) // Position - 0xCAC7
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_175(int iParam0) // Position - 0xCB3B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_176(int iParam0) // Position - 0xCC22
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_177(int iParam0) // Position - 0xCF85
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_178(int iParam0) // Position - 0xD196
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_179(int iParam0) // Position - 0xD3C6
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_180(int iParam0) // Position - 0xD4D6
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_181(int iParam0) // Position - 0xDE75
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_182(int iParam0) // Position - 0xE9E8
{
	if (iParam0 < 136)
		func_184(iParam0);
	else
...
void func_183(int iParam0) // Position - 0xEA1D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_184(int iParam0) // Position - 0xF621
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_185(int iParam0) // Position - 0x10531
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_186(int iParam0) // Position - 0x1065E
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_187(int iParam0, int iParam1) // Position - 0x1075C
{
	switch (iParam0)
	{
		case 0:
...
void func_188(int iParam0) // Position - 0x1084C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_189(int iParam0) // Position - 0x11D3D
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_190(int iParam0) // Position - 0x11E8E
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_191(int iParam0) // Position - 0x12399
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_192(int iParam0) // Position - 0x12A07
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_193(int iParam0) // Position - 0x12A7B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_194(int iParam0) // Position - 0x12B4B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_195(int iParam0) // Position - 0x1307B
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_196(int iParam0) // Position - 0x13212
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_197(int iParam0) // Position - 0x13A10
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_198(int iParam0) // Position - 0x13B20
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_199(int iParam0) // Position - 0x14A4C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_200(int iParam0) // Position - 0x15709
{
	if (iParam0 < 107)
		func_203(iParam0);
	else if (iParam0 < 227)
...
void func_201(int iParam0) // Position - 0x1574F
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_202(int iParam0) // Position - 0x161F4
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_203(int iParam0) // Position - 0x16FE3
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_204(int iParam0) // Position - 0x17C2C
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_205(int iParam0) // Position - 0x17EA5
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_206(int iParam0, int iParam1) // Position - 0x17FEB
{
	switch (iParam0)
	{
		case 0:
...
void func_207(int iParam0) // Position - 0x180E9
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_208(int iParam0) // Position - 0x18E73
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_209(int iParam0) // Position - 0x18FED
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_210(int iParam0) // Position - 0x19564
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_211(int iParam0) // Position - 0x19A8E
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_212(int iParam0) // Position - 0x19B02
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_213(int iParam0) // Position - 0x19BD2
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_214(int iParam0) // Position - 0x1A0AA
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_215(int iParam0) // Position - 0x1A313
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_216(int iParam0) // Position - 0x1A5E9
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_217(int iParam0) // Position - 0x1A7B2
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_218(int iParam0) // Position - 0x1B306
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_219(int iParam0) // Position - 0x1BF50
{
	if (iParam0 < 60)
		func_221(iParam0);
	else
...
void func_220(int iParam0) // Position - 0x1BF85
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_221(int iParam0) // Position - 0x1CD79
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_222(int iParam0) // Position - 0x1D405
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_223(int iParam0) // Position - 0x1D4EC
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
void func_224() // Position - 0x1D5EA
{
...
bool func_225(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1D663
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x1D96A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0) // Position - 0x1D9C1
{
	switch (iParam0)
	{
		case 0:
...
void func_228(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x1DA71
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			func_232(iParam0, iVar1, &uParam1->f_13[iVar1], &uParam1->[iVar1], &uParam1->f_26[iVar1], iParam2, 145);
		}
	
		for (iVar1 = 0; iVar1 < 9; iVar1 = iVar1 + 1)
		{
			func_231(iParam0, iVar1, &uParam1->f_39[iVar1], &uParam1->f_49[iVar1], iParam2, 145);
		}
...
bool func_229(int iParam0, int iParam1) // Position - 0x1DC0B
{
	var uVar0;
	bool bVar1;

	uVar0 = func_230(iParam0, iParam1);
...
var func_230(int iParam0, int iParam1) // Position - 0x1DC2F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_17(iParam1));
}

void func_231(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0x1DC44
{
	int iVar0;
...
void func_232(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6) // Position - 0x1E18D
{
	int iVar0;
...
void func_233(var uParam0, int iParam1) // Position - 0x1E3CE
{
	int iVar0;
	bool bVar1;
	...
	bVar1 = 15;
	bVar1 = bVar1 || func_241(iParam1, true);
	bVar1 = bVar1 || BUILTIN::SHIFT_LEFT(64, iVar0);
	bVar1 = bVar1 || BUILTIN::SHIFT_LEFT(func_234(iParam1), iVar0);
	CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST(uParam0, bVar1, 8);
}

int func_234(int iParam0) // Position - 0x1E425
{
	var uVar0;
	var uVar1;

	uVar1 = { func_235(iParam0, true, true, &uVar0) };

	if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW01"))
		return 128;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW02"))
		return 256;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW03"))
		return 512;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW04"))
		return 1024;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW05"))
		return 2048;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW06"))
		return 4096;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW07"))
		return 8192;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW08"))
		return 16384;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW09"))
		return 32768;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW10"))
		return 65536;
	else if (MISC::ARE_STRINGS_EQUAL(&uVar1, "OBTOW11"))
		return 131072;

	return 128;
}

struct<4> func_235(int iParam0, bool bParam1, bool bParam2, var uParam3) // Position - 0x1E52E
{
	var uVar0;
	int iVar4;
	int iVar5;
	...
	if (!func_240(&(Global_114931.f_19968), 8) && bParam1 && iParam0 != 4 && func_238(3) > 0 && MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f)
	{
		iVar4 = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_240(&(Global_114931.f_19968), 1) && func_238(5) > 0)
		{
			MISC::SET_BIT(&iVar5, 1);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 2) && func_238(7) >= 2)
		{
			MISC::SET_BIT(&iVar5, 2);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 3) && func_238(8) > 0 || func_238(9) > 0 && func_238(7) > 0 && bParam1 && iParam0 != 4)
		{
			MISC::SET_BIT(&iVar5, 3);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 4) && func_238(1) > 0 && func_238(1) < 3)
		{
			MISC::SET_BIT(&iVar5, 4);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 5) && func_238(1) >= 3)
		{
			MISC::SET_BIT(&iVar5, 5);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 6) && func_238(0) > 0)
		{
			MISC::SET_BIT(&iVar5, 6);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 7))
		{
			MISC::SET_BIT(&iVar5, 7);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 8) && bParam1 && func_238(3) > 0 && iParam0 != 4)
		{
			MISC::SET_BIT(&iVar5, 8);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 9))
		{
			MISC::SET_BIT(&iVar5, 9);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 10))
		{
			MISC::SET_BIT(&iVar5, 10);
			iVar6 = iVar6 + 1;
		}
	
		if (!func_240(&(Global_114931.f_19968), 11))
		{
		...
		{
			if (iParam0 != 4)
				iVar4 = func_237(7, 9, 10, 11, 0);
			else
				iVar4 = func_237(7, 9, 10, 0, 0);
		}
		else
		{
			iVar7 = MISC::GET_RANDOM_INT_IN_RANGE(1, iVar6 + 1);
		
			for (iVar8 = 1; iVar7 > 0; iVar8 = iVar8 + 1)
			{
	...
	if (bParam2)
		func_236(&(Global_114931.f_19968), iVar4, true);

	TEXT_LABEL_ASSIGN_STRING(&uVar0, "OBTOW", 16);
...
void func_236(var uParam0, int iParam1, bool bParam2) // Position - 0x1E88E
{
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1E8C7
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (iParam0 > 0 && iParam0 < 12 && !func_240(&(Global_114931.f_19968), iParam0))
	{
		uVar2[iParam0] = 0;
		bVar15 = true;
	}

	if (iParam1 > 0 && iParam1 < 12 && !func_240(&(Global_114931.f_19968), iParam1))
	{
		uVar2[iParam1] = 0;
		bVar15 = true;
	}

	if (iParam2 > 0 && iParam2 < 12 && !func_240(&(Global_114931.f_19968), iParam2))
	{
		uVar2[iParam2] = 0;
		bVar15 = true;
	}

	if (iParam3 > 0 && iParam3 < 12 && !func_240(&(Global_114931.f_19968), iParam3))
	{
		uVar2[iParam3] = 0;
		bVar15 = true;
	}

	if (iParam4 > 0 && iParam4 < 12 && !func_240(&(Global_114931.f_19968), iParam4))
	{
		uVar2[iParam4] = 0;
		bVar15 = true;
	}
...
int func_238(int iParam0) // Position - 0x1EA92
{
	switch (iParam0)
	{
		case 0:
			return func_239(&Global_98897, 1);
	
		case 1:
			return func_239(&Global_98899, 3);
	
		case 2:
			return func_239(&Global_98903, 1);
	
		case 3:
			return func_239(&Global_98905, 1);
	
		case 4:
			return func_239(&Global_98907, 1);
	
		case 5:
			return func_239(&Global_98909, 1);
	
		case 6:
			return func_239(&Global_98911, 1);
	
		case 7:
			return func_239(&Global_98913, 2);
	
		case 8:
			return func_239(&Global_98916, 1);
	
		case 9:
			return func_239(&Global_98918, 1);
	}

	return 0;
}

int func_239(var uParam0, int iParam1) // Position - 0x1EB74
{
	int iVar0;
	int iVar1;
...
bool func_240(var uParam0, int iParam1) // Position - 0x1EBA1
{
	if (iParam1 < 0 || iParam1 > 11)
		return false;
...
bool func_241(int iParam0, bool bParam1) // Position - 0x1EBC6
{
	switch (iParam0)
	{
		case 0:
			if (func_242(19) && !func_242(20))
				if (func_242(44))
					return 32;
				else
					return 16;
		...
		case 1:
			if (func_242(20) && !func_242(59))
				if (!func_242(21) || func_242(72) || func_242(73))
					if (func_242(21))
						return 64;
					else if (func_242(29))
						return 32;
		...
		case 4:
			if (func_242(48) && func_242(61) && func_242(22))
				if (func_242(27))
					return 64;
				else if (func_242(24))
					return 32;
				else if (!func_242(84) && !func_242(85))
					return 16;
			break;
	}
...
bool func_242(int iParam0) // Position - 0x1ECE0
{
...
void func_243(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1ED0C
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0) || ENTITY::IS_ENTITY_DEAD(*uParam0, 0))
		*uParam0 = PED::CREATE_PED(26, iParam1, uParam2, fParam5, 1, 1);

	PED::SET_PED_COMPONENT_VARIATION(*uParam0, 3, iParam6, iParam7, 0);
	PED::SET_PED_COMPONENT_VARIATION(*uParam0, 4, 0, iParam8, 0);
	func_244(1, false);
	func_86(true, true, true, 0, false, false, false);
}

void func_244(int iParam0, bool bParam1) // Position - 0x1ED85
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
bool func_245(int iParam0) // Position - 0x1EE31
{
	int iVar0;
...
struct<2> func_246(int iParam0) // Position - 0x1EE62
{
	int iVar0;
...
void func_247(int iParam0, bool bParam1) // Position - 0x1EE8F
{
	var uVar0;
...
char* func_248(int iParam0, var uParam1) // Position - 0x1EED2
{
	var uVar0;
...
struct<5> func_249(int iParam0) // Position - 0x1EEF7
{
	var uVar0;
	var uVar5;
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			uVar0.f_3 = func_251(&Global_4718592.f_238097[0 /*160*/]);
			uVar0.f_4 = uVar0.f_3;
			break;
	
		case 244:
			uVar0 = { Global_4718592.f_238097[1 /*160*/].f_16 };
			uVar0.f_3 = func_251(&Global_4718592.f_238097[1 /*160*/]);
			uVar0.f_4 = uVar0.f_3;
			break;
	
		case 245:
			uVar0 = { Global_4718592.f_238097[2 /*160*/].f_16 };
			uVar0.f_3 = func_251(&Global_4718592.f_238097[2 /*160*/]);
			uVar0.f_4 = uVar0.f_3;
			break;
	
		case 246:
			uVar0 = { Global_4718592.f_238097[3 /*160*/].f_16 };
			uVar0.f_3 = func_251(&Global_4718592.f_238097[3 /*160*/]);
			uVar0.f_4 = uVar0.f_3;
			break;
	
		case 247:
			uVar0 = { Global_4718592.f_238097[4 /*160*/].f_16 };
			uVar0.f_3 = func_251(&Global_4718592.f_238097[4 /*160*/]);
			uVar0.f_4 = uVar0.f_3;
			break;
...
bool func_250(float fParam0, var uParam1, var uParam2) // Position - 0x21BB5
{
...
char* func_251(char* sParam0) // Position - 0x21BDF
{
	return sParam0;
}

struct<6> func_252(int iParam0, bool bParam1) // Position - 0x21BE9
{
	var uVar0;
...
bool func_253(var uParam0) // Position - 0x2279F
{
...
bool func_254(var uParam0) // Position - 0x227D1
{
	int iVar0;
	...
	for (iVar0 = 0; iVar0 < *uParam0; iVar0 = iVar0 + 1)
	{
		if (uParam0->[iVar0] != 0)
		{
			...
			{
				!STREAMING::HAS_MODEL_LOADED(uParam0->[iVar0]);
				return false;
			}
		}
	}
...
void func_255(var uParam0) // Position - 0x22818
{
	if (!func_83(uParam0))
		func_128(uParam0);
}

void func_256() // Position - 0x22830
{
	Global_24407.f_5 = 1;
}

void func_257(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2283E
{
...
int func_260(var uParam0, int iParam1) // Position - 0x22906
{
	int iVar0;
	int iVar1;
...
int func_261(var uParam0) // Position - 0x22963
{
	int iVar0;
...
bool func_262() // Position - 0x2298F
{
	int iVar0;
...
void func_263(char* sParam0, int iParam1) // Position - 0x229F6
{
	switch (iParam1)
	{
		case 0:
...
int func_264() // Position - 0x22AD9
{
	return 4;
}

void func_265(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x22AE2
{
	HUD::DISPLAY_HUD(1);
	HUD::DISPLAY_RADAR(1);
	func_269();
...
void func_266() // Position - 0x22BBC
{
	int iVar0;

	for (iVar0 = 0; iVar0 < 1; iVar0 = iVar0 + 1)
	{
		Global_98894[iVar0] = 0;
	}

	for (iVar0 = 0; iVar0 < 2; iVar0 = iVar0 + 1)
	{
		Global_98891[iVar0] = 0;
	}
}

void func_267() // Position - 0x22BFA
{
	int iVar0;
	int iVar1;
	...
	for (iVar1 = 0; iVar1 < 10; iVar1 = iVar1 + 1)
	{
		...
		{
			case 0:
				func_268(&Global_98897, 1);
				break;
		
			case 1:
				func_268(&Global_98899, 3);
				break;
		
			case 2:
				func_268(&Global_98903, 1);
				break;
		
			case 3:
				func_268(&Global_98905, 1);
				break;
		
			case 4:
				func_268(&Global_98907, 1);
				break;
		
			case 5:
				func_268(&Global_98909, 1);
				break;
		
			case 6:
				func_268(&Global_98911, 1);
				break;
		
			case 7:
				func_268(&Global_98913, 2);
				break;
		
			case 8:
				func_268(&Global_98916, 1);
				break;
		
			case 9:
				func_268(&Global_98918, 1);
				break;
		}
	}
}

void func_268(var uParam0, int iParam1) // Position - 0x22CD4
{
	int iVar0;
...
void func_269() // Position - 0x22CF6
{
	Global_21866 = 0;
	func_78();
}

void func_270() // Position - 0x22D06
{
	int iVar0;
	...
	if (Global_114931.f_9092 || func_279(false))
	{
		if (!func_278())
		{
			iVar0 = func_277();
...
void func_271() // Position - 0x22D77
{
	Global_102489 = 1;
...
bool func_272(int iParam0) // Position - 0x22E64
{
	int iVar0;
	int iVar1;
	...
	func_273(&(Global_114931.f_2370.f_539), iVar1);
...
void func_273(var uParam0, int iParam1) // Position - 0x22F74
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	for (iVar0 = 0; iVar0 < 3; iVar0 = iVar0 + 1)
	{
		...
		else
		{
			...
			if (!func_275(Global_114931.f_18540[iVar0], &uVar2, &fVar5))
			{
				Global_114931.f_18540[iVar0] = 318;
				func_274(&uParam0->f_2296[iVar0]);
...
void func_274(var uParam0) // Position - 0x2313A
{
	*uParam0 = -15;
}

bool func_275(int iParam0, var uParam1, var uParam2) // Position - 0x23148
{
	switch (iParam0)
	{
		case 11:
		...
		case 9:
			return func_275(8, uParam1, uParam2);
...
void func_276(int iParam0, bool bParam1) // Position - 0x23AB7
{
	if (bParam1)
...
bool func_278() // Position - 0x23B27
{
...
bool func_279(bool bParam0) // Position - 0x23B65
{
...
void func_280(bool bParam0, bool bParam1) // Position - 0x23B8D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam0)
	{
		if (func_279(false) && Global_80552.f_1 == 1 && func_281(Global_80552))
		{
		}
		else
		{
...
bool func_281(int iParam0) // Position - 0x23C5D
{
	switch (iParam0)
	{
		case 71:
...
void func_282(int iParam0, bool bParam1) // Position - 0x23C9B
{
	if (iParam0 == 146 || iParam0 == -1)
		return;
...
void func_283() // Position - 0x23CE0
{
	Global_24407.f_5 = 0;
}

var func_284(bool bParam0, var uParam1, var uParam2) // Position - 0x23CEE
{
	if (bParam0)
		return uParam1;
...
bool func_285() // Position - 0x23D05
{
