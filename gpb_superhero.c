...
void func_21(char* sParam0) // Position - 0x18E6
{
	...
	*sParam0 = { uVar0 };
	...
	TEXT_LABEL_APPEND_INT(sParam0, Static_297[func_22()], 16);
}
...
void func_23() // Position - 0x192A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(iVar0) && !func_24(14) || Global_113879)
			{
...
int func_26(var uParam0) // Position - 0x1A41
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0) // Position - 0x1AA3
{
...
bool func_38(int iParam0, int iParam1) // Position - 0x1F3D
{
	return IS_BIT_SET(Global_1892798[iParam0 /*615*/].f_10.f_4, iParam1);
}

bool func_39(int iParam0) // Position - 0x1F55
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

int func_40() // Position - 0x1F67
{
	return -1;
}

void func_41() // Position - 0x1F70
{
	int iVar0;
...
bool func_47(int iParam0, int iParam1) // Position - 0x21ED
{
	switch (iParam0)
	{
		case 5:
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2225
{
...
void func_49(var uParam0) // Position - 0x227B
{
	int iVar0;
...
void func_50(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x22B6
{
...
void func_51(char* sParam0) // Position - 0x2351
{
	int iVar0;
...
void func_52(int iParam0) // Position - 0x2389
{
}

void func_53(int iParam0, int iParam1, var uParam2) // Position - 0x2391
{
}

void func_54() // Position - 0x2399
{
...
void func_56(int iParam0) // Position - 0x241E
{
}

void func_57(var uParam0) // Position - 0x2426
{
	MISC::ARE_STRINGS_EQUAL(uParam0, uParam0);
}

void func_58(int iParam0, char* sParam1, char* sParam2) // Position - 0x2439
{
...
bool func_60() // Position - 0x25A3
{
	return Global_102506.f_417 > 0;
}

bool func_61() // Position - 0x25B4
{
	bool bVar0;
...
void func_65(char* sParam0) // Position - 0x2637
{
	var uVar0;
...
void func_66(char* sParam0) // Position - 0x2677
{
	func_19(Static_295, sParam0);
}

void func_67(char* sParam0) // Position - 0x2688
{
	TEXT_LABEL_ASSIGN_STRING(sParam0, "MONOLOGUE_", 16);
	TEXT_LABEL_APPEND_INT(sParam0, Global_114876[Static_249] + 1, 16);
}

void func_68(int iParam0, bool bParam1) // Position - 0x26A6
{
	int iVar0;
...
void func_69(int iParam0, bool bParam1) // Position - 0x26C7
{
	int iVar0;
...
void func_70(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x2738
{
	func_71(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_71(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x2758
{
	int iVar0;
...
bool func_73(int iParam0) // Position - 0x2A41
{
	int iVar0;
	int iVar1;
...
void func_74(char* sParam0) // Position - 0x2A81
{
...
char* func_75(int iParam0) // Position - 0x2AA4
{
	switch (iParam0)
	{
		case 0:
...
bool func_76(int iParam0) // Position - 0x2B87
{
	if (func_78(iParam0))
...
bool func_77(int iParam0) // Position - 0x2BAB
{
	int iVar0;
...
bool func_78(int iParam0) // Position - 0x2BDB
{
...
int func_79(int iParam0) // Position - 0x2C05
{
	switch (iParam0)
	{
...
void func_80(var uParam0) // Position - 0x2CC3
{
	if (Static_445 == 1)
...
void func_81(var uParam0, var uParam1, bool bParam2) // Position - 0x2CE2
{
	if (Static_445 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*uParam0))
...
int func_82(var uParam0, bool bParam1, int iParam2) // Position - 0x2D35
{
	int iVar0;
...
int func_83(var uParam0, bool bParam1, bool bParam2) // Position - 0x2D7F
{
	int iVar0;
...
var func_84(bool bParam0, var uParam1, var uParam2) // Position - 0x2E23
{
	if (bParam0)
		return uParam1;
...
float func_85(var uParam0, var uParam1, int iParam2) // Position - 0x2E3A
{
	var uVar0;
	var uVar3;
...
bool func_86(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2E98
{
	var uVar0;
	var uVar3;
	float fVar6;
...
float func_87(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x2F29
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_88(float fParam0, var uParam1, var uParam2) // Position - 0x2F4A
{
	float fVar0;
	float fVar1;
...
int func_89(var uParam0) // Position - 0x2F89
{
	int iVar0;
...
void func_92() // Position - 0x2FDD
{
	Global_21866 = 0;
	func_93();
}

void func_93() // Position - 0x2FED
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
bool func_94() // Position - 0x300E
{
	return false;
}

void func_95() // Position - 0x3017
{
}

bool func_96() // Position - 0x301F
{
	return true;
}

float func_97(var uParam0, var uParam1) // Position - 0x3028
{
	return func_85(uParam0, uParam1, 1);
}

void func_98(int iParam0) // Position - 0x3039
{
	int iVar0;
...
int func_99(int iParam0) // Position - 0x306A
{
	int iVar0;
	int iVar1;
...
int func_100(int iParam0, bool bParam1) // Position - 0x309B
{
	if (!func_78(iParam0))
	{
		!bParam1;
...
void func_101(int iParam0, int iParam1) // Position - 0x314E
{
	*iParam0 = *iParam0 || iParam1;
}

void func_102(int iParam0, bool bParam1) // Position - 0x315F
{
	if (iParam0 == 1)
		TASK::TASK_PLAY_ANIM(Static_238, &Static_322, &Static_216, 2f, -2f, -1, 0, 0, 0, 0, 0);
	else
...
bool func_103(var uParam0) // Position - 0x31D1
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
			return true;
...
void func_104() // Position - 0x31F2
{
	func_105();
}

void func_105() // Position - 0x31FE
{
	if (!ENTITY::IS_ENTITY_DEAD(Static_238, 0))
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Static_238, "MAG_2_RAGE_PED_GROUP", 0);
}

void func_106() // Position - 0x321C
{
	Static_34 = joaat("U_M_Y_IMPORAGE");
	TEXT_LABEL_ASSIGN_STRING(&Static_232, "PBSH", 8);
	TEXT_LABEL_ASSIGN_STRING(&Static_234, "IMPORAGE", 16);
	TEXT_LABEL_ASSIGN_STRING(&Static_200, "Special_Ped@Impotent_Rage", 64);
	TEXT_LABEL_ASSIGN_STRING(&Static_216, "Base", 64);
	Static_434 = true;
	Static_436 = true;
	Static_250 = 15;
	Static_251 = 6;
	Static_301 = "PBSH_INTERACT" /* GXT: Press ~INPUT_CONTEXT~ to talk to Impotent Rage. */;
	TEXT_LABEL_ASSIGN_STRING(&Static_310, "PBSH_CONV_M1", 16);
	TEXT_LABEL_ASSIGN_STRING(&Static_314, "PBSH_CONV_T1", 16);
	TEXT_LABEL_ASSIGN_STRING(&Static_318, "PBSH_CONV_F1", 16);
	TEXT_LABEL_ASSIGN_STRING(&Static_322, "special_ped@Impotent_Rage@base", 64);
	TEXT_LABEL_ASSIGN_STRING(&Static_338, "special_ped@Impotent_Rage@intro", 64);
	Static_249 = 11;
	Static_253[0] = 4;
	Static_253[1] = 3;
	Static_253[2] = 4;
...
bool func_110() // Position - 0x3375
{
	return true;
}

bool func_111(int iParam0) // Position - 0x337E
{
	return func_112(Global_114931.f_20124, iParam0);
}

bool func_112(int iParam0, int iParam1) // Position - 0x3393
{
	return iParam0 && iParam1 != false;
}

int func_113(var uParam0) // Position - 0x33A2
{
...
void func_114(int iParam0) // Position - 0x34C9
{
	var uVar0;
...
void func_115(var uParam0) // Position - 0x3598
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
struct<6> func_116() // Position - 0x35B8
{
	var uVar0;
...
void func_117() // Position - 0x35DC
{
	func_118();
}

void func_118() // Position - 0x35E8
{
}

void func_119() // Position - 0x35F0
{
	if (Static_243 == -1)
