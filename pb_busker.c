...
void func_1() // Position - 0xE7
{
	...
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Static_43, 10f, 10f, 10f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Static_43, 3f, 3f, 3f, 0, 1, 0))
		{
			BUILTIN::SETTIMERB(0);
			Static_46 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			TASK::OPEN_SEQUENCE_TASK(&Static_52);
			TASK::TASK_TURN_PED_TO_FACE_COORD(0, Static_46, 0);
			TASK::TASK_PLAY_ANIM(0, "amb@BUSKER", "SAX_loop_B", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK::CLOSE_SEQUENCE_TASK(Static_52);
		
			if (!ENTITY::IS_ENTITY_DEAD(Static_50, 0))
				TASK::TASK_PERFORM_SEQUENCE(Static_50, Static_52);
		
			TASK::CLEAR_SEQUENCE_TASK(&Static_52);
		}
	
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Static_43, 3f, 3f, 3f, 0, 1, 0))
		{
			Static_46 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			BUILTIN::SETTIMERB(0);
			TASK::OPEN_SEQUENCE_TASK(&Static_52);
...
{
	Static_49 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);

	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Static_43, 50f, 50f, 50f, 0, 1, 0))
	{
		...
		Static_50 = PED::CREATE_PED(19, joaat("G_M_Y_MEXGOON_02"), Static_43, Static_43.f_1, Static_46.f_2, 0f, 1, 1);
		...
		if (Static_49 == 1)
		{
			Static_46 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Static_50, 3.8f, 0.8f, 0f) };
			Static_51 = PED::CREATE_PED(5, joaat("A_F_M_BEVHILLS_02"), Static_46, 0f, 1, 1);
		
			if (!ENTITY::IS_ENTITY_DEAD(Static_51, 0))
				TASK::TASK_TURN_PED_TO_FACE_COORD(Static_51, Static_43, 0);
		}
