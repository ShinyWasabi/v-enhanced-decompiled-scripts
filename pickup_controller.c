...
void func_3(int iParam0, int iParam1, float fParam2, float fParam3, float fParam4, bool bParam5, bool bParam6) // Position - 0x10B
{
	...
	Static_279[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_4(iParam0), fParam2, iVar0, -1, 2, 1, 0);
	OBJECT::SET_PICKUP_REGENERATION_TIME(Static_279[iParam0], 600000);
}
...
void func_7(int iParam0, int iParam1, float fParam2, float fParam3, float fParam4, bool bParam5, bool bParam6) // Position - 0x1E7
{
	...
	Static_276[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_8(iParam0), fParam2, iVar0, -1, 2, 1, 0);
	OBJECT::SET_PICKUP_REGENERATION_TIME(Static_276[iParam0], 600000);
}
...
void func_11(int iParam0, int iParam1, float fParam2, float fParam3, float fParam4, bool bParam5, bool bParam6) // Position - 0x3F9
{
	...
	Static_264[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_12(iParam0), fParam2, iVar0, -1, 2, 1, 0);
	OBJECT::SET_PICKUP_REGENERATION_TIME(Static_264[iParam0], 600000);
}
...
void func_14() // Position - 0x5B6
{
	switch (Global_34037)
	{
		...
		case 1:
			...
			{
				case 0:
					if (OBJECT::DOES_PICKUP_EXIST(Static_18[Global_34039]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(Static_18[Global_34039]))
						Global_34040 = false;
					else
						Global_34040 = true;
					break;
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(Static_84[Global_34039]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(Static_84[Global_34039]))
						Global_34040 = false;
					else
						Global_34040 = true;
					break;
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(Static_161[Global_34039]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(Static_161[Global_34039]))
						Global_34040 = false;
					else
						Global_34040 = true;
					break;
...
void func_16() // Position - 0x6DF
{
	...
	{
		if (OBJECT::DOES_PICKUP_EXIST(Static_279[iVar0]))
			OBJECT::REMOVE_PICKUP(Static_279[iVar0]);
	}
...
void func_17() // Position - 0x716
{
	...
	for (iVar0 = 0; iVar0 < 1; iVar0 = iVar0 + 1)
	{
		if (OBJECT::DOES_PICKUP_EXIST(Static_276[iVar0]))
			OBJECT::REMOVE_PICKUP(Static_276[iVar0]);
	}
...
void func_18() // Position - 0x74D
{
	...
	{
		if (OBJECT::DOES_PICKUP_EXIST(Static_264[iVar0]))
			OBJECT::REMOVE_PICKUP(Static_264[iVar0]);
	}
...
void func_19() // Position - 0x785
{
	...
	for (iVar0 = 0; iVar0 < 102; iVar0 = iVar0 + 1)
	{
		if (OBJECT::DOES_PICKUP_EXIST(Static_161[iVar0]))
			OBJECT::REMOVE_PICKUP(Static_161[iVar0]);
	}
}
...
void func_20() // Position - 0x7B7
{
	...
	for (iVar0 = 0; iVar0 < 76; iVar0 = iVar0 + 1)
	{
		if (OBJECT::DOES_PICKUP_EXIST(Static_84[iVar0]))
			OBJECT::REMOVE_PICKUP(Static_84[iVar0]);
	}
}
...
void func_21() // Position - 0x7E9
{
	...
	for (iVar0 = 0; iVar0 < 19; iVar0 = iVar0 + 1)
	{
		if (OBJECT::DOES_PICKUP_EXIST(Static_64[iVar0]))
			OBJECT::REMOVE_PICKUP(Static_64[iVar0]);
	}
}
...
void func_22() // Position - 0x81B
{
	...
	for (iVar0 = 0; iVar0 < 45; iVar0 = iVar0 + 1)
	{
		if (OBJECT::DOES_PICKUP_EXIST(Static_18[iVar0]))
			OBJECT::REMOVE_PICKUP(Static_18[iVar0]);
	}
}
...
void func_26(int iParam0, int iParam1, float fParam2, float fParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7) // Position - 0xFF5
{
	...
	Static_161[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_28(iParam0, false), fParam2, iVar0, -1, 2, 1, 0);
	OBJECT::SET_PICKUP_REGENERATION_TIME(Static_161[iParam0], 600000);

	if (bParam6)
		INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(Static_161[iParam0], func_27(iParam0));
}
...
void func_30(int iParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5) // Position - 0x2437
{
	...
	Static_84[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_HEALTH_STANDARD"), func_32(iParam0, false), fParam1, iVar0, -1, 2, 1, 0);
	OBJECT::SET_PICKUP_REGENERATION_TIME(Static_84[iParam0], 600000);

	if (bParam5)
		INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(Static_84[iParam0], func_31(iParam0));
}
...
void func_34(int iParam0, float fParam1, float fParam2, float fParam3, bool bParam4) // Position - 0x3432
{
	...
	Static_64[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_WEAPON_PETROLCAN"), func_35(iParam0), fParam1, iVar0, -1, 2, 1, 0);
	OBJECT::SET_PICKUP_REGENERATION_TIME(Static_64[iParam0], 600000);
}
...
void func_37(int iParam0, float fParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6) // Position - 0x3932
{
	...
	Static_18[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_ARMOUR_STANDARD"), func_39(iParam0, false), fParam1, iVar0, -1, 2, 1, 0);
	OBJECT::SET_PICKUP_REGENERATION_TIME(Static_18[iParam0], 600000);

	if (bParam5)
		INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(Static_18[iParam0], func_38(iParam0));
}
